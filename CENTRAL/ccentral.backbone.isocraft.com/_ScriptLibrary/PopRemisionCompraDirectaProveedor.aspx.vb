...
Public Class clsPopRemisionCompraDirectaProveedor
...
#End Region
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        objProveedor = clsCompras.clsRemision.strBuscarProveedor(intCompaniaId, intSucursalId, strProveedorId, 0, 0, strCadenaConexion)
