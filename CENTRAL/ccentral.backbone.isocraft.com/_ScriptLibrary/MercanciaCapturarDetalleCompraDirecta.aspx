...
<%@ Page Language="vb" AutoEventWireup="false" EnableSessionState="False" EnableViewState="False" Explicit="True" Trace="False" Strict="True" Codebehind="MercanciaCapturarDetalleCompraDirecta.aspx.vb" Inherits="com.isocraft.backbone.ccentral.clsMercanciaCapturarDetalleCompraDirecta" codePage="28592"%>
<HTML>
<HEAD>
<title>Sistema Administrador de Sucursal</title>
<%  '====================================================================
    ' Page          : MercanciaCapturarDetalleCompraDirecta.aspx
    ' Title         : Administracion POS y BackOffice
    ' Description   : Captura el Detalle de la Compra Directa
...
function strFolioOrdenId(){
    document.write("<%= Request("txtFolioOrdenId")%>");
    return(true);
}
...
function objLupa2Articulo_onClick() { 
   ...
   if (document.forms[0].elements['hdnSoloOrden'].value==1) {
       // El proveedor solo admite captura por orden
         ...
         if (!isNaN(document.forms[0].txtArticuloId.value)){
			   if (document.forms[0].txtArticuloId.value != '0'){
			       ...
			       return(true);
		             ...
		             strParametros = strParametros + '&strTipoProveedorNombreId=COMPRADIRECTA'
				     strParametros = strParametros + '&intArticulosCompletos=0';
                    
				    Pop('PopArticuloProveedor.aspx?'+strParametros,500,540);
			       }
			    return(false);
	         }
	      else{ 
...
function cmdRegresar_onclick() {
   document.forms[0].action = "MercanciaCapturarCompraDirecta.aspx?strCmd=ModificarDatos";
   document.forms[0].submit();
   return(true);
}
...
function cmdAgregar_onclick() {
  ...
  if (document.forms(0).txtArticuloId.value != document.forms(0).hdnArticuloEncontradoId.value)  {
   ...
   if (valida){valida=blnValidarCampo(document.forms['frmMercanciaCapturarDetalleCompraDirecta'].elements['txtCantidad'],true,"Cantidad", cintTipoCampoEntero,20,1,""); }
      if (!valida){
         return(valida);
        }
       
    // Cantidad que sea mayor a cero
    if (parseInt(document.forms['frmMercanciaCapturarDetalleCompraDirecta'].elements['txtCantidad'].value) <= 0){
   ...
   // Validacion del costo del articulo si esta configurada su captura
    if (document.forms[0].elements['hdnCapturaCosto'].value==1) {
       ...
       if (valida) {
           valida=blnValidarCampo(document.forms['frmMercanciaCapturarDetalleCompraDirecta'].elements["txtCostoUnitario"],true,"Costo Unitario", cintTipoCampoCadenaDefinida,20,1,".0123456789");
       }
       ...
       fltMargenInferiorCompra = document.forms[0].txtMargenInferiorCompra.value;
       fltMargenSuperiorCompra = document.forms[0].txtMargenSuperiorCompra.value;
	...
	{ // Validar que exista coto de reposicion para el articulo capturado
...
function cmdModificarDatos_onClick(){
   document.forms[0].action = "MercanciaCapturarCompraDirecta.aspx?strCmd=ModificarImporte"; 
   document.forms[0].submit();  
   return(true); 
}
...
// Despliega el Folio asignado a la Compra Directa
function fnUpRegistrarCompraDirecta(intFolioCompraDirecta, intError) {
   if (intError==0) {
       document.forms(0).txtIntFolioCDI.value = intFolioCompraDirecta;
       alert("Compra Directa Registrada con el Folio : [" + intFolioCompraDirecta + "]");       
       
       strParametros = '?intCompraDirectaId=' + document.forms[0].txtCompraDirectaId.value ;
       ...
       strParametros = strParametros + '&txtRazonSocialProveedor='  + document.forms[0].txtRazonSocialProveedor.value;       
   	   strParametros = strParametros + '&txtFolioOrdenId=' + document.forms[0].txtFolioOrdenId.value;       
       ...
       window.location.href = "MercanciaCompraDirectaConfirmada.aspx" + strParametros;       
   }
   else {
       if (intError == -97) {
       ...
       if (intError == -120) {
           alert ("No existe la remisión pendiente");
       }   	   
       if (intError == -1000) {
...
<form name="frmMercanciaCapturarDetalleCompraDirecta" action="about:blank" method="post">
      ...
      <td width="100%"> <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr> 
            ...
            <td class="tdmigaja" width="583"><span class="txdmigaja">Está en : 
              ...
              <span class="txdmigaja">Capturar compra directa</span></td>
            ...
            <td vAlign="top" width="583"> <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                <tr> 
                  <td class="tdtablacont" vAlign="top" width="100%"> <table width="100%" cellSpacing="0" cellPadding="0" border="0">
                      <tr> 
                        <td class="tdtittablas3" vAlign="middle" align="right" width="80%">Compra 
                          Directa Folio: </td>
                    ...
                    <br> <table class="tdenvolventetablas" width="100%">
                      ...
                      <TR> 
                        ...
                        <td class="campotablaresultadoenvolventeazul" align="left" width="20%"><script language="JavaScript">strFolioOrdenId()</script></td>
                      </TR>
                    </table>
                    <br> <table class="tdenvolventetablas" width="100%">
                      <tr> 
                    ...
                    <div id="divDetalle" name="divDetalle"></div>
                      ...
                      <tr> 
                        ...
                        <td class="tdpadleft5" vAlign="middle" align="left" width="10%"> 
                          <input class="campotablahabilitadoderecha" id="txtCantidad" onkeydown="if(event.keyCode==13){if(document.forms[0].elements['hdnCapturaCosto'].value==1){document.forms[0].elements['txtCostoUnitario'].focus();}else{document.forms[0].elements['cmdAgregar'].focus();};}"
																onfocus="return txtCantidad_onfocus()" type="text" maxLength="8" size="12" name="txtCantidad"
																autocomplete="off"> 
                        </td>
                        <td class="tdpadleft5" vAlign="middle" align="left" width="10%"><input class="campotablahabilitadoderecha" id="txtCostoUnitario" onkeydown="if(event.keyCode==13){document.forms[0].elements['cmdAgregar'].focus();} if(event.keyCode==9){document.forms[0].elements['cmdAgregar'].click(); return(false);}"
  ...
  <tr> 
    ...
    <input type='hidden' value= '<%=Request.Form("hdnCapturaRemision")%>' name='hdnCapturaRemision' >
    <input type='hidden' value= '<%=Request.Form("hdnRemisionDisponible")%>'  name='hdnRemisionDisponible' >
    <input type='hidden' value= '<%=Request.Form("hdnRemisionId")%>'  name='hdnRemisionId' >
    <input type='hidden' value= '<%=Request.Form("txtRemisionFolio")%>'  name='txtRemisionFolio' >
