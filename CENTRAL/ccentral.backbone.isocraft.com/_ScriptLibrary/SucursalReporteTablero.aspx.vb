'====================================================================
' Page          : SucursalReporteTablero.aspx
' Title         : Administracion POS y BackOffice
' Description   : Página Reporte de Genericos
...
Public Class SucursalReporteTablero
...
#Region " Class Private Attributes"
    ...
    Private intDireccionOperativaId As Integer = 0
    Private intZonaOperativaId As Integer = 0
...
#End Region
    ...
    Public ReadOnly Property strRegionId() As String
        Get
            Return intDireccionOperativaId.ToString("000")
        End Get
    End Property

    Public ReadOnly Property strZonaId() As String
        Get
            Return intZonaOperativaId.ToString("000")
        End Get
    End Property
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        intDireccionOperativaId = 0
        intZonaOperativaId = 0

        objArraySucursal = clsConcentrador.clsSucursal.strBuscar(intCompaniaId.ToString("00") & intSucursalId.ToString("0000"), strCadenaConexion)
