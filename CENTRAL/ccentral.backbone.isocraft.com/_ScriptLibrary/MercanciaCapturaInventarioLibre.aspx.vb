...
Public Class MercanciaCapturaInventarioLibre
...
#End Region
    ...
    Private Function strImprimeEncabezado(ByVal strHojaActual As String, ByVal strHojaFinal As String) As String
        ...
        strHtmlEncabezado.Append("<th align='center' colspan='3'  class='tdblancoSinRaya' nowrap>" & strCentroLogisticoId & " - " & strSucursalNombre & " (" & intCompaniaId.ToString & intSucursalId.ToString("000") & ")</th>")
