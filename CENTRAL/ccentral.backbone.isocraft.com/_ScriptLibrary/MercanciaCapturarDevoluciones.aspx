...
<%@ Page Language="vb" AutoEventWireup="false" EnableSessionState="False" EnableViewState="False" Explicit="True" Trace="False" Strict="True" Codebehind="MercanciaCapturarDevoluciones.aspx.vb" Inherits="com.isocraft.backbone.ccentral.clsMercanciaCapturarDevoluciones" codePage="28592"%>
<HTML>
<HEAD>
<title>Sistema Administrador de Sucursal</title>
<%
    '====================================================================
    ' Page          : MercanciaCapturarDevoluciones.aspx
	...
	'                 02 Septiembre 2016 [JAHD]   Validacion productos autorizados
    '====================================================================	
%>
...
function strTituloMigaja3(){
	document.write("Devolución de mercancía");
}
function strTituloPrincipalDePagina() {
	document.write("Capturar devoluciones");
}
...
function window_onload() {
	...
	if("<%=Lcase(strTipoProveedorNombreId)%>"=="proveedordirecto"){ document.forms[0].elements['rdoTipoProveedor1'].checked=true; }
	if("<%=Lcase(strTipoProveedorNombreId)%>"=="proveedormayorista"){ document.forms[0].elements['rdoTipoProveedor2'].checked=true; }
...
function cmdOtraDevolucion_onclick(){
  window.location = "MercanciaCapturarDevoluciones.aspx";
  return(true);
}
...
function objLupaProveedor_onclick(){
   ...
   {   
       ...
       if (document.frmMercanciaCapturarDevoluciones.rdoTipoProveedor1.checked){
           strTipoProveedor = "ProveedorDirecto";
       }       
       // Esta seleccionado el proveedor mayorista
       if (document.frmMercanciaCapturarDevoluciones.rdoTipoProveedor2.checked){
           strTipoProveedor = "ProveedorMayorista";
       }
       if (strTipoProveedor == "") {
	    alert("Seleccionar el Tipo de proveedor");
		document.forms[0].elements['cmbMotivo'].focus();
        return(false);
       }
      ...
      strParametros = strParametros + '&intTipoVigencia=2'; // Consulta todos los proveedores
...
function txtNumeroFactura_onblur() { 
   ...
   if ( document.forms(0).txtProveedorNombreId.value == '' && document.forms(0).txtNumeroFactura.value == '') {
       ...
       var intMotivoDevolucion = document.forms[0].elements['cmbMotivo'].value*1;
		...
		if(document.forms(0).elements('rdoTipoProveedor2').checked && (intMotivoDevolucion==3 || intMotivoDevolucion==4 || intMotivoDevolucion==5)) {	   
...
function txtIntArticuloId_onblur() {
	if(Trim(document.forms(0).elements('txtIntArticuloId').value)==''){
		...
		document.forms(0).hdnArticuloPermiteDevolucion.value = '';
		return
	}
...
function fnUpdArticuloPorIframe(strAccion, strListaHTML, intRegistrosLista, intDevolucionId, intArticuloBuscadoId, strArticuloBuscadoDescripcion, blnArticuloPermiteDevolucion, intError) {
   ...
   if (strAccion == 'BUSCAR') { 
       ...
       document.forms(0).hdnArticuloPermiteDevolucion.value = blnArticuloPermiteDevolucion;
           	
       if(intError == 0) {
           if(blnArticuloPermiteDevolucion == 1) {
               document.forms(0).txtCantidad.focus();
               document.forms(0).txtCantidad.select();
           }
           else {
               alert("Artículo no autorizado para devolución.");
               document.forms(0).txtCantidad.value='';	
               document.forms(0).hdnIntArticuloId.value = '';
               document.forms(0).txtIntArticuloId.value = '';
               document.forms(0).txtIntArticuloId.focus();
   ...
   if (strAccion == 'AGREGAR' || strAccion == 'ELIMINAR' ) { 
       ...
       if (intError == 0) {
           ...
           if (strAccion == 'AGREGAR' ) { 
               ...
               if (intError == -130) {
                   strMensaje = "El articulo no esta autorizado para devolución";
               }
           }
...
function blnDatosDevolucion() {
   ...
   //fecha de devolucion
   if(valida){ valida=blnValidarCampo(document.forms(0).elements("txtFechaDeDevolucion"),true,"Fecha de devolución",cintTipoCampoFecha,10,10,""); } 
   ...
   if(valida) {  
       ...
       if ( document.forms(0).elements('rdoTipoProveedor2').checked && hdnFacturaElectronicaId < 1 && (intMotivoDevolucion==3 || intMotivoDevolucion==4 || intMotivoDevolucion==5) ) {
...
function intAgregarArticulo() {
   ...
   if(valida){	 
       ...
       if(document.forms(0).hdnArticuloPermiteDevolucion.value=='0') {
           document.forms(0).elements("txtIntArticuloId").value='';
           document.forms(0).elements("txtIntArticuloId").focus();
           valida=false;
       } 
...
<form name="frmMercanciaCapturarDevoluciones" action="about:blank" method="post">
  <table width="780" border="0" cellpadding="0" cellspacing="0">
            ...
            <td class="tdtablacont" vAlign="top" width="583"><span class="txtitulo"> 
              ...
              <br> <div id="ToPrintHtmContenido"> 
                ...
                <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                  ...
                  <tr> 
                    <td class="tdtittablas" width="25%">Tipo de proveedor:</td>
                    <td class="tdconttablas" width="75%" vAlign="top"><input onkeypress="cmdonKeyPressed(3,event.keyCode);" id="rdoTipoProveedor1" type="radio"
    ...
    <tr> 
      <td> <input type="hidden" name="hdnDevolucionId"> <input type="hidden" name="hdnFacturaElectronicaId" value= '<%=Request.Form("hdnFacturaElectronicaId")%>'> 
        ...
        <input type="hidden" name="hdnArticuloPermiteDevolucion" value= '<%=Request.Form("hdnArticuloPermiteDevolucion")%>'> 
...
<iframe name="ifrOculto" src="" width="850" height="600"></iframe>
