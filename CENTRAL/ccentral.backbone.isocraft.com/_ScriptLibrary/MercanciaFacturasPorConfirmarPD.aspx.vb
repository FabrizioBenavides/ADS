...
Public Class clsMercanciaFacturasPorConfirmarPD
    ...
    Public ReadOnly Property strRecordBrowserHTML() As String
        Get
            ...
            strTargetURL = "MercanciaFacturasPorConfirmarPD.aspx?"

            ' Consultamos los proveedores con facturas pendientes por Confirmar

            If intProveedorId > 0 Then

                objProveedoresConFacturas = clsConcentrador.clsSucursal.clsMercancia.clsCompras.clsFacturaElectronica.strBuscarProveedor(intCompaniaId, intSucursalId, intProveedorId, 0, 0, strCadenaConexion)
                ...
                If IsArray(objProveedoresConFacturas) AndAlso objProveedoresConFacturas.Length > 0 Then
                    ...
                    Return clsCommons.strGenerateJavascriptString(clsRecordBrowser.strGetHTML("MercanciaFacturasPorConfirmarPD", objProveedoresConFacturas, 1, objProveedoresConFacturas.Length, strTargetURL))
                Else
                    Return ""
                End If
            Else
    ...
    ' Output     : Integer
    '====================================================================
    Public ReadOnly Property intFacturaElectronicaCompraDirectaId() As Integer
        Get
            If Not IsNothing(Request.QueryString("intFacturaElectronicaCompraDirectaId")) Then
                Return CInt(Request.QueryString("intFacturaElectronicaCompraDirectaId"))
            Else
                Return 0
            End If
        End Get
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case strCmd
            Case "Ver"
                Call Response.Redirect("MercanciaDetalleFacturaElectronicaPD.aspx" & "?intProveedorId=" & intProveedorId.ToString & "&intFacturaElectronicaId=" & intFacturaElectronicaCompraDirectaId.ToString)

            Case "Confirmar"
                Call Response.Redirect("MercanciaConfirmacionFacturaPD.aspx" & "?intProveedorId=" & intProveedorId.ToString & "&intFacturaElectronicaId=" & intFacturaElectronicaCompraDirectaId.ToString)
