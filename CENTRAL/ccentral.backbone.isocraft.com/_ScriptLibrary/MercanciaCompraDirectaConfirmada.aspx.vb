...
Public Class clsMercanciaCompraDirectaConfirmada
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If IsArray(objArrayComprasDirectas) AndAlso objArrayComprasDirectas.Length > 0 Then
            ...
            Dim objDetalleCompra As Array = clsConcentrador.clsSucursal.clsMercancia.clsCompras.strBuscarDetalle(intCompaniaId, intSucursalId, intCompraDirectaId, strCadenaConexion)
