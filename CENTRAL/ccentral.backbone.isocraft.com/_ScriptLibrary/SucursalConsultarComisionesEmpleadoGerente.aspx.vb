...
Public Class clsSucursalConsultarComisionesEmpleadoGerente
...
#End Region
    ...
    Public ReadOnly Property strRecordBrowserHTML() As String
        Get
            ...
            Dim strTargetURL As String = "SucursalConsultarComisionesEmpleadoGerente.aspx?"

            strbldRecordBrowserHTML = New StringBuilder

            ' Busco los empelados de la sucursal
            objEmpleadoPrenomina = clsConcentrador.clsPrenomina.strBuscarComisionEmpleadoGerente(intCompaniaId, intSucursalId, intEmpleadoBusquedaId, dtmInicioPeriodo, dtmFinPeriodo, 0, 0, strCadenaConexion)

            If IsArray(objEmpleadoPrenomina) Then
                If objEmpleadoPrenomina.Length > 0 Then

                    ' Generamos el Navegador de Registros
                    strbldRecordBrowserHTML.Append(clsRecordBrowser.strGetHTML("SucursalConsultarComisionesEmpleadoGerente", objEmpleadoPrenomina, 1, intElementos, strTargetURL))
                End If
            End If
