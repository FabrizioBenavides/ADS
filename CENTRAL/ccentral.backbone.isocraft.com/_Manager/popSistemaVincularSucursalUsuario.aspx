<%@ Page CodeBehind="popSistemaVincularSucursalUsuario.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="com.isocraft.backbone.ccentral.clsPopSistemaVincularSucursalUsuario" Explicit="True" Trace="False" Strict="True" codePage="1252" EnableSessionState="False" enableViewState="False"%>
<html>
<head>
...
<form method="POST" action="about:blank" name="frmPopSucursalVincularSucursalUsuario">
  ...
  <table width="360" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="tdgeneralcontentpop"><h2>Asignar Sucursales a usuario </h2>
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="19%" class="tdtexttablebold"> Usuario: </td>
            <td width="81%" class="tdcontentableblue"><script language="javascript">strEmpleadoId()</script></td>
          </tr>
          <tr>
            <td class="tdtexttablebold">Nombre:</td>
            <td class="tdcontentableblue"><script language="javascript">strEmpleadoNombre()</script></td>
          </tr>
          <tr>
            <td class="tdtexttablebold">Grupo: </td>
            <td class="tdcontentableblue"><script language="javascript">strGrupoUsuarioNombre()</script></td>
          </tr>
          <tr>
      ...
      <br>
         <p>Elija las sucursales que desea asignar al usuario indicado y oprima el botón cerrar selección. Para elegir m&aacute;s de una sucursal, haga clic en los nombres correspondientes. </p>
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
...
&nbsp;Seleccionar todas</td>
          ...
          <tr>
            <td width="81%" class="tdpadleft5"><select name="cboSucursal" size="10" multiple="multiple">
              </select>
            </td>
          </tr>
        </table>
