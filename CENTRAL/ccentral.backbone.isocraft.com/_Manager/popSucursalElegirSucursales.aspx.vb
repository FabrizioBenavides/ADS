'====================================================================
' Class         : clsPopSucursalElegirSucursales
...
'====================================================================
Public Class clsPopSucursalElegirSucursales
...
#End Region
    ...
    Public ReadOnly Property intMonedaId() As Integer
        Get
            If intmMonedaId = 0 Then
                intmMonedaId = CInt(isocraft.commons.clsWeb.strGetPageParameter("intMonedaId", isocraft.commons.clsWeb.strGetPageParameter("txtMonedaId", "0")))
            End If
            Return intmMonedaId
        End Get
    End Property
    ...
    Public ReadOnly Property strMonedaNombre() As String
        Get
            If intMonedaId > 0 Then
                Dim astrData As Array = Benavides.CC.Data.clstblMoneda.strBuscar(intMonedaId, "", "", Now, "", 0, 0, strConnectionString)
    ...
    Public Function strLlenarSucursalesComboBox() As String
        If intMonedaId > 0 AndAlso intDireccionId > 0 AndAlso intZonaId > 0 Then
            Return isocraft.commons.clsWeb.strCreateJavascriptComboBoxOptions("cboSucursales", "", Benavides.CC.Data.clsTienda.clsSucursal.strBuscarSucursalesConMonedasAsignadas(intMonedaId, intDireccionId, intZonaId, strConnectionString), New Integer(1) {0, 1}, 2, 0)
        End If
    End Function
