<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SucursalAsignacionDeArticuloDPEmpresasServicios.aspx.vb" Inherits="com.isocraft.backbone.ccentral.SucursalAsignacionDeArticuloDPEmpresasServicios" %>
...
function window_onload() {  
  ...
  document.forms[0].elements["txtEmpresaServicioCodigoServicio"].value = "<%= strEmpresaServicioCodigoServicio %>";
...
{
      document.forms[0].action += "?strCmd=Guardar&intEmpresaServicioId=" + <%= intEmpresaServicioId()%>;
...
function cmdRegresar_onclick() {
    window.location.href = "SucursalAsignacionDeArticuloEmpresasServicios.aspx";   
}
			...
			<table border="0" cellSpacing="0" cellPadding="0" width="780">
				<tr>
					...
					<td class="tdtab" width="770">Está en : <A href="SucursalHome.aspx">Sucursal</A> : 
						Promoción de Servicios :<A href="SucursalAsignacionDeArticuloHome.aspx"> Empresas 
							de Servicios </A>: Asignacion de codigo DP&nbsp;Empresas de Servicios
					</td>
				</tr>
			</table>
			<table border="0" cellSpacing="0" cellPadding="0" width="780">
				<tr>
					<td class="tdgeneralcontent">
						<h1>Promoción Asignación de Artículo&nbsp;Empresas de Servicios</h1>
						<P>Aquí podrá dar de alta o modificar&nbsp;el codigo DP de una empresa de 
							servicios.</P>
						<P>&nbsp;</P>
						<table border="0" cellSpacing="0" cellPadding="0">
							<tr>
								...
								<td class="tdpadleft5"><input class="field" value="Empresas de Servicios" readOnly maxLength="50" size="80">
								</td>
							</tr>
							<tr>
						...
						<h2>Definir&nbsp;Empresa de Servicios</h2>
						<table border="0" cellSpacing="0" cellPadding="0">
							<tr>
								<td style="WIDTH: 179px" class="tdtexttablebold"><label for="txtEmpresaServicioNombre">Servicio:</label>								
								</td>
								<td class="tdpadleft5"><input id="txtEmpresaServicioNombre" class="field" readOnly maxLength="80" size="80" name="txtEmpresaServicioNombre">
								</td>
							</tr>
							<%---EBCV---%>
							<tr>
								<td style="WIDTH: 179px" class="tdtexttablebold"><label for="txtEmpresaServicioCodigoServicio">Código 
										Producto:</label>
								</td>
								<td class="tdpadleft5"><input id="txtEmpresaServicioCodigoServicio" class="field" readOnly maxLength="80" size="80"
										name="txtEmpresaServicioCodigoServicio">
								</td>
							</tr>
							<tr>
						...
						<table>
							<TBODY>
								<tr>
									<td class="tdpadleft5" width="499"><input style="DISPLAY: none" id="txtEmpresaServicioId" class="campotablaresultado" readOnly
											maxLength="80" size="80" name="txtEmpresaServicioId">
									</td>
								</tr>
					</td>
				</tr>
