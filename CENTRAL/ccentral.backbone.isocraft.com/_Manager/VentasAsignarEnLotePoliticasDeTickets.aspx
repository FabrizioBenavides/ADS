<%@ Page CodeBehind="VentasAsignarEnLotePoliticasDeTickets.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="com.isocraft.backbone.ccentral.clsVentasAsignarEnLotePoliticasDeTickets" codePage="1252" EnableSessionState="False" enableViewState="False"%>
<html>
<head>
...
function cmdRegresar_onclick() {
  window.location.href = "VentasAdministrarPoliticasDeTickets.aspx?intDireccionId=<%= intDestinoDireccionId %>&intZonaId=<%= intDestinoZonaId %>";
}
...
<form method="POST" action="about:blank" name="frmVentasAdministrarPoliticasDeTickets" onSubmit="return blnFormValidator(this)">
  ...
  <table width="780" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="10">&nbsp;</td>
      <td width="770" class="tdtab">Est&aacute; en : <a href="Ventas.htm">Ventas</a> : Tickets : Administrar pol&iacute;ticas de tickets  : Asignar en lote pol&iacute;ticas de tickets </td>
    </tr>
  </table>
  <table width="780" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td class="tdgeneralcontent"><h1>Asignar en lote pol&iacute;ticas de tickets </h1>
        <h2>Definir sucursal origen (de ella se copiar&aacute;n las pol&iacute;ticas) </h2>
        <p>Elija la sucursal cuyas pol&iacute;ticas de tickets asignar&aacute; a un lote de sucursales. </p>
