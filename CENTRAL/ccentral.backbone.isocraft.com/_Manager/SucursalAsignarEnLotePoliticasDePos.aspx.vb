'====================================================================
' Class         : clsSucursalAsignarEnLotePoliticasDePos
' Title         : Grupo Benavides. Administrador POS y Backoffice.
' Description   : Asignar en lote políticas de POS
...
'====================================================================
Public Class clsSucursalAsignarEnLotePoliticasDePos
                            ...
                            For Each astrElementoCompaniaSucursal In astrCompaniaSucursal
                                ...
                                If intDestinoCompaniaId > 0 AndAlso intDestinoSucursalId > 0 Then
                                    ...
                                    For Each strPoliticaId In astrPoliticas
                                        ...
                                        Dim intTipoDatoPoliticaPOSId As Integer = CInt(strPoliticaId)
                                        ...
                                        If intTipoDatoPoliticaPOSId > 0 Then
                                            ...
                                            If Benavides.CC.Data.clstblPoliticaPosSucursal.strBuscar(intTipoDatoPoliticaPOSId, intDestinoCompaniaId, intDestinoSucursalId, intCajaId, "", Now, "", 0, 0, strConnectionString).Length = 0 Then
                                                ...
                                                If astrData.Length > 0 Then
                                                    ...
                                                    ' Obtenemos las cajas de la compañía y sucursal destino
                                                    Dim astrCajas As Array = Benavides.CC.Data.clstblCaja.strBuscar(intDestinoCompaniaId, intDestinoSucursalId, 0, 0, 0, "", "", "", "", Now, Now, "", 0, 0, strConnectionString)
                                                    Dim astrCaja As Array = Nothing

                                                    ' Por cada caja destino
                                                    For Each astrCaja In astrCajas

                                                        ' Obtenemos el identificador de la caja
                                                        Dim intDestinoCajaId As Integer = CInt(astrCaja.GetValue(2))
