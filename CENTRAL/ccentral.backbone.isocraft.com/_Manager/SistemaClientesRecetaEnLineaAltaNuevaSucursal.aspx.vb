...
Public Class SistemaClientesRecetaEnLineaAltaNuevaSucursal
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim intContadorAlta As Integer
        Dim intErrorAgregar As Integer
        ...
        Select Case strCmd
            Case "AgregarCliente"
                ...
                intContadorAlta = clsClientesABF. _
                                  clsClienteRecetaEnLineaABF. _
                                  intCopiarClienteSucursalesAsignadas(intCompaniaEspejoId, _
                                                                      intSucursalEspejoId, _
                                                                      intCompaniaNuevaId, _
                                                                      intSucursalNuevaId, _
                                                                      strUsuarioNombre, _
                                                                      strConnectionString)

                If intContadorAlta < 0 Then
                    'Error al copiar los clientes de la sucursal espejo
                    intErrorAgregar = -100
                End If

                strHTML.Append("<script language='Javascript'> parent.fnUpAgregarClientes( " & _
