...
'====================================================================
Public Class clsVentasAdministrarArticulosNoAutorizados
...
#End Region
    ...
    Public Function strGetRecordBrowserHTML() As String
        ...
        If intClienteEspecialId > 0 Then
            ...
            Const strRecordBrowserName As String = "VentasAdministrarArticulosNoAutorizados"

            ' Declaramos e inicializamos las variables locales
            Dim intSelectedPage As Integer = GetPageParameter("intNavegadorRegistrosPagina", 1)
            Dim astrDataArray As Array = Benavides.CC.Data.clsClienteEspecial.strBuscarArticulosNoAutorizadoParaVentaACredito(intClienteEspecialId, 0, Now(), "", Benavides.CC.Commons.clsRecordBrowser.clsIndicator.intCalculateFirstElement(intSelectedPage, intElementsPerPage), intElementsPerPage, strConnectionString)
            ...
            Case "Agregar"
                ...
                If IsNothing(txtArticuloClienteEspecialArchivo.PostedFile) = False AndAlso intClienteEspecialId > 0 Then
                    ...
                    If IsNothing(astrRows) = False AndAlso astrRows.Length > 0 Then
                        ...
                        Call Benavides.CC.Data.clstblArticuloNoAutorizadoParaVentaCredito.intEliminar(intClienteEspecialId, 0, Now(), strUsuarioNombre, strConnectionString)
                        ...
                        For Each astrColumns As Array In astrRows
                            ...
                            If astrColumns.Length = 1 Then
                                ...
                                If intArticuloId > 0 Then
                                    intCounter += Benavides.CC.Data.clstblArticuloNoAutorizadoParaVentaCredito.intAgregar(intClienteEspecialId, intArticuloId, Now(), strUsuarioNombre, strConnectionString)
                                End If
                    ...
                    If IsNothing(astrRows) = False AndAlso astrRows.Length > 0 Then
                        ...
                        For Each astrColumns As Array In astrRows
                            ...
                            If astrColumns.Length = 1 Then
                                ...
                                If intArticuloId > 0 Then
                                    ...
                                    Dim intReturnedValue As Integer = Benavides.CC.Data.clstblArticuloNoAutorizadoParaVentaCredito.intAgregar(intClienteEspecialId, intArticuloId, Now(), strUsuarioNombre, strConnectionString)
                                    ...
                                    If intReturnedValue > 0 Then
                                        ...
                                        Call aobjDataList.Add(New String() {CStr(intClienteEspecialId), CStr(intArticuloId), Now.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture), strUsuarioNombre})
                        ...
                        If aobjData.Length > 0 Then
                            ...
                            If Len(strTiendaConcentradorIP) > 0 AndAlso IsNothing(objStoresArray) = False AndAlso objStoresArray.Length > 0 Then
                                ...
                                Call Benavides.CC.Business.clsConcentrador.strEnviarMensajeCompletoHaciaServidoresPuntoDeVenta("clstblArticuloNoAutorizadoParaVentaCredito", Benavides.POSAdmin.Commons.clsCommons.clsMSMQ.enmMQCommandId.ELIMINAR_AGREGAR, "POS", aobjData, objStoresArray)
