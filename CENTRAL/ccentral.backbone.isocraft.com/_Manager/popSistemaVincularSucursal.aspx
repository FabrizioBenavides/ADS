				...
				<tr>
					<td class="tdgeneralcontentpop"><h2>Vincular sucursales
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td class="tdtexttablebold">Descripción Sucursal:
								</td>
						...
						<p>Elija la sucursal a la que quiere vincular a la tienda y oprima el botón 
							"Vincular". Para elegir más de una sucursal, haga clic en los nombres 
							correspondientes.
						</p>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
