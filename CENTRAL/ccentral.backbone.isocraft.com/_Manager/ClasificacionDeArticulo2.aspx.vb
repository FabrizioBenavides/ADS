'====================================================================
' Class         : clsClasificacionDeArticulo2
' Title         : Grupo Benavides. Catálogo de Catergorías2 
...
Public Class clsClasificacionDeArticulo2
...
#Region "Properties"
    ...
    Protected _txtNombre As String
    Protected _txtClasificacion As String
    ...
    ' Output     : String
    '====================================================================
    Public Property txtClasificacion() As String
        Get
            Return _txtClasificacion
        End Get
        Set(ByVal strValue As String)
            _txtClasificacion = strValue
        End Set
    End Property
#End Region
...
#Region "Document Business"
    ...
    Protected Overrides Function strDesplegarValores(ByVal arrValues As Array) As String
        If arrValues.Length > 0 Then
            ...
            htmlResult += "parent.parent.document.getElementById('divClasificacionId').innerHTML=" + Chr(39) + CStr(rowArray.GetValue(0)) + Chr(39) + ";" + vbTab
            htmlResult += "	parent.parent.document.getElementById('divClasificacionNombre').innerHTML=" + Chr(39) + CStr(rowArray.GetValue(1)) + Chr(39) + ";" + vbTab
            If CStr(rowArray.GetValue(2)).ToLower = "true" Then
                htmlResult += "parent.parent.document.getElementById('divClasificacionActivo').innerHTML=" + Chr(39) + "Si" + Chr(39) + ";" + vbTab
            Else
                htmlResult += "parent.parent.document.getElementById('divClasificacionActivo').innerHTML=" + Chr(39) + "No" + Chr(39) + ";" + vbTab
            End If
            Return htmlResult
        Else
            Return ""
    ...
    Protected Overrides Function strGenerarListado(ByVal strCmd As String) As String
        ...
        actions.Add(New clsActionLink("Editar", pkNames, pkIndexes, Me._IMG_DETALLE, "Haga clic aquí para editar este listado"))
...
#Region "metodos de la interface PrintInterface"
    ...
    Protected Overrides Function getHeaders() As String
        ...
        Dim values As String() = {"No. Clasificación", "Nombre", "Activo"}
    ...
    Protected Overrides Function getTitle(ByVal currentPage As Integer, ByVal totalPages As Integer) As String
        ...
        Dim values1 As String() = {"Reporte de Clasificación de Artículos", "", "HOJA: " + currentPage.ToString + " / " + totalPages.ToString}
