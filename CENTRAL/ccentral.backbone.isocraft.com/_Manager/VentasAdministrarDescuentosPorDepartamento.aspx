<%@ Page CodeBehind="VentasAdministrarDescuentosPorDepartamento.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="com.isocraft.backbone.ccentral.clsVentasAdministrarDescuentosPorDepartamento" codePage="1252" EnableSessionState="False" enableViewState="False"%>
<HTML>
<HEAD>
...
function cmdLimpiar_onclick() {
  window.location.href = "VentasAdministrarDescuentosPorDepartamento.aspx";
}
  ...
  <table width="780" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="770" class="tdtab">Está en : <a href="Sistema.aspx">Sistema</a> : <a href="SistemaClientesEspeciales.aspx"> Clientes
          especiales</a> : Asignar descuentos por división categoría</td>
    </tr>
  </table>
  <table width="780" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td class="tdgeneralcontent"><h1>Asignar descuentos por división categoría</h1>
        <p>Aquí podrá dar de alta en el sistema descuentos por división categoría
          y	asignárselos a un cliente especial.</p>
        <h2>Buscar cliente especial y archivo con descuentos </h2>
        <table border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td colspan="3"><p>2. Localice el archivo a importar con los descuentos
                correspondientes.</p>
            </td>
          </tr>
          <tr>
