'====================================================================
' Class         : clsSucursalVerCajasInhabilitadasDetalleDireccion
...
'====================================================================
Public Class clsSucursalVerCajasInhabilitadasDetalleDireccion
...
#End Region
    ...
    Public Function strLlenarDireccionComboBox() As String
        Return isocraft.commons.clsWeb.strCreateJavascriptComboBoxOptions("cboDireccion", intDireccionId, Benavides.CC.Data.clsTienda.clsSucursal.clsPuntoVenta.strEjecutarBuscarCajasInhabilitadas(CDate(strFechaInicial), CDate(strFechaFinal), 1, 100, strConnectionString), 0, 1, 1)
    End Function
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        Const strRecordBrowserName As String = "SucursalVerCajasInhabilitadasDetalleDireccion"
        ...
        Dim astrDataArray As Array = Benavides.CC.Data.clsCaja.strEjecutarBuscarCajasInhabilitadasPorDireccion(intDireccionId, dtmFechaInicial, dtmFechaFinal, CInt(Benavides.CC.Commons.clsRecordBrowser.clsIndicator.intCalculateFirstElement(intSelectedPage, intElementsPerPage)), intElementsPerPage, strConnectionString)
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case strCmd
            ...
            Case "Ver"
                ...
                Call Response.Redirect("SucursalVerCajasInhabilitadasDetalleZona.aspx?intDireccionOperativaId=" & intDireccionId & "&intZonaOperativaId=" & intZonaOperativaId & "&strFechaInicial=" & strFechaInicial & "&strFechaFinal=" & strFechaFinal)
