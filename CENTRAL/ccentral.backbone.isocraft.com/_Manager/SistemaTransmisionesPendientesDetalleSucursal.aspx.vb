...
Imports System.Text
'====================================================================
' Class         : clsSistemaTransmisionesPendientesDetalleSucursal
...
'====================================================================
Public Class clsSistemaTransmisionesPendientesDetalleSucursal
...
#End Region
    ...
    Public ReadOnly Property strEncabezadoHTML() As String
        Get
            ...
            objData = Benavides.CC.Data.clstblSucursal.strBuscar(intCompaniaId, intSucursalId, 0, 0, "", 0, 0, 0, Now(), "", "", "", "", 0, 0, strConnectionString)

            If IsArray(objData) AndAlso objData.Length > 0 Then
                strNombreZonaOperativa = CStr(DirectCast(objData.GetValue(0), Array).GetValue(4))
            End If
            ...
            Select Case intReporteId
                Case 1
                    ...
                    astrTransmisionPendiente = Benavides.CC.Data.clsTransmision.strEjecutarBuscarTransmisionesPolizaPendientes(intDireccionOperativaId, intZonaOperativaId, intCompaniaId, intSucursalId, strConnectionString)

                Case 2
                    ' Si es 2, buscar las ventas diariras pendientes de transmitir
                    astrTransmisionPendiente = Benavides.CC.Data.clsTransmision.strEjecutarBuscarTransmisionesVentaDiariaPendientes(intDireccionOperativaId, intZonaOperativaId, intCompaniaId, intSucursalId, strConnectionString)

                Case 3
                    ' Si es 3, buscar los tickets pendientes de transmitir
            ...
            If IsArray(astrTransmisionPendiente) AndAlso astrTransmisionPendiente.Length > 0 Then
                ...
                strbldEncabezadoHTML.Append("<td width=""84%"" class=""tdcontentableblue"">Sucursal " & strNombreZonaOperativa & "</td></tr>")
    ...
    Public ReadOnly Property strRecordBrowserHTML() As String
        Get
            ...
            Const strRecordBrowserName As String = "SistemaTransmisionesPendientesDetalleSucursal"
            ...
            Dim strTargetURL As String = "SistemaTransmisionesPendientesDetalleSucursal.aspx?intReporteId=" & intReporteId & "&intDireccionOperativaId=" & intDireccionOperativaId & "&intZonaOperativaId=" & intZonaOperativaId & "&intCompaniaId=" & intCompaniaId & "&intSucursalId=" & intSucursalId & "&"

            Dim intSelectedPage As Integer = CInt(isocraft.commons.clsWeb.strGetPageParameter("intNavegadorRegistrosPagina", "1"))

            'Variables para eliminar el boton de agregar en el navegador de registros
            Dim strCadenaOriginal As String = "<input name=""cmdNavegadorRegistrosAgregar"" type=""button"" class=""boton"" id=""cmdNavegadorRegistrosAgregar"" value="""" onclick=""window.location='SistemaTransmisionesPendientesDetalleSucursal.aspx?intReporteId=" & intReporteId & "&amp;intDireccionOperativaId=" & intDireccionOperativaId & "&amp;intZonaOperativaId=" & intZonaOperativaId & "&amp;intCompaniaId=" & intCompaniaId & "&amp;intSucursalId=" & intSucursalId & "&amp;strCmd=Agregar'"">"
            ...
            Select Case intReporteId
                Case 1
                    ' Si es 1, buscar las pólizas pendientes de transmitir
                    astrDataArray = Benavides.CC.Data.clsTransmision.strEjecutarBuscarTransmisionesPolizaPendientesPorSucursal(intDireccionOperativaId, intZonaOperativaId, intCompaniaId, intSucursalId, CInt(Benavides.CC.Commons.clsRecordBrowser.clsIndicator.intCalculateFirstElement(intSelectedPage, intElementsPerPage)), intElementsPerPage, strConnectionString)

                Case 2
                    ' Si es 2, buscar las ventas diariras pendientes de transmitir
                    astrDataArray = Benavides.CC.Data.clsTransmision.strEjecutarBuscarTransmisionesVentaDiariaPendientesPorSucursal(intDireccionOperativaId, intZonaOperativaId, intCompaniaId, intSucursalId, CInt(Benavides.CC.Commons.clsRecordBrowser.clsIndicator.intCalculateFirstElement(intSelectedPage, intElementsPerPage)), intElementsPerPage, strConnectionString)
            ...
            Return clsCommons.strGenerateJavascriptString(Replace(strbldRecordBrowserHTML.ToString, strCadenaOriginal, strCadenaFinal))
