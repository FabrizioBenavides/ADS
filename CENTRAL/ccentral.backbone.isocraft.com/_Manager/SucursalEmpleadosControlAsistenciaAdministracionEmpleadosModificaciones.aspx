<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SucursalEmpleadosControlAsistenciaAdministracionEmpleadosModificaciones.aspx.vb" Inherits="com.isocraft.backbone.ccentral.SucursalEmpleadoControlAsistenciaAdministracionEmpleadosModificaciones" %>
    ...
    <tr> 
      <td width="100%"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr> 
            ...
            <td width="538" class="tdmigaja"> <div id="ToPrintTxtMigaja"><span class="txdmigaja">Está 
                ...
                de Empleados</A> : Modificaciones</span></div></td>
            <td width="182" class="tdfechahora" > <script language="javascript">strGetCustomDateTime()</script></td>
          </tr>
          <tr> 
            <td width="10">&nbsp;</td>
            <td width="583" valign="top"> <div id="ToPrintHtmContenido" align="left"> 
              <table cellSpacing="0" cellPadding="0" border="0" width="100%">
                <tr> 
                  <td class="tdtablacont" vAlign="top" width="584"> <p> <span class="txtitulo"><IMG src="../static/images/bullet_subtitulos.gif" align="middle">&nbsp;Administración 
                      de Empleados</span> </p>
                    <script language="JavaScript">crearDatosSucursal()</script> 
                    <br> <table id="Table3" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
                      <tr> 
                        <TD vAlign="top"> <TABLE class="tdenvolventetablas" id="Table1" height="38" cellSpacing="0" cellPadding="0" width="100%">
                            <TR> 
                              ...
                              <TD class="tdtittablas3" vAlign="top" align="left">Día 
                                de descanso<br> <SCRIPT language="javascript">strDiadeDescanso()</SCRIPT> 
                              </TD>
                              <TD class="tdtittablas3" vAlign="top" align="center" bgColor="#ffcccc">Baja 
                                Temporal<BR> <SCRIPT language="javascript">strBajaTemporal()</SCRIPT> 
                              </TD>
                            </TR>
                          </TABLE>
                          <br> <div class="txsubtitulo">Vacaciones</div>
                          <TABLE class="tdenvolventetablas" id="Table2" height="19" cellSpacing="0" cellPadding="0" width="100%">
                            <tr> 
                              ...
                              <TD class="tdtittablas3" align="right" width="100" height="20">Días 
                                Disponibles:</TD>
                              <TD class="tdtittablas3" align="left" height="20"><SCRIPT language="javascript">strDiasDisponiblesVacaciones()</SCRIPT></TD>
                            </tr>
                            <TR> 
                              <TD class="tdtittablas3" align="left" width="100" height="20">Fecha 
                                Fin:</TD>
                              ...
                              <TD class="tdtittablas3" align="left" width="20" height="20"> 
                                <div id="lblDias">0</div></TD>
                            </TR>
                          </TABLE></TD>
                      </TR>
                      <TR> 
                        <TD vAlign="top"><br> <DIV class="txsubtitulo">Incapacidad 
                            Médica</DIV>
                          <TABLE class="tdenvolventetablas" id="tblBusqueda" cellSpacing="0" cellPadding="0" width="100%">
                            ...
                            <TR> 
                              ...
                              <TD colSpan="4"> <script language="javascript">strIncapacidadMedicaMotivos()</script> 
                              </TD>
                            </TR>
                          </TABLE>
                          <TABLE>
                            <TR> 
                              <TD class="tdtittablas3" align="left" colSpan="2"><INPUT class="boton" onclick="if(document.getElementById('changeDefault').style.display =='block')document.getElementById('changeDefault').style.display='none';else document.getElementById('changeDefault').style.display='block';" type="button" value="Observaciones" name="btnObservacionesIncapacidad"> 
                      ...
                      <tr> 
                        <TD vAlign="top"><br> <DIV class="txsubtitulo">Permiso 
                            Especial </DIV>
                          <TABLE class="tdenvolventetablas" id="tblBusqueda" cellSpacing="0" cellPadding="0" width="100%">
                            <TR> 
                              <TD class="tdtittablas3" align="left" width="100" height="20">Fecha 
                              ...
                              <TD class="tdtittablas3" align="left" height="60"> 
                                <div id="lblDiasPermiso">0</div></TD>
                            </TR>
                            <TR> 
                              <TD class="tdtittablas3" align="left" width="100" height="20">Fecha 
                                Fin:</TD>
                          ...
                          <TABLE>
                            <TR> 
                              <TD class="tdtittablas3" align="left" colSpan="2"><INPUT class="boton" onclick="if(document.getElementById('changeDefault2').style.display == 'block')document.getElementById('changeDefault2').style.display='none';else document.getElementById('changeDefault2').style.display='block';"
                        ...
                        <tr> 
                        <TD vAlign="top"><br> <DIV class="txsubtitulo">Capacitación y/o Junta Operacional </DIV>
                          <TABLE class="tdenvolventetablas" id="TABLE4" cellSpacing="0" cellPadding="0" width="100%">
                            <TR> 
                              ...
                              <TD class="tdtittablas3" align="right" height="20">Días:</TD>
                              <TD class="tdtittablas3" align="left" height="60"> 
                                <div id="lblDiasCapacitacion">0</div></TD>
                            </TR>
                            <TR> 
                              <TD class="tdtittablas3" align="left" width="100" height="20">Fecha 
                                Fin:</TD>
                          ...
                          <TABLE>
                            <TR> 
                              <TD class="tdtittablas3" align="left" colSpan="2"><INPUT class="boton" onclick="if(document.getElementById('changeDefault3').style.display == 'block')document.getElementById('changeDefault3').style.display='none';else document.getElementById('changeDefault3').style.display='block';"
                      ...
                      <TR> 
                        <TD class="txsubtitulo" vAlign="top"><br> <input class="boton" id="cmdRegresar" style="WIDTH: 64px; HEIGHT: 20px" onclick="return cmdRegresar_onclick()"
                    ...
                    <div id="lblMensajeError" align="center">&nbsp;</div></td>
                </tr>
              </table></td>
