'====================================================================
' Class         : clsAdministrarPoliticasDeTickets
' Title         : Grupo Benavides. Administrador POS y Backoffice.
' Description   : Administrar políticas de tickets
...
'====================================================================
Public Class clsAdministrarPoliticasDeTickets
...
#End Region
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        Const strRecordBrowserName As String = "VentasAdministrarPoliticasDeTickets"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case strCmd
            ...
            Case "Ver"
                ...
                Call Response.Redirect("VentasAsignarPoliticasDeTicketAUnaSucursal.aspx?intDireccionId=" & intDireccionId & "&intZonaId=" & intZonaId & "&intCompaniaId=" & isocraft.commons.clsWeb.strGetPageParameter("intCompaniaId", "0") & "&intSucursalId=" & isocraft.commons.clsWeb.strGetPageParameter("intSucursalId", "0"))
