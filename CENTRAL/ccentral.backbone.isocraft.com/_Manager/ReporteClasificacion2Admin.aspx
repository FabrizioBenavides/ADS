<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ReporteClasificacion2Admin.aspx.vb" Inherits="com.isocraft.backbone.ccentral.clsReporteClasificacion2Admin" Explicit="True" Trace="False" Strict="True" codePage="1252" EnableSessionState="true" enableViewState="False" %>
...
{	var key;		
	...
	case 2:
		...
		break;
	case 3:
		openPopup('Listado de Tipo de Artículos','popupClasificacionArticulo2','_','intClasificacionArticulo2Id','strClasificacionArticulo2Nombre','&intClasificacionArticulo2Id='+document.forms[0].intClasificacionArticulo2Id.value)
		break;
	}
	}
}
...
//-->
	...
	<body>
		...
		<h1>Reporte de Producción (por Tipo de Artículo)</h1>
		<p>Seleccione los parámetros de filtrado para el Reporte por Producción.</p>		
		...
		<div id="divFiltros">
			<table  cellSpacing="0" cellPadding="0"  border="0" >																	
				...
				<tr>
					<td class="txtitintabla" Align="right" width="20%"><span class="tdtittablas3">Tipo de Artículo:</span>
