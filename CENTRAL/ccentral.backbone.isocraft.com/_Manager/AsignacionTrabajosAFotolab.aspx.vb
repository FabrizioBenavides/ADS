'====================================================================
' Class         : clsAsignacionTrabajosAFotolab
...
Public Class clsAsignacionTrabajosAFotolab
...
#Region "Document Business"
    ...
    Protected Overrides Sub initialize()
        Me.clsServicesObj = prjFotolabBusiness.Benavides.Fotolab.Business.clsAsignacionTrabajosAFotolab.SERVICIOS
    End Sub
    ...
    Protected Overrides Function strGenerarlistado(ByVal strCmd As String) As String
        ...
        actions.Add(New clsActionLink(Me._EDITAR, pkNames, pkIndexes, "imgNRVer.gif", "Haga clic aquí para ver los Trabajos Asignados a este Laboratorio"))
        ...
        If dataArray.Length > 0 Then
            ...
            End If
        End If
        htmlResult = clsHTMLUtils.displayScroll(totalRows, intSelectedPage, Me._MAX_PER_PAGE, "AsignacionTrabajosAFotolab.aspx", Nothing, , "../static/images/")
    ...
    Protected Sub DesasignarFotolab(ByVal strCmd As String)
        ...
        End If
        Resultado = clsServicesObj.strAfectarListado("DESASIGNACIONTRABAJOSMULTIPLES", Request, strConnectionString, Me.strUsuarioNombre, intDireccionOperativaId + ", " + intZonaOperativaId + ", '" + strLaboratoriosId + "', '" + Request("strTrabajoId") + "', '" + Request("strCodigoDeBarras") + "', '" + Date.Now.ToString("MM/dd/yyyy HH:mm:ss") + "', '" + Me.strUsuarioNombre + "'")
    End Sub
    ...
    ' Output     : String
    '====================================================================
    Public Function displayTrabajo(ByVal totalRows As Integer, _
    ...
    Protected Sub AsignarFotolab(ByVal strCmd As String)
        ...
        Else
            strLaboratoriosId = Request("strLaboratoriosId")
        End If
        Resultado = clsServicesObj.strAfectarListado("ASIGNACIONTRABAJOSMULTIPLES", Request, strConnectionString, Me.strUsuarioNombre, intDireccionOperativaId + ", " + intZonaOperativaId + ", '" + strLaboratoriosId + "', '" + Request("strTrabajoId") + "', '" + Request("strCodigoDeBarras") + "', '" + Date.Now.ToString("MM/dd/yyyy HH:mm:ss") + "', '" + Me.strUsuarioNombre + "'")
    End Sub



    '====================================================================
    ' Name       : strGenerarlistadoTrabajo
    ' Description: Regresa el HTML del navegador de registros
    ' Accessor   : Read
    ' Throws     : Ninguna
    ' Output     : String
    '====================================================================
    Protected Function strGenerarlistadoTrabajo(ByVal strCmd As String) As String
        ...
        ' Obtenemos los listados que ya se han capturado previamente.
        ' If Request("strTrabajo") <> "" Then
        dataArray = clsServicesObj.strConsultarListado("TRABAJOS", Request, strConnectionString, Me.strUsuarioNombre, intSelectedPage, Me._MAX_PER_PAGE)
        'Else
        ...
        Dim columnOrder As Integer() = {0, 2, 3, 5}

        Dim actions As ArrayList = New ArrayList()
        Dim pkNames As String() = {"strTrabajoId"}
        Dim pkIndexes As Integer() = {0}
        ...
        htmlResult = displayTrabajo(totalRows, intSelectedPage, Me._MAX_PER_PAGE, "AsignacionTrabajosAFotolab.aspx", Nothing, , "../static/images/")
        htmlResult += clsHTMLUtils.displayTable(headers, dataArray, columnOrder, actions, intSelectedPage, Me._MAX_PER_PAGE, -1, , "../static/images/")
        Return htmlResult
    End Function
