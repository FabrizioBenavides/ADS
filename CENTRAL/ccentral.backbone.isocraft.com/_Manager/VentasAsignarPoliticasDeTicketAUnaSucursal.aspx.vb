'====================================================================
' Class         : clsVentasVerPoliticasDeTicketAUnaSucursal
' Title         : Grupo Benavides. Administrador POS y Backoffice.
' Description   : Ver políticas de ticket a una sucursal
...
'====================================================================
Public Class clsVentasVerPoliticasDeTicketAUnaSucursal
...
#End Region
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        Const strRecordBrowserName As String = "VentasAsignarPoliticasDeTicketAUnaSucursal"
        ...
        Dim astrDataArray As Array = Benavides.CC.Data.clstblPoliticaTicket.strBuscar(0, intCompaniaId, intSucursalId, "", "", Now, "", Benavides.CC.Commons.clsRecordBrowser.clsIndicator.intCalculateFirstElement(intSelectedPage, intElementsPerPage), intElementsPerPage, strConnectionString)
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case strCmd
            ...
            Case "Editar", "Agregar", "Borrar"
                ...
                Call Response.Redirect("VentasEditarPoliticaDeTicketDeUnaSucursal.aspx?strCmd=" & strCmd & "&intDireccionId=" & intDireccionId & "&intZonaId=" & intZonaId & "&intCompaniaId=" & intCompaniaId & "&intSucursalId=" & intSucursalId & "&intPoliticaTicketId=" & isocraft.commons.clsWeb.strGetPageParameter("intPoliticaTicketId", "0"))
