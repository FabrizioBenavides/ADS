'====================================================================
' Class         : clsSucursalConsultarCajasEnSucursales
' Title         : Grupo Benavides. Administrador POS y Backoffice.
' Description   : Consultar cajas en sucursales
...
'====================================================================
Public Class clsSucursalConsultarCajasEnSucursales
...
#End Region
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        Const strRecordBrowserName As String = "SucursalAsignarCuentaSucursal"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case strCmd
            ...
            Case "Ver"
                ...
                Call Response.Redirect("SucursalVerDetalleDeCajas.aspx?intDireccionId=" & intDireccionId & "&intZonaId=" & intZonaId & "&intCompaniaId=" & isocraft.commons.clsWeb.strGetPageParameter("intCompaniaId", "0") & "&intSucursalId=" & isocraft.commons.clsWeb.strGetPageParameter("intSucursalId", "0"))
