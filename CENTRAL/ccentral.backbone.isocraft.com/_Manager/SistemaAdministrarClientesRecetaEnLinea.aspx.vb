...
Public Class SistemaAdministrarClientesRecetaEnLinea
    Inherits PaginaBase
    ...
    Protected Function strConsultarClientes() As String
        ...
        objClientes = clsClientesABF. _
                      ...
                      strBuscarTblClienteRecetaEnLineaABF(strClienteABF, intTipoFiltroSucursales, strConnectionString)
        ...
        If IsArray(objClientes) AndAlso objClientes.Length > 0 Then
            ...
            strResultadoTablaClientes.Append("<th class='rayita' style='text-align:left'>Integrador</th>")
            ...
            strResultadoTablaClientes.Append("<th class='rayita' colspan='2'>Acción</th>")
    ...
    Private Function CrearRegistrosClientes(ByVal registrosProductos As Array) As String
        ...
        Dim strClienteRecetaEnLineaNombre As String = String.Empty

        For Each renglon As SortedList In registrosProductos
            contadorRegistros += 1
            strClienteABFIdResultado = renglon.Item("strClienteABFId").ToString()
            strClienteRecetaEnLineaNombre = renglon.Item("strClienteRecetaEnLineaNombre").ToString()
            ...
            resultadoCliente.AppendFormat("<td class='{0}' style='text-align:left'>{1}</td>", colorRegistro, renglon.Item("strIntegradorRecetaEnLineaNombre").ToString())
            resultadoCliente.AppendFormat("<td class='{0}' style='text-align:left'>{1}</td>", colorRegistro, strClienteABFIdResultado)
            resultadoCliente.AppendFormat("<td class='{0}' style='text-align:left'>{1}</td>", colorRegistro, strClienteRecetaEnLineaNombre)
            ...
            resultadoCliente.AppendFormat("<td align='center' style='width: 50px;' class='{0}'>" & _
                                          ...
                                          "{3}</a></td>", _
                                           ...
                                           strClienteRecetaEnLineaNombre, _
                                           imagenVerSucursales)
