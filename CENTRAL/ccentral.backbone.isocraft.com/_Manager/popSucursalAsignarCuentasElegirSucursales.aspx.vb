Public Class popSucursalAsignarCuentasElegirSucursales
...
#End Region
    ...
    ' Description: Identificador de la TipoCuenta
    ' Accessor   : Read
    ' Throws     : None
    ' Output     : Integer
    '====================================================================
    Public ReadOnly Property intTipoCuentaId() As Integer
        Get
            If intmTipoCuentaId = 0 Then
                intmTipoCuentaId = CInt(isocraft.commons.clsWeb.strGetPageParameter("intTipoCuentaId", isocraft.commons.clsWeb.strGetPageParameter("txtTipoCuentaId", "0")))
            End If
    ...
    '====================================================================
    ' Name       : strTipoCuentaNombre
    ' Description: Nombre de la Dirección
    ' Accessor   : Read
    ' Throws     : None
    ' Output     : Integer
    '====================================================================
    Public ReadOnly Property strTipoCuentaNombre() As String
        Get
            If intTipoCuentaId > 0 Then
                Dim astrData As Array = Benavides.CC.Data.clstblTipoCuenta.strBuscar(intTipoCuentaId, "", "", Now, "", 0, 0, strConnectionString)
    ...
    Public Function strLlenarSucursalesComboBox() As String
        If intTipoCuentaId > 0 AndAlso intDireccionId > 0 AndAlso intZonaId > 0 Then
