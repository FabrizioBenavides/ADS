...
'====================================================================
' Class         : clsVentasAdministrarDescuentosPorCliente
' Title         : Grupo Benavides. Administrador POS y Backoffice.
' Description   : Administrar descuentos por cliente
...
'====================================================================
Public Class clsVentasAdministrarDescuentosPorCliente
...
#End Region
    ...
    Public Function strGetRecordBrowserHTML() As String
        ...
        If intClienteEspecialId > 0 Then
            ...
            Const strRecordBrowserName As String = "VentasAdministrarDescuentosPorCliente"

            ' Declaramos e inicializamos las variables locales
            Dim intSelectedPage As Integer = GetPageParameter("intNavegadorRegistrosPagina", 1)
            Dim astrDataArray As Array = Benavides.CC.Data.clsClienteEspecial.strBuscarArticulosConDescuento(intClienteEspecialId, 0, 0, Now(), "", Benavides.CC.Commons.clsRecordBrowser.clsIndicator.intCalculateFirstElement(intSelectedPage, intElementsPerPage), intElementsPerPage, strConnectionString)
            ...
            Case "Agregar"
                ...
                If IsNothing(txtArticuloClienteEspecialArchivo.PostedFile) = False AndAlso intClienteEspecialId > 0 Then
                    ...
                    If IsNothing(astrRows) = False AndAlso astrRows.Length > 0 Then
                        ...
                        Call Benavides.CC.Data.clstblDescuentoClienteArticulo.intEliminar(intClienteEspecialId, 0, 0, Now(), strUsuarioNombre, strConnectionString)
                        ...
                        For Each astrColumns As Array In astrRows
                            ...
                            If astrColumns.Length = 2 Then
                                ...
                                Dim fltDescuentoClienteArticuloPorcentaje As Decimal = CDec(ConvertObject(astrColumns.GetValue(1), TypeCode.Decimal))

                                ' Agregamos los nuevos registros, si los valores de las columnas son válidos
                                If intArticuloId > 0 Then

                                    ' Buscamos el registro
                                    Dim aobjDataToSearch As Array = Benavides.CC.Data.clstblDescuentoClienteArticulo.strBuscar(intClienteEspecialId, intArticuloId, fltDescuentoClienteArticuloPorcentaje, Now(), strUsuarioNombre, 0, 0, strConnectionString)

                                    ' Si el registro existe
                                    If IsNothing(aobjDataToSearch) = False AndAlso aobjDataToSearch.Length > 0 Then

                                        ' Actualizamos el registro
                                        intCounter += Benavides.CC.Data.clstblDescuentoClienteArticulo.intActualizar(intClienteEspecialId, intArticuloId, fltDescuentoClienteArticuloPorcentaje, Now(), strUsuarioNombre, strConnectionString)

                                    Else

                                        ' Agregamos el nuevo registro
                                        intCounter += Benavides.CC.Data.clstblDescuentoClienteArticulo.intAgregar(intClienteEspecialId, intArticuloId, fltDescuentoClienteArticuloPorcentaje, Now(), strUsuarioNombre, strConnectionString)
                    ...
                    If IsNothing(astrRows) = False AndAlso astrRows.Length > 0 Then
                        ...
                        For Each astrColumns As Array In astrRows
                            ...
                            If astrColumns.Length = 2 Then
                                ...
                                If intArticuloId > 0 Then
                                    ...
                                    Dim intReturnedValue As Integer = Benavides.CC.Data.clstblDescuentoClienteArticulo.intAgregar(intClienteEspecialId, intArticuloId, fltDescuentoClienteArticuloPorcentaje, Now(), strUsuarioNombre, strConnectionString)
                                    ...
                                    If intReturnedValue > 0 Then
                                        ...
                                        Call aobjDataList.Add(New String() {CStr(intClienteEspecialId), CStr(intArticuloId), CStr(fltDescuentoClienteArticuloPorcentaje), Now.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture), strUsuarioNombre})
                        ...
                        If aobjData.Length > 0 Then
                            ...
                            If Len(strTiendaConcentradorIP) > 0 AndAlso IsNothing(objStoresArray) = False AndAlso objStoresArray.Length > 0 Then
                                ...
                                Call Benavides.CC.Business.clsConcentrador.strEnviarMensajeCompletoHaciaServidoresPuntoDeVenta("clstblDescuentoClienteArticulo", Benavides.POSAdmin.Commons.clsCommons.clsMSMQ.enmMQCommandId.ELIMINAR_AGREGAR, "POS", aobjData, objStoresArray)
