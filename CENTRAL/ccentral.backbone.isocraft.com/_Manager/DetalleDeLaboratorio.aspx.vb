...
Public Class clsDetalleDeLaboratorio
...
#Region "Document Business"
    ...
    Protected Overrides Sub initialize()
        Me.clsServicesObj = prjFotolabBusiness.Benavides.Fotolab.Business.clsDetalleDeLaboratorio.SERVICIOS
    End Sub
    ...
    Protected Overrides Function strDesplegarValores(ByVal arrValues As Array) As String
        If arrValues.Length > 0 Then
            ...
            htmlResult += "document.getElementById('divSucursalccsss').innerHTML=" + Chr(39) + CStr(rowArray.GetValue(2)) + Chr(39) + ";" + vbTab
            htmlResult += "	document.getElementById('divSucursalRazonSocial').innerHTML=" + Chr(39) + CStr(rowArray.GetValue(3)) + Chr(39) + ";" + vbTab
            htmlResult += "	document.getElementById('divSucursalZonaOperativa').innerHTML=" + Chr(39) + CStr(rowArray.GetValue(4)) + Chr(39) + ";" + vbTab
            Return htmlResult
        Else
            Return ""
        End If
    ...
    Protected Overrides Function strGenerarListado(ByVal strcmd As String) As String
        ...
        dataArray = clsServicesObj.strConsultarListado("SUCURSALLISTADODETALLE", Request, strConnectionString, strUsuarioNombre, intSelectedPage, 5)
