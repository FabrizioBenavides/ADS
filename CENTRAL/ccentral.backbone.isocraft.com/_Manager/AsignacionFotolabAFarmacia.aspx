...
if (action == 'Asignar')
{
	parent.parent.document.getElementById('divEncabezadoLista').innerHTML= '<p><span class="txsubtitulo"><img src="../static/images/bullet_subtitulos.gif" width="17" height="11" align="absMiddle"> Laboratorios a los cuales se asignarán Farmacias </span> </p>' ;
	parent.parent.document.getElementById('divEncabezadoDetalle').innerHTML= '<br><p><span class="txsubtitulo"><img src="../static/images/bullet_subtitulos.gif" width="17" height="11" align="absMiddle">  Selección de Farmacias a Asignar </span> </p>' ;
...
{
	parent.parent.document.getElementById('divEncabezadoLista').innerHTML= '<p><span class="txsubtitulo"><img src="../static/images/bullet_subtitulos.gif" width="17" height="11" align="absMiddle"> Laboratorios a los cuales se desasignarán Farmacias</span> </p>' ;
	parent.parent.document.getElementById('divEncabezadoDetalle').innerHTML= '<br><p><span class="txsubtitulo"><img src="../static/images/bullet_subtitulos.gif" width="17" height="11" align="absMiddle">  Selección de Farmacias a Desasignar </span> </p>' ;
	...
	<body onload="window_onload()">
		<form id="Form1" name="frmFotolabaFarmacias" action="about:blank" method="post">			
			...
			<table cellSpacing="0" cellPadding="0" width="780" border="0">
				...
				<tr>
					<td width="10">&nbsp;</td>
					<td class="tdtab" width="770">Está en : ADMIN : Asignaciones : Farmacia a Laboratorio</td>
				</tr>
			</table>			
			<table cellSpacing="0" cellPadding="0" width="780" border="0" >
				<tr>
					<td class="tdgeneralcontent">
						<div id="divPrincipalTexto"style="position:static">
							...
							<p>Busque los Laboratorios al cual se le Asignarán las Farmacias.<br></p>	
						</div>
						<div id="divAsignacionTexto" style="position:absolute; top:-800; left:-800">
							<h1>Asignación de Farmacias a Laboratorios</h1>
							<p>De la lista de Laboratorios seleccionados, busque las farmacias a asignar. Para asignar una Farmacia hacer click sobre el icono correspondiente, para asignar todos hacer click sobre el botón "Asignar Todos".<br></p>	
						</div>
						<div id="divDesasignacionTexto" style="position:absolute; top:-800; left:-800">
							<h1>Desasignación de Farmacias a Laboratorios </h1>
							<p>De la lista de Laboratorios seleccionados, busque las farmacias a desasignar. Para desasignar un cliente hacer click sobre el icono correspondiente, para desasignar todos hacer click sobre el botón "Desasignar Todos". <br></p>	
						</div>
						<div id="divConsultaTexto" style="position:absolute; top:-800; left:-800">
							<h1>Consulta de Farmacias a Laboratorios </h1>
							<p>Para consultar las Farmacias que están asignados a un Laboratorio, hacer click sobre el icono en forma de lupa correspondiente.<br></p>	
						</div>		
						<!-- FILTROS -->
