<%@ Page Language="vb" EnableViewState="true" AutoEventWireup="false" CodeBehind="SistemaAdministrarClientesRecetaEnLinea.aspx.vb" Inherits="com.isocraft.backbone.ccentral.SistemaAdministrarClientesRecetaEnLinea" CodePage="28592" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">

<html>
<head>
    <title>Benavides : Consulta Clientes Recetas en Línea</title>
    ...
    <script type="text/javascript">
        ...
        function btnConsultarClientes_onclick() {
            ...
            document.forms[0].action = "SistemaAdministrarClientesRecetaEnLinea.aspx?strCmd2=Buscar" +
        ...
        function mostrarVentaConsultaSucursales(strClienteABFId, strClienteRecetaEnLineaNombre) {
        ...
        <table width="780" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td width="780" class="tdtab">Est&aacute; en : 
                    <a href="../_Manager/.aspx">Sistema</a> : Consulta Clientes Recetas en Línea
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td class="tdgeneralcontent">
                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            <td>
                                <h1>Consulta Clientes Recetas en Línea</h1>
                                <p>
