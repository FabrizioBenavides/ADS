<%@ Page CodeBehind="SucursalAdministrarPoliticasDePos.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="com.isocraft.backbone.ccentral.clsSucursalAdministrarPoliticasDePos" codePage="28591" EnableSessionState="False" enableViewState="False"%>
<html>
<head>
...
<form method="POST" action="about:blank" name="frmMain">
  ...
  <table width="780" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="10">&nbsp;</td>
      <td width="770" class="tdtab">Est&aacute; en : Sucursal : Puntos de venta : Administrar pol&iacute;ticas de POS</td>
    </tr>
  </table>
  <table width="780" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td class="tdgeneralcontent"><h1>Administrar pol&iacute;ticas de POS </h1>
