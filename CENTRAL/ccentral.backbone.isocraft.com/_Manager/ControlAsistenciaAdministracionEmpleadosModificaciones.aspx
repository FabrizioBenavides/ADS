...
function cambioIncapacidadFechaInicio() {
    ...
    if (fIni != "") {
        if (blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtIncapacidadMedicaInicio'), false, 'IncapacidadMedica Fecha inicio', cintTipoCampoFecha, 10, 10, '')) {
...
function cambioIncapacidadFechaFin() {
    ...
    if (fFin != "") {
        if (fIni != "") {
            if ((blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtIncapacidadMedicaInicio'), false, 'IncapacidadMedica Fecha inicio', cintTipoCampoFecha, 10, 10, '')) && (blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtIncapacidadMedicaFinal'), false, 'IncapacidadMedica Fecha Final', cintTipoCampoFecha, 10, 10, ''))) {
...
function cambioPermisoEspecialFechaInicio() {
    ...
    if (fIni != "") {
        if ((blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtPermisoEspecialInicio'), false, 'Permiso Especial Fecha de Inicio', cintTipoCampoFecha, 10, 10, '')) && (blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtPermisoEspecialFin'), false, 'Permiso Especial Fecha de Fin', cintTipoCampoFecha, 10, 10, ''))) {
...
function cambioPermisoEspecialFechaFin() {
    if ((document.forms[0].elements["txtPermisoEspecialInicio"].value != "") && (document.forms[0].elements["txtPermisoEspecialFin"].value != "")) {
        ...
        if ((blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtPermisoEspecialInicio'), false, 'Permiso Especial Fecha Inicio', cintTipoCampoFecha, 10, 10, '')) && (blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtPermisoEspecialFin'), false, 'Permiso Especial Fecha Fin', cintTipoCampoFecha, 10, 10, ''))) {
            if (fIni != "") {
                if (fIni <= fFin) {
...
function cambioVacacionesFechaInicio() {
    ...
    if ((document.forms[0].elements["txtVacacionesInicio"].value != "") && (document.forms[0].elements["txtVacacionesFin"].value != "")) {
        ...
        //validar si las fechas son validas
        if ((blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtVacacionesInicio'), false, 'txtVacacionesInicio', cintTipoCampoFecha, 10, 10, '')) && (blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtVacacionesFin'), false, 'txtVacacionesFin', cintTipoCampoFecha, 10, 10, ''))) {
            if (fFin != "") {
                if (fIni <= fFin) {
                    fFestivas = new Array();
    ...
    var diaDescanso = "<%=ConsultaArray(1)%>";
     ...
     document.forms[0].elements["hdnMotivo"].value = "<%=ConsultaArray(14)%>"; //motivo
        ...
        if ((document.forms[0].elements["txtCapacitacionInicio"].value != "") && (document.forms[0].elements["txtCapacitacionFin"].value != "")) {
            ...
            //validar si las fechas son validas
            if ((blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtCapacitacionInicio'), false, 'txtCapacitacionInicio', cintTipoCampoFecha, 10, 10, '')) && (blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtCapacitacionFin'), false, 'txtCapacitacionFin', cintTipoCampoFecha, 10, 10, ''))) {
        ...
        var strGrupo = "<%= strGrupoDescripcion()%>";
            ...
            if (nombreText == "txtPermisoEspecialInicio") {
                if (document.forms[0].elements["txtPermisoEspecialInicio"].disabled == false) {
                    if (blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtPermisoEspecialInicio'), false, 'Permiso Especial Fecha Inicio', cintTipoCampoFecha, 10, 10, '')) {
            ...
            if (nombreText == "txtPermisoEspecialFin") {
                if (document.forms[0].elements["txtPermisoEspecialFin"].disabled == false) {
                    if (blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtPermisoEspecialFin'), false, 'PermisoEspecial Fecha Fin', cintTipoCampoFecha, 10, 10, '')) {
            ...
            if (nombreText == "txtIncapacidadMedicaFinal") {
                if (document.forms[0].elements["txtIncapacidadMedicaFinal"].disabled == false) {
                    if (blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtIncapacidadMedicaFinal'), false, 'Incapacidad Medica Fecha Fin', cintTipoCampoFecha, 10, 10, '')) {
            ...
            if (nombreText == "txtIncapacidadMedicaInicio") {
                if (document.forms[0].elements["txtIncapacidadMedicaInicio"].disabled == false) {
                    if (blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtIncapacidadMedicaInicio'), false, 'Incapacidad Fecha Inicio', cintTipoCampoFecha, 10, 10, '')) {
            ...
            if (nombreText == "txtVacacionesInicio") {
                if (document.forms[0].elements["txtVacacionesInicio"].disabled == false) {
                    if (blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtVacacionesInicio'), false, 'Vacaciones Fecha Inicio', cintTipoCampoFecha, 10, 10, '')) {
            ...
            if (nombreText == "txtVacacionesFin") {
                if (document.forms[0].elements["txtVacacionesFin"].disabled == false) {
                    if (blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtVacacionesFin'), false, 'Vacaciones Fecha Fin', cintTipoCampoFecha, 10, 10, '')) {
            ...
            if (nombreText == "txtCapacitacionInicio") {
                if (document.forms[0].elements["txtCapacitacionInicio"].disabled == false) {
                    if (blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtCapacitacionInicio'), false, 'Capacitacion Fecha Inicio', cintTipoCampoFecha, 10, 10, '')) {
            ...
            if (nombreText == "txtCapacitacionFin") {
                if (document.forms[0].elements["txtCapacitacionFin"].disabled == false) {
                    if (blnValidarCampo(document.forms('ControlAsistenciaAdministracionEmpleadosModificaciones').elements('txtCapacitacionFin'), false, 'Capacitacion Fecha Fin', cintTipoCampoFecha, 10, 10, '')) {
...
<body onload="return window_onload()">
    <form name="ControlAsistenciaAdministracionEmpleadosModificaciones" action="about:blank" method="post">
        ...
        <script language="JavaScript">
            ...
            var objCalendarVacacionesInicio = new calendar1(document.forms['ControlAsistenciaAdministracionEmpleadosModificaciones'].elements['txtVacacionesInicio']);
            var objCalendarVacacionesFin = new calendar1(document.forms['ControlAsistenciaAdministracionEmpleadosModificaciones'].elements['txtVacacionesFin']);
            var objCalendarIncapacidadMedicaInicio = new calendar1(document.forms['ControlAsistenciaAdministracionEmpleadosModificaciones'].elements['txtIncapacidadMedicaInicio']);
            var objCalendarIncapacidadMedicaFin = new calendar1(document.forms['ControlAsistenciaAdministracionEmpleadosModificaciones'].elements['txtIncapacidadMedicaFinal']);
            var objCalendarPermisoEspecialInicio = new calendar1(document.forms['ControlAsistenciaAdministracionEmpleadosModificaciones'].elements['txtPermisoEspecialInicio']);
            var objCalendarPermisoEspecialFin = new calendar1(document.forms['ControlAsistenciaAdministracionEmpleadosModificaciones'].elements['txtPermisoEspecialFin']);
            var objCalendarCapacitacionInicio = new calendar1(document.forms['ControlAsistenciaAdministracionEmpleadosModificaciones'].elements['txtCapacitacionInicio']);
            var objCalendarCapacitacionFin = new calendar1(document.forms['ControlAsistenciaAdministracionEmpleadosModificaciones'].elements['txtCapacitacionFin']);
        </script>
    </form>
