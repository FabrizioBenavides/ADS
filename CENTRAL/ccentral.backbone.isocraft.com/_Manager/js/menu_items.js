var MENU_ITEMS = [
	...
	['VENTAS', 'VentasHome.aspx', null,
		...
		['Conciliacion POS - CTF', 'VentasConciliacionPOSCTF.aspx'],
	],
		...
		['Corresponsalía', 'SucursalCorresponsaliaServicios.aspx', {'bw' : 122},
			...
			['Tarjetas de Regalo', 'SucursalAsignacionDeArticuloTarjetaRegalo.aspx'],
                ...
                ['Control de Asistencias', null, null,
                   ['Administracion', '', {'bw' : 190},
		        ['Usuarios', 'ControlAsistenciaAdministracionDeUsuarios.aspx'],
                   ...
                   ['Consulta y Confirmacion de Asistencia', 'ControlAsistencia.aspx'],                   
                   ['Reporte Coordinadores', 'ControlAsistenciaReportePorCoordinador.aspx'],
                   ['Empleados Medicos', 'ControlAsistenciaAdministraciondeEmpleadosMedicos.aspx'],
           	],
                ...
                ['Reporte de Faltantes', null, null,
                    ['Reporte de Acciones Faltante Caja', 'SucursalReporteActas.aspx'],
                    ['Reporte de Tarjetas Faltante de Caja', 'SucursalReporteTarjetaFaltanteCaja.aspx']	,
                ],
	],
	['SISTEMA', 'Sistema.aspx', null,
		...
		['Consulta Promociones', '', null,
			...
			['Consulta Masiva','SistemaConsultarPromocionesMasiva.aspx'],
                ...
                ['Control Ventas', 'SistemaControlVentas.aspx', null,
                   ['Administrar Empleados Certificados', 'SistemaEmpleadosCertificadosAdministrar.aspx'],
                   ['Administrar Medicamentos Ilegales', 'SistemaMedicamentosIlegalesAdministrar.aspx'],
                ],
	],
];
