<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SistemaClientesRecetaEnLineaAltaNuevaSucursal.aspx.vb" Inherits="com.isocraft.backbone.ccentral.SistemaClientesRecetaEnLineaAltaNuevaSucursal" %>
...
<head>
    ...
    <script id="clientEventHandlersJS" language="javascript">
        ...
        function objLupaClientesAsignados_onclick() {
            ...
            Pop('popSucursalClientesRecetaEnLineaConsultar.aspx?' + strParametros + '&strEvalJs=', 660, 620);
        }
        ...
        <table cellspacing="0" cellpadding="0" width="780" border="0">
            <tr>
                ...
                <td class="tdtab" width="770">Está en : 
                    ...
                    <a href="">Clientes</a>:Alta Receta en Línea a Nueva Sucursal
                </td>
            </tr>
        </table>
        <table cellspacing="0" cellpadding="0" width="780" border="0">
            <tr>
                <td class="tdgeneralcontent">
                    <h1>Alta Receta en Línea a Nueva Sucursal</h1>
                    <p>
