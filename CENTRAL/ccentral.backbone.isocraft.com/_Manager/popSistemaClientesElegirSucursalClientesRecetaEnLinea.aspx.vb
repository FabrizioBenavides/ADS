...
Public Class popSistemaClientesElegirSucursalClientesRecetaEnLinea
    Inherits PaginaBase
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case strCmd2
            ...
            Case "Agregar"
                Call AgregarTblClienteRecetaEnLineaSucursal()

        End Select
    End Sub

    Private Sub AgregarTblClienteRecetaEnLineaSucursal()
        ...
        intResultado = clsClientesABF. _
                       ...
                       intGuardarTblClienteRecetaEnLineaSucursal(CStr(_intmCadenaId), _
                                                                 _intmEstadoId, _
                                                                 _intmCiudadId, _
                                                                 intCompaniaId, _
                                                                 intSucursalId, _
