<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DetalleDeLaboratorio.aspx.vb" Inherits="com.isocraft.backbone.ccentral.clsDetalleDeLaboratorio" Explicit="True" Trace="False" Strict="True" codePage="1252" EnableSessionState="true" enableViewState="False" %>
...
//-->
	...
	<tr><td class="tdclosewindow">x <a href="#" onClick="window.close();">cerrar ventana </a> </td></tr></table>
			...
			<table cellSpacing="0" cellPadding="0" width="600" border="0" >
				<tr>
					<td class="tdgeneralcontent">
						...
						<br>
						<p><span class="txsubtitulo"><img src="../static/images/bullet_subtitulos.gif" width="17" height="11" align="absMiddle">Clientes Asignados </span> </p>							
