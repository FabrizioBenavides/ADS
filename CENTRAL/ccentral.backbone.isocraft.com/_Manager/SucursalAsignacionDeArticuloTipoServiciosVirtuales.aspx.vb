...
'====================================================================
' Class         : AsignacionDeArticuloTipoServiciosVirtuales
' Title         : Grupo Benavides. Administrador POS y Backoffice.
' Description   : Muestra los tipos de servicios virtuales para poder asignarle un articulo promocional
...
Public Class AsignacionDeArticuloTipoServiciosVirtuales
...
#End Region
    ...
    Public Function strGetRecordBrowserHTML() As String
        ...
        Const strRecordBrowserName As String = "SucursalTipoServicioVirtualAsignacion"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case strCmd
            ...
            Case "Asignar"
                ...
                Call Response.Redirect("SucursalAsignacionDeArticuloServiciosVirtuales.aspx?strCmd=" & strCmd & "&intTipoServicioId=" & intTipoServicioId)
