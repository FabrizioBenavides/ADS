...
'====================================================================
Public NotInheritable Class clstblUsuario

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblUsuario"
    ...
    '====================================================================
    Public Shared Function intActualizar(ByVal intEmpleadoId As Integer, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblUsuario ")
    ...
    '                  - Número de registros afectados por el comando
    '====================================================================
    Public Shared Function intAgregar(ByVal intEmpleadoId As Integer, _
                                      ByVal intUsuarioId As Integer, _
                                      ByVal strUsuarioNombre As String, _
                                      ByVal strUsuarioContrasena As String, _
                                      ByVal blnUsuarioHabilitado As Byte, _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblUsuario ")
            Call strSQLStatement.Append(intEmpleadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intUsuarioId)
            Call strSQLStatement.Append(",")
    ...
    '                   c = Campo
    '====================================================================
    Public Shared Function strBuscar(ByVal intEmpleadoId As Integer, _
                                     ByVal intUsuarioId As Integer, _
                                     ByVal strUsuarioNombre As String, _
                                     ByVal strUsuarioContrasena As String, _
                                     ByVal blnUsuarioHabilitado As Byte, _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblUsuario ")
            Call strSQLStatement.Append(intEmpleadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intUsuarioId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar(ByVal dtmUltimaModificacionInicial As Date, _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblUsuario ")
            Call strSQLStatement.Append("'")
    ...
    '====================================================================
    Public Shared Function intContar(ByVal intEmpleadoId As Integer, _
                                     ByVal intUsuarioId As Integer, _
                                     ByVal strUsuarioNombre As String, _
                                     ByVal strUsuarioContrasena As String, _
                                     ByVal blnUsuarioHabilitado As Byte, _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblUsuario ")
            Call strSQLStatement.Append(intEmpleadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intUsuarioId)
            Call strSQLStatement.Append(",")
    ...
    '                 - Número de registros afectados por el comando
    '====================================================================
    Public Shared Function intEliminar(ByVal intEmpleadoId As Integer, _
                                       ByVal intUsuarioId As Integer, _
                                       ByVal strUsuarioNombre As String, _
                                       ByVal strUsuarioContrasena As String, _
                                       ByVal blnUsuarioHabilitado As Byte, _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblUsuario ")
            Call strSQLStatement.Append(intEmpleadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intUsuarioId)
            Call strSQLStatement.Append(",")
