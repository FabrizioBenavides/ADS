...
'====================================================================
' Class         : clstblDescuentoClienteEspecialCategoriaArticulos
...
'====================================================================
Public NotInheritable Class clstblDescuentoClienteEspecialCategoriaArticulos

    ' Class identifier
    Private Const CLASS_NAME As String = "Benavides.CC.Data.clstblDescuentoClienteEspecialCategoriaArticulos"
    ...
    '                  - 
    '              ByVal fltDescuentoClienteEspecialCategoriaArticulosPorcentaje As Decimal
    '                  - 
    '              ByVal fltDescuentoClienteEspecialCategoriaArticulosPorcentajeTope As Decimal
    '                  - 
    '              ByVal blnDescuentoClienteEspecialCategoriaArticulosTotal As Byte
    '                  - 
    '              ByVal dtmDescuentoClienteEspecialCategoriaArticulosUltimaModificacion As DateTime
    '                  - 
    ...
    Public Shared Function intAgregar(ByVal intDivisionArticulosId As Integer, _
                                      ...
                                      ByVal fltDescuentoClienteEspecialCategoriaArticulosPorcentaje As Decimal, _
                                      ByVal fltDescuentoClienteEspecialCategoriaArticulosPorcentajeTope As Decimal, _
                                      ByVal blnDescuentoClienteEspecialCategoriaArticulosTotal As Byte, _
                                      ByVal dtmDescuentoClienteEspecialCategoriaArticulosUltimaModificacion As DateTime, _
        ...
        Try
            ...
            Call sqlStatementToBeExecuted.Append("EXECUTE spAgregartblDescuentoClienteEspecialCategoriaArticulos ")
            ...
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intClienteEspecialId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(fltDescuentoClienteEspecialCategoriaArticulosPorcentaje)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(fltDescuentoClienteEspecialCategoriaArticulosPorcentajeTope)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(blnDescuentoClienteEspecialCategoriaArticulosTotal)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(dtmDescuentoClienteEspecialCategoriaArticulosUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strDescuentoClienteEspecialCategoriaArticulosModificadoPor)
            Call sqlStatementToBeExecuted.Append("'")
    ...
    Public Shared Function intEliminar(ByVal intDivisionArticulosId As Integer, _
        ...
        Try
            ...
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spEliminartblDescuentoClienteEspecialCategoriaArticulos ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCategoriaArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    Public Shared Function strBuscar(ByVal intDivisionArticulosId As Integer, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscartblDescuentoClienteEspecialCategoriaArticulos ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCategoriaArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    Public Shared Function strBuscar(ByVal dtmStart As DateTime, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscarCambiotblDescuentoClienteEspecialCategoriaArticulos ")
            Call sqlStatementToBeExecuted.Append("'")
    ...
    Public Shared Function intActualizar(ByVal intDivisionArticulosId As Integer, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spActualizartblDescuentoClienteEspecialCategoriaArticulos ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCategoriaArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
