...
'====================================================================
' Class         : clstblTipoEstadoFacturaElectronica
...
'====================================================================
Public NotInheritable Class clstblTipoEstadoFacturaElectronica

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTipoEstadoFacturaElectronica"
    ...
    '                 - Tabla tblTipoEstadoFacturaElectronica
    ' Parameters : 
    '              ByVal intTipoEstadoFacturaElectronicaId As Integer
    '                 - 
    '              ByVal strTipoEstadoFacturaElectronicaNombre As String
    '                 - 
    '              ByVal strTipoEstadoFacturaElectronicaNombreId As String
    '                 - 
    '              ByVal dtmTipoEstadoFacturaElectronicaUltimaModificacion As Date
    '                 - 
    '              ByVal strTipoEstadoFacturaElectronicaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strTipoEstadoFacturaElectronicaNombre As String, _
      ByVal strTipoEstadoFacturaElectronicaNombreId As String, _
      ByVal dtmTipoEstadoFacturaElectronicaUltimaModificacion As Date, _
      ByVal strTipoEstadoFacturaElectronicaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblTipoEstadoFacturaElectronica ")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoFacturaElectronicaNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoFacturaElectronicaNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmTipoEstadoFacturaElectronicaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoFacturaElectronicaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblTipoEstadoFacturaElectronica ")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoFacturaElectronicaNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblTipoEstadoFacturaElectronica ")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoFacturaElectronicaNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblTipoEstadoFacturaElectronica ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblTipoEstadoFacturaElectronica ")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoFacturaElectronicaNombre)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblTipoEstadoFacturaElectronica ")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoFacturaElectronicaNombre)
