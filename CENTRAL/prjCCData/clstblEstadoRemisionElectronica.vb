...
'====================================================================
' Class         : clstblEstadoRemisionElectronica
...
'====================================================================
Public NotInheritable Class clstblEstadoRemisionElectronica

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblEstadoRemisionElectronica"
    ...
    '                 - Tabla tblEstadoRemisionElectronica
    ' Parameters : 
    '              ByVal intRemisionElectronicaId As Integer
    '                 - 
    '              ByVal intTipoEstadoRemisionElectronicaId As Integer
    '                 - 
    '              ByVal intEstadoRemisionElectronicaFolio As Integer
    '                 - 
    '              ByVal dtmEstadoRemisionElectronicaRegistro As Date
    '                 - 
    '              ByVal dtmEstadoRemisionElectronicaUltimaModificacion As Date
    '                 - 
    '              ByVal strEstadoRemisionElectronicaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intTipoEstadoRemisionElectronicaId As Integer, _
      ByVal intEstadoRemisionElectronicaFolio As Integer, _
      ByVal dtmEstadoRemisionElectronicaRegistro As Date, _
      ByVal dtmEstadoRemisionElectronicaUltimaModificacion As Date, _
      ByVal strEstadoRemisionElectronicaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblEstadoRemisionElectronica ")
            Call strSQLStatement.Append(intRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEstadoRemisionElectronicaFolio)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmEstadoRemisionElectronicaRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmEstadoRemisionElectronicaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEstadoRemisionElectronicaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblEstadoRemisionElectronica ")
            Call strSQLStatement.Append(intRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoRemisionElectronicaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblEstadoRemisionElectronica ")
            Call strSQLStatement.Append(intRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoRemisionElectronicaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblEstadoRemisionElectronica ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblEstadoRemisionElectronica ")
            Call strSQLStatement.Append(intRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoRemisionElectronicaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblEstadoRemisionElectronica ")
            Call strSQLStatement.Append(intRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoRemisionElectronicaId)
            Call strSQLStatement.Append(",")
