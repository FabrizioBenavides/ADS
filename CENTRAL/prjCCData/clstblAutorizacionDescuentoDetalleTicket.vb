...
'====================================================================
' Class         : clstblAutorizacionDescuentoDetalleTicket
...
'====================================================================
Public NotInheritable Class clstblAutorizacionDescuentoDetalleTicket

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblAutorizacionDescuentoDetalleTicket"
    ...
    '                 - Tabla tblAutorizacionDescuentoDetalleTicket
    ' Parameters : 
    ...
    '                 - 
    '              ByVal dtmAutorizacionDescuentoDetalleTicketUltimaModificacion As Date
    '                 - 
    '              ByVal strAutorizacionDescuentoDetalleTicketModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal dtmAutorizacionDescuentoDetalleTicketUltimaModificacion As Date, _
      ByVal strAutorizacionDescuentoDetalleTicketModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblAutorizacionDescuentoDetalleTicket ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmAutorizacionDescuentoDetalleTicketUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strAutorizacionDescuentoDetalleTicketModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblAutorizacionDescuentoDetalleTicket ")
            Call strSQLStatement.Append(intTipoDescuentoDetalleTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEmpleadoCajeroId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblAutorizacionDescuentoDetalleTicket ")
            Call strSQLStatement.Append(intTipoDescuentoDetalleTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEmpleadoCajeroId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblAutorizacionDescuentoDetalleTicket ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblAutorizacionDescuentoDetalleTicket ")
            Call strSQLStatement.Append(intTipoDescuentoDetalleTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEmpleadoCajeroId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblAutorizacionDescuentoDetalleTicket ")
            Call strSQLStatement.Append(intTipoDescuentoDetalleTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEmpleadoCajeroId)
            Call strSQLStatement.Append(",")
