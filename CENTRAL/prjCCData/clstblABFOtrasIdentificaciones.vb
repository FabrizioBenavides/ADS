...
Public NotInheritable Class clstblABFOtrasIdentificaciones
    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblABFOtrasIdentificaciones"
    ...
    '                 - Tabla tblABFOtrasIdentificaciones
    ' Parameters :
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscartblABFOtrasIdentificaciones ")
    ...
    Public Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblABFOtrasIdentificacionesCambios ")
