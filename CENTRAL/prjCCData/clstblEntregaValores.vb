...
'====================================================================
Public NotInheritable Class clstblEntregaValores

    ' Class identifier
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblEntregaValores"
    ...
    ' Table name    : tblEntregaValores
    ' Parameters    : 
    '              ByVal intCompaniaId As Int32
    '                  - 
    '              ByVal intSucursalId As Int32
    '                  - 
    '              ByVal intEmpresaValoresId As Decimal
    '                  - 
    ...
    '                  - 
    '              ByVal intEntregaValoresId As Int32
    '                  - 
    '              ByVal strEntregaValoresFolioRemision As String
    '                  - 
    '              ByVal strEntregaValoresFolioBolsa As String
    '                  - 
    '              ByVal fltEntregaValoresImporteMonedaNacional As Double
    '                  - 
    '              ByVal fltEntregaValoresImporteDolares As Double
    '                  - 
    '              ByVal fltEntregaValoresImporteDocumentos As Double
    '                  - 
    '              ByVal dtmEntregaValoresUltimaModificacion As DateTime
    '                  - 
    '              ByVal strEntregaValoresModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal intEmpresaValoresId As Decimal, _
      ...
      ByVal intEntregaValoresId As Int32, _
      ByVal strEntregaValoresFolioRemision As String, _
      ByVal strEntregaValoresFolioBolsa As String, _
      ByVal fltEntregaValoresImporteMonedaNacional As Double, _
      ByVal fltEntregaValoresImporteDolares As Double, _
      ByVal fltEntregaValoresImporteDocumentos As Double, _
      ByVal dtmEntregaValoresUltimaModificacion As DateTime, _
      ByVal strEntregaValoresModificadoPor As String, _
      ByVal strConnectionString As String) As integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spAgregartblEntregaValores ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEmpresaValoresId)
            Call strSQLStatement.Append(",")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEntregaValoresId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEntregaValoresFolioRemision)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEntregaValoresFolioBolsa)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltEntregaValoresImporteMonedaNacional)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltEntregaValoresImporteDolares)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltEntregaValoresImporteDocumentos)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmEntregaValoresUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEntregaValoresModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spEliminartblEntregaValores ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscartblEntregaValores ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblEntregaValores ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spActualizartblEntregaValores ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
