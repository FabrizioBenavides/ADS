...
'====================================================================
' Class         : clstblVentaClienteEspecial
...
'====================================================================
Public NotInheritable Class clstblVentaClienteEspecial

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblVentaClienteEspecial"
    ...
    '                 - 
    '              ByVal fltVentaClienteEspecialImporte As Double
    '                 - 
    '              ByVal fltVentaClienteEspecialImporteCopago As Double
    '                 - 
    '              ByVal blnVentaClienteEspecialValidada As Byte
    '                 - 
    '              ByVal dtmVentaClienteEspecialUltimaModificacion As Date
    '                 - 
    '              ByVal strVentaClienteEspecialModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal fltVentaClienteEspecialImporte As Double, _
      ByVal fltVentaClienteEspecialImporteCopago As Double, _
      ByVal blnVentaClienteEspecialValidada As Byte, _
      ByVal dtmVentaClienteEspecialUltimaModificacion As Date, _
      ByVal strVentaClienteEspecialModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblVentaClienteEspecial ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltVentaClienteEspecialImporte)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltVentaClienteEspecialImporteCopago)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnVentaClienteEspecialValidada)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmVentaClienteEspecialUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strVentaClienteEspecialModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblVentaClienteEspecial ")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblVentaClienteEspecial ")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblVentaClienteEspecial ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblVentaClienteEspecial ")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblVentaClienteEspecial ")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
