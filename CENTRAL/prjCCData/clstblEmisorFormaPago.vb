...
'====================================================================
Public NotInheritable Class clstblEmisorFormaPago

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblEmisorFormaPago"
    ...
    '                 - Tabla tblEmisorFormaPago
    ' Parameters : 
    '              ByVal intEmisorFormaPagoId As Integer
    '                 - 
    '              ByVal strEmisorFormaPagoNombreId As String
    '                 - 
    '              ByVal strEmisorFormaPagoNombre As String
    '                 - 
    '              ByVal dtmEmisorFormaPagoVigente As Date
    '                 - 
    '              ByVal dtmEmisorFormaPagoUltimaModificacion As Date
    '                 - 
    '              ByVal strEmisorFormaPagoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strEmisorFormaPagoNombreId As String, _
      ByVal strEmisorFormaPagoNombre As String, _
      ByVal dtmEmisorFormaPagoVigente As Date, _
      ByVal dtmEmisorFormaPagoUltimaModificacion As Date, _
      ByVal strEmisorFormaPagoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblEmisorFormaPago ")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmisorFormaPagoNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmisorFormaPagoNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmEmisorFormaPagoVigente.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmEmisorFormaPagoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmisorFormaPagoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblEmisorFormaPago ")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmisorFormaPagoNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblEmisorFormaPago ")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmisorFormaPagoNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblEmisorFormaPago ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblEmisorFormaPago ")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmisorFormaPagoNombreId)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblEmisorFormaPago ")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmisorFormaPagoNombreId)
