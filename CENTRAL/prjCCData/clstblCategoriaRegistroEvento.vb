...
'====================================================================
' Class         : clstblCategoriaRegistroEvento
...
'====================================================================
Public NotInheritable Class clstblCategoriaRegistroEvento

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblCategoriaRegistroEvento"
    ...
    '                 - Tabla tblCategoriaRegistroEvento
    ' Parameters : 
    '              ByVal intCategoriaRegistroEventoId As Integer
    '                 - 
    '              ByVal strCategoriaRegistroEventoNombre As String
    '                 - 
    '              ByVal strCategoriaRegistroEventoNombreId As String
    '                 - 
    '              ByVal strCategoriaRegistroEventoModificadoPor As String
    '                 - 
    '              ByVal dtmCategoriaRegistroEventoUltimaModificacion As Date
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strCategoriaRegistroEventoNombre As String, _
      ByVal strCategoriaRegistroEventoNombreId As String, _
      ByVal strCategoriaRegistroEventoModificadoPor As String, _
      ByVal dtmCategoriaRegistroEventoUltimaModificacion As Date, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblCategoriaRegistroEvento ")
            Call strSQLStatement.Append(intCategoriaRegistroEventoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCategoriaRegistroEventoNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCategoriaRegistroEventoNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCategoriaRegistroEventoModificadoPor)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCategoriaRegistroEventoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblCategoriaRegistroEvento ")
            Call strSQLStatement.Append(intCategoriaRegistroEventoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCategoriaRegistroEventoNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblCategoriaRegistroEvento ")
            Call strSQLStatement.Append(intCategoriaRegistroEventoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCategoriaRegistroEventoNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblCategoriaRegistroEvento ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblCategoriaRegistroEvento ")
            Call strSQLStatement.Append(intCategoriaRegistroEventoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCategoriaRegistroEventoNombre)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblCategoriaRegistroEvento ")
            Call strSQLStatement.Append(intCategoriaRegistroEventoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCategoriaRegistroEventoNombre)
