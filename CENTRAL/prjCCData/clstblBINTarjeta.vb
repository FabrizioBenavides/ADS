...
'====================================================================
Public NotInheritable Class clstblBINTarjeta

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblBINTarjeta"
    ...
    '                 - 
    '              ByVal blnValidaPagoConVales As Boolean, _
    '                 -
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal blnBINCobraComision As Boolean, _
      ByVal intBancoIntegradorCorresponsaliaId As Integer, _
      ByVal blnValidaPagoConVales As Boolean, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblBINTarjeta ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(CByte(blnBINCobraComision))
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intBancoIntegradorCorresponsaliaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(CByte(blnValidaPagoConVales))
    ...
    '              ByVal strBINTarjetaModificadoPor As String
    '                  - 
    '              ByVal blnValidaPagoConVales As Boolean  
    '                  -
    '              ByVal strConnectionString As String
    '                  - Cadena de conexión hacia el RDBMS
    ' Throws     : Exception
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblBINTarjeta ")
            Call strSQLStatement.Append(intBINTarjetaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblBINTarjeta ")
            Call strSQLStatement.Append(intBINTarjetaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblBINTarjeta ")
            Call strSQLStatement.Append(intBINTarjetaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
