...
'====================================================================
Public NotInheritable Class clstblCompraDirecta

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblCompraDirecta"
    ...
    '                 - Tabla tblCompraDirecta
    ' Parameters : 
    '              ByVal intCompraDirectaId As Integer
    '                 - 
    ...
    '                 - 
    '              ByVal intCompraDirectaFolio As Integer
    '                 - 
    '              ByVal dtmCompraDirectaRecepcion As Date
    '                 - 
    '              ByVal strCompraDirectaNumeroFactura As String
    '                 - 
    '              ByVal dtmCompraDirectaRegistroFactura As Date
    '                 - 
    ...
    '                 - 
    '              ByVal fltCompraDirectaImporteTotalFactura As Double
    '                 - 
    '              ByVal dtmCompraDirectaUltimaModificacion As Date
    '                 - 
    '              ByVal strCompraDirectaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intCompraDirectaId As Integer, _
      ...
      ByVal intCompraDirectaFolio As Integer, _
      ByVal dtmCompraDirectaRecepcion As Date, _
      ByVal strCompraDirectaNumeroFactura As String, _
      ByVal dtmCompraDirectaRegistroFactura As Date, _
      ByVal fltCompraDirectaImporteNetoFactura As Double, _
      ByVal fltCompraDirectaImporteIvaFactura As Double, _
      ByVal fltCompraDirectaImporteIvaDescuento As Double, _
      ByVal fltCompraDirectaImporteDescuentoDespuesIVA As Double, _
      ByVal fltCompraDirectaImporteTotalFactura As Double, _
      ByVal dtmCompraDirectaUltimaModificacion As Date, _
      ByVal strCompraDirectaModificadoPor As String, _
      ByVal strConnectionString As String, _
      ByVal fltCompraDirectaImporteIEPS As Double) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblCompraDirecta ")
            Call strSQLStatement.Append(intCompraDirectaId)
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompraDirectaFolio)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCompraDirectaRecepcion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCompraDirectaNumeroFactura)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCompraDirectaRegistroFactura.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltCompraDirectaImporteNetoFactura)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltCompraDirectaImporteIvaFactura)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltCompraDirectaImporteIvaDescuento)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltCompraDirectaImporteDescuentoDespuesIVA)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltCompraDirectaImporteTotalFactura)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCompraDirectaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCompraDirectaModificadoPor)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltCompraDirectaImporteIEPS)
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal fltCompraDirectaImporteIEPS As Double) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblCompraDirecta ")
            Call strSQLStatement.Append(intCompraDirectaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intProveedorId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String, _
      ByVal fltCompraDirectaImporteIEPS As Double) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblCompraDirecta ")
            Call strSQLStatement.Append(intCompraDirectaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intProveedorId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblCompraDirecta ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strCompraDirectaModificadoPor As String, _
      ByVal strConnectionString As String, _
      ByVal fltCompraDirectaImporteIEPS As Double) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblCompraDirecta ")
            Call strSQLStatement.Append(intCompraDirectaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intProveedorId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal fltCompraDirectaImporteIEPS As Double) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblCompraDirecta ")
            Call strSQLStatement.Append(intCompraDirectaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intProveedorId)
            Call strSQLStatement.Append(",")
