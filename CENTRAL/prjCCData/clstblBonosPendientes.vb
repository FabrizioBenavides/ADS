...
'====================================================================
Public NotInheritable Class clstblBonosPendientes

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblBonosPendientes"
    ...
    '                 - Tabla tblBonosPendientes
    ' Parameters : 
    '              ByVal intBonosPendientesCompaniaId As Integer
    '                 - 
    '              ByVal intBonosPendientesSucursalId As Integer
    '                 - 
    '              ByVal dtmBonosPendientesFechaRegistro As Date
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intBonosPendientesCompaniaId As Integer, _
      ByVal intBonosPendientesSucursalId As Integer, _
      ByVal dtmBonosPendientesFechaRegistro As Date, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblBonosPendientes ")
            Call strSQLStatement.Append(intBonosPendientesCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intBonosPendientesSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmBonosPendientesFechaRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblBonosPendientes ")
            Call strSQLStatement.Append(intBonosPendientesCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intBonosPendientesSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblBonosPendientes ")
            Call strSQLStatement.Append(intBonosPendientesCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intBonosPendientesSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblBonosPendientes ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblBonosPendientes ")
            Call strSQLStatement.Append(intBonosPendientesCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intBonosPendientesSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblBonosPendientes ")
            Call strSQLStatement.Append(intBonosPendientesCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intBonosPendientesSucursalId)
            Call strSQLStatement.Append(",")
