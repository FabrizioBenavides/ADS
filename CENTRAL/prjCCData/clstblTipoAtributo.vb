...
'====================================================================
Public NotInheritable Class clstblTipoAtributo

    ' Class identifier
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTipoAtributo"
    ...
    ' Table name    : tblTipoAtributo
    ' Parameters    : 
    '              ByVal intTipoAtributoId As Decimal
    '                  - 
    '              ByVal strTipoAtributoNombreId As String
    '                  - 
    '              ByVal strTipoAtributoNombre As String
    '                  - 
    '              ByVal strTipoAtributoDescripcion As String
    '                  - 
    '              ByVal strTipoAtributoCaracteresPermitidos As String
    '                  - 
    '              ByVal strTipoAtributoFormato As String
    '                  - 
    '              ByVal dtmTipoAtributoUltimaModificacion As DateTime
    '                  - 
    '              ByVal strTipoAtributoModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strTipoAtributoNombreId As String, _
      ByVal strTipoAtributoNombre As String, _
      ByVal strTipoAtributoDescripcion As String, _
      ByVal strTipoAtributoCaracteresPermitidos As String, _
      ByVal strTipoAtributoFormato As String, _
      ByVal dtmTipoAtributoUltimaModificacion As DateTime, _
      ByVal strTipoAtributoModificadoPor As String, _
      ByVal blnTipoAtributoActivo As Boolean, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spAgregartblTipoAtributo ")
            Call strSQLStatement.Append(intTipoAtributoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoAtributoNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoAtributoNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoAtributoDescripcion)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoAtributoCaracteresPermitidos)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoAtributoFormato)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmTipoAtributoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoAtributoModificadoPor)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(CByte(blnTipoAtributoActivo))
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spEliminartblTipoAtributo ")
            Call strSQLStatement.Append(intTipoAtributoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoAtributoNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscartblTipoAtributo ")
            Call strSQLStatement.Append(intTipoAtributoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoAtributoNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblTipoAtributo ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spActualizartblTipoAtributo ")
            Call strSQLStatement.Append(intTipoAtributoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoAtributoNombreId)
