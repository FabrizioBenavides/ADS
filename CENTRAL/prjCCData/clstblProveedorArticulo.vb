...
' Version       : 1.0
' Last Modified : Monday, August 04, 2009
'====================================================================

Public Class clstblProveedorArticulo
    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblProveedorArticulo"
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal dtmProveedorArticuloUltimaModificacion As Date, _
      ByVal strProveedorArticuloModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblProveedorArticulo ")
            Call strSQLStatement.Append(intProveedorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmProveedorArticuloUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strProveedorArticuloModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    '              ByVal intArticuloId As Integer
    '                  - 
    '              ByVal dtmProveedorArticuloUltimaModificacion As Date
    '                  - 
    '              ByVal strProveedorArticuloModificadoPor As String
    '                  - 
    '              ByVal strConnectionString As String
    '                  - Cadena de conexión hacia el RDBMS
    ' Throws     : Exception
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblProveedorArticulo ")
            Call strSQLStatement.Append(intProveedorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblProveedorArticulo ")
            Call strSQLStatement.Append(intProveedorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    '                 - Tabla tblProveedorArticulo
    ' Parameters :
    '              ByVal intTiendaActualizarId As Integer
    '                 - identificador de la tienda a actualizar
    ...
    '====================================================================
    Public Shared Function strBuscar( _
      ByVal intTiendaActualizarId As Integer, _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblProveedorArticulo ")
            Call strSQLStatement.Append(intTiendaActualizarId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
