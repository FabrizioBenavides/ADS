...
'====================================================================
' Class         : clsFacturaElectronicaGlobal
...
'====================================================================
Public NotInheritable Class clsFacturaElectronicaGlobal

    Private Const strmThisClassName As String = "Benavides.CC.Data.clsPromocionMonedero"
    ' Class identifier
    Private Const CLASS_NAME As String = "Benavides.CC.Data.clsFacturaElectronicaGlobal"
    ...
    Public Shared Function strBuscarDatosFacturacion(ByVal strConnectionString As String) As Array

        ' Member identifier
        Const strmThisMemberName As String = "strBuscarDatosFacturacion"
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarDatosFacturacionFacturaElectronicaGlobalSucursal ")
    ...
    Public Shared Function strBuscar( _
        ...
        ByVal intMesVenta As Double, _
        ByVal intDiasFaltantes As Double, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarFacturaElectronicaGlobalSucursal ")
            ...
            Call strSQLStatement.Append(intMesVenta)
            Call strSQLStatement.Append(",")

            Call strSQLStatement.Append(intDiasFaltantes)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscarDetalle( _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarDetalleFacturaElectronicaGlobalSucursal ")
    ...
    Public Shared Function strBuscarTotales( _
    ByVal intDireccionOperativaId As Double, _
    ByVal intZonaOperativaId As Double, _
    ByVal intCompaniaId As Double, _
    ByVal intSucursalId As Double, _
    ByVal intMesVenta As Double, _
    ByVal intDiasFaltantes As Double, _
    ByVal blnMesDetallado As Byte, _
    ByVal intInitialPosition As Double, _
    ByVal intElementsToRetrieve As Double, _
    ByVal strConnectionString As String) As Array
        ...
        ' Member identifier
        Const strmThisMemberName As String = "strBuscarTotales"
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarTotalesFacturaElectronicaGlobalSucursal ")
            ...
            Call strSQLStatement.Append(blnMesDetallado)
            Call strSQLStatement.Append(",")
            ...
            strBuscarTotales = Benavides.Data.SQL.MSSQL.clsSQLOperation.strExecuteQuery(strSQLStatement.ToString, strConnectionString)
            strSQLStatement = Nothing
    ...
    Public Shared Function strBuscarMesGenerado( _
    ByVal intMesVenta As Double, _
    ByVal intInitialPosition As Double, _
    ByVal intElementsToRetrieve As Double, _
    ByVal strConnectionString As String) As Array
        ...
        ' Member identifier
        Const strmThisMemberName As String = "strBuscarMesGenerado"
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarMesGeneradoFacturaElectronicaGlobal ")
            ...
            strBuscarMesGenerado = Benavides.Data.SQL.MSSQL.clsSQLOperation.strExecuteQuery(strSQLStatement.ToString, strConnectionString)
            strSQLStatement = Nothing
    ...
    Public Shared Function strGenerarFactura(ByVal intMesVenta As Double, ByVal strConnectionString As String) As Array

        ' Member identifier
        Const strmThisMemberName As String = "strGenerarFactura"
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spGenerarFacturaElectronicaGlobal ")
            Call strSQLStatement.Append(intMesVenta)
    ...
    Public Shared Function strObtenerFacturaXML(ByVal intMesVenta As Double, ByVal strConnectionString As String) As Array

        ' Member identifier
        Const strmThisMemberName As String = "strObtenerFacturaXML"
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spObtenerFacturaGloblaMensualXML ")
            Call strSQLStatement.Append(intMesVenta)
