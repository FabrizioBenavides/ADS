...
'====================================================================
' Class         : clstblTipoDatoAdicionalPagoTicket
...
'====================================================================
Public NotInheritable Class clstblTipoDatoAdicionalPagoTicket

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTipoDatoAdicionalPagoTicket"
    ...
    '                 - Tabla tblTipoDatoAdicionalPagoTicket
    ' Parameters : 
    '              ByVal intTipoDatoAdicionalPagoTicketId As Integer
    '                 - 
    '              ByVal strTipoDatoAdicionalPagoTicketNombreId As String
    '                 - 
    '              ByVal strTipoDatoAdicionalPagoTicketNombre As String
    '                 - 
    '              ByVal intTipoDatoAdicionalPagoTicketLongitud As Integer
    '                 - 
    '              ByVal strTipoDatoAdicionalPagoTicketTipo As String
    '                 - 
    '              ByVal dtmTipoDatoAdicionalPagoTicketUltimaModificacion As Date
    '                 - 
    '              ByVal strTipoDatoAdicionalPagoTicketModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intTipoDatoAdicionalPagoTicketId As Integer, _
      ByVal strTipoDatoAdicionalPagoTicketNombreId As String, _
      ByVal strTipoDatoAdicionalPagoTicketNombre As String, _
      ByVal intTipoDatoAdicionalPagoTicketLongitud As Integer, _
      ByVal strTipoDatoAdicionalPagoTicketTipo As String, _
      ByVal dtmTipoDatoAdicionalPagoTicketUltimaModificacion As Date, _
      ByVal strTipoDatoAdicionalPagoTicketModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblTipoDatoAdicionalPagoTicket ")
            Call strSQLStatement.Append(intTipoDatoAdicionalPagoTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoAdicionalPagoTicketNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoAdicionalPagoTicketNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoDatoAdicionalPagoTicketLongitud)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoAdicionalPagoTicketTipo)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmTipoDatoAdicionalPagoTicketUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoAdicionalPagoTicketModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblTipoDatoAdicionalPagoTicket ")
            Call strSQLStatement.Append(intTipoDatoAdicionalPagoTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoAdicionalPagoTicketNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblTipoDatoAdicionalPagoTicket ")
            Call strSQLStatement.Append(intTipoDatoAdicionalPagoTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoAdicionalPagoTicketNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblTipoDatoAdicionalPagoTicket ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblTipoDatoAdicionalPagoTicket ")
            Call strSQLStatement.Append(intTipoDatoAdicionalPagoTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoAdicionalPagoTicketNombreId)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblTipoDatoAdicionalPagoTicket ")
            Call strSQLStatement.Append(intTipoDatoAdicionalPagoTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoAdicionalPagoTicketNombreId)
