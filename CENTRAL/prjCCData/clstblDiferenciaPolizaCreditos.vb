...
'====================================================================
' Class         : clstblDiferenciaPolizaCreditos
...
' Version       : 1.0
' Last Modified : Martes, 17 de Agosto de 2004
'====================================================================
Public NotInheritable Class clstblDiferenciaPolizaCreditos

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblDiferenciaPolizaCreditos"
    ...
    '                 - Tabla tblDiferenciaPolizaCreditos
    ' Parameters : 
    '              ByVal intDiferenciaPolizaCreditosId As Double
    '                 - 
    '              ByVal intCompaniaId As Double
    '                 - 
    '              ByVal intSucursalId As Double
    '                 - 
    '              ByVal intCuentaId As Double
    '                 - 
    '              ByVal dtmDiferenciaPolizaCreditosRegistro As Date
    '                 - 
    '              ByVal fltDiferenciaPolizaCreditosImportePoliza As Double
    '                 - 
    '              ByVal fltDiferenciaPolizaCreditosImporteCreditos As Double
    '                 - 
    '              ByVal dtmDiferenciaPolizaCreditosUltimaModificacion As Date
    '                 - 
    '              ByVal strDiferenciaPolizaCreditosModificadoPor As String
    '                 -       
    ...
    Shared Function intActualizar( _
                ByVal intDiferenciaPolizaCreditosId As Double, _
                ByVal intCompaniaId As Double, _
                ByVal intSucursalId As Double, _
                ByVal intCuentaId As Double, _
                ByVal dtmDiferenciaPolizaCreditosRegistro As Date, _
                ByVal fltDiferenciaPolizaCreditosImportePoliza As Double, _
                ByVal fltDiferenciaPolizaCreditosImporteCreditos As Double, _
                ByVal dtmDiferenciaPolizaCreditosUltimaModificacion As Date, _
                ByVal strDiferenciaPolizaCreditosModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblDiferenciaPolizaCreditos ")
            Call strSQLStatement.Append(intDiferenciaPolizaCreditosId)
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmDiferenciaPolizaCreditosRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltDiferenciaPolizaCreditosImportePoliza)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltDiferenciaPolizaCreditosImporteCreditos)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmDiferenciaPolizaCreditosUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strDiferenciaPolizaCreditosModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblDiferenciaPolizaCreditos ")
            Call strSQLStatement.Append(intDiferenciaPolizaCreditosId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblDiferenciaPolizaCreditos ")
            Call strSQLStatement.Append(intDiferenciaPolizaCreditosId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Shared Function intContar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblDiferenciaPolizaCreditos ")
            Call strSQLStatement.Append(intDiferenciaPolizaCreditosId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Shared Function intEliminar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblDiferenciaPolizaCreditos ")
            Call strSQLStatement.Append(intDiferenciaPolizaCreditosId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
