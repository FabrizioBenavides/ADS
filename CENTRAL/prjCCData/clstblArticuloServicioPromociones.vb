...
Public Class clstblArticuloServicioPromociones
    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblArticuloServicioPromociones"

    ' Constructor en blanco para prevenir la generación de un constructor por defecto
    Private Sub New()
    End Sub

    Public Shared Function IntAgregarArticuloIdServicioPromociones( _
          ...
          ByVal IntArticuloServicioPromocionesArticuloId As Integer, _
          ByVal strUsuarioNombre As String, _
          ByVal strConnectionString As String) As Integer

        ' Constantes locales
        Const strmThisMemberName As String = "IntAgregarArticuloIdServicioPromociones"
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spAgregarArticuloIdServicioPromociones ")
            ...
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(IntArticuloServicioPromocionesArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            ...
            IntAgregarArticuloIdServicioPromociones = intRowsAffected
        ...
        Catch objException As Exception
            ...
            ' Regresamos la información
            IntAgregarArticuloIdServicioPromociones = 0
    ...
    Public Shared Function IntAgregarArticuloIdEmpresaServicioPromociones( _
              ByVal intServicioVirtualId As Integer, _
              ByVal intEmpresaServicioId As Integer, _
              ByVal strEmpresaServicioCodigoServicio As String, _
              ByVal IntArticuloServicioPromocionesArticuloId As Integer, _
        ...
        ' Constantes locales
        Const strmThisMemberName As String = "IntAgregarArticuloIdEmpresaServicioPromociones"
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregarArticuloIdEmpresaServicioPromociones ")
            Call strSQLStatement.Append(intServicioVirtualId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEmpresaServicioId)
            Call strSQLStatement.Append(",")
            ...
            ' Regresamos la información
            strSQLStatement = Nothing
            IntAgregarArticuloIdEmpresaServicioPromociones = intRowsAffected
        ...
        Catch objException As Exception
            ...
            ' Regresamos la información
            IntAgregarArticuloIdEmpresaServicioPromociones = 0
    ...
    '====================================================================
    ' Class         : strBuscarArticuloIdServicioPromociones
    ' Title         : Grupo Benavides. Administrador POS y Backoffice.
    ' Description   : Mantenimiento de Tablas.
    ' Copyright     : 2013 Todos los Derechos Reservados.
    ' Company       : Softtek
    ...
    ' Creado        : Martes , Junio 11, 2013
    '====================================================================
    Public Shared Function strBuscarArticuloIdServicioPromociones( _
      ByVal intEmpresaServicioId As Integer, _
      ByVal intServicioVirtualId As Integer, _
      ByVal strEmpresaServicioCodigoServicio As String, _
      ByVal strConnectionString As String) As Array
        ' Member identifier
        Const strmThisMemberName As String = "strBuscarArticuloIdServicioPromociones"
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarArticuloIdServicioPromociones ")
            Call strSQLStatement.Append(intEmpresaServicioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intServicioVirtualId)
            Call strSQLStatement.Append(",")
    ...
    ' Copyright     : 2013 Todos los Derechos Reservados.
    ' Company       : Softtek
    ' Author        : Eloy Barreras Covarrubias EBCV
    ' Version       : 1
    ' Creado        : Jueves , Junio 20, 2013
    '====================================================================

    Public Shared Function IntValidarArticuloServicioVirtual(ByVal IntArticuloServicioPromocionesArticuloId As Integer, _
              ByVal strConnectionString As String) As Integer

        ' Constantes locales
        Const strmThisMemberName As String = "IntValidarArticuloServicioVirtual"
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spValidarArticuloServicioVirtual ")
            Call strSQLStatement.Append(IntArticuloServicioPromocionesArticuloId)
            ...
            ' Regresamos la información
            strSQLStatement = Nothing
            IntValidarArticuloServicioVirtual = intRowsAffected
        ...
        Catch objException As Exception
            ...
            ' Regresamos la información
            IntValidarArticuloServicioVirtual = 0
    ...
    ' Copyright     : 2013 Todos los Derechos Reservados.
    ' Company       : Softtek
    ' Author        : Jaime Rodriguez Hernandez JMRH
    ' Version       : 1
    ' Creado        : Miercoles 12 de Junio de 2013
    '====================================================================
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblArticuloServicioPromociones ")
            Call strSQLStatement.Append("'")
