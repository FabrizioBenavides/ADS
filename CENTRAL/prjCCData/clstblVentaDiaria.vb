...
'====================================================================
Public NotInheritable Class clstblVentaDiaria

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblVentaDiaria"
    ...
    '                 - Tabla tblVentaDiaria
    ' Parameters : 
    '              ByVal intVentaDiariaId As Integer
    '                 - 
    '              ByVal intVentaDiariaCompaniaId As Integer
    '                 - 
    '              ByVal intVentaDiariaSucursalId As Integer
    '                 - 
    '              ByVal intVentaDiariaArticuloId As Integer
    '                 - 
    '              ByVal dtmVentaDiariaRegistro As Date
    '                 - 
    '              ByVal intVentaDiariaDepartamentoId As Integer
    '                 - 
    '              ByVal intVentaDiariaCantidadArticulo As Integer
    '                 - 
    '              ByVal fltVentaDiariaImporteNormalSinImpuesto As Double
    '                 - 
    '              ByVal fltVentaDiariaImporteVentaSinImpuesto As Double
    '                 - 
    '              ByVal dtmVentaDiariaUltimaModificacion As Date
    '                 - 
    '              ByVal strVentaDiariaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intVentaDiariaId As Integer, _
      ByVal intVentaDiariaCompaniaId As Integer, _
      ByVal intVentaDiariaSucursalId As Integer, _
      ByVal intVentaDiariaArticuloId As Integer, _
      ByVal dtmVentaDiariaRegistro As Date, _
      ByVal intVentaDiariaDepartamentoId As Integer, _
      ByVal intVentaDiariaCantidadArticulo As Integer, _
      ByVal fltVentaDiariaImporteNormalSinImpuesto As Double, _
      ByVal fltVentaDiariaImporteVentaSinImpuesto As Double, _
      ByVal dtmVentaDiariaUltimaModificacion As Date, _
      ByVal strVentaDiariaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblVentaDiaria ")
            Call strSQLStatement.Append(intVentaDiariaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaDiariaCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaDiariaSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaDiariaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmVentaDiariaRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaDiariaDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaDiariaCantidadArticulo)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltVentaDiariaImporteNormalSinImpuesto)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltVentaDiariaImporteVentaSinImpuesto)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmVentaDiariaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strVentaDiariaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblVentaDiaria ")
            Call strSQLStatement.Append(intVentaDiariaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaDiariaCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblVentaDiaria ")
            Call strSQLStatement.Append(intVentaDiariaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaDiariaCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblVentaDiaria ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblVentaDiaria ")
            Call strSQLStatement.Append(intVentaDiariaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaDiariaCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblVentaDiaria ")
            Call strSQLStatement.Append(intVentaDiariaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaDiariaCompaniaId)
            Call strSQLStatement.Append(",")
