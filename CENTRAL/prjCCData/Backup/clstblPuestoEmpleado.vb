...
'====================================================================
Public NotInheritable Class clstblPuestoEmpleado

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblPuestoEmpleado"
    ...
    '                 - Tabla tblPuestoEmpleado
    ' Parameters : 
    '              ByVal intPuestoEmpleadoId As Integer
    '                 - 
    '              ByVal strPuestoEmpleadoNombre As String
    '                 - 
    '              ByVal dtmPuestoEmpleadoUltimaModificacion As Date
    '                 - 
    '              ByVal strPuestoEmpleadoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strPuestoEmpleadoNombre As String, _
      ByVal dtmPuestoEmpleadoUltimaModificacion As Date, _
      ByVal strPuestoEmpleadoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblPuestoEmpleado ")
            Call strSQLStatement.Append(intPuestoEmpleadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPuestoEmpleadoNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmPuestoEmpleadoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPuestoEmpleadoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblPuestoEmpleado ")
            Call strSQLStatement.Append(intPuestoEmpleadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPuestoEmpleadoNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblPuestoEmpleado ")
            Call strSQLStatement.Append(intPuestoEmpleadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPuestoEmpleadoNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblPuestoEmpleado ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblPuestoEmpleado ")
            Call strSQLStatement.Append(intPuestoEmpleadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPuestoEmpleadoNombre)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblPuestoEmpleado ")
            Call strSQLStatement.Append(intPuestoEmpleadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPuestoEmpleadoNombre)
