...
'====================================================================
' Class         : clstblGrupoClienteEspecial
...
'====================================================================
Public NotInheritable Class clstblGrupoClienteEspecial

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblGrupoClienteEspecial"
    ...
    '                 - Tabla tblGrupoClienteEspecial
    ' Parameters : 
    '              ByVal intGrupoClienteEspecialId As Integer
    '                 - 
    '              ByVal strGrupoClienteEspecialNombreId As String
    '                 - 
    '              ByVal strGrupoClienteEspecialNombre As String
    '                 - 
    '              ByVal dtmGrupoClienteEspecialUltimaModificacion As Date
    '                 - 
    '              ByVal strGrupoClienteEspecialModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strGrupoClienteEspecialNombreId As String, _
      ByVal strGrupoClienteEspecialNombre As String, _
      ByVal dtmGrupoClienteEspecialUltimaModificacion As Date, _
      ByVal strGrupoClienteEspecialModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblGrupoClienteEspecial ")
            Call strSQLStatement.Append(intGrupoClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strGrupoClienteEspecialNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strGrupoClienteEspecialNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmGrupoClienteEspecialUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strGrupoClienteEspecialModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblGrupoClienteEspecial ")
            Call strSQLStatement.Append(intGrupoClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strGrupoClienteEspecialNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblGrupoClienteEspecial ")
            Call strSQLStatement.Append(intGrupoClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strGrupoClienteEspecialNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblGrupoClienteEspecial ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblGrupoClienteEspecial ")
            Call strSQLStatement.Append(intGrupoClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strGrupoClienteEspecialNombreId)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblGrupoClienteEspecial ")
            Call strSQLStatement.Append(intGrupoClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strGrupoClienteEspecialNombreId)
