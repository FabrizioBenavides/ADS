...
'====================================================================
Public NotInheritable Class clstblCuentaFormaPago

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblCuentaFormaPago"
    ...
    '                 - 
    '              ByVal dtmCuentaFormaPagoUltimaModificacion As Date
    '                 - 
    '              ByVal strCuentaFormaPagoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal dtmCuentaFormaPagoUltimaModificacion As Date, _
      ByVal strCuentaFormaPagoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblCuentaFormaPago ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCuentaFormaPagoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCuentaFormaPagoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblCuentaFormaPago ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intUbicacionBancoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblCuentaFormaPago ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intUbicacionBancoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblCuentaFormaPago ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblCuentaFormaPago ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intUbicacionBancoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblCuentaFormaPago ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intUbicacionBancoId)
            Call strSQLStatement.Append(",")
