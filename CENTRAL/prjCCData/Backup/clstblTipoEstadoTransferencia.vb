...
'====================================================================
' Class         : clstblTipoEstadoTransferencia
...
'====================================================================
Public NotInheritable Class clstblTipoEstadoTransferencia

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTipoEstadoTransferencia"
    ...
    '                 - Tabla tblTipoEstadoTransferencia
    ' Parameters : 
    '              ByVal intTipoEstadoTransferenciaId As Integer
    '                 - 
    '              ByVal strTipoEstadoTransferenciaNombre As String
    '                 - 
    '              ByVal strTipoEstadoTransferenciaNombreId As String
    '                 - 
    '              ByVal dtmTipoEstadoTransferenciaUltimaModificacion As Date
    '                 - 
    '              ByVal strTipoEstadoTransferenciaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strTipoEstadoTransferenciaNombre As String, _
      ByVal strTipoEstadoTransferenciaNombreId As String, _
      ByVal dtmTipoEstadoTransferenciaUltimaModificacion As Date, _
      ByVal strTipoEstadoTransferenciaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblTipoEstadoTransferencia ")
            Call strSQLStatement.Append(intTipoEstadoTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoTransferenciaNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoTransferenciaNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmTipoEstadoTransferenciaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoTransferenciaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblTipoEstadoTransferencia ")
            Call strSQLStatement.Append(intTipoEstadoTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoTransferenciaNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblTipoEstadoTransferencia ")
            Call strSQLStatement.Append(intTipoEstadoTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoTransferenciaNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblTipoEstadoTransferencia ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblTipoEstadoTransferencia ")
            Call strSQLStatement.Append(intTipoEstadoTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoTransferenciaNombre)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblTipoEstadoTransferencia ")
            Call strSQLStatement.Append(intTipoEstadoTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoTransferenciaNombre)
