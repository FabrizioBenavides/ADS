...
'====================================================================
Public NotInheritable Class clstblProveedor

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblProveedor"
    ...
    '                 - 
    '              ByVal strProveedorRazonSocial As String
    '                 - 
    '              ByVal blnProveedorNacional As Byte
    '                 - 
    '              ByVal strProveedorRFC As String
    '                 - 
    '              ByVal blnProveedorAplicaComision As Byte
    '                 - 
    '              ByVal blnProveedorVigente As Byte
    '                 - 
    '              ByVal dtmProveedorUltimaModificacion As Date
    '                 - 
    '              ByVal strProveedorModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intTipoProveedorId As Integer, _
      ByVal strProveedorRazonSocial As String, _
      ByVal blnProveedorNacional As Byte, _
      ByVal strProveedorRFC As String, _
      ByVal blnProveedorAplicaComision As Byte, _
      ByVal blnProveedorVigente As Byte, _
      ByVal dtmProveedorUltimaModificacion As Date, _
      ByVal strProveedorModificadoPor As String, _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblProveedor ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoProveedorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strProveedorRazonSocial)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnProveedorNacional)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strProveedorRFC)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnProveedorAplicaComision)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnProveedorVigente)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmProveedorUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strProveedorModificadoPor)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblProveedor ")
            Call strSQLStatement.Append(intProveedorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEstadoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblProveedor ")
            Call strSQLStatement.Append(intProveedorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEstadoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblProveedor ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblProveedor ")
            Call strSQLStatement.Append(intProveedorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEstadoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblProveedor ")
            Call strSQLStatement.Append(intProveedorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEstadoId)
            Call strSQLStatement.Append(",")
