'====================================================================
' Class         : clstblOperacionEntregaValores
...
'====================================================================
Public NotInheritable Class clstblOperacionEntregaValores

    ' Class identifier
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblOperacionEntregaValores"
    ...
    ' Table name    : tblOperacionEntregaValores
    ' Parameters    : 
    '              ByVal intOperacionEntregaValoresId As Decimal
    '                  - 
    '              ByVal strOperacionEntregaValoresNombreId As String
    '                  - 
    '              ByVal strOperacionEntregaValoresNombre As String
    '                  - 
    '              ByVal dtmOperacionEntregaValoresUltimaModificacion As DateTime
    '                  - 
    '              ByVal strOperacionEntregaValoresModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strOperacionEntregaValoresNombreId As String, _
      ByVal strOperacionEntregaValoresNombre As String, _
      ByVal dtmOperacionEntregaValoresUltimaModificacion As DateTime, _
      ByVal strOperacionEntregaValoresModificadoPor As String, _
      ByVal strConnectionString As String) As integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spAgregartblOperacionEntregaValores ")
            Call strSQLStatement.Append(intOperacionEntregaValoresId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strOperacionEntregaValoresNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strOperacionEntregaValoresNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmOperacionEntregaValoresUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strOperacionEntregaValoresModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spEliminartblOperacionEntregaValores ")
            Call strSQLStatement.Append(intOperacionEntregaValoresId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strOperacionEntregaValoresNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscartblOperacionEntregaValores ")
            Call strSQLStatement.Append(intOperacionEntregaValoresId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strOperacionEntregaValoresNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblOperacionEntregaValores ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spActualizartblOperacionEntregaValores ")
            Call strSQLStatement.Append(intOperacionEntregaValoresId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strOperacionEntregaValoresNombreId)
