...
'====================================================================
Public NotInheritable Class clstblCiudad

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblCiudad"
    ...
    '                 - 
    '              ByVal strCiudadNombre As String
    '                 - 
    '              ByVal dtmCiudadUltimaModificacion As Date
    '                 - 
    '              ByVal strCiudadModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strCiudadNombre As String, _
      ByVal dtmCiudadUltimaModificacion As Date, _
      ByVal strCiudadModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblCiudad ")
            Call strSQLStatement.Append(intEstadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCiudadId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCiudadNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCiudadUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCiudadModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblCiudad ")
            Call strSQLStatement.Append(intEstadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCiudadId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblCiudad ")
            Call strSQLStatement.Append(intEstadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCiudadId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblCiudad ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblCiudad ")
            Call strSQLStatement.Append(intEstadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCiudadId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblCiudad ")
            Call strSQLStatement.Append(intEstadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCiudadId)
            Call strSQLStatement.Append(",")
