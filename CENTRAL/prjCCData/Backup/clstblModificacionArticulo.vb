...
'====================================================================
' Class         : clstblModificacionArticulo
...
'====================================================================
Public NotInheritable Class clstblModificacionArticulo

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblModificacionArticulo"
    ...
    '                 - Tabla tblModificacionArticulo
    ' Parameters : 
    '              ByVal intImpuestoId As Integer
    '                 - 
    '              ByVal intModificacionArticuloId As Integer
    '                 - 
    ...
    '                 - 
    '              ByVal fltModificacionArticuloPrecioNormalActualizado As Double
    '                 - 
    '              ByVal fltModificacionArticuloPrecioNormalAnterior As Double
    '                 - 
    '              ByVal fltModificacionArticuloPrecioOficial As Double
    '                 - 
    '              ByVal dtmModificacionArticuloRegistro As Date
    '                 - 
    '              ByVal dtmModificacionArticuloUltimaModificacion As Date
    '                 - 
    '              ByVal strModificacionArticuloModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intModificacionArticuloId As Integer, _
      ByVal intCompaniaId As Integer, _
      ByVal intSucursalId As Integer, _
      ByVal intArticuloId As Integer, _
      ByVal fltModificacionArticuloPrecioNormalActualizado As Double, _
      ByVal fltModificacionArticuloPrecioNormalAnterior As Double, _
      ByVal fltModificacionArticuloPrecioOficial As Double, _
      ByVal dtmModificacionArticuloRegistro As Date, _
      ByVal dtmModificacionArticuloUltimaModificacion As Date, _
      ByVal strModificacionArticuloModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblModificacionArticulo ")
            Call strSQLStatement.Append(intImpuestoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intModificacionArticuloId)
            Call strSQLStatement.Append(",")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltModificacionArticuloPrecioNormalActualizado)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltModificacionArticuloPrecioNormalAnterior)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltModificacionArticuloPrecioOficial)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmModificacionArticuloRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmModificacionArticuloUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strModificacionArticuloModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblModificacionArticulo ")
            Call strSQLStatement.Append(intImpuestoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intModificacionArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblModificacionArticulo ")
            Call strSQLStatement.Append(intImpuestoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intModificacionArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblModificacionArticulo ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblModificacionArticulo ")
            Call strSQLStatement.Append(intImpuestoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intModificacionArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblModificacionArticulo ")
            Call strSQLStatement.Append(intImpuestoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intModificacionArticuloId)
            Call strSQLStatement.Append(",")
