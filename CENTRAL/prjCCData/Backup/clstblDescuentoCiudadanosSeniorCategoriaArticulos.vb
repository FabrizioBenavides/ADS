...
'====================================================================
' Class         : clstblDescuentoCiudadanosSeniorCategoriaArticulos
...
'====================================================================
Public NotInheritable Class clstblDescuentoCiudadanosSeniorCategoriaArticulos

    ' Class identifier
    Private Const CLASS_NAME As String = "Benavides.CC.Data.clstblDescuentoCiudadanosSeniorCategoriaArticulos"
    ...
    ' Table name    : tblDescuentoCiudadanosSeniorCategoriaArticulos
    ' Parameters    : 
    '              ByVal intDivisionArticulosId As Integer
    '                  - 
    '              ByVal intCategoriaArticulosId As Integer
    '                  - 
    '              ByVal intDescuentoCiudadanosSeniorCategoriaArticulosId As Integer
    '                  - 
    '              ByVal fltDescuentoCiudadanosSeniorCategoriaArticulosMonto As Double
    '                  - 
    '              ByVal blnDescuentoCiudadanosSeniorCategoriaArticulosEsAdicional As Byte
    '                  - 
    '              ByVal fltDescuentoCiudadanosSeniorCategoriaArticulosMaximo As Double
    '                  - 
    '              ByVal dtmDescuentoCiudadanosSeniorCategoriaArticulosUltimaModificacion As DateTime
    '                  - 
    '              ByVal strDescuentoCiudadanosSeniorCategoriaArticulosModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar(ByVal intDivisionArticulosId As Integer, _
                                      ...
                                      ByVal intDescuentoCiudadanosSeniorCategoriaArticulosId As Integer, _
                                      ByVal fltDescuentoCiudadanosSeniorCategoriaArticulosMonto As Double, _
                                      ByVal blnDescuentoCiudadanosSeniorCategoriaArticulosEsAdicional As Byte, _
                                      ByVal fltDescuentoCiudadanosSeniorCategoriaArticulosMaximo As Double, _
                                      ByVal dtmDescuentoCiudadanosSeniorCategoriaArticulosUltimaModificacion As DateTime, _
                                      ByVal strDescuentoCiudadanosSeniorCategoriaArticulosModificadoPor As String, _
        ...
        Try
            ...
            Call sqlStatementToBeExecuted.Append("EXECUTE spAgregartblDescuentoCiudadanosSeniorCategoriaArticulos ")
            ...
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intDescuentoCiudadanosSeniorCategoriaArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(fltDescuentoCiudadanosSeniorCategoriaArticulosMonto)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(blnDescuentoCiudadanosSeniorCategoriaArticulosEsAdicional)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(fltDescuentoCiudadanosSeniorCategoriaArticulosMaximo)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(dtmDescuentoCiudadanosSeniorCategoriaArticulosUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strDescuentoCiudadanosSeniorCategoriaArticulosModificadoPor)
            Call sqlStatementToBeExecuted.Append("'")
    ...
    Public Shared Function intEliminar(ByVal intDivisionArticulosId As Integer, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spEliminartblDescuentoCiudadanosSeniorCategoriaArticulos ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCategoriaArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    Public Shared Function strBuscar(ByVal intDivisionArticulosId As Integer, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscartblDescuentoCiudadanosSeniorCategoriaArticulos ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCategoriaArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    Public Shared Function strBuscar(ByVal dtmStart As DateTime, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscarCambiotblDescuentoCiudadanosSeniorCategoriaArticulos ")
            Call sqlStatementToBeExecuted.Append("'")
    ...
    Public Shared Function intActualizar(ByVal intDivisionArticulosId As Integer, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spActualizartblDescuentoCiudadanosSeniorCategoriaArticulos ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCategoriaArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
