...
'====================================================================
' Class         : clstblMotivoDevolucionTicket
...
' Version       : 1.0
' Last Modified : Lunes, 1 de Septiembre, 2008
'====================================================================
Public Class clstblMotivoDevolucionTicket

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblMotivoDevolucionTicket"
    ...
    '                 - Tabla tblMotivoDevolucionTicket
    ' Parameters :
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblMotivoDevolucionTicket ")
