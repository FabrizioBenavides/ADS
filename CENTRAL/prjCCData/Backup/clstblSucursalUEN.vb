...
'====================================================================
' Class         : clstblSucursalUEN
' Title         : tblSucursalUEN
' Description   : 
' Copyright     : 2008 Todos los Derechos Reservados.
' Company       : Softtek
' Author        : Oswaldo Laguna.
' Version       : 1.0
' Last Modified : Miercoles, 20 de Febrero de 2008
'====================================================================
Public NotInheritable Class clstblSucursalUEN

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblSucursalUEN"
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblSucursalUEN ")
