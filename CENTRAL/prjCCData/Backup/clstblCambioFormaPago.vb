...
'====================================================================
Public NotInheritable Class clstblCambioFormaPago

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblCambioFormaPago"
    ...
    '                 - Tabla tblCambioFormaPago
    ' Parameters : 
    '              ByVal intFormaPagoId As Integer
    '                 - 
    '              ByVal intFormaPagoCambioId As Integer
    '                 - 
    '              ByVal dtmCambioFormaPagoUltimaModificacion As Date
    '                 - 
    '              ByVal strCambioFormaPagoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intFormaPagoCambioId As Integer, _
      ByVal dtmCambioFormaPagoUltimaModificacion As Date, _
      ByVal strCambioFormaPagoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblCambioFormaPago ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFormaPagoCambioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCambioFormaPagoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCambioFormaPagoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblCambioFormaPago ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFormaPagoCambioId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblCambioFormaPago ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFormaPagoCambioId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblCambioFormaPago ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblCambioFormaPago ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFormaPagoCambioId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblCambioFormaPago ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFormaPagoCambioId)
            Call strSQLStatement.Append(",")
