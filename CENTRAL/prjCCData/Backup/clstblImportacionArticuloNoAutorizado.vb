...
'====================================================================
' Class         : clstblImportacionArticuloNoAutorizado
' Title         : AdminCTX
...
'====================================================================
Public NotInheritable Class clstblImportacionArticuloNoAutorizado

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblImportacionArticuloNoAutorizado"
    ...
    '                 - Tabla tblImportacionArticuloNoAutorizado
    ' Parameters : 
    '              ByVal intImportacionArticuloNoAutorizadoArticuloId As Integer
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intImportacionArticuloNoAutorizadoArticuloId As Integer, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblImportacionArticuloNoAutorizado ")
            Call strSQLStatement.Append(intImportacionArticuloNoAutorizadoArticuloId)
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblImportacionArticuloNoAutorizado ")
            Call strSQLStatement.Append(intImportacionArticuloNoAutorizadoArticuloId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblImportacionArticuloNoAutorizado ")
            Call strSQLStatement.Append(intImportacionArticuloNoAutorizadoArticuloId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblImportacionArticuloNoAutorizado ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblImportacionArticuloNoAutorizado ")
            Call strSQLStatement.Append(intImportacionArticuloNoAutorizadoArticuloId)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblImportacionArticuloNoAutorizado ")
            Call strSQLStatement.Append(intImportacionArticuloNoAutorizadoArticuloId)
