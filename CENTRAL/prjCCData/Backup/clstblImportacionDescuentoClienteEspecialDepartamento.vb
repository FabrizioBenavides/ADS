...
'====================================================================
' Class         : clstblImportacionDescuentoClienteEspecialDepartamento
' Title         : AdminCTX
' Description   : Administración del Concentrador Central.
...
'====================================================================
Public NotInheritable Class clstblImportacionDescuentoClienteEspecialDepartamento

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblImportacionDescuentoClienteEspecialDepartamento"
    ...
    '                 - Tabla tblImportacionDescuentoClienteEspecialDepartamento
    ' Parameters : 
    '              ByVal intImportacionDescuentoClienteEspecialDepartamentoDepartamentoId As Integer
    '                 - 
    '              ByVal fltImportacionDescuentoClienteEspecialDepartamentoPorcentaje As Double
    '                 - 
    '              ByVal fltImportacionDescuentoClienteEspecialDepartamentoPorcentajeTope As Double
    '                 - 
    '              ByVal blnImportacionDescuentoClienteEspecialDepartamentoTotal As Byte
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intImportacionDescuentoClienteEspecialDepartamentoDepartamentoId As Integer, _
      ByVal fltImportacionDescuentoClienteEspecialDepartamentoPorcentaje As Double, _
      ByVal fltImportacionDescuentoClienteEspecialDepartamentoPorcentajeTope As Double, _
      ByVal blnImportacionDescuentoClienteEspecialDepartamentoTotal As Byte, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblImportacionDescuentoClienteEspecialDepartamento ")
            Call strSQLStatement.Append(intImportacionDescuentoClienteEspecialDepartamentoDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltImportacionDescuentoClienteEspecialDepartamentoPorcentaje)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltImportacionDescuentoClienteEspecialDepartamentoPorcentajeTope)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnImportacionDescuentoClienteEspecialDepartamentoTotal)
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblImportacionDescuentoClienteEspecialDepartamento ")
            Call strSQLStatement.Append(intImportacionDescuentoClienteEspecialDepartamentoDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltImportacionDescuentoClienteEspecialDepartamentoPorcentaje)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblImportacionDescuentoClienteEspecialDepartamento ")
            Call strSQLStatement.Append(intImportacionDescuentoClienteEspecialDepartamentoDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltImportacionDescuentoClienteEspecialDepartamentoPorcentaje)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblImportacionDescuentoClienteEspecialDepartamento ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblImportacionDescuentoClienteEspecialDepartamento ")
            Call strSQLStatement.Append(intImportacionDescuentoClienteEspecialDepartamentoDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltImportacionDescuentoClienteEspecialDepartamentoPorcentaje)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblImportacionDescuentoClienteEspecialDepartamento ")
            Call strSQLStatement.Append(intImportacionDescuentoClienteEspecialDepartamentoDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltImportacionDescuentoClienteEspecialDepartamentoPorcentaje)
            Call strSQLStatement.Append(",")
