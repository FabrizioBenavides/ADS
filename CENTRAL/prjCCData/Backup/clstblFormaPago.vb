...
'====================================================================
Public NotInheritable Class clstblFormaPago

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblFormaPago"
    ...
    '                 - 
    '              ByVal strFormaPagoNombreId As String
    '                 - 
    '              ByVal strFormaPagoNombre As String
    '                 - 
    '              ByVal strFormaPagoDescripcion As String
    '                 - 
    '              ByVal blnFormaPagoEsDeCredito As Byte
    '                 - 
    '              ByVal blnFormaPagoModificaImporte As Byte
    '                 - 
    '              ByVal blnFormaPagoEscribirCantidadDocumentos As Byte
    '                 - 
    '              ByVal blnFormaPagoDepositoManual As Byte
    '                 - 
    '              ByVal blnFormaPagoAplicaDeposito As Byte
    '                 - 
    '              ByVal dtmFormaPagoUltimaModificacion As Date
    '                 - 
    '              ByVal strFormaPagoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strFormaPagoNombreId As String, _
      ByVal strFormaPagoNombre As String, _
      ByVal strFormaPagoDescripcion As String, _
      ByVal blnFormaPagoEsDeCredito As Byte, _
      ByVal blnFormaPagoModificaImporte As Byte, _
      ByVal blnFormaPagoEscribirCantidadDocumentos As Byte, _
      ByVal blnFormaPagoDepositoManual As Byte, _
      ByVal blnFormaPagoAplicaDeposito As Byte, _
      ByVal dtmFormaPagoUltimaModificacion As Date, _
      ByVal strFormaPagoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblFormaPago ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strFormaPagoNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strFormaPagoNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strFormaPagoDescripcion)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnFormaPagoEsDeCredito)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnFormaPagoModificaImporte)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnFormaPagoEscribirCantidadDocumentos)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnFormaPagoDepositoManual)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnFormaPagoAplicaDeposito)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmFormaPagoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strFormaPagoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblFormaPago ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strFormaPagoNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblFormaPago ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strFormaPagoNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblFormaPago ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblFormaPago ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strFormaPagoNombreId)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblFormaPago ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strFormaPagoNombreId)
    ...
    '====================================================================
    ' Name       : strObtenerFormaPago
    ' Description: Buscar las formas de pago y sus id
    '               ByVal strConnectionString As String
    '              - Cadena de conexión hacia el RDBMS
    ' Throws     : Exception
    ' Output     : Array
    ...
    '                Array = { (), (), ..... () }
    '====================================================================
    Public Shared Function strObtenerFormaPago(ByVal strConnectionString As String) As Array

        ' Constantes locales
        Const strmThisMemberName As String = "strObtenerFormaPago"
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spObtenerFormaPago ")

            ' Ejecutamos el comando
            strObtenerFormaPago = clsSQLOperation.strExecuteQuery(strSQLStatement.ToString(), strConnectionString)
            strSQLStatement = Nothing
