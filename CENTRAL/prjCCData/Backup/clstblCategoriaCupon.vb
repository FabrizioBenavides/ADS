...
'====================================================================
Public NotInheritable Class clstblCategoriaCupon

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblCategoriaCupon"
    ...
    '                 - Tabla tblCategoriaCupon
    ' Parameters : 
    '              ByVal intCategoriaArticuloId As Double
    '                 - 
    '              ByVal intCuponId As Double
    '                 - 
    '              ByVal dtmCategoriaCuponUltimaModificacion As Date
    '                 - 
    '              ByVal strCategoriaCuponModificadoPor As String
    '                 -       
    ...
    Public Shared Function intActualizar( _
                ...
                ByVal dtmCategoriaCuponUltimaModificacion As Date, _
                ByVal strCategoriaCuponModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblCategoriaCupon ")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCuponId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCategoriaCuponUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCategoriaCuponModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblCategoriaCupon ")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCuponId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblCategoriaCupon ")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCuponId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intContar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblCategoriaCupon ")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCuponId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblCategoriaCupon ")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCuponId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblCategoriaCupon ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spReenvioCambiotblCategoriaCupon ")
