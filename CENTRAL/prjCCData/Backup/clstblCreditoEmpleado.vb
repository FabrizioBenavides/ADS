...
'====================================================================
Public NotInheritable Class clstblCreditoEmpleado

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblCreditoEmpleado"
    ...
    '                 - Tabla tblCreditoEmpleado
    ' Parameters : 
    '              ByVal intEmpleadoClienteId As Integer
    '                 - 
    ...
    '                 - 
    '              ByVal fltCreditoEmpleadoImporte As Double
    '                 - 
    '              ByVal dtmCreditoEmpleadoUltimaModificacion As Date
    '                 - 
    '              ByVal strCreditoEmpleadoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intEmpleadoClienteId As Integer, _
      ...
      ByVal fltCreditoEmpleadoImporte As Double, _
      ByVal dtmCreditoEmpleadoUltimaModificacion As Date, _
      ByVal strCreditoEmpleadoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblCreditoEmpleado ")
            Call strSQLStatement.Append(intEmpleadoClienteId)
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltCreditoEmpleadoImporte)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCreditoEmpleadoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCreditoEmpleadoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblCreditoEmpleado ")
            Call strSQLStatement.Append(intEmpleadoClienteId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblCreditoEmpleado ")
            Call strSQLStatement.Append(intEmpleadoClienteId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblCreditoEmpleado ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblCreditoEmpleado ")
            Call strSQLStatement.Append(intEmpleadoClienteId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblCreditoEmpleado ")
            Call strSQLStatement.Append(intEmpleadoClienteId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
