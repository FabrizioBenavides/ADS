...
'====================================================================
' Class         : clstblBinesNoPermitidosPagoDeServicio
...
' Author        : Softtek
' Version       : 1.0
' Last Modified : Miércoles, 18 de Junio, 2008
'====================================================================
Public NotInheritable Class clstblBinesNoPermitidosPagoDeServicio

    'Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblBinesNoPermitidosPagoDeServicio"
    ...
    '                 - Tabla tblBinesNoPermitidosPagoDeServicio
    ' Parameters :
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblBinesNoPermitidosPagoDeServicio ")
