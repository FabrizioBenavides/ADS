'====================================================================
' Class         : clstblArticuloTipoTBI
' Title         : Grupo Benavides. Administrador POS y Backoffice.
' Description   : Articulos Restringidos para pagos con Vales.
' Copyright     : 2014 Todos los Derechos Reservados.
' Company       : Softtek
' Author        : JPMB
' Version       : 1.0
' Last Modified : Diciembre 2014
'====================================================================

Imports System.Text
Imports Benavides.Data.SQL.MSSQL

Public NotInheritable Class clstblArticuloTipoTBI

    'Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblArticuloTipoTBI"
    ...
    Public Shared Function strBuscar( _
     ...
     ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblArticuloTipoTBI ")
