...
'====================================================================
Public NotInheritable Class clstblTipoCaja

    ' Class identifier
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTipoCaja"
    ...
    ' Table name    : tblTipoCaja
    ' Parameters    : 
    '              ByVal intTipoCajaId As Decimal
    '                  - 
    '              ByVal strTipoCajaNombreId As String
    '                  - 
    '              ByVal strTipoCajaNombre As String
    '                  - 
    '              ByVal strTipoCajaDescripcion As String
    '                  - 
    '              ByVal dtmTipoCajaUltimaModificacion As DateTime
    '                  - 
    '              ByVal strTipoCajaModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar( _
      ByVal intTipoCajaId As Decimal, _
      ByVal strTipoCajaNombreId As String, _
      ByVal strTipoCajaNombre As String, _
      ByVal strTipoCajaDescripcion As String, _
      ByVal dtmTipoCajaUltimaModificacion As DateTime, _
      ByVal strTipoCajaModificadoPor As String, _
      ByVal strConnectionString As String) As integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spAgregartblTipoCaja ")
            Call strSQLStatement.Append(intTipoCajaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoCajaNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoCajaNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoCajaDescripcion)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmTipoCajaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoCajaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spEliminartblTipoCaja ")
            Call strSQLStatement.Append(intTipoCajaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoCajaNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscartblTipoCaja ")
            Call strSQLStatement.Append(intTipoCajaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoCajaNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblTipoCaja ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spActualizartblTipoCaja ")
            Call strSQLStatement.Append(intTipoCajaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoCajaNombreId)
