...
'====================================================================
' Class         : clstblVentaPorDepartamento
...
'====================================================================
Public NotInheritable Class clstblVentaPorDepartamento

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblVentaPorDepartamento"
    ...
    '                 - Tabla tblVentaPorDepartamento
    ' Parameters : 
    '              ByVal intVentaPorDepartamentoId As Integer
    '                 - 
    '              ByVal intVentaPorDepartamentoCompaniaId As Integer
    '                 - 
    '              ByVal intVentaPorDepartamentoSucursalId As Integer
    '                 - 
    '              ByVal intVentaPorDepartamentoDepartamentoId As Integer
    '                 - 
    '              ByVal dtmVentaPorDepartamentoRegistro As Date
    '                 - 
    '              ByVal fltVentaPorDepartamentoImporteVenta As Double
    '                 - 
    '              ByVal dtmVentaPorDepartamentoUltimaModificacion As Date
    '                 - 
    '              ByVal strVentaPorDepartamentoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intVentaPorDepartamentoId As Integer, _
      ByVal intVentaPorDepartamentoCompaniaId As Integer, _
      ByVal intVentaPorDepartamentoSucursalId As Integer, _
      ByVal intVentaPorDepartamentoDepartamentoId As Integer, _
      ByVal dtmVentaPorDepartamentoRegistro As Date, _
      ByVal fltVentaPorDepartamentoImporteVenta As Double, _
      ByVal dtmVentaPorDepartamentoUltimaModificacion As Date, _
      ByVal strVentaPorDepartamentoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblVentaPorDepartamento ")
            Call strSQLStatement.Append(intVentaPorDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaPorDepartamentoCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaPorDepartamentoSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaPorDepartamentoDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmVentaPorDepartamentoRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltVentaPorDepartamentoImporteVenta)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmVentaPorDepartamentoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strVentaPorDepartamentoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblVentaPorDepartamento ")
            Call strSQLStatement.Append(intVentaPorDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaPorDepartamentoCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblVentaPorDepartamento ")
            Call strSQLStatement.Append(intVentaPorDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaPorDepartamentoCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblVentaPorDepartamento ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblVentaPorDepartamento ")
            Call strSQLStatement.Append(intVentaPorDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaPorDepartamentoCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblVentaPorDepartamento ")
            Call strSQLStatement.Append(intVentaPorDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaPorDepartamentoCompaniaId)
            Call strSQLStatement.Append(",")
