...
Public NotInheritable Class clstblVentaAgregada
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strVentaAgregadaSigno As String, _
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strVentaAgregadaSigno)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function strBuscarInterfaz( _
      ...
      ByVal intVentaAgregadaSucursalId As Integer, _
      ByVal intVentaAgregadaArticuloId As Integer, _
      ByVal dtmVentaAgregadaRegistroini As Date, _
      ByVal dtmVentaAgregadaRegistrofin As Date, _
      ByVal strVentaAgregadaSigno As String, _
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblVentaAgregadaInterfaz ")
            Call strSQLStatement.Append(intVentaAgregadaCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaAgregadaSucursalId)
            Call strSQLStatement.Append(",")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmVentaAgregadaRegistroini.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmVentaAgregadaRegistrofin.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strVentaAgregadaSigno)
            ...
            ' Ejecutamos el comando
            strBuscarInterfaz = clsSQLOperation.strExecuteQuery(strSQLStatement.ToString(), strConnectionString)
            strSQLStatement = Nothing
