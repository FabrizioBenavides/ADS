...
'====================================================================
' Class         : clstblArticuloEstadoRemisionElectronica
...
'====================================================================
Public NotInheritable Class clstblArticuloEstadoRemisionElectronica

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblArticuloEstadoRemisionElectronica"
    ...
    '                 - Tabla tblArticuloEstadoRemisionElectronica
    ' Parameters : 
    ...
    '                 - 
    '              ByVal intArticuloEstadoRemisionElectronicaCantidad As Integer
    '                 - 
    '              ByVal dtmArticuloEstadoRemisionElectronicaUltimaModificacion As Date
    '                 - 
    '              ByVal strArticuloEstadoRemisionElectronicaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intArticuloEstadoRemisionElectronicaCantidad As Integer, _
      ByVal dtmArticuloEstadoRemisionElectronicaUltimaModificacion As Date, _
      ByVal strArticuloEstadoRemisionElectronicaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblArticuloEstadoRemisionElectronica ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloEstadoRemisionElectronicaCantidad)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloEstadoRemisionElectronicaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloEstadoRemisionElectronicaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblArticuloEstadoRemisionElectronica ")
            Call strSQLStatement.Append(intRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoRemisionElectronicaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblArticuloEstadoRemisionElectronica ")
            Call strSQLStatement.Append(intRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoRemisionElectronicaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblArticuloEstadoRemisionElectronica ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblArticuloEstadoRemisionElectronica ")
            Call strSQLStatement.Append(intRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoRemisionElectronicaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblArticuloEstadoRemisionElectronica ")
            Call strSQLStatement.Append(intRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoRemisionElectronicaId)
            Call strSQLStatement.Append(",")
