...
'====================================================================
' Class         : clstblTicketServicioPublico
...
'====================================================================
Public NotInheritable Class clstblTicketServicioPublico

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTicketServicioPublico"
    ...
    '                 - Tabla tblTicketServicioPublico
    ' Parameters : 
    '              ByVal intServicioPublicoId As Integer
    '                 - 
    ...
    '                 - 
    '              ByVal strTicketServicioPublicoReferencia As String
    '                 - 
    '              ByVal fltTicketServicioPublicoImporte As Double
    '                 - 
    '              ByVal dtmTicketServicioPublicoUltimaModificacion As Date
    '                 - 
    '              ByVal strTicketServicioPublicoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intServicioPublicoId As Integer, _
      ...
      ByVal strTicketServicioPublicoReferencia As String, _
      ByVal fltTicketServicioPublicoImporte As Double, _
      ByVal dtmTicketServicioPublicoUltimaModificacion As Date, _
      ByVal strTicketServicioPublicoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblTicketServicioPublico ")
            Call strSQLStatement.Append(intServicioPublicoId)
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTicketServicioPublicoReferencia)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltTicketServicioPublicoImporte)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmTicketServicioPublicoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTicketServicioPublicoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblTicketServicioPublico ")
            Call strSQLStatement.Append(intServicioPublicoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblTicketServicioPublico ")
            Call strSQLStatement.Append(intServicioPublicoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblTicketServicioPublico ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblTicketServicioPublico ")
            Call strSQLStatement.Append(intServicioPublicoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblTicketServicioPublico ")
            Call strSQLStatement.Append(intServicioPublicoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
