...
'====================================================================
' Class         : clstblArticuloInventarioNegado
...
'====================================================================
Public NotInheritable Class clstblArticuloInventarioNegado

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblArticuloInventarioNegado"
    ...
    '                 - Tabla tblArticuloInventarioNegado
    ' Parameters : 
    '              ByVal intInventarioNegadoFolioId As Integer
    '                 - 
    ...
    '                 - 
    '              ByVal intArticuloInventarioNegadoCantidad As Integer
    '                 - 
    '              ByVal dtmArticuloInventarioNegadoUltimaModificacion As Date
    '                 - 
    '              ByVal strArticuloInventarioNegadoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intInventarioNegadoFolioId As Integer, _
      ByVal intCompaniaId As Integer, _
      ByVal intSucursalId As Integer, _
      ByVal intArticuloId As Integer, _
      ByVal intArticuloInventarioNegadoCantidad As Integer, _
      ByVal dtmArticuloInventarioNegadoUltimaModificacion As Date, _
      ByVal strArticuloInventarioNegadoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblArticuloInventarioNegado ")
            Call strSQLStatement.Append(intInventarioNegadoFolioId)
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloInventarioNegadoCantidad)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloInventarioNegadoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloInventarioNegadoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblArticuloInventarioNegado ")
            Call strSQLStatement.Append(intInventarioNegadoFolioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblArticuloInventarioNegado ")
            Call strSQLStatement.Append(intInventarioNegadoFolioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblArticuloInventarioNegado ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblArticuloInventarioNegado ")
            Call strSQLStatement.Append(intInventarioNegadoFolioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblArticuloInventarioNegado ")
            Call strSQLStatement.Append(intInventarioNegadoFolioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
