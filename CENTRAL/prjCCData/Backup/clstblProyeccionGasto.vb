...
'====================================================================
Public NotInheritable Class clstblProyeccionGasto

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblProyeccionGasto"
    ...
    '                 - Tabla tblProyeccionGasto
    ' Parameters : 
    '              ByVal intProyeccionGastoCompaniaId As Integer
    '                 - 
    '              ByVal intProyeccionGastoSucursalId As Integer
    '                 - 
    '              ByVal intProyeccionGastoId As Integer
    '                 - 
    '              ByVal dtmProyeccionGastoRegistro As Date
    '                 - 
    '              ByVal fltProyeccionGastoImporteCompra As Double
    '                 - 
    '              ByVal dtmProyeccionGastoUltimaModificacion As Date
    '                 - 
    '              ByVal strProyeccionGastoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intProyeccionGastoCompaniaId As Integer, _
      ByVal intProyeccionGastoSucursalId As Integer, _
      ByVal intProyeccionGastoId As Integer, _
      ByVal dtmProyeccionGastoRegistro As Date, _
      ByVal fltProyeccionGastoImporteCompra As Double, _
      ByVal dtmProyeccionGastoUltimaModificacion As Date, _
      ByVal strProyeccionGastoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblProyeccionGasto ")
            Call strSQLStatement.Append(intProyeccionGastoCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intProyeccionGastoSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intProyeccionGastoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmProyeccionGastoRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltProyeccionGastoImporteCompra)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmProyeccionGastoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strProyeccionGastoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblProyeccionGasto ")
            Call strSQLStatement.Append(intProyeccionGastoCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intProyeccionGastoSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblProyeccionGasto ")
            Call strSQLStatement.Append(intProyeccionGastoCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intProyeccionGastoSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblProyeccionGasto ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblProyeccionGasto ")
            Call strSQLStatement.Append(intProyeccionGastoCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intProyeccionGastoSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblProyeccionGasto ")
            Call strSQLStatement.Append(intProyeccionGastoCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intProyeccionGastoSucursalId)
            Call strSQLStatement.Append(",")
