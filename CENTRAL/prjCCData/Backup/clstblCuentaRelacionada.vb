...
'====================================================================
Public NotInheritable Class clstblCuentaRelacionada

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblCuentaRelacionada"
    ...
    '                 - Tabla tblCuentaRelacionada
    ' Parameters : 
    '              ByVal intCuentaId As Integer
    '                 - 
    '              ByVal intCuentaPadreId As Integer
    '                 - 
    '              ByVal dtmCuentaRelacionadaUltimaModificacion As Date
    '                 - 
    '              ByVal strCuentaRelacionadaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intCuentaPadreId As Integer, _
      ByVal dtmCuentaRelacionadaUltimaModificacion As Date, _
      ByVal strCuentaRelacionadaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblCuentaRelacionada ")
            Call strSQLStatement.Append(intCuentaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCuentaPadreId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCuentaRelacionadaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCuentaRelacionadaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblCuentaRelacionada ")
            Call strSQLStatement.Append(intCuentaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCuentaPadreId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblCuentaRelacionada ")
            Call strSQLStatement.Append(intCuentaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCuentaPadreId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblCuentaRelacionada ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblCuentaRelacionada ")
            Call strSQLStatement.Append(intCuentaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCuentaPadreId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblCuentaRelacionada ")
            Call strSQLStatement.Append(intCuentaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCuentaPadreId)
            Call strSQLStatement.Append(",")
