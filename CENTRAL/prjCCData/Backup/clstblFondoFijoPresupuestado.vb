...
'====================================================================
' Class         : clstblFondoFijoPresupuestado
...
'====================================================================
Public NotInheritable Class clstblFondoFijoPresupuestado

    ' Class identifier
    Private Const CLASS_NAME As String = "Benavides.CC.Data.clstblFondoFijoPresupuestado"
    ...
    ' Table name    : tblFondoFijoPresupuestado
    ' Parameters    : 
    '              ByVal intFondoFijoPresupuestadoId As Decimal
    '                  - 
    '              ByVal intCompaniaId As Int32
    '                  - 
    '              ByVal intSucursalId As Int32
    '                  - 
    '              ByVal fltFondoFijoPresupuestadoImporteAsignado As Double
    '                  - 
    '              ByVal fltFondoFijoPresupuestadoImporteAdicional As Double
    '                  - 
    '              ByVal blnFondoFijoPresupuestadoSePuedeEditar As Byte
    '                  - 
    '              ByVal dtmFondoFijoPresupuestadoCreacion As DateTime
    '                  - 
    '              ByVal dtmFondoFijoPresupuestadoUltimaModificacion As DateTime
    '                  - 
    '              ByVal strFondoFijoPresupuestadoModificadoPor As String
    '                  - 
    ...
    ' Output        : Integer
    '====================================================================
    Public Shared Function intAgregar(ByVal intFondoFijoPresupuestadoId As Decimal, _
                                      ByVal intCompaniaId As Int32, _
                                      ByVal intSucursalId As Int32, _
                                      ByVal fltFondoFijoPresupuestadoImporteAsignado As Double, _
                                      ByVal fltFondoFijoPresupuestadoImporteAdicional As Double, _
                                      ByVal fltFondoFijoPresupuestadoImporteDiarioMaximo As Double, _
                                      ByVal blnFondoFijoPresupuestadoSePuedeEditar As Byte, _
                                      ByVal dtmFondoFijoPresupuestadoAsignacion As DateTime, _
                                      ByVal dtmFondoFijoPresupuestadoCreacion As DateTime, _
                                      ByVal dtmFondoFijoPresupuestadoUltimaModificacion As DateTime, _
                                      ByVal strFondoFijoPresupuestadoModificadoPor As String, _
        ...
        Try
            ...
            Call sqlStatementToBeExecuted.Append("EXECUTE spAgregartblFondoFijoPresupuestado ")
            Call sqlStatementToBeExecuted.Append(intFondoFijoPresupuestadoId)
            ...
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(fltFondoFijoPresupuestadoImporteAsignado)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(fltFondoFijoPresupuestadoImporteAdicional)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(fltFondoFijoPresupuestadoImporteDiarioMaximo)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(blnFondoFijoPresupuestadoSePuedeEditar)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(dtmFondoFijoPresupuestadoAsignacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(dtmFondoFijoPresupuestadoCreacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(dtmFondoFijoPresupuestadoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strFondoFijoPresupuestadoModificadoPor)
            Call sqlStatementToBeExecuted.Append("'")
    ...
    ' Output        : Integer
    '====================================================================
    Public Shared Function intEliminar(ByVal intFondoFijoPresupuestadoId As Decimal, _
                                       ByVal intCompaniaId As Int32, _
                                       ByVal intSucursalId As Int32, _
                                       ByVal fltFondoFijoPresupuestadoImporteAsignado As Double, _
                                       ByVal fltFondoFijoPresupuestadoImporteAdicional As Double, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spEliminartblFondoFijoPresupuestado ")
            Call sqlStatementToBeExecuted.Append(intFondoFijoPresupuestadoId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCompaniaId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    ' Output        : Array
    '====================================================================
    Public Shared Function strBuscar(ByVal intFondoFijoPresupuestadoId As Decimal, _
                                     ByVal intCompaniaId As Int32, _
                                     ByVal intSucursalId As Int32, _
                                     ByVal fltFondoFijoPresupuestadoImporteAsignado As Double, _
                                     ByVal fltFondoFijoPresupuestadoImporteAdicional As Double, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscartblFondoFijoPresupuestado ")
            Call sqlStatementToBeExecuted.Append(intFondoFijoPresupuestadoId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCompaniaId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    ' Output        : Array
    '====================================================================
    Public Shared Function strBuscar(ByVal intTiendaId As Integer, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscarCambiotblFondoFijoPresupuestado ")
    ...
    ' Output        : Integer
    '====================================================================
    Public Shared Function intActualizar(ByVal intFondoFijoPresupuestadoId As Decimal, _
                                         ByVal intCompaniaId As Int32, _
                                         ByVal intSucursalId As Int32, _
                                         ByVal fltFondoFijoPresupuestadoImporteAsignado As Double, _
                                         ByVal fltFondoFijoPresupuestadoImporteAdicional As Double, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spActualizartblFondoFijoPresupuestado ")
            Call sqlStatementToBeExecuted.Append(intFondoFijoPresupuestadoId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCompaniaId)
            Call sqlStatementToBeExecuted.Append(",")
