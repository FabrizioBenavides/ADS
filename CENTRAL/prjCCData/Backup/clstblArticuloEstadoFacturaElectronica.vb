...
'====================================================================
' Class         : clstblArticuloEstadoFacturaElectronica
...
'====================================================================
Public NotInheritable Class clstblArticuloEstadoFacturaElectronica

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblArticuloEstadoFacturaElectronica"
    ...
    '                 - Tabla tblArticuloEstadoFacturaElectronica
    ' Parameters : 
    ...
    '                 - 
    '              ByVal intArticuloEstadoFacturaElectronicaCantidad As Integer
    '                 - 
    '              ByVal dtmArticuloEstadoFacturaElectronicaUltimaModificacion As Date
    '                 - 
    '              ByVal strArticuloEstadoFacturaElectronicaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intArticuloEstadoFacturaElectronicaCantidad As Integer, _
      ByVal dtmArticuloEstadoFacturaElectronicaUltimaModificacion As Date, _
      ByVal strArticuloEstadoFacturaElectronicaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblArticuloEstadoFacturaElectronica ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloEstadoFacturaElectronicaCantidad)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloEstadoFacturaElectronicaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloEstadoFacturaElectronicaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblArticuloEstadoFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblArticuloEstadoFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblArticuloEstadoFacturaElectronica ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblArticuloEstadoFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblArticuloEstadoFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
