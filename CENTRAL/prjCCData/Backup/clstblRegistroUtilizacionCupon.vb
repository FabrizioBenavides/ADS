...
'====================================================================
' Class         : clstblRegistroUtilizacionCupon
...
'====================================================================
Public NotInheritable Class clstblRegistroUtilizacionCupon

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblRegistroUtilizacionCupon"
    ...
    '                 - Tabla tblRegistroUtilizacionCupon
    ' Parameters : 
    '              ByVal intRegistroUtilizacionCuponId As Double
    '                 - 
    '              ByVal intRegistroUtilizacionCuponRecolectadoId As Double
    '                 - 
    '              ByVal intRegistroUtilizacionCuponFolio As Double
    '                 - 
    '              ByVal dtmRegistroUtilizacionCuponUltimaModificacion As Date
    '                 - 
    '              ByVal strRegistroUtilizacionCuponModificadoPor As String
    '                 -       
    ...
    Public Shared Function intActualizar( _
                ByVal intRegistroUtilizacionCuponId As Double, _
                ByVal intRegistroUtilizacionCuponRecolectadoId As Double, _
                ByVal intRegistroUtilizacionCuponFolio As Double, _
                ByVal dtmRegistroUtilizacionCuponUltimaModificacion As Date, _
                ByVal strRegistroUtilizacionCuponModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblRegistroUtilizacionCupon ")
            Call strSQLStatement.Append(intRegistroUtilizacionCuponId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intRegistroUtilizacionCuponRecolectadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intRegistroUtilizacionCuponFolio)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmRegistroUtilizacionCuponUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strRegistroUtilizacionCuponModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblRegistroUtilizacionCupon ")
            Call strSQLStatement.Append(intRegistroUtilizacionCuponId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intRegistroUtilizacionCuponRecolectadoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblRegistroUtilizacionCupon ")
            Call strSQLStatement.Append(intRegistroUtilizacionCuponId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intRegistroUtilizacionCuponRecolectadoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intContar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblRegistroUtilizacionCupon ")
            Call strSQLStatement.Append(intRegistroUtilizacionCuponId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intRegistroUtilizacionCuponRecolectadoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblRegistroUtilizacionCupon ")
            Call strSQLStatement.Append(intRegistroUtilizacionCuponId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intRegistroUtilizacionCuponRecolectadoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblRegistroUtilizacionCupon ")
            Call strSQLStatement.Append("'")
