...
'====================================================================
Public NotInheritable Class clstblPolizaPendiente

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblPolizaPendiente"
    ...
    '                 - Tabla tblPolizaPendiente
    ' Parameters : 
    '              ByVal intPolizaPendienteCompaniaId As Integer
    '                 - 
    '              ByVal intPolizaPendienteSucursalId As Integer
    '                 - 
    '              ByVal dtmPolizaPendienteFechaCreacion As Date
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intPolizaPendienteCompaniaId As Integer, _
      ByVal intPolizaPendienteSucursalId As Integer, _
      ByVal dtmPolizaPendienteFechaCreacion As Date, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblPolizaPendiente ")
            Call strSQLStatement.Append(intPolizaPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPolizaPendienteSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmPolizaPendienteFechaCreacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblPolizaPendiente ")
            Call strSQLStatement.Append(intPolizaPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPolizaPendienteSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblPolizaPendiente ")
            Call strSQLStatement.Append(intPolizaPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPolizaPendienteSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblPolizaPendiente ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblPolizaPendiente ")
            Call strSQLStatement.Append(intPolizaPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPolizaPendienteSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblPolizaPendiente ")
            Call strSQLStatement.Append(intPolizaPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPolizaPendienteSucursalId)
            Call strSQLStatement.Append(",")
