...
'====================================================================
' Class         : clstblTransferenciaInterna
...
'====================================================================
Public NotInheritable Class clstblTransferenciaInterna

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTransferenciaInterna"
    ...
    '                 - Tabla tblTransferenciaInterna
    ' Parameters : 
    '              ByVal intTransferenciaInternaId As Integer
    '                 - 
    '              ByVal intDepartamentoOrigenId As Integer
    '                 - 
    '              ByVal intCompaniaId As Integer
    '                 - 
    '              ByVal intSucursalId As Integer
    '                 - 
    '              ByVal intDepartamentoDestinoId As Integer
    '                 - 
    '              ByVal intCuentaGastoId As Integer
    '                 - 
    '              ByVal intTransferenciaInternaFolio As Integer
    '                 - 
    '              ByVal blnTransferenciaInternaEsConsumo As Byte
    '                 - 
    '              ByVal dtmTransferenciaInternaFechaRegistro As Date
    '                 - 
    '              ByVal dtmTransferenciaInternaUltimaModificacion As Date
    '                 - 
    '              ByVal strTransferenciaInternaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intTransferenciaInternaId As Integer, _
      ByVal intDepartamentoOrigenId As Integer, _
      ByVal intCompaniaId As Integer, _
      ByVal intSucursalId As Integer, _
      ByVal intDepartamentoDestinoId As Integer, _
      ByVal intCuentaGastoId As Integer, _
      ByVal intTransferenciaInternaFolio As Integer, _
      ByVal blnTransferenciaInternaEsConsumo As Byte, _
      ByVal dtmTransferenciaInternaFechaRegistro As Date, _
      ByVal dtmTransferenciaInternaUltimaModificacion As Date, _
      ByVal strTransferenciaInternaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblTransferenciaInterna ")
            Call strSQLStatement.Append(intTransferenciaInternaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDepartamentoOrigenId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDepartamentoDestinoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCuentaGastoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTransferenciaInternaFolio)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnTransferenciaInternaEsConsumo)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmTransferenciaInternaFechaRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmTransferenciaInternaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTransferenciaInternaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblTransferenciaInterna ")
            Call strSQLStatement.Append(intTransferenciaInternaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDepartamentoOrigenId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblTransferenciaInterna ")
            Call strSQLStatement.Append(intTransferenciaInternaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDepartamentoOrigenId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblTransferenciaInterna ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblTransferenciaInterna ")
            Call strSQLStatement.Append(intTransferenciaInternaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDepartamentoOrigenId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblTransferenciaInterna ")
            Call strSQLStatement.Append(intTransferenciaInternaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDepartamentoOrigenId)
            Call strSQLStatement.Append(",")
