...
'====================================================================
Public NotInheritable Class clstblPlano

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblPlano"
    ...
    '                 - 
    '              ByVal strPlanoNombre As String
    '                 - 
    '              ByVal dtmPlanoRegistro As Date
    '                 - 
    '              ByVal intPlanoMuebleId As Integer
    '                 - 
    '              ByVal blnPlanoEsOrdenadoAlfabeticamente
    '                 - 
    '              ByVal dtmPlanoUltimaModificacion As Date
    '                 - 
    '              ByVal strPlanoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strPlanoNombre As String, _
      ByVal dtmPlanoRegistro As Date, _
      ByVal intPlanoMuebleId As Integer, _
      ByVal blnPlanoEsOrdenadoAlfabeticamente As Byte, _
      ByVal dtmPlanoUltimaModificacion As Date, _
      ByVal strPlanoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblPlano ")
            Call strSQLStatement.Append(intPlanoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPlanoNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmPlanoRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPlanoMuebleId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnPlanoEsOrdenadoAlfabeticamente)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmPlanoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPlanoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblPlano ")
            Call strSQLStatement.Append(intPlanoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblPlano ")
            Call strSQLStatement.Append(intPlanoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblPlano ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function strBuscarCambios( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL         
            Call strSQLStatement.Append("EXECUTE spBuscartblPlanoCambios ")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblPlano ")
            Call strSQLStatement.Append(intPlanoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblPlano ")
            Call strSQLStatement.Append(intPlanoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
