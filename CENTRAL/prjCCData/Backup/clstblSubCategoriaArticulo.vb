...
'====================================================================
' Class         : clstblSubCategoriaArticulo
...
'====================================================================
Public NotInheritable Class clstblSubCategoriaArticulo

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblSubCategoriaArticulo"
    ...
    '                 - 
    '              ByVal dtmSubCategoriaArticuloUltimaModificacion As Date
    '                 - 
    '              ByVal strSubCategoriaArticuloModificadoPor As String
    '                 -       
    ...
    Public Shared Function intActualizar( _
                ...
                ByVal dtmSubCategoriaArticuloUltimaModificacion As Date, _
                ByVal strSubCategoriaArticuloModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblSubCategoriaArticulo ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmSubCategoriaArticuloUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strSubCategoriaArticuloModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblSubCategoriaArticulo ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblSubCategoriaArticulo ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intContar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblSubCategoriaArticulo ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblSubCategoriaArticulo ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblSubCategoriaArticulo ")
            Call strSQLStatement.Append("'")
