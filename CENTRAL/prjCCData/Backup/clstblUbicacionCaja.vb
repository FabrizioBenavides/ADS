...
'====================================================================
Public NotInheritable Class clstblUbicacionCaja

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblUbicacionCaja"
    ...
    '                 - Tabla tblUbicacionCaja
    ' Parameters : 
    '              ByVal intUbicacionCajaId As Integer
    '                 - 
    '              ByVal strUbicacionCajaNombreId As String
    '                 - 
    '              ByVal strUbicacionCajaNombre As String
    '                 - 
    '              ByVal dtmUbicacionCajaUltimaModificacion As Date
    '                 - 
    '              ByVal strUbicacionCajaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strUbicacionCajaNombreId As String, _
      ByVal strUbicacionCajaNombre As String, _
      ByVal dtmUbicacionCajaUltimaModificacion As Date, _
      ByVal strUbicacionCajaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblUbicacionCaja ")
            Call strSQLStatement.Append(intUbicacionCajaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strUbicacionCajaNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strUbicacionCajaNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmUbicacionCajaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strUbicacionCajaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblUbicacionCaja ")
            Call strSQLStatement.Append(intUbicacionCajaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strUbicacionCajaNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblUbicacionCaja ")
            Call strSQLStatement.Append(intUbicacionCajaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strUbicacionCajaNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblUbicacionCaja ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblUbicacionCaja ")
            Call strSQLStatement.Append(intUbicacionCajaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strUbicacionCajaNombreId)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblUbicacionCaja ")
            Call strSQLStatement.Append(intUbicacionCajaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strUbicacionCajaNombreId)
