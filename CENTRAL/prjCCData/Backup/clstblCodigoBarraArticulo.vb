...
'====================================================================
' Class         : clstblCodigoBarraArticulo
...
'====================================================================
Public NotInheritable Class clstblCodigoBarraArticulo

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblCodigoBarraArticulo"
    ...
    '                 - Tabla tblCodigoBarraArticulo
    ' Parameters : 
    '              ByVal intCodigoBarraArticuloId As Integer
    '                 - 
    '              ByVal intArticuloId As Integer
    '                 - 
    '              ByVal strCodigoBarraArticuloValor As String
    '                 - 
    '              ByVal dtmCodigoBarraArticuloUltimaModificacion As Date
    '                 - 
    '              ByVal strCodigoBarraArticuloModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intCodigoBarraArticuloId As Integer, _
      ByVal intArticuloId As Integer, _
      ByVal strCodigoBarraArticuloValor As String, _
      ByVal dtmCodigoBarraArticuloUltimaModificacion As Date, _
      ByVal strCodigoBarraArticuloModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblCodigoBarraArticulo ")
            Call strSQLStatement.Append(intCodigoBarraArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCodigoBarraArticuloValor)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCodigoBarraArticuloUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCodigoBarraArticuloModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblCodigoBarraArticulo ")
            Call strSQLStatement.Append(intCodigoBarraArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblCodigoBarraArticulo ")
            Call strSQLStatement.Append(intCodigoBarraArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblCodigoBarraArticulo ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblCodigoBarraArticulo ")
            Call strSQLStatement.Append(intCodigoBarraArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblCodigoBarraArticulo ")
            Call strSQLStatement.Append(intCodigoBarraArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
