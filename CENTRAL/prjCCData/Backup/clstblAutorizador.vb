...
Public Class clstblAutorizador

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblAutorizador"
    ...
    '                 - Tabla tblAutorizador
    ' Parameters : 
    '              ByVal @intAutorizadorId As Integer
    '                 - 
    '              ByVal @strAutorizadorDescripcion As String
    '                 - 
    '              ByVal @dtmAutorizadorUltimaModificacion As Date
    '                 - 
    '              ByVal @strAutorizadorModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intAutorizadorId As Integer, _
      ByVal strAutorizadorDescripcion As String, _
      ByVal dtmAutorizadorUltimaModificacion As Date, _
      ByVal strAutorizadorModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblAutorizador ")
            Call strSQLStatement.Append(intAutorizadorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strAutorizadorDescripcion)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmAutorizadorUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strAutorizadorModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblAutorizador ")
            Call strSQLStatement.Append(intAutorizadorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strAutorizadorDescripcion)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblAutorizador ")
            Call strSQLStatement.Append(intAutorizadorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strAutorizadorDescripcion)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblAutorizador ")
            Call strSQLStatement.Append("'")
    ...
    '====================================================================
    ' Name       : strBuscarAutorizadores
    ' Description: Busca los autorizadores en la BD
    '                 - Tabla tblAutorizador
    ' Parameters :
    '              ByVal strConnectionString As String
    '                 - Cadena de conexión hacia el RDBMS
    ...
    '                   c = Campo
    '====================================================================
    Public Shared Function strBuscarAutorizadores(ByVal strConnectionString As String) As Array

        ' Constantes locales
        Const strmThisMemberName As String = "strBuscarAutorizadores"
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spObtenerAutorizadores ")

            ' Ejecutamos el comando
            strBuscarAutorizadores = clsSQLOperation.strExecuteQuery(strSQLStatement.ToString(), strConnectionString)
            strSQLStatement = Nothing
        ...
        Catch objException As Exception
            ...
            ' Regresamos la información
            strBuscarAutorizadores = Nothing
