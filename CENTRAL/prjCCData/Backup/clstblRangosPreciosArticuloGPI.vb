...
'====================================================================
' Class         : clstblRangosPreciosArticuloGPI
...
' Version       : 1.0
' Last Modified : Martes, 25 de Noviembre, 2008
'====================================================================
Public Class clstblRangosPreciosArticuloGPI

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblRangosPreciosArticuloGPI"
    ...
    '                 - Tabla tblRangosPreciosArticuloGPI
    ' Parameters :
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblRangosPreciosArticuloGPI ")
