...
'====================================================================
Public NotInheritable Class clstblMotivoReclamacion

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblMotivoReclamacion"
    ...
    '                 - Tabla tblMotivoReclamacion
    ' Parameters : 
    '              ByVal intMotivoReclamacionId As Integer
    '                 - 
    '              ByVal strMotivoReclamacionNombre As String
    '                 - 
    '              ByVal strMotivoReclamacionNombreId As String
    '                 - 
    '              ByVal dtmMotivoReclamacionUltimaModificacion As Date
    '                 - 
    '              ByVal strMotivoReclamacionModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intMotivoReclamacionId As Integer, _
      ByVal strMotivoReclamacionNombre As String, _
      ByVal strMotivoReclamacionNombreId As String, _
      ByVal dtmMotivoReclamacionUltimaModificacion As Date, _
      ByVal strMotivoReclamacionModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblMotivoReclamacion ")
            Call strSQLStatement.Append(intMotivoReclamacionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoReclamacionNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoReclamacionNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmMotivoReclamacionUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoReclamacionModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblMotivoReclamacion ")
            Call strSQLStatement.Append(intMotivoReclamacionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoReclamacionNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblMotivoReclamacion ")
            Call strSQLStatement.Append(intMotivoReclamacionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoReclamacionNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblMotivoReclamacion ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblMotivoReclamacion ")
            Call strSQLStatement.Append(intMotivoReclamacionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoReclamacionNombre)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblMotivoReclamacion ")
            Call strSQLStatement.Append(intMotivoReclamacionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoReclamacionNombre)
