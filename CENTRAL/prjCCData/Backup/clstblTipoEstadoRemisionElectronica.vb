...
'====================================================================
' Class         : clstblTipoEstadoRemisionElectronica
...
'====================================================================
Public NotInheritable Class clstblTipoEstadoRemisionElectronica

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTipoEstadoRemisionElectronica"
    ...
    '                 - Tabla tblTipoEstadoRemisionElectronica
    ' Parameters : 
    '              ByVal intTipoEstadoRemisionElectronicaId As Integer
    '                 - 
    '              ByVal strTipoEstadoRemisionElectronicaNombre As String
    '                 - 
    '              ByVal strTipoEstadoRemisionElectronicaNombreId As String
    '                 - 
    '              ByVal dtmTipoEstadoRemisionElectronicaUltimaModificacion As Date
    '                 - 
    '              ByVal strTipoEstadoRemisionElectronicaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strTipoEstadoRemisionElectronicaNombre As String, _
      ByVal strTipoEstadoRemisionElectronicaNombreId As String, _
      ByVal dtmTipoEstadoRemisionElectronicaUltimaModificacion As Date, _
      ByVal strTipoEstadoRemisionElectronicaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblTipoEstadoRemisionElectronica ")
            Call strSQLStatement.Append(intTipoEstadoRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoRemisionElectronicaNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoRemisionElectronicaNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmTipoEstadoRemisionElectronicaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoRemisionElectronicaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblTipoEstadoRemisionElectronica ")
            Call strSQLStatement.Append(intTipoEstadoRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoRemisionElectronicaNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblTipoEstadoRemisionElectronica ")
            Call strSQLStatement.Append(intTipoEstadoRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoRemisionElectronicaNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblTipoEstadoRemisionElectronica ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblTipoEstadoRemisionElectronica ")
            Call strSQLStatement.Append(intTipoEstadoRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoRemisionElectronicaNombre)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblTipoEstadoRemisionElectronica ")
            Call strSQLStatement.Append(intTipoEstadoRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoEstadoRemisionElectronicaNombre)
