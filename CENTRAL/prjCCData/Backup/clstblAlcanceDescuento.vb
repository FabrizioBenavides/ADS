...
'====================================================================
Public NotInheritable Class clstblAlcanceDescuento

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblAlcanceDescuento"
    ...
    '                 - Tabla tblAlcanceDescuento
    ' Parameters : 
    '              ByVal intAlcanceDescuentoId As Double
    '                 - 
    '              ByVal strAlcanceDescuentoDescripcion As String
    '                 - 
    '              ByVal dtmAlcanceDescuentoUltimaModificacion As Date
    '                 - 
    '              ByVal strAlcanceDescuentoModificadoPor As String
    '                 -       
    ...
    Public Shared Function intActualizar( _
                ...
                ByVal strAlcanceDescuentoDescripcion As String, _
                ByVal dtmAlcanceDescuentoUltimaModificacion As Date, _
                ByVal strAlcanceDescuentoModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblAlcanceDescuento ")
            Call strSQLStatement.Append(intAlcanceDescuentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strAlcanceDescuentoDescripcion)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmAlcanceDescuentoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strAlcanceDescuentoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblAlcanceDescuento ")
            Call strSQLStatement.Append(intAlcanceDescuentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strAlcanceDescuentoDescripcion)
    ...
    Public Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblAlcanceDescuento ")
            Call strSQLStatement.Append(intAlcanceDescuentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strAlcanceDescuentoDescripcion)
    ...
    Public Shared Function intContar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblAlcanceDescuento ")
            Call strSQLStatement.Append(intAlcanceDescuentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strAlcanceDescuentoDescripcion)
    ...
    Public Shared Function intEliminar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblAlcanceDescuento ")
            Call strSQLStatement.Append(intAlcanceDescuentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strAlcanceDescuentoDescripcion)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblAlcanceDescuento ")
            Call strSQLStatement.Append("'")
