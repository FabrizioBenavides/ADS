...
'====================================================================
Public NotInheritable Class clstblTicketPendiente

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTicketPendiente"
    ...
    '                 - Tabla tblTicketPendiente
    ' Parameters : 
    '              ByVal intTicketPendienteCompaniaId As Integer
    '                 - 
    '              ByVal intTicketPendienteSucursalId As Integer
    '                 - 
    '              ByVal intTicketPendienteAsignacionCajaId As Integer
    '                 - 
    '              ByVal intTicketPendienteCajaId As Integer
    '                 - 
    '              ByVal intTicketPendienteTurnoLaboralId As Integer
    '                 - 
    '              ByVal intTicketPendienteTicketId As Integer
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intTicketPendienteCompaniaId As Integer, _
      ByVal intTicketPendienteSucursalId As Integer, _
      ByVal intTicketPendienteAsignacionCajaId As Integer, _
      ByVal intTicketPendienteCajaId As Integer, _
      ByVal intTicketPendienteTurnoLaboralId As Integer, _
      ByVal intTicketPendienteTicketId As Integer, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblTicketPendiente ")
            Call strSQLStatement.Append(intTicketPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTicketPendienteSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTicketPendienteAsignacionCajaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTicketPendienteCajaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTicketPendienteTurnoLaboralId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTicketPendienteTicketId)
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblTicketPendiente ")
            Call strSQLStatement.Append(intTicketPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTicketPendienteSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblTicketPendiente ")
            Call strSQLStatement.Append(intTicketPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTicketPendienteSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblTicketPendiente ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblTicketPendiente ")
            Call strSQLStatement.Append(intTicketPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTicketPendienteSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblTicketPendiente ")
            Call strSQLStatement.Append(intTicketPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTicketPendienteSucursalId)
            Call strSQLStatement.Append(",")
