'====================================================================
' Class         : clstblCategoriaComisionDiferenciada
...
'====================================================================
Public NotInheritable Class clstblCategoriaComisionDiferenciada

    ' Class identifier
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblCategoriaComisionDiferenciada"
    ...
    ' Table name    : tblCategoriaComisionDiferenciada
    ' Parameters    : 
    '              ByVal intCategoriaComisionDiferenciadaId As Int32
    '                  - 
    '              ByVal strCategoriaComisionDiferenciadaNombre As String
    '                  - 
    '              ByVal strCategoriaComisionDiferenciadaModificadoPor As String
    '                  - 
    '              ByVal dtmCategoriaComisionDiferenciadaUltimaModificacion As DateTime
    '                  - 
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strCategoriaComisionDiferenciadaNombre As String, _
      ByVal strCategoriaComisionDiferenciadaModificadoPor As String, _
      ByVal dtmCategoriaComisionDiferenciadaUltimaModificacion As DateTime, _
      ByVal strConnectionString As String) As integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spAgregartblCategoriaComisionDiferenciada ")
            Call strSQLStatement.Append(intCategoriaComisionDiferenciadaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCategoriaComisionDiferenciadaNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCategoriaComisionDiferenciadaModificadoPor)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCategoriaComisionDiferenciadaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intEliminar( _ 
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spEliminartblCategoriaComisionDiferenciada ")
            Call strSQLStatement.Append(intCategoriaComisionDiferenciadaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCategoriaComisionDiferenciadaNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscartblCategoriaComisionDiferenciada ")
            Call strSQLStatement.Append(intCategoriaComisionDiferenciadaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCategoriaComisionDiferenciadaNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblCategoriaComisionDiferenciada ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intActualizar( _ 
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spActualizartblCategoriaComisionDiferenciada ")
            Call strSQLStatement.Append(intCategoriaComisionDiferenciadaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCategoriaComisionDiferenciadaNombre)
