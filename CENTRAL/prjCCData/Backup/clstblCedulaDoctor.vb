...
'====================================================================
Public NotInheritable Class clstblCedulaDoctor

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblCedulaDoctor"
    ...
    '                 - Tabla tblCedulaDoctor
    ' Parameters : 
    '              ByVal intCedulaDoctorId As Integer
    '                 - 
    '              ByVal intCompaniaId As Integer
    '                 - 
    '              ByVal intCedulaDoctorCedula As Integer
    '                 - 
    '              ByVal strCedulaDoctorTelefono As String
    '                 - 
    '              ByVal strCedulaDoctorNombre As String
    '                 - 
    '              ByVal dtmCedulaDoctorUltimaModificacion As Date
    '                 - 
    '              ByVal strCedulaDoctorModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intCedulaDoctorId As Integer, _
      ByVal intCompaniaId As Integer, _
      ByVal intCedulaDoctorCedula As Integer, _
      ByVal strCedulaDoctorTelefono As String, _
      ByVal strCedulaDoctorNombre As String, _
      ByVal dtmCedulaDoctorUltimaModificacion As Date, _
      ByVal strCedulaDoctorModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblCedulaDoctor ")
            Call strSQLStatement.Append(intCedulaDoctorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCedulaDoctorCedula)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCedulaDoctorTelefono)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCedulaDoctorNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCedulaDoctorUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCedulaDoctorModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblCedulaDoctor ")
            Call strSQLStatement.Append(intCedulaDoctorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblCedulaDoctor ")
            Call strSQLStatement.Append(intCedulaDoctorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblCedulaDoctor ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblCedulaDoctor ")
            Call strSQLStatement.Append(intCedulaDoctorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblCedulaDoctor ")
            Call strSQLStatement.Append(intCedulaDoctorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
