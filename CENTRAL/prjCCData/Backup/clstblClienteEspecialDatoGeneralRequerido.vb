...
'====================================================================
' Class         : clstblClienteEspecialDatoGeneralRequerido
...
'====================================================================
Public NotInheritable Class clstblClienteEspecialDatoGeneralRequerido

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblClienteEspecialDatoGeneralRequerido"
    ...
    '                 - Tabla tblClienteEspecialDatoGeneralRequerido
    ' Parameters : 
    '              ByVal intTipoDatoGeneralClienteEspecialId As Integer
    '                 - 
    '              ByVal intClienteEspecialId As Integer
    '                 - 
    '              ByVal blnClienteEspecialDatoGeneralRequeridoEsMostrado As Byte
    '                 - 
    '              ByVal dtmClienteEspecialDatoGeneralRequeridoUltimaModificacion As Date
    '                 - 
    '              ByVal strClienteEspecialDatoGeneralRequeridoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intTipoDatoGeneralClienteEspecialId As Integer, _
      ByVal intClienteEspecialId As Integer, _
      ByVal blnClienteEspecialDatoGeneralRequeridoEsMostrado As Byte, _
      ByVal dtmClienteEspecialDatoGeneralRequeridoUltimaModificacion As Date, _
      ByVal strClienteEspecialDatoGeneralRequeridoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblClienteEspecialDatoGeneralRequerido ")
            Call strSQLStatement.Append(intTipoDatoGeneralClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnClienteEspecialDatoGeneralRequeridoEsMostrado)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmClienteEspecialDatoGeneralRequeridoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strClienteEspecialDatoGeneralRequeridoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblClienteEspecialDatoGeneralRequerido ")
            Call strSQLStatement.Append(intTipoDatoGeneralClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblClienteEspecialDatoGeneralRequerido ")
            Call strSQLStatement.Append(intTipoDatoGeneralClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblClienteEspecialDatoGeneralRequerido ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblClienteEspecialDatoGeneralRequerido ")
            Call strSQLStatement.Append(intTipoDatoGeneralClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblClienteEspecialDatoGeneralRequerido ")
            Call strSQLStatement.Append(intTipoDatoGeneralClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spReenvioCambiotblClienteEspecialDatoGeneralRequerido ")
