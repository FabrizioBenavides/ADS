...
'====================================================================
' Class         : clstblArticuloCompraDirecta
...
'====================================================================
Public NotInheritable Class clstblArticuloCompraDirecta

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblArticuloCompraDirecta"
    ...
    '                 - 
    '              ByVal intArticuloCompraDirectaCantidad As Integer
    '                 - 
    '              ByVal fltArticuloCompraDirectaCostoCapturado As Double
    '                 - 
    '              ByVal dtmArticuloCompraDirectaUltimaModificacion As Date
    '                 - 
    '              ByVal strArticuloCompraDirectaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intArticuloCompraDirectaCantidad As Integer, _
      ByVal fltArticuloCompraDirectaCostoCapturado As Double, _
      ByVal dtmArticuloCompraDirectaUltimaModificacion As Date, _
      ByVal strArticuloCompraDirectaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblArticuloCompraDirecta ")
            Call strSQLStatement.Append(intCompraDirectaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloCompraDirectaCantidad)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltArticuloCompraDirectaCostoCapturado)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloCompraDirectaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloCompraDirectaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblArticuloCompraDirecta ")
            Call strSQLStatement.Append(intCompraDirectaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblArticuloCompraDirecta ")
            Call strSQLStatement.Append(intCompraDirectaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblArticuloCompraDirecta ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblArticuloCompraDirecta ")
            Call strSQLStatement.Append(intCompraDirectaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblArticuloCompraDirecta ")
            Call strSQLStatement.Append(intCompraDirectaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
