...
'====================================================================
Public NotInheritable Class clstblPolizaCorteCuenta

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblPolizaCorteCuenta"
    ...
    '                 - 
    '              ByVal intCorteCajaId As Integer
    '                 - 
    '              ByVal intCuentaId As Integer
    '                 - 
    '              ByVal fltPolizaCorteCuentaImporteContado As Double
    '                 - 
    '              ByVal fltPolizaCorteCuentaImporteCredito As Double
    '                 - 
    '              ByVal fltPolizaCorteCuentaCantidadDocumentos As Double
    '                 - 
    '              ByVal dtmPolizaCorteCuentaRegistro As Date
    '                 - 
    '              ByVal dtmPolizaCorteCuentaUltimaModificacion As Date
    '                 - 
    '              ByVal strPolizaCorteCuentaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intCorteCajaId As Integer, _
      ByVal intCuentaId As Integer, _
      ByVal fltPolizaCorteCuentaImporteContado As Double, _
      ByVal fltPolizaCorteCuentaImporteCredito As Double, _
      ByVal fltPolizaCorteCuentaCantidadDocumentos As Double, _
      ByVal dtmPolizaCorteCuentaRegistro As Date, _
      ByVal dtmPolizaCorteCuentaUltimaModificacion As Date, _
      ByVal strPolizaCorteCuentaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblPolizaCorteCuenta ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCorteCajaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCuentaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltPolizaCorteCuentaImporteContado)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltPolizaCorteCuentaImporteCredito)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltPolizaCorteCuentaCantidadDocumentos)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmPolizaCorteCuentaRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmPolizaCorteCuentaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPolizaCorteCuentaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblPolizaCorteCuenta ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblPolizaCorteCuenta ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblPolizaCorteCuenta ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblPolizaCorteCuenta ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblPolizaCorteCuenta ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
