...
'====================================================================
Public NotInheritable Class clstblSubCategoria

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblSubCategoria"
    ...
    '                 - Tabla tblSubCategoria
    ' Parameters : 
    '              ByVal intCategoriaArticuloId As Double
    '                 - 
    '              ByVal intSubCategoriaId As Double
    '                 - 
    '              ByVal strSubCategoriaNombre As String
    '                 - 
    '              ByVal dtmSubCategoriaUltimaModificacion As Date
    '                 - 
    '              ByVal strSubCategoriaModificadoPor As String
    '                 -       
    ...
    Public Shared Function intActualizar( _
                ...
                ByVal strSubCategoriaNombre As String, _
                ByVal dtmSubCategoriaUltimaModificacion As Date, _
                ByVal strSubCategoriaModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblSubCategoria ")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSubCategoriaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strSubCategoriaNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmSubCategoriaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strSubCategoriaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblSubCategoria ")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSubCategoriaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblSubCategoria ")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSubCategoriaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intContar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblSubCategoria ")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSubCategoriaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblSubCategoria ")
            Call strSQLStatement.Append(intCategoriaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSubCategoriaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblSubCategoria ")
            Call strSQLStatement.Append("'")
