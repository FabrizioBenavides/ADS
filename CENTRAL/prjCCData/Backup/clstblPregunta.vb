...
Imports Benavides.Data.SQL.MSSQL
  ...
  '====================================================================
  Public NotInheritable Class clstblPregunta
  
    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblPregunta"
    ...
    '                 - 
    '              ByVal strPreguntaNombre As String
    '                 - 
    '              ByVal strPreguntaDescripcion As String
    '                 - 
    '              ByVal blnPreguntaActivo As boolean
    '                 - 
    '              ByVal dtmPreguntaUltimaModificacion As Date
    '                 - 
    '              ByVal strPreguntaModificadoPor As String
    '                 -       
    ...
    Shared Function intActualizar( _
        ...
        ByVal strPreguntaEncuestaAsociada As String, _
        ByVal strPreguntaDescripcion As String, _
        ByVal blnPreguntaActivo As Boolean, _
        ByVal dtmPreguntaUltimaModificacion As Date, _
        ByVal strPreguntaModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblPregunta ")
            Call strSQLStatement.Append(intPreguntaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPreguntaEncuestaAsociada)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPreguntaDescripcion)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(CByte(blnPreguntaActivo))
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmPreguntaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPreguntaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblPregunta ")
            Call strSQLStatement.Append(intPreguntaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPreguntaEncuestaAsociada)
    ...
    Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblPregunta ")
            Call strSQLStatement.Append(intPreguntaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPreguntaEncuestaAsociada)
    ...
    Shared Function intEliminar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblPregunta ")
            Call strSQLStatement.Append(intPreguntaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPreguntaEncuestaAsociada)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblPregunta ")
            Call strSQLStatement.Append("'")
