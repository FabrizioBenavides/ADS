...
'====================================================================
' Class         : clstblMotivoTransferencia
...
'====================================================================
Public NotInheritable Class clstblMotivoTransferencia

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblMotivoTransferencia"
    ...
    '                 - Tabla tblMotivoTransferencia
    ' Parameters : 
    '              ByVal intMotivoTransferenciaId As Integer
    '                 - 
    '              ByVal strMotivoTransferenciaNombre As String
    '                 - 
    '              ByVal strMotivoTransferenciaNombreId As String
    '                 - 
    '              ByVal dtmMotivoTransferenciaUltimaModificacion As Date
    '                 - 
    '              ByVal strMotivoTransferenciaIModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strMotivoTransferenciaNombre As String, _
      ByVal strMotivoTransferenciaNombreId As String, _
      ByVal intTipoTransferenciaId As Integer, _
      ByVal dtmMotivoTransferenciaUltimaModificacion As Date, _
      ByVal strMotivoTransferenciaIModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblMotivoTransferencia ")
            Call strSQLStatement.Append(intMotivoTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoTransferenciaNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoTransferenciaNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmMotivoTransferenciaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoTransferenciaIModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblMotivoTransferencia ")
            Call strSQLStatement.Append(intMotivoTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoTransferenciaNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblMotivoTransferencia ")
            Call strSQLStatement.Append(intMotivoTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoTransferenciaNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblMotivoTransferencia ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblMotivoTransferencia ")
            Call strSQLStatement.Append(intMotivoTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoTransferenciaNombre)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblMotivoTransferencia ")
            Call strSQLStatement.Append(intMotivoTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoTransferenciaNombre)
