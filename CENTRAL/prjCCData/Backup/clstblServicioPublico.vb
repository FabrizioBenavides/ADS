...
'====================================================================
Public NotInheritable Class clstblServicioPublico

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblServicioPublico"
    ...
    '                 - Tabla tblServicioPublico
    ' Parameters : 
    '              ByVal intServicioPublicoId As Integer
    '                 - 
    '              ByVal strServicioPublicoNombreId As String
    '                 - 
    '              ByVal strServicioPublicoNombre As String
    '                 - 
    '              ByVal dtmServicioPublicoUltimaModificacion As Date
    '                 - 
    '              ByVal strServicioPublicoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strServicioPublicoNombreId As String, _
      ByVal strServicioPublicoNombre As String, _
      ByVal dtmServicioPublicoUltimaModificacion As Date, _
      ByVal strServicioPublicoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblServicioPublico ")
            Call strSQLStatement.Append(intServicioPublicoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strServicioPublicoNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strServicioPublicoNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmServicioPublicoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strServicioPublicoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblServicioPublico ")
            Call strSQLStatement.Append(intServicioPublicoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strServicioPublicoNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblServicioPublico ")
            Call strSQLStatement.Append(intServicioPublicoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strServicioPublicoNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblServicioPublico ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblServicioPublico ")
            Call strSQLStatement.Append(intServicioPublicoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strServicioPublicoNombreId)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblServicioPublico ")
            Call strSQLStatement.Append(intServicioPublicoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strServicioPublicoNombreId)
