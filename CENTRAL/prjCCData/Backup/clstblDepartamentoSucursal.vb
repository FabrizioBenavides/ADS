...
'====================================================================
' Class         : clstblDepartamentoSucursal
...
'====================================================================
Public NotInheritable Class clstblDepartamentoSucursal

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblDepartamentoSucursal"
    ...
    '                 - 
    '              ByVal blnDepartamentoSucursalAceptaRebaja As Byte
    '                 - 
    '              ByVal fltDepartamentoSucursalPorcentajeRebaja As Double
    '                 - 
    '              ByVal dtmDepartamentoSucursalRebajaInicio As Date
    '                 - 
    '              ByVal dtmDepartamentoSucursalRebajaFin As Date
    '                 - 
    '              ByVal dtmDepartamentoSucursalUltimaModificacion As Date
    '                 - 
    '              ByVal strDepartamentoSucursalModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal blnDepartamentoSucursalAceptaRebaja As Byte, _
      ByVal fltDepartamentoSucursalPorcentajeRebaja As Double, _
      ByVal dtmDepartamentoSucursalRebajaInicio As Date, _
      ByVal dtmDepartamentoSucursalRebajaFin As Date, _
      ByVal dtmDepartamentoSucursalUltimaModificacion As Date, _
      ByVal strDepartamentoSucursalModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblDepartamentoSucursal ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnDepartamentoSucursalAceptaRebaja)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltDepartamentoSucursalPorcentajeRebaja)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmDepartamentoSucursalRebajaInicio.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmDepartamentoSucursalRebajaFin.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmDepartamentoSucursalUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strDepartamentoSucursalModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblDepartamentoSucursal ")
            Call strSQLStatement.Append(intDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblDepartamentoSucursal ")
            Call strSQLStatement.Append(intDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblDepartamentoSucursal ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblDepartamentoSucursal ")
            Call strSQLStatement.Append(intDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblDepartamentoSucursal ")
            Call strSQLStatement.Append(intDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
