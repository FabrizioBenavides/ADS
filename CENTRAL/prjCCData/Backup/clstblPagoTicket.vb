...
'====================================================================
Public NotInheritable Class clstblPagoTicket

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblPagoTicket"
    ...
    '                 - 
    '              ByVal intPagoTicketId As Integer
    '                 - 
    '              ByVal fltPagoTicketImporte As Double
    '                 - 
    '              ByVal fltPagoTicketAjusteEfectivo As Double
    '                 - 
    '              ByVal fltPagoTicketCambioCliente As Double
    '                 - 
    '              ByVal fltPagoTicketDonativo As Double
    '                 - 
    '              ByVal fltPagoTicketCantidadDocumentos As Double
    '                 - 
    '              ByVal fltPagoTicketTipoCambio As Double
    '                 - 
    '              ByVal dtmPagoTicketUltimaModificacion As Date
    '                 - 
    '              ByVal strPagoTicketModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intPagoTicketId As Integer, _
      ByVal fltPagoTicketImporte As Double, _
      ByVal fltPagoTicketAjusteEfectivo As Double, _
      ByVal fltPagoTicketCambioCliente As Double, _
      ByVal fltPagoTicketDonativo As Double, _
      ByVal fltPagoTicketCantidadDocumentos As Double, _
      ByVal fltPagoTicketTipoCambio As Double, _
      ByVal dtmPagoTicketUltimaModificacion As Date, _
      ByVal strPagoTicketModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblPagoTicket ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPagoTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltPagoTicketImporte)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltPagoTicketAjusteEfectivo)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltPagoTicketCambioCliente)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltPagoTicketDonativo)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltPagoTicketCantidadDocumentos)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltPagoTicketTipoCambio)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmPagoTicketUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPagoTicketModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblPagoTicket ")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblPagoTicket ")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblPagoTicket ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblPagoTicket ")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblPagoTicket ")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
