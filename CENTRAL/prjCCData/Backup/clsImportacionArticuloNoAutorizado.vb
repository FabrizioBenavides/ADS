Imports System.Text
'====================================================================
' Class         : clsImportacionArticuloNoAutorizado
...
'====================================================================
Public NotInheritable Class clsImportacionArticuloNoAutorizado

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clsImportacionArticuloNoAutorizado"
    ...
    Public Shared Function strBuscarDetalle( _
       ...
       ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarDetalleImportacionArticuloNoAutorizadoVentaCredito ")
    ...
    '               ByVal strArticuloNoAutorizadoModificadoPor As String
    '               ByVal strConnectionString As String
    '              - Cadena de conexión hacia el RDBMS
    ' Throws     : Exception
    ' Output     : Integer
    ...
    Public Shared Function intReemplazar( _
       ...
       ByVal strArticuloNoAutorizadoModificadoPor As String, _
       ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spReemplazarImportacionArticuloNoAutorizadoVentaCredito ")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(", '")
            Call strSQLStatement.Append(strArticuloNoAutorizadoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
       ...
       ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregarImportacionArticuloNoAutorizadoParaVentaCredito ")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(", '")
            Call strSQLStatement.Append(strArticuloNoAutorizadoModificadoPor)
            Call strSQLStatement.Append("'")
