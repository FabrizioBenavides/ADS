...
'====================================================================
' Class         : clstblFacturaElectronica
...
'====================================================================
Public NotInheritable Class clstblFacturaElectronica

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblFacturaElectronica"
    ...
    '                 - Tabla tblFacturaElectronica
    ' Parameters : 
    '              ByVal intFacturaElectronicaId As Integer
    '                 - 
    ...
    '                 - 
    '              ByVal strFacturaElectronicaNumero As String
    '                 - 
    '              ByVal intFacturaElectronicaPedido As Integer
    '                 - 
    '              ByVal dtmFacturaElectronicaEmisionDocumento As Date
    '                 - 
    '              ByVal fltFacturaElectronicaImporteNeto As Double
    '                 - 
    '              ByVal fltFacturaElectronicaImporteIVA As Double
    '                 - 
    '              ByVal fltFacturaElectronicaImporteTotal As Double
    '                 - 
    '              ByVal fltFacturaElectronicaImporteDescuentoDespuesIVA As Double
    '                 - 
    '              ByVal fltFacturaElectronicaImporteIVADescuento As Double
    '                 - 
    '              ByVal dtmFacturaElectronicaUltimaModificacion As Date
    '                 - 
    '              ByVal strFacturaElectronicaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intFacturaElectronicaId As Integer, _
      ByVal intCompaniaId As Integer, _
      ByVal intSucursalId As Integer, _
      ByVal intProveedorId As Integer, _
      ByVal strFacturaElectronicaNumero As String, _
      ByVal intFacturaElectronicaPedido As Integer, _
      ByVal dtmFacturaElectronicaEmisionDocumento As Date, _
      ByVal fltFacturaElectronicaImporteNeto As Double, _
      ByVal fltFacturaElectronicaImporteIVA As Double, _
      ByVal fltFacturaElectronicaImporteTotal As Double, _
      ByVal fltFacturaElectronicaImporteDescuentoDespuesIVA As Double, _
      ByVal fltFacturaElectronicaImporteIVADescuento As Double, _
      ByVal dtmFacturaElectronicaUltimaModificacion As Date, _
      ByVal strFacturaElectronicaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strFacturaElectronicaNumero)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFacturaElectronicaPedido)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmFacturaElectronicaEmisionDocumento.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltFacturaElectronicaImporteNeto)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltFacturaElectronicaImporteIVA)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltFacturaElectronicaImporteTotal)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltFacturaElectronicaImporteDescuentoDespuesIVA)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltFacturaElectronicaImporteIVADescuento)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmFacturaElectronicaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strFacturaElectronicaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblFacturaElectronica ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
