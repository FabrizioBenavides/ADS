...
'====================================================================
' Class         : clstblFolioInventarioAgotado
...
'====================================================================
Public NotInheritable Class clstblFolioInventarioAgotado

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblFolioInventarioAgotado"
    ...
    '                 - Tabla tblFolioInventarioAgotado
    ' Parameters : 
    '              ByVal intCompaniaId As Integer
    '                 - 
    '              ByVal intSucursalId As Integer
    '                 - 
    '              ByVal intFolioInventarioAgotadoValorActual As Integer
    '                 - 
    '              ByVal intFolioInventarioAgotadoValorMaximo As Integer
    '                 - 
    '              ByVal dtmFolioInventarioAgotadoUltimaModificacion As Date
    '                 - 
    '              ByVal strFolioInventarioModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intFolioInventarioAgotadoValorActual As Integer, _
      ByVal intFolioInventarioAgotadoValorMaximo As Integer, _
      ByVal dtmFolioInventarioAgotadoUltimaModificacion As Date, _
      ByVal strFolioInventarioModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblFolioInventarioAgotado ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFolioInventarioAgotadoValorActual)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFolioInventarioAgotadoValorMaximo)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmFolioInventarioAgotadoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strFolioInventarioModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblFolioInventarioAgotado ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblFolioInventarioAgotado ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblFolioInventarioAgotado ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblFolioInventarioAgotado ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblFolioInventarioAgotado ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
