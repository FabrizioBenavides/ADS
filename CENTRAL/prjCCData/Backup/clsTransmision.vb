...
'====================================================================
Public NotInheritable Class clsTransmision
...
51:         Throw
    ...
    '====================================================================
    ' Name       : strEjecutarBuscarTrasladoStock
    ...
    '                          (Col0, Col1, ...,  Coln)}
    '====================================================================
    Public Shared Function strEjecutarBuscarTrasladoStock( _
       ByVal intDireccionOperativaId As Integer, _
       ByVal intZonaOperativaId As Integer, _
       ByVal intCompaniaId As Integer, _
       ByVal intSucursalId As Integer, _
       ...
       ByVal strConnectionString As String) As Array
        ...
        ' Constantes locales
        Const strmThisMemberName As String = "strEjecutarBuscarTrasladoStock"
        ...
        Try
            ...
            ' Creamos estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarTrasladoStocks ")
            Call strSQLStatement.Append(intDireccionOperativaId)
            Call strSQLStatement.Append(", ")
            Call strSQLStatement.Append(intZonaOperativaId)
            Call strSQLStatement.Append(", ")
            ...
            ' Ejecutamos el comando
            strEjecutarBuscarTrasladoStock = Benavides.Data.SQL.MSSQL.clsSQLOperation.strExecuteQuery(strSQLStatement.ToString, strConnectionString)
            strSQLStatement = Nothing
        ...
        Catch objException As Exception
            ...
            ' Regresamos la información
            strSQLStatement = Nothing
            strEjecutarBuscarTrasladoStock = Nothing
    ...
    '====================================================================
    ' Name       : strEjecutarBuscarTransmisionesRecetasCreditoPendientesPorSucursal
    ' Description: Regresa las transmisiones pendientes por sucursal
    '             
    ' Parameters :
    '               ByVal intDireccionOperativaId As Integer
    ...
    '                          (Col0, Col1, ...,  Coln)}
    '====================================================================
    Public Shared Function strEjecutarBuscarTransmisionesRecetasCreditoPendientesPorSucursal(ByVal intDireccionOperativaId As Integer, ByVal intZonaOperativaId As Integer, ByVal intCompaniaId As Integer, ByVal intSucursalId As Integer, ByVal intInitialPosition As Integer, ByVal intElemensPerPage As Integer, ByVal strConnectionString As String) As Array
    ...
    '                          (Col0, Col1, ...,  Coln)}
    '====================================================================
    Public Shared Function strEjecutarBuscarTransmisionesBonosPendientesPorSucursal(ByVal intDireccionOperativaId As Integer, ByVal intZonaOperativaId As Integer, ByVal intCompaniaId As Integer, ByVal intSucursalId As Integer, ByVal intInitialPosition As Integer, ByVal intElemensPerPage As Integer, ByVal strConnectionString As String) As Array
    ...
    Public Shared Function strEjecutarBuscarTransmisionesFacturaElectronicaGlobalSucursalPendientesPorSucursal(ByVal strConnectionString As String) As Array

        ' Constantes locales
        Const strmThisMemberName As String = "strEjecutarBuscarTransmisionesFacturaElectronicaGlobalSucursalPendientesPorSucursal"
        ...
        Try
            ...
            ' Creamos estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarTransmisionesFacturaElectronicaGlobalSucursalPendientesPorSucursal ")

            ' Ejecutamos el comando
            strEjecutarBuscarTransmisionesFacturaElectronicaGlobalSucursalPendientesPorSucursal = Benavides.Data.SQL.MSSQL.clsSQLOperation.strExecuteQuery(strSQLStatement.ToString, strConnectionString)
            strSQLStatement = Nothing
        ...
        Catch objException As Exception
            ...
            ' Regresamos la información
            strSQLStatement = Nothing
            strEjecutarBuscarTransmisionesFacturaElectronicaGlobalSucursalPendientesPorSucursal = Nothing
    ...
    Public Shared Function strEjecutarBuscarTransmisionesTransferenciaPendientePorSucursal(ByVal strConnectionString As String) As Array

        ' Constantes locales
        Const strmThisMemberName As String = "strEjecutarBuscarTransmisionesTransferenciaPendientePorSucursal"
        ...
        Try
            ...
            ' Creamos estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarTransmisionesTransferenciaPendientePorSucursal ")

            ' Ejecutamos el comando
            strEjecutarBuscarTransmisionesTransferenciaPendientePorSucursal = Benavides.Data.SQL.MSSQL.clsSQLOperation.strExecuteQuery(strSQLStatement.ToString, strConnectionString)
            strSQLStatement = Nothing
        ...
        Catch objException As Exception
            ...
            ' Regresamos la información
            strSQLStatement = Nothing
            strEjecutarBuscarTransmisionesTransferenciaPendientePorSucursal = Nothing
    ...
    Public Shared Function strEjecutarBuscarTransmisionesFacturaSucursalPendientePorSucursal(ByVal strConnectionString As String) As Array

        ' Constantes locales
        Const strmThisMemberName As String = "strEjecutarBuscarTransmisionesFacturaSucursalPendientePorSucursal"
        ...
        Try
            ...
            ' Creamos estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarTransmisionesFacturaSucursalPendientePorSucursal ")

            ' Ejecutamos el comando
            strEjecutarBuscarTransmisionesFacturaSucursalPendientePorSucursal = Benavides.Data.SQL.MSSQL.clsSQLOperation.strExecuteQuery(strSQLStatement.ToString, strConnectionString)
            strSQLStatement = Nothing
        ...
        Catch objException As Exception
            ...
            ' Regresamos la información
            strSQLStatement = Nothing
            strEjecutarBuscarTransmisionesFacturaSucursalPendientePorSucursal = Nothing
    ...
    Public Shared Function strEjecutarBuscarTransmisionesFacturaSucursalCanceladaPendientePorSucursal(ByVal strConnectionString As String) As Array

        ' Constantes locales
        Const strmThisMemberName As String = "strEjecutarBuscarTransmisionesFacturaSucursalCanceladaPendientePorSucursal"
        ...
        Try
            ...
            ' Creamos estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarTransmisionesFacturaSucursalCanceladaPendientePorSucursal ")

            ' Ejecutamos el comando
            strEjecutarBuscarTransmisionesFacturaSucursalCanceladaPendientePorSucursal = Benavides.Data.SQL.MSSQL.clsSQLOperation.strExecuteQuery(strSQLStatement.ToString, strConnectionString)
            strSQLStatement = Nothing
        ...
        Catch objException As Exception
            ...
            ' Regresamos la información
            strSQLStatement = Nothing
            strEjecutarBuscarTransmisionesFacturaSucursalCanceladaPendientePorSucursal = Nothing
    ...
    Public Shared Function strEjecutarBuscarTransmisionesMovimientosEmpleadosPendientesPorSucursal(ByVal strConnectionString As String) As Array

        ' Constantes locales
        Const strmThisMemberName As String = "strEjecutarBuscarTransmisionesMovimientosEmpleadosPendientesPorSucursal"
        ...
        Try
            ...
            ' Creamos estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarTransmisionesMovimientosEmpleadosPendientesPorSucursal ")

            ' Ejecutamos el comando
            strEjecutarBuscarTransmisionesMovimientosEmpleadosPendientesPorSucursal = Benavides.Data.SQL.MSSQL.clsSQLOperation.strExecuteQuery(strSQLStatement.ToString, strConnectionString)
            strSQLStatement = Nothing
        ...
        Catch objException As Exception
            ...
            ' Regresamos la información
            strSQLStatement = Nothing
            strEjecutarBuscarTransmisionesMovimientosEmpleadosPendientesPorSucursal = Nothing
