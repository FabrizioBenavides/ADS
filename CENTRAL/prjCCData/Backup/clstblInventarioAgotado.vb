...
'====================================================================
Public NotInheritable Class clstblInventarioAgotado

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblInventarioAgotado"
    ...
    '                 - Tabla tblInventarioAgotado
    ' Parameters : 
    '              ByVal intInventarioAgotadoFolioId As Integer
    '                 - 
    '              ByVal intCompaniaId As Integer
    '                 - 
    '              ByVal intSucursalId As Integer
    '                 - 
    '              ByVal dtmInventarioAgotadoRegistroCaptura As Date
    '                 - 
    '              ByVal dtmInventarioAgotadoUltimaModificacion As Date
    '                 - 
    '              ByVal strInventarioAgotadoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intInventarioAgotadoFolioId As Integer, _
      ByVal intCompaniaId As Integer, _
      ByVal intSucursalId As Integer, _
      ByVal dtmInventarioAgotadoRegistroCaptura As Date, _
      ByVal dtmInventarioAgotadoUltimaModificacion As Date, _
      ByVal strInventarioAgotadoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblInventarioAgotado ")
            Call strSQLStatement.Append(intInventarioAgotadoFolioId)
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmInventarioAgotadoRegistroCaptura.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmInventarioAgotadoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strInventarioAgotadoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblInventarioAgotado ")
            Call strSQLStatement.Append(intInventarioAgotadoFolioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblInventarioAgotado ")
            Call strSQLStatement.Append(intInventarioAgotadoFolioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblInventarioAgotado ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblInventarioAgotado ")
            Call strSQLStatement.Append(intInventarioAgotadoFolioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblInventarioAgotado ")
            Call strSQLStatement.Append(intInventarioAgotadoFolioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
