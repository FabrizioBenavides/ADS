...
'====================================================================
Public NotInheritable Class clstblTipoFormaCaptura

    ' Class identifier
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTipoFormaCaptura"
    ...
    ' Table name    : tblTipoFormaCaptura
    ' Parameters    : 
    '              ByVal intTipoFormaCapturaId As Decimal
    '                  - 
    '              ByVal strTipoFormaCapturaNombreId As String
    '                  - 
    '              ByVal strTipoFormaCapturaNombre As String
    '                  - 
    '              ByVal strTipoFormaCapturaDescripcion As String
    '                  - 
    '              ByVal dtmTipoFormaCapturaUltimaModificacion As DateTime
    '                  - 
    '              ByVal strTipoFormaCapturaModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strTipoFormaCapturaNombreId As String, _
      ByVal strTipoFormaCapturaNombre As String, _
      ByVal strTipoFormaCapturaDescripcion As String, _
      ByVal dtmTipoFormaCapturaUltimaModificacion As DateTime, _
      ByVal strTipoFormaCapturaModificadoPor As String, _
      ByVal blnTipoFormaCapturaActivo As Boolean, _
      ByVal strTipoFormaCapturaInstruccionVenta As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spAgregartblTipoFormaCaptura ")
            Call strSQLStatement.Append(intTipoFormaCapturaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoFormaCapturaNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoFormaCapturaNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoFormaCapturaDescripcion)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmTipoFormaCapturaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoFormaCapturaModificadoPor)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(CByte(blnTipoFormaCapturaActivo))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoFormaCapturaInstruccionVenta)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spEliminartblTipoFormaCaptura ")
            Call strSQLStatement.Append(intTipoFormaCapturaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoFormaCapturaNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscartblTipoFormaCaptura ")
            Call strSQLStatement.Append(intTipoFormaCapturaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoFormaCapturaNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblTipoFormaCaptura ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spActualizartblTipoFormaCaptura ")
            Call strSQLStatement.Append(intTipoFormaCapturaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoFormaCapturaNombreId)
