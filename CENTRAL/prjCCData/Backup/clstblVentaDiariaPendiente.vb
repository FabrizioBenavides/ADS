...
'====================================================================
' Class         : clstblVentaDiariaPendiente
' Title         : Benavides
...
'====================================================================
Public NotInheritable Class clstblVentaDiariaPendiente

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblVentaDiariaPendiente"
    ...
    '                 - Tabla tblVentaDiariaPendiente
    ' Parameters : 
    '              ByVal intVentaDiariaPendienteCompaniaId As Integer
    '                 - 
    '              ByVal intVentaDiariaPendienteSucursalId As Integer
    '                 - 
    '              ByVal dtmVentaDiariaPendienteFechaCreacion As Date
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intVentaDiariaPendienteCompaniaId As Integer, _
      ByVal intVentaDiariaPendienteSucursalId As Integer, _
      ByVal dtmVentaDiariaPendienteFechaCreacion As Date, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblVentaDiariaPendiente ")
            Call strSQLStatement.Append(intVentaDiariaPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaDiariaPendienteSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmVentaDiariaPendienteFechaCreacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblVentaDiariaPendiente ")
            Call strSQLStatement.Append(intVentaDiariaPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaDiariaPendienteSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblVentaDiariaPendiente ")
            Call strSQLStatement.Append(intVentaDiariaPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaDiariaPendienteSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblVentaDiariaPendiente ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblVentaDiariaPendiente ")
            Call strSQLStatement.Append(intVentaDiariaPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaDiariaPendienteSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblVentaDiariaPendiente ")
            Call strSQLStatement.Append(intVentaDiariaPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaDiariaPendienteSucursalId)
            Call strSQLStatement.Append(",")
