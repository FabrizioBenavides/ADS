...
'====================================================================
Public NotInheritable Class clstblNotaCargo

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblNotaCargo"
    ...
    '                 - 
    '              ByVal intNotaCargoId As Integer
    '                 - 
    '              ByVal intTipoNotaCargoId As Integer
    '                 - 
    '              ByVal intNotaCargoFolio As Integer
    '                 - 
    '              ByVal intNotaCargoProveedorId As Integer
    '                 - 
    '              ByVal strNotaCargoNumeroFactura As String
    '                 - 
    '              ByVal fltNotaCargoImporteTotal As Double
    '                 - 
    '              ByVal fltNotaCargoImporteIVA As Double
    '                 - 
    '              ByVal dtmNotaCargoRegistro As Date
    '                 - 
    '              ByVal dtmNotaCargoUltimaModificacion As Date
    '                 - 
    '              ByVal strNotaCargoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intNotaCargoId As Integer, _
      ByVal intTipoNotaCargoId As Integer, _
      ByVal intNotaCargoFolio As Integer, _
      ByVal intNotaCargoProveedorId As Integer, _
      ByVal strNotaCargoNumeroFactura As String, _
      ByVal fltNotaCargoImporteTotal As Double, _
      ByVal fltNotaCargoImporteIVA As Double, _
      ByVal dtmNotaCargoRegistro As Date, _
      ByVal dtmNotaCargoUltimaModificacion As Date, _
      ByVal strNotaCargoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblNotaCargo ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intNotaCargoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoNotaCargoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intNotaCargoFolio)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intNotaCargoProveedorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strNotaCargoNumeroFactura)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltNotaCargoImporteTotal)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltNotaCargoImporteIVA)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmNotaCargoRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmNotaCargoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strNotaCargoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblNotaCargo ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblNotaCargo ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblNotaCargo ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblNotaCargo ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblNotaCargo ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
