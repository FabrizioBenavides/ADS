...
'====================================================================
Public NotInheritable Class clstblRegistroEtiben

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblRegistroEtiben"
    ...
    '                 - Tabla tblRegistroEtiben
    ' Parameters : 
    '    intCompaniaId As Integer 
    '    intSucursalId As Integer 
    '    intArticuloId As Integer 
    '    intPlanoId As Integer 
    '    intRegistroEtibenId As Integer 
    '    dtmRegistroEtibenSiguienteCaptura As Date 
    '    blnRegistroEtibenFueCapturado As Byte 
    '    dtmRegistroEtibenHoraCaptura As Date 
    '    dtmRegistroEtibenFechaCaptura As Date 
    '    intRegistroEtibenExistenciaReal As Integer 
    '    dtmRegistroEtibenUltimaModificacion As Date 
    '    strRegistroEtibenModificadoPor As String 
    '    strConnectionString As String As Integer
    ...
    Public Shared Function intActualizar( _
        ...
        , ByVal intRegistroEtibenId As Integer _
        , ByVal dtmRegistroEtibenSiguienteCaptura As Date _
        , ByVal blnRegistroEtibenFueCapturado As Byte _
        , ByVal dtmRegistroEtibenHoraCaptura As Date _
        , ByVal dtmRegistroEtibenFechaCaptura As Date _
        , ByVal intRegistroEtibenExistenciaReal As Integer _
        , ByVal dtmRegistroEtibenUltimaModificacion As Date _
        , ByVal strRegistroEtibenModificadoPor As String _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblRegistroEtiben ")

            Call strSQLStatement.Append(intCompaniaId) 'Campo 01

            Call strSQLStatement.Append(",") 'Campo 02
            Call strSQLStatement.Append(intSucursalId)

            Call strSQLStatement.Append(",") 'Campo 03
            Call strSQLStatement.Append(intArticuloId)

            Call strSQLStatement.Append(",") 'Campo 04
            Call strSQLStatement.Append(intPlanoId)

            Call strSQLStatement.Append(",") 'Campo 05
            Call strSQLStatement.Append(intRegistroEtibenId)

            Call strSQLStatement.Append(",'") 'Campo 06
            Call strSQLStatement.Append(dtmRegistroEtibenSiguienteCaptura.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")

            Call strSQLStatement.Append(",") 'Campo 07
            Call strSQLStatement.Append(blnRegistroEtibenFueCapturado)

            Call strSQLStatement.Append(",") 'Campo 08
            Call strSQLStatement.Append(dtmRegistroEtibenHoraCaptura.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))

            Call strSQLStatement.Append(",'") 'Campo 09
            Call strSQLStatement.Append(dtmRegistroEtibenFechaCaptura.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")

            Call strSQLStatement.Append(",") 'Campo 10
            Call strSQLStatement.Append(intRegistroEtibenExistenciaReal)

            Call strSQLStatement.Append(",'") 'Campo 11
            Call strSQLStatement.Append(dtmRegistroEtibenUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")

            Call strSQLStatement.Append(",'") 'Campo 12
            Call strSQLStatement.Append(strRegistroEtibenModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblRegistroEtiben ")
    ...
    Public Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblRegistroEtiben ")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblRegistroEtiben ")
    ...
    Public Shared Function intContar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblRegistroEtiben ")
    ...
    Public Shared Function intEliminar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblRegistroEtiben ")
