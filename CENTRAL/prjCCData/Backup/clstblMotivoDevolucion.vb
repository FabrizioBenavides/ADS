...
'====================================================================
Public NotInheritable Class clstblMotivoDevolucion

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblMotivoDevolucion"
    ...
    '                 - Tabla tblMotivoDevolucion
    ' Parameters : 
    '              ByVal intMotivoDevolucionId As Integer
    '                 - 
    '              ByVal strMotivoDevolucionNombre As String
    '                 - 
    '              ByVal strMotivoDevolucionNombreId As String
    '                 - 
    '              ByVal dtmMotivoDevolucionUltimaModificacion As Date
    '                 - 
    '              ByVal strMotivoDevolucionModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strMotivoDevolucionNombre As String, _
      ByVal strMotivoDevolucionNombreId As String, _
      ByVal dtmMotivoDevolucionUltimaModificacion As Date, _
      ByVal strMotivoDevolucionModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblMotivoDevolucion ")
            Call strSQLStatement.Append(intMotivoDevolucionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoDevolucionNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoDevolucionNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmMotivoDevolucionUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoDevolucionModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblMotivoDevolucion ")
            Call strSQLStatement.Append(intMotivoDevolucionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoDevolucionNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblMotivoDevolucion ")
            Call strSQLStatement.Append(intMotivoDevolucionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoDevolucionNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblMotivoDevolucion ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblMotivoDevolucion ")
            Call strSQLStatement.Append(intMotivoDevolucionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoDevolucionNombre)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblMotivoDevolucion ")
            Call strSQLStatement.Append(intMotivoDevolucionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMotivoDevolucionNombre)
