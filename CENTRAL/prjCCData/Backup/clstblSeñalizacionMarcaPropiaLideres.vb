...
Public NotInheritable Class clstblSeñalizacionMarcaPropiaLideres

    '====================================================================
    ' Class         : clstblSeñalizacionMarcaPropiaLideres
    ...
    ' Author        : Softtek
    ' Version       : 1.0
    ' Last Modified : Miércoles, 7 de Abril 2010
    '====================================================================

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblSeñalizacionMarcaPropiaLideres"
    ...
    '                 - Tabla tblSeñalizacionMarcaPropiaLideres
    ' Parameters : 
    '              ByVal intSeñalizacionMarcaPropiaLideresId As Integer
    '                 - 
    '              ByVal intArticuloMarcaPropiaId As Integer
    '                 - 
    '              ByVal intArticuloMarcaLiderId As Integer
    '                 - 
    '              ByVal dtmSeñalizacionMarcaPropiaLideresUltimaModificacion As Date
    '                 - 
    '              ByVal strSeñalizacionMarcaPropiaLideresModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intSeñalizacionMarcaPropiaLideresId As Integer, _
      ByVal intArticuloMarcaPropiaId As Integer, _
      ByVal intArticuloMarcaLiderId As Integer, _
      ByVal dtmSeñalizacionMarcaPropiaLideresUltimaModificacion As Date, _
      ByVal strSeñalizacionMarcaPropiaLideresModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblSenalizacionMarcaPropiaLideres ")
            Call strSQLStatement.Append(intSeñalizacionMarcaPropiaLideresId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloMarcaPropiaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloMarcaLiderId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmSeñalizacionMarcaPropiaLideresUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strSeñalizacionMarcaPropiaLideresModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblSenalizacionMarcaPropiaLideres ")
            Call strSQLStatement.Append(intSeñalizacionMarcaPropiaLideresId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloMarcaPropiaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblSenalizacionMarcaPropiaLideres ")
            Call strSQLStatement.Append(intSeñalizacionMarcaPropiaLideresId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloMarcaPropiaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblSenalizacionMarcaPropiaLideres ")
            Call strSQLStatement.Append("'")
    ...
    '                   c = Campo
    '====================================================================
    Public Shared Function strBuscarParejas( _
      ByVal intSeñalizacionMarcaPropiaLideresId As Integer, _
      ByVal intArticuloMarcaPropiaId As Integer, _
      ByVal intPosicionInicial As Double, _
      ByVal intElementos As Double, _
      ByVal strConnectionString As String) As Array
        ...
        ' Constantes locales
        Const strmThisMemberName As String = "strBuscarParejas"
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarParejasSenalizacionMarcaPropiaLideres ")
            Call strSQLStatement.Append(intSeñalizacionMarcaPropiaLideresId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloMarcaPropiaId)
            Call strSQLStatement.Append(",")
            ...
            ' Ejecutamos el comando
            strBuscarParejas = clsSQLOperation3.aobjExecuteQuery(strSQLStatement.ToString(), strConnectionString)
            strSQLStatement = Nothing
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblSenalizacionMarcaPropiaLideres ")
            Call strSQLStatement.Append(intSeñalizacionMarcaPropiaLideresId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloMarcaPropiaId)
            Call strSQLStatement.Append(",")
