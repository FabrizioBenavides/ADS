...
'====================================================================
' Class         : clstblModificacionExistenciaIdealArticulo
...
'====================================================================
Public NotInheritable Class clstblModificacionExistenciaIdealArticulo

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblModificacionExistenciaIdealArticulo"
    ...
    '                 - Tabla tblModificacionExistenciaIdealArticulo
    ' Parameters : 
    ...
    '                 - 
    '              ByVal intModificacionExistenciaIdealArticuloValorAnterior As Integer
    '                 - 
    '              ByVal dtmModificacionExistenciaIdealArticuloUltimaModificacion As Date
    '                 - 
    '              ByVal strModificacionExistenciaIdealArticuloModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _ 
      ...
      ByVal intModificacionExistenciaIdealArticuloValorAnterior As Integer, _
      ByVal dtmModificacionExistenciaIdealArticuloUltimaModificacion As Date, _
      ByVal strModificacionExistenciaIdealArticuloModificadoPor As String, _
      ...
      Try
        ...
        Call strSQLStatement.Append("EXECUTE spActualizartblModificacionExistenciaIdealArticulo ")
        ...
        Call strSQLStatement.Append(",")
        Call strSQLStatement.Append(intModificacionExistenciaIdealArticuloValorAnterior)
        Call strSQLStatement.Append(",")
        Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmModificacionExistenciaIdealArticuloUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strModificacionExistenciaIdealArticuloModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblModificacionExistenciaIdealArticulo ")
            Call strSQLStatement.Append(intImpuestoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblModificacionExistenciaIdealArticulo ")
            Call strSQLStatement.Append(intImpuestoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblModificacionExistenciaIdealArticulo ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblModificacionExistenciaIdealArticulo ")
            Call strSQLStatement.Append(intImpuestoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblModificacionExistenciaIdealArticulo ")
            Call strSQLStatement.Append(intImpuestoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
