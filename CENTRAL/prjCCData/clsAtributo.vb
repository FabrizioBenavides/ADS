...
'====================================================================
Public NotInheritable Class clsAtributo

    ' Class identifier
    Private Const strmThisClassName As String = "Benavides.CC.Data.clsAtributo"
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarAtributo ")
