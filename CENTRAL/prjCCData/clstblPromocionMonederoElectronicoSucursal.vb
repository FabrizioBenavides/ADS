'====================================================================
' Class         : clstblPromocionMonederoElectronicoSucursal
...
'====================================================================
Public NotInheritable Class clstblPromocionMonederoElectronicoSucursal

    ' Identificador de la clase
    Private Const CLASS_NAME As String = "Benavides.CC.Data.clstblPromocionMonederoElectronicoSucursal"
    ...
    '                 - 
    '              ByVal dtmSucursalPromocionMonederoElectronicoUltimaModificacion As DateTime
    '                 - 
    '              ByVal strSucursalPromocionMonederoElectronicoModificadoPor As String
    '                 -       
    ...
    Shared Function intActualizar( _
                ...
                ByVal dtmSucursalPromocionMonederoElectronicoUltimaModificacion As DateTime, _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call sqlStatementToBeExecuted.Append("EXECUTE spActualizartblPromocionMonederoElectronicoSucursal ")
            ...
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(dtmSucursalPromocionMonederoElectronicoUltimaModificacion.ToString("MM/dd/yyyy"))
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strSucursalPromocionMonederoElectronicoModificadoPor)
            Call sqlStatementToBeExecuted.Append("'")
    ...
    Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call sqlStatementToBeExecuted.Append("EXECUTE spAgregartblPromocionMonederoElectronicoSucursal ")
            Call sqlStatementToBeExecuted.Append(intCompaniaId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intSucursalId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscartblPromocionMonederoElectronicoSucursal ")
            Call sqlStatementToBeExecuted.Append(intCompaniaId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intSucursalId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    Shared Function strBuscarCambios( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscarCambiostblPromocionMonederoElectronicoSucursal ")
