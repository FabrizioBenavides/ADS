...
'====================================================================
' Class         : clstblArticuloEmpresaServicio
' Title         : Grupo Benavides. Administrador POS y Backoffice.
' Description   : Store Procedure Mantenimiento Datos
' Copyright     : 2009 Todos los Derechos Reservados.
' Company       : SOFTTEK
' Author        : Cesar Ortiz (OCOT)
' Version       : 1.0
' Last Modified : 27 de Agosto, 2009
'====================================================================

Public Class clstblArticuloEmpresaServicio
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblArticuloEmpresaServicio ")
    ...
    Shared Function strBuscar( _
            ...
            ByVal fltArticuloEmpresaServicioPrecioVenta As Double, _
            ByVal blnArticuloEmpresaServicioActivo As Boolean, _
            ByVal dtmArticuloEmpresaServicioUltimaModificacion As Date, _
            ByVal strArticuloEmpresaServicioModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscartblArticuloEmpresaServicio ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEmpresaServicioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltArticuloEmpresaServicioPrecioVenta)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(CByte(blnArticuloEmpresaServicioActivo))
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloEmpresaServicioUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloEmpresaServicioModificadoPor)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
    ...
    Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblArticuloEmpresaServicio ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEmpresaServicioId)
            Call strSQLStatement.Append(",")
    ...
    Shared Function intActualizar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spActualizartblArticuloEmpresaServicio ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEmpresaServicioId)
            Call strSQLStatement.Append(",")
