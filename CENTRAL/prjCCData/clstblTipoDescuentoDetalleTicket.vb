...
'====================================================================
' Class         : clstblTipoDescuentoDetalleTicket
...
'====================================================================
Public NotInheritable Class clstblTipoDescuentoDetalleTicket

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTipoDescuentoDetalleTicket"
    ...
    '                 - Tabla tblTipoDescuentoDetalleTicket
    ' Parameters : 
    '              ByVal intTipoDescuentoDetalleTicketId As Integer
    '                 - 
    '              ByVal strTipoDescuentoDetalleTicketNombreId As String
    '                 - 
    '              ByVal strTipoDescuentoDetalleTicketNombre As String
    '                 - 
    '              ByVal blnTipoDescuentoDetalleTicketConsideraImporteNormal As Byte
    '                 - 
    '              ByVal dtmTipoDescuentoDetalleTicketUltimaModificacion As Date
    '                 - 
    '              ByVal strTipoDescuentoDetalleTicketModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intTipoDescuentoDetalleTicketId As Integer, _
      ByVal strTipoDescuentoDetalleTicketNombreId As String, _
      ByVal strTipoDescuentoDetalleTicketNombre As String, _
      ByVal blnTipoDescuentoDetalleTicketConsideraImporteNormal As Byte, _
      ByVal dtmTipoDescuentoDetalleTicketUltimaModificacion As Date, _
      ByVal strTipoDescuentoDetalleTicketModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblTipoDescuentoDetalleTicket ")
            Call strSQLStatement.Append(intTipoDescuentoDetalleTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDescuentoDetalleTicketNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDescuentoDetalleTicketNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnTipoDescuentoDetalleTicketConsideraImporteNormal)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmTipoDescuentoDetalleTicketUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDescuentoDetalleTicketModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblTipoDescuentoDetalleTicket ")
            Call strSQLStatement.Append(intTipoDescuentoDetalleTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDescuentoDetalleTicketNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblTipoDescuentoDetalleTicket ")
            Call strSQLStatement.Append(intTipoDescuentoDetalleTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDescuentoDetalleTicketNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblTipoDescuentoDetalleTicket ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblTipoDescuentoDetalleTicket ")
            Call strSQLStatement.Append(intTipoDescuentoDetalleTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDescuentoDetalleTicketNombreId)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblTipoDescuentoDetalleTicket ")
            Call strSQLStatement.Append(intTipoDescuentoDetalleTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDescuentoDetalleTicketNombreId)
