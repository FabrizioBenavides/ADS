...
'====================================================================
' Class         : clstblArticuloDatoAdicional
...
' Version       : 1
' Last Modified : 25 Septiembre 2014
'====================================================================

' Clase que no permite tener mas Clases dentro de la misma.
Public NotInheritable Class clstblArticuloDatoAdicional

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblArticuloDatoAdicional"
    ...
    '                 - Tabla tblArticuloDatoAdicional
    ' Parameters :
    ...
    Public Shared Function strBuscar(ByVal dtmUltimaModificacionInicial As Date, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblArticuloDatoAdicional ")
