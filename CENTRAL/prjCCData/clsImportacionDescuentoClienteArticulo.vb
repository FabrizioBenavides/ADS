'====================================================================
' Class         : clsImportacionDescuentoClienteArticulo
' Title         : Grupo Benavides. Administrador POS y Backoffice.
' Description   : Importación de descuentos a clientes.
...
'====================================================================
Public NotInheritable Class clsImportacionDescuentoClienteArticulo

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clsImportacionDescuentoClienteArticulo"
    ...
    Public Shared Function strBuscarDetalle( _
       ...
       ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarDetalleImportacionDescuentoClienteArticulo ")
    ...
    Public Shared Function intReemplazar( _
       ...
       ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spReemplazarImportacionDescuentoClienteArticulo ")
    ...
    Public Shared Function intAgregar( _
       ...
       ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregarImportacionDescuentoClienteArticulo ")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(", '")
            Call strSQLStatement.Append(strDescuentoClienteArticuloModificadoPor)
            Call strSQLStatement.Append("'")
