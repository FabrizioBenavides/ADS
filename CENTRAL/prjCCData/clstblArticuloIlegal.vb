...
'====================================================================
Public NotInheritable Class clstblArticuloIlegal
    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblArticuloIlegal"
    ...
    '                 - Tabla tblArticuloIlegal
    ' Parameters : 
    '              ByVal intArticuloIlegalId As Integer
    '                 - 
    '              ByVal strArticuloIlegalLote As String
    '                 - 
    '              ByVal blnArticuloIlegalVigente As Boolean
    '                 - 
    '              ByVal dtmArticuloIlegalUltimaModificacion As Date
    '                 - 
    '              ByVal strArticuloIlegalModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intArticuloIlegalId As Integer, _
      ByVal strArticuloIlegalLote As String, _
      ByVal blnArticuloIlegalVigente As Boolean, _
      ByVal dtmArticuloIlegalUltimaModificacion As Date, _
      ByVal strArticuloIlegalModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblArticuloIlegal ")
            Call strSQLStatement.Append(intArticuloIlegalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloIlegalLote)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(Convert.ToInt32(blnArticuloIlegalVigente))
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloIlegalUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloIlegalModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ByVal intArticuloIlegalId As Integer, _
      ByVal strArticuloIlegalLote As String, _
      ByVal intArticuloIlegalVigente As Boolean, _
      ByVal dtmArticuloIlegalUltimaModificacion As Date, _
      ByVal strArticuloIlegalModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblArticuloIlegal ")
            Call strSQLStatement.Append(intArticuloIlegalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloIlegalLote)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(Convert.ToInt32(intArticuloIlegalVigente))
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloIlegalUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblArticuloIlegal ")
            Call strSQLStatement.Append(intArticuloIlegalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloIlegalUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblArticuloIlegal ")
            Call strSQLStatement.Append(intArticuloIlegalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloIlegalUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
    ...
    '====================================================================
    ' Name       : aobjObtenerArticulosIlegales
    ' Description: Búsqueda de registros.
    '                 - Tabla tblArticuloIlegal
    ' Parameters : 
    '              ByVal intArticuloIlegalId As String
    '                 - 
    '              ByVal dtmArticuloIlegalUltimaModificacion As Date
    '                 - 
    '              ByVal strArticuloIlegalModificadoPor As String
    ...
    '                   c = Campo
    '====================================================================
    Public Shared Function aobjObtenerArticulosIlegales( _
        ByVal intArticuloIlegalId As String, _
        ByVal intPosicionInicial As Double, _
        ByVal intElementos As Double, _
        ByVal strConnectionString As String) As Array
        ...
        ' Member identifier
        Const strmThisMemberName As String = "aobjObtenerArticulosIlegales"
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarArticuloIlegal ")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(intArticuloIlegalId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
