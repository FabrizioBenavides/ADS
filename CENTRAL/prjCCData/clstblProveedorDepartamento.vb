...
'====================================================================
' Class         : clstblProveedorDepartamento
...
'====================================================================
Public NotInheritable Class clstblProveedorDepartamento

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblProveedorDepartamento"
    ...
    '                 - Tabla tblProveedorDepartamento
    ' Parameters : 
    ...
    '                 - 
    '              ByVal dtmProveedorDepartamentoUltimaModificacion As Date
    '                 - 
    '              ByVal strProveedorDepartamentoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal dtmProveedorDepartamentoUltimaModificacion As Date, _
      ByVal strProveedorDepartamentoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblProveedorDepartamento ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmProveedorDepartamentoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strProveedorDepartamentoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblProveedorDepartamento ")
            Call strSQLStatement.Append(intProveedorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDepartamentoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblProveedorDepartamento ")
            Call strSQLStatement.Append(intProveedorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDepartamentoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblProveedorDepartamento ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblProveedorDepartamento ")
            Call strSQLStatement.Append(intProveedorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDepartamentoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblProveedorDepartamento ")
            Call strSQLStatement.Append(intProveedorId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDepartamentoId)
            Call strSQLStatement.Append(",")
