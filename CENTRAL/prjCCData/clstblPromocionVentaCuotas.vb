'====================================================================
' Class         : clstblPromocionVentaCuotas
...
'====================================================================
Public NotInheritable Class clstblPromocionVentaCuotas

    ' Class identifier
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblPromocionVentaCuotas"
    ...
    ' Table name    : tblPromocionVentaCuotas
    ' Parameters    : 
    '              ByVal intPromocionVentaCuotasId As Decimal
    '                  - 
    '              ByVal strPromocionVentaCuotasNombre As String
    '                  - 
    '              ByVal intPromocionVentaCuotasPlazo As Int32
    '                  - 
    '              ByVal fltPromocionVentaCuotasMontoMinimo As Decimal
    '                  - 
    '              ByVal dtmPromocionVentaCuotasVigenciaInicio As DateTime
    '                  - 
    '              ByVal dtmPromocionVentaCuotasVigenciaFin As DateTime
    '                  - 
    '              ByVal blnPromocionVentaCuotasActiva As Boolean
    '                  - 
    '              ByVal dtmPromocionVentaCuotasUltimaModificacion As DateTime
    '                  - 
    '              ByVal strPromocionVentaCuotasModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar( _
      ByVal intPromocionVentaCuotasId As Decimal, _
      ByVal strPromocionVentaCuotasNombre As String, _
      ByVal intPromocionVentaCuotasPlazo As Int32, _
      ByVal fltPromocionVentaCuotasMontoMinimo As Decimal, _
      ByVal dtmPromocionVentaCuotasVigenciaInicio As DateTime, _
      ByVal dtmPromocionVentaCuotasVigenciaFin As DateTime, _
      ByVal blnPromocionVentaCuotasActiva As Boolean, _
      ByVal dtmPromocionVentaCuotasUltimaModificacion As DateTime, _
      ByVal strPromocionVentaCuotasModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spAgregartblPromocionVentaCuotas ")
            Call strSQLStatement.Append(intPromocionVentaCuotasId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPromocionVentaCuotasNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPromocionVentaCuotasPlazo)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltPromocionVentaCuotasMontoMinimo)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            ...
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(CByte(blnPromocionVentaCuotasActiva))
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmPromocionVentaCuotasUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPromocionVentaCuotasModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spEliminartblPromocionVentaCuotas ")
            Call strSQLStatement.Append(intPromocionVentaCuotasId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPromocionVentaCuotasNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscartblPromocionVentaCuotas ")
            Call strSQLStatement.Append(intPromocionVentaCuotasId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPromocionVentaCuotasNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblPromocionVentaCuotas ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spActualizartblPromocionVentaCuotas ")
            Call strSQLStatement.Append(intPromocionVentaCuotasId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPromocionVentaCuotasNombre)
