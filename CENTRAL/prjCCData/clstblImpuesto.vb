...
'====================================================================
Public NotInheritable Class clstblImpuesto

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblImpuesto"
    ...
    '                 - 
    '              ByVal strImpuestoNombre As String
    '                 - 
    '              ByVal fltImpuestoValor As Double
    '                 - 
    '              ByVal dtmImpuestoUltimaModificacion As Date
    '                 - 
    '              ByVal strImpuestoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strImpuestoNombre As String, _
      ByVal fltImpuestoValor As Double, _
      ByVal dtmImpuestoUltimaModificacion As Date, _
      ByVal strImpuestoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblImpuesto ")
            Call strSQLStatement.Append(intImpuestoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoImpuestoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strImpuestoNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltImpuestoValor)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmImpuestoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strImpuestoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblImpuesto ")
            Call strSQLStatement.Append(intImpuestoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoImpuestoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblImpuesto ")
            Call strSQLStatement.Append(intImpuestoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoImpuestoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblImpuesto ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblImpuesto ")
            Call strSQLStatement.Append(intImpuestoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoImpuestoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblImpuesto ")
            Call strSQLStatement.Append(intImpuestoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoImpuestoId)
            Call strSQLStatement.Append(",")
