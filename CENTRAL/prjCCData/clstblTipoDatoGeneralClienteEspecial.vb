...
'====================================================================
' Class         : clstblTipoDatoGeneralClienteEspecial
...
'====================================================================
Public NotInheritable Class clstblTipoDatoGeneralClienteEspecial

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTipoDatoGeneralClienteEspecial"
    ...
    '                 - Tabla tblTipoDatoGeneralClienteEspecial
    ' Parameters : 
    '              ByVal intTipoDatoGeneralClienteEspecialId As Integer
    '                 - 
    '              ByVal strTipoDatoGeneralClienteEspecialNombreId As String
    '                 - 
    '              ByVal strTipoDatoGeneralClienteEspecialNombre As String
    '                 - 
    '              ByVal dtmTipoDatoGeneralClienteEspecialUltimaModificacion As Date
    '                 - 
    '              ByVal strTipoDatoGeneralClienteEspecialModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strTipoDatoGeneralClienteEspecialNombreId As String, _
      ByVal strTipoDatoGeneralClienteEspecialNombre As String, _
      ByVal dtmTipoDatoGeneralClienteEspecialUltimaModificacion As Date, _
      ByVal strTipoDatoGeneralClienteEspecialModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblTipoDatoGeneralClienteEspecial ")
            Call strSQLStatement.Append(intTipoDatoGeneralClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoGeneralClienteEspecialNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoGeneralClienteEspecialNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmTipoDatoGeneralClienteEspecialUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoGeneralClienteEspecialModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblTipoDatoGeneralClienteEspecial ")
            Call strSQLStatement.Append(intTipoDatoGeneralClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoGeneralClienteEspecialNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblTipoDatoGeneralClienteEspecial ")
            Call strSQLStatement.Append(intTipoDatoGeneralClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoGeneralClienteEspecialNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblTipoDatoGeneralClienteEspecial ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblTipoDatoGeneralClienteEspecial ")
            Call strSQLStatement.Append(intTipoDatoGeneralClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoGeneralClienteEspecialNombreId)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblTipoDatoGeneralClienteEspecial ")
            Call strSQLStatement.Append(intTipoDatoGeneralClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoGeneralClienteEspecialNombreId)
