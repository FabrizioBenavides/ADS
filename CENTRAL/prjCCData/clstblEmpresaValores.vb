...
'====================================================================
Public NotInheritable Class clstblEmpresaValores

    ' Class identifier
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblEmpresaValores"
    ...
    ' Table name    : tblEmpresaValores
    ' Parameters    : 
    '              ByVal intEmpresaValoresId As Decimal
    '                  - 
    '              ByVal strEmpresaValoresNombre As String
    '                  - 
    '              ByVal dtmEmpresaValoresAlta As DateTime
    '                  - 
    '              ByVal strEmpresaValoresContacto As String
    '                  - 
    '              ByVal strEmpresaValoresTelefono As String
    '                  - 
    '              ByVal blnEmpresaValoresActiva As Boolean
    '                  - 
    '              ByVal dtmEmpresaValoresUltimaModificacion As DateTime
    '                  - 
    '              ByVal strEmpresaValoresModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strEmpresaValoresNombre As String, _
      ByVal dtmEmpresaValoresAlta As DateTime, _
      ByVal strEmpresaValoresContacto As String, _
      ByVal strEmpresaValoresTelefono As String, _
      ByVal blnEmpresaValoresActiva As Boolean, _
      ByVal dtmEmpresaValoresUltimaModificacion As DateTime, _
      ByVal strEmpresaValoresModificadoPor As String, _
      ByVal strConnectionString As String) As integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spAgregartblEmpresaValores ")
            Call strSQLStatement.Append(intEmpresaValoresId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmpresaValoresNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmEmpresaValoresAlta.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmpresaValoresContacto)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmpresaValoresTelefono)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(CByte(blnEmpresaValoresActiva))
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmEmpresaValoresUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmpresaValoresModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spEliminartblEmpresaValores ")
            Call strSQLStatement.Append(intEmpresaValoresId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmpresaValoresNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscartblEmpresaValores ")
            Call strSQLStatement.Append(intEmpresaValoresId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmpresaValoresNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblEmpresaValores ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spActualizartblEmpresaValores ")
            Call strSQLStatement.Append(intEmpresaValoresId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmpresaValoresNombre)
