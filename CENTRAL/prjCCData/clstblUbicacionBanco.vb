...
'====================================================================
Public NotInheritable Class clstblUbicacionBanco

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblUbicacionBanco"
    ...
    '                 - Tabla tblUbicacionBanco
    ' Parameters : 
    '              ByVal intUbicacionBancoId As Integer
    '                 - 
    '              ByVal strUbicacionBancoNombreId As String
    '                 - 
    '              ByVal strUbicacionBancoNombre As String
    '                 - 
    '              ByVal dtmUbicacionBancoUltimaModificacion As Date
    '                 - 
    '              ByVal strUbicacionBancoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intUbicacionBancoId As Integer, _
      ByVal strUbicacionBancoNombreId As String, _
      ByVal strUbicacionBancoNombre As String, _
      ByVal dtmUbicacionBancoUltimaModificacion As Date, _
      ByVal strUbicacionBancoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblUbicacionBanco ")
            Call strSQLStatement.Append(intUbicacionBancoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strUbicacionBancoNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strUbicacionBancoNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmUbicacionBancoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strUbicacionBancoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblUbicacionBanco ")
            Call strSQLStatement.Append(intUbicacionBancoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strUbicacionBancoNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblUbicacionBanco ")
            Call strSQLStatement.Append(intUbicacionBancoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strUbicacionBancoNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblUbicacionBanco ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblUbicacionBanco ")
            Call strSQLStatement.Append(intUbicacionBancoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strUbicacionBancoNombreId)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblUbicacionBanco ")
            Call strSQLStatement.Append(intUbicacionBancoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strUbicacionBancoNombreId)
