...
'====================================================================
' Class         : clstblSubcategoriaArticulosCupon
...
'====================================================================
Public NotInheritable Class clstblSubcategoriaArticulosCupon

    ' Class identifier
    Private Const CLASS_NAME As String = "Benavides.CC.Data.clstblSubcategoriaArticulosCupon"
    ...
    ' Table name    : tblSubcategoriaArticulosCupon
    ' Parameters    : 
    ...
    '                  - 
    '              ByVal dtmSubcategoriaArticulosCuponUltimaModificacion As DateTime
    '                  - 
    '              ByVal strSubcategoriaArticulosCuponModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar(ByVal intCuponId As Int32, _
                                      ...
                                      ByVal dtmSubcategoriaArticulosCuponUltimaModificacion As DateTime, _
                                      ByVal strSubcategoriaArticulosCuponModificadoPor As String, _
        ...
        Try
            ...
            Call sqlStatementToBeExecuted.Append("EXECUTE spAgregartblSubcategoriaArticulosCupon ")
            ...
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(dtmSubcategoriaArticulosCuponUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strSubcategoriaArticulosCuponModificadoPor)
            Call sqlStatementToBeExecuted.Append("'")
    ...
    Public Shared Function intEliminar(ByVal intCuponId As Int32, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spEliminartblSubcategoriaArticulosCupon ")
            Call sqlStatementToBeExecuted.Append(intCuponId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    Public Shared Function strBuscar(ByVal intCuponId As Int32, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscartblSubcategoriaArticulosCupon ")
            Call sqlStatementToBeExecuted.Append(intCuponId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    Public Shared Function strBuscar(ByVal dtmStart As DateTime, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscarCambiotblSubcategoriaArticulosCupon ")
            Call sqlStatementToBeExecuted.Append("'")
    ...
    Public Shared Function intActualizar(ByVal intCuponId As Int32, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spActualizartblSubcategoriaArticulosCupon ")
            Call sqlStatementToBeExecuted.Append(intCuponId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
