...
'====================================================================
Public NotInheritable Class clstblOferta

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblOferta"
    ...
    '                 - 
    '              ByVal strOfertaNombre As String
    '                 - 
    '              ByVal dtmOfertaRegistro As Date
    '                 - 
    '              ByVal dtmOfertaUltimaModificacion As Date
    '                 - 
    '              ByVal strOfertaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strOfertaNombre As String, _
      ByVal dtmOfertaRegistro As Date, _
      ByVal dtmOfertaUltimaModificacion As Date, _
      ByVal strOfertaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblOferta ")
            Call strSQLStatement.Append(intOfertaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoOfertaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strOfertaNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmOfertaRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmOfertaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strOfertaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblOferta ")
            Call strSQLStatement.Append(intOfertaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoOfertaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblOferta ")
            Call strSQLStatement.Append(intOfertaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoOfertaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblOferta ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spReenvioCambiotblOferta ")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblOferta ")
            Call strSQLStatement.Append(intOfertaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoOfertaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblOferta ")
            Call strSQLStatement.Append(intOfertaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoOfertaId)
            Call strSQLStatement.Append(",")
