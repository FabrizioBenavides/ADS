...
'====================================================================
' Class         : clstblTipoDeCambioMoneda
...
'====================================================================
Public NotInheritable Class clstblTipoDeCambioMoneda

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTipoDeCambioMoneda"
    ...
    '                 - Tabla tblTipoDeCambioMoneda
    ' Parameters : 
    '              ByVal intMonedaCambioId As Integer
    '                 - 
    '              ByVal intMonedaBaseId As Integer
    '                 - 
    '              ByVal fltTipoDeCambioMonedaValor As Double
    '                 - 
    '              ByVal dtmTipoDeCambioMonedaUltimaModificacion As Date
    '                 - 
    '              ByVal strTipoDeCambioMonedaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal dtmTipoDeCambioMonedaUltimaModificacion As Date, _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblTipoDeCambioMoneda ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmTipoDeCambioMonedaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblTipoDeCambioMoneda ")
            Call strSQLStatement.Append(intMonedaCambioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intMonedaBaseId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblTipoDeCambioMoneda ")
            Call strSQLStatement.Append(intMonedaCambioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intMonedaBaseId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblTipoDeCambioMoneda ")
            Call strSQLStatement.Append("'")
    ...
    '                 - Tabla tblTipoDeCambioMoneda
    ' Parameters :
    '              ByVal strConcentradorDeEnvioIp
    '
    '              ByVal dtmUltimaModificacionInicial As Date
    '                 - Fecha inicial de búsqueda
    '              ByVal dtmUltimaModificacionFinal As Date
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblTipoDeCambioMoneda ")
            Call strSQLStatement.Append(intMonedaCambioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intMonedaBaseId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblTipoDeCambioMoneda ")
            Call strSQLStatement.Append(intMonedaCambioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intMonedaBaseId)
            Call strSQLStatement.Append(",")
