...
'====================================================================
Public NotInheritable Class clstblReclamacion

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblReclamacion"
    ...
    '                 - Tabla tblReclamacion
    ' Parameters : 
    '              ByVal intReclamacionId As Integer
    '                 - 
    ...
    '                 - 
    '              ByVal intReclamacionFolio As Integer
    '                 - 
    '              ByVal intReclamacionNumeroDocumento As Integer
    '                 - 
    '              ByVal strReclamacionNumeroFactura As String
    '                 - 
    '              ByVal dtmReclamacionFecha As Date
    '                 - 
    '              ByVal dtmReclamacionUltimaModificacion As Date
    '                 - 
    '              ByVal strReclamacionModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intReclamacionId As Integer, _
      ...
      ByVal intReclamacionFolio As Integer, _
      ByVal intReclamacionNumeroDocumento As Integer, _
      ByVal strReclamacionNumeroFactura As String, _
      ByVal dtmReclamacionFecha As Date, _
      ByVal dtmReclamacionUltimaModificacion As Date, _
      ByVal strReclamacionModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblReclamacion ")
            Call strSQLStatement.Append(intReclamacionId)
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intReclamacionFolio)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intReclamacionNumeroDocumento)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strReclamacionNumeroFactura)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmReclamacionFecha.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmReclamacionUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strReclamacionModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblReclamacion ")
            Call strSQLStatement.Append(intReclamacionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblReclamacion ")
            Call strSQLStatement.Append(intReclamacionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblReclamacion ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblReclamacion ")
            Call strSQLStatement.Append(intReclamacionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblReclamacion ")
            Call strSQLStatement.Append(intReclamacionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
