...
'====================================================================
' Class         : clstblClienteEspecialTipoFormaCaptura
...
'====================================================================
Public NotInheritable Class clstblClienteEspecialTipoFormaCaptura

    ' Class identifier
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblClienteEspecialTipoFormaCaptura"
    ...
    ' Table name    : tblClienteEspecialTipoFormaCaptura
    ' Parameters    : 
    '              ByVal intTipoFormaCapturaId As Decimal
    '                  - 
    '              ByVal intClienteEspecialId As Decimal
    '                  - 
    '              ByVal dtmClienteEspecialTipoFormaCapturaUltimaModificacion As DateTime
    '                  - 
    '              ByVal strClienteEspecialTipoFormaCapturaModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal dtmClienteEspecialTipoFormaCapturaUltimaModificacion As DateTime, _
      ByVal strClienteEspecialTipoFormaCapturaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spAgregartblClienteEspecialTipoFormaCaptura ")
            Call strSQLStatement.Append(intTipoFormaCapturaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmClienteEspecialTipoFormaCapturaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strClienteEspecialTipoFormaCapturaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spEliminartblClienteEspecialTipoFormaCaptura ")
            Call strSQLStatement.Append(intTipoFormaCapturaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscartblClienteEspecialTipoFormaCaptura ")
            Call strSQLStatement.Append(intTipoFormaCapturaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblClienteEspecialTipoFormaCaptura ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spActualizartblClienteEspecialTipoFormaCaptura ")
            Call strSQLStatement.Append(intTipoFormaCapturaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intClienteEspecialId)
            Call strSQLStatement.Append(",")
