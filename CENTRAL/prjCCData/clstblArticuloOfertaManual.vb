...
'====================================================================
' Class         : clstblArticuloOfertaManual
...
'====================================================================
Public NotInheritable Class clstblArticuloOfertaManual

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblArticuloOfertaManual"
    ...
    '                 - Tabla tblArticuloOfertaManual
    ' Parameters : 
    '              ByVal intCompaniaId As Integer
    '                 - 
    '              ByVal intSucursalId As Integer
    '                 - 
    '              ByVal intOfertaManualId As Integer
    '                 - 
    '              ByVal intArticuloId As Integer
    '                 - 
    '              ByVal fltArticuloOfertaManualPrecioConImpuesto As Double
    '                 - 
    '              ByVal dtmArticuloOfertaManualVigenciaInicio As Date
    '                 - 
    '              ByVal dtmArticuloOfertaManualVigenciaFin As Date
    '                 - 
    '              ByVal intArticuloOfertaManualPrioridad As Integer
    '                 - 
    '              ByVal blnArticuloOfertaManualCancelada As Byte
    '                 - 
    '              ByVal dtmArticuloOfertaManualUltimaModificacion As Date
    '                 - 
    '              ByVal strArticuloOfertaManualModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intOfertaManualId As Integer, _
      ByVal intArticuloId As Integer, _
      ByVal fltArticuloOfertaManualPrecioConImpuesto As Double, _
      ByVal dtmArticuloOfertaManualVigenciaInicio As Date, _
      ByVal dtmArticuloOfertaManualVigenciaFin As Date, _
      ByVal intArticuloOfertaManualPrioridad As Integer, _
      ByVal blnArticuloOfertaManualCancelada As Byte, _
      ByVal dtmArticuloOfertaManualUltimaModificacion As Date, _
      ByVal strArticuloOfertaManualModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblArticuloOfertaManual ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intOfertaManualId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltArticuloOfertaManualPrecioConImpuesto)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloOfertaManualVigenciaInicio.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloOfertaManualVigenciaFin.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloOfertaManualPrioridad)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnArticuloOfertaManualCancelada)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloOfertaManualUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloOfertaManualModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblArticuloOfertaManual ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblArticuloOfertaManual ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblArticuloOfertaManual ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblArticuloOfertaManual ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblArticuloOfertaManual ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
