...
'====================================================================
Public NotInheritable Class clstblPrivilegioAcceso

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblPrivilegioAcceso"
    ...
    '                 - Tabla tblPrivilegioAcceso
    ' Parameters : 
    '              ByVal intGrupoUsuarioId As Integer
    '                 - 
    '              ByVal intObjetoId As Integer
    '                 - 
    '              ByVal strPrivilegioAccesoModificadoPor As String
    '                 - 
    '              ByVal dtmPrivilegioAccesoUltimaModificacion As Date
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strPrivilegioAccesoModificadoPor As String, _
      ByVal dtmPrivilegioAccesoUltimaModificacion As Date, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblPrivilegioAcceso ")
            Call strSQLStatement.Append(intGrupoUsuarioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intObjetoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPrivilegioAccesoModificadoPor)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmPrivilegioAccesoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblPrivilegioAcceso ")
            Call strSQLStatement.Append(intGrupoUsuarioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intObjetoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblPrivilegioAcceso ")
            Call strSQLStatement.Append(intGrupoUsuarioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intObjetoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblPrivilegioAcceso ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblPrivilegioAcceso ")
            Call strSQLStatement.Append(intGrupoUsuarioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intObjetoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblPrivilegioAcceso ")
            Call strSQLStatement.Append(intGrupoUsuarioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intObjetoId)
            Call strSQLStatement.Append(",")
