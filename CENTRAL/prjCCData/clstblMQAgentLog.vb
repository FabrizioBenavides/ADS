...
' Last Modified : Wednesday, August 04, 2004
'====================================================================
Public NotInheritable Class clstblMQAgentLog

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblMQAgentLog"
    ...
    '                 - Tabla tblMQAgentLog
    ' Parameters : 
    '              ByVal intMQAgentLogId As Integer
    '                 - 
    '              ByVal strMQAgentLogQueueName As String
    '                 - 
    '              ByVal strMQAgentLogMessageId As String
    '                 - 
    '              ByVal dtmMQAgentLogLastModified As Date
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intMQAgentLogId As Integer, _
      ByVal strMQAgentLogQueueName As String, _
      ByVal strMQAgentLogMessageId As String, _
      ByVal dtmMQAgentLogLastModified As Date, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblMQAgentLog ")
            Call strSQLStatement.Append(intMQAgentLogId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMQAgentLogQueueName)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMQAgentLogMessageId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmMQAgentLogLastModified.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblMQAgentLog ")
            Call strSQLStatement.Append(intMQAgentLogId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMQAgentLogQueueName)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblMQAgentLog ")
            Call strSQLStatement.Append(intMQAgentLogId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMQAgentLogQueueName)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblMQAgentLog ")
            Call strSQLStatement.Append(intMQAgentLogId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMQAgentLogQueueName)
