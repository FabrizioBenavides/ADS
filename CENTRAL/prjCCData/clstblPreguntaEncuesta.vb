...
Imports Benavides.Data.SQL.MSSQL
  ...
  '====================================================================
  Public NotInheritable Class clstblPreguntaEncuesta
  
    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblPreguntaEncuesta"
    ...
    '                 - Tabla tblPreguntaEncuesta
    ' Parameters : 
    '              ByVal intPreguntaId As Double
    '                 - 
    '              ByVal intEncuestaId As Double
    '                 - 
    '              ByVal blnPreguntaEncuestaActivo As boolean
    '                 - 
    '              ByVal dtmPreguntaEncuestaUltimaModificacion As Date
    '                 - 
    '              ByVal strPreguntaEncuestaModificadoPor As String
    '                 -       
    ...
    Shared Function intActualizar( _
                ...
                ByVal blnPreguntaEncuestaActivo As Boolean, _
                ByVal dtmPreguntaEncuestaUltimaModificacion As Date, _
                ByVal strPreguntaEncuestaModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblPreguntaEncuesta ")
            Call strSQLStatement.Append(intPreguntaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEncuestaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(CByte(blnPreguntaEncuestaActivo))
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmPreguntaEncuestaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strPreguntaEncuestaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblPreguntaEncuesta ")
            Call strSQLStatement.Append(intPreguntaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEncuestaId)
            Call strSQLStatement.Append(",")
    ...
    Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblPreguntaEncuesta ")
            Call strSQLStatement.Append(intPreguntaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEncuestaId)
            Call strSQLStatement.Append(",")
    ...
    Shared Function intEliminar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblPreguntaEncuesta ")
            Call strSQLStatement.Append(intPreguntaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEncuestaId)
            Call strSQLStatement.Append(",")
    ...
    ' Table name    : tblPreguntaEncuesta
    ' Parameters    :
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblPreguntaEncuesta ")
            Call strSQLStatement.Append("'")
