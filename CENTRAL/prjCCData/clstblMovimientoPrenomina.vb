...
'====================================================================
' Class         : clstblMovimientoPrenomina
...
'====================================================================
Public NotInheritable Class clstblMovimientoPrenomina

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblMovimientoPrenomina"
    ...
    '                 - Tabla tblMovimientoPrenomina
    ' Parameters : 
    '              ByVal intMovimientoPrenominaId As Integer
    '                 - 
    ...
    '                 - 
    '              ByVal fltMovimientoPrenominaCantidad As Double
    '                 - 
    '              ByVal dtmMovimientoPrenominaRegistroMovimiento As Date
    '                 - 
    '              ByVal dtmMovimientoPrenominaUltimaModificacion As Date
    '                 - 
    '              ByVal strMovimientoPrenominaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intMovimientoPrenominaId As Integer, _
      ...
      ByVal fltMovimientoPrenominaCantidad As Double, _
      ByVal dtmMovimientoPrenominaRegistroMovimiento As Date, _
      ByVal dtmMovimientoPrenominaUltimaModificacion As Date, _
      ByVal strMovimientoPrenominaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblMovimientoPrenomina ")
            Call strSQLStatement.Append(intMovimientoPrenominaId)
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltMovimientoPrenominaCantidad)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmMovimientoPrenominaRegistroMovimiento.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmMovimientoPrenominaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMovimientoPrenominaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblMovimientoPrenomina ")
            Call strSQLStatement.Append(intMovimientoPrenominaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intConceptoPrenominaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblMovimientoPrenomina ")
            Call strSQLStatement.Append(intMovimientoPrenominaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intConceptoPrenominaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblMovimientoPrenomina ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblMovimientoPrenomina ")
            Call strSQLStatement.Append(intMovimientoPrenominaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intConceptoPrenominaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblMovimientoPrenomina ")
            Call strSQLStatement.Append(intMovimientoPrenominaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intConceptoPrenominaId)
            Call strSQLStatement.Append(",")
