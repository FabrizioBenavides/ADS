...
'====================================================================
' Class         : clstblImportacionDescuentoClienteArticulo
' Title         : AdminCTX
...
'====================================================================
Public NotInheritable Class clstblImportacionDescuentoClienteArticulo

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblImportacionDescuentoClienteArticulo"
    ...
    '                 - Tabla tblImportacionDescuentoClienteArticulo
    ' Parameters : 
    '              ByVal intImportacionDescuentoClienteArticuloId As Integer
    '                 - 
    '              ByVal fltImportacionDescuentoClienteArticuloPorcentaje As Double
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intImportacionDescuentoClienteArticuloId As Integer, _
      ByVal fltImportacionDescuentoClienteArticuloPorcentaje As Double, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblImportacionDescuentoClienteArticulo ")
            Call strSQLStatement.Append(intImportacionDescuentoClienteArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltImportacionDescuentoClienteArticuloPorcentaje)
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblImportacionDescuentoClienteArticulo ")
            Call strSQLStatement.Append(intImportacionDescuentoClienteArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltImportacionDescuentoClienteArticuloPorcentaje)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblImportacionDescuentoClienteArticulo ")
            Call strSQLStatement.Append(intImportacionDescuentoClienteArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltImportacionDescuentoClienteArticuloPorcentaje)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblImportacionDescuentoClienteArticulo ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblImportacionDescuentoClienteArticulo ")
            Call strSQLStatement.Append(intImportacionDescuentoClienteArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltImportacionDescuentoClienteArticuloPorcentaje)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblImportacionDescuentoClienteArticulo ")
            Call strSQLStatement.Append(intImportacionDescuentoClienteArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltImportacionDescuentoClienteArticuloPorcentaje)
