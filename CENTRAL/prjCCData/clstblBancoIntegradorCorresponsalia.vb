...
Public NotInheritable Class clstblBancoIntegradorCorresponsalia

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblBancoIntegradorCorresponsalia"
    ...
    '                 - Tabla tblBancoIntegradorCorresponsalia
    ' Parameters : 
    ...
    '                   c = Campo
    '====================================================================
    Public Shared Function strObtenerBancoIntegrador(ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscartblBancoIntegradorCorresponsalia ")

            ' Ejecutamos el comando
            strObtenerBancoIntegrador = clsSQLOperation.strExecuteQuery(strSQLStatement.ToString(), strConnectionString)
        ...
        Catch objException As Exception
            ...
            strObtenerBancoIntegrador = Nothing
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblBancoIntegradorCorresponsalia ")
