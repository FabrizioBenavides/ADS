...
'====================================================================
' Class         : clstblSolicitudActualizacion
...
'====================================================================
Public NotInheritable Class clstblSolicitudActualizacion

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblSolicitudActualizacion"
    ...
    '                 - Tabla tblSolicitudActualizacion
    ' Parameters : 
    '              ByVal intSolicitudActualizacionId As Double
    '                 - 
    '              ByVal strDescripcionSolicitudActualizacion As String
    '                 - 
    '              ByVal dtmFechaSolicitudActualizacionUltimaModificacion As Date
    '                 - 
    '              ByVal strSolicitudActualizacionModificadoPor As String
    '                 -       
    ...
    Shared Function intActualizar( _
                ByVal intSolicitudActualizacionId As Double, _
                ByVal strDescripcionSolicitudActualizacion As String, _
                ByVal dtmFechaSolicitudActualizacionUltimaModificacion As Date, _
                ByVal strSolicitudActualizacionModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblSolicitudActualizacion ")
            Call strSQLStatement.Append(intSolicitudActualizacionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strDescripcionSolicitudActualizacion)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmFechaSolicitudActualizacionUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strSolicitudActualizacionModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblSolicitudActualizacion ")
            Call strSQLStatement.Append(intSolicitudActualizacionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strDescripcionSolicitudActualizacion)
    ...
    Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblSolicitudActualizacion ")
            Call strSQLStatement.Append(intSolicitudActualizacionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strDescripcionSolicitudActualizacion)
    ...
    Shared Function intContar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblSolicitudActualizacion ")
            Call strSQLStatement.Append(intSolicitudActualizacionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strDescripcionSolicitudActualizacion)
    ...
    Shared Function intEliminar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblSolicitudActualizacion ")
            Call strSQLStatement.Append(intSolicitudActualizacionId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strDescripcionSolicitudActualizacion)
