...
'====================================================================
Public NotInheritable Class clstblGrupoArticulos

    ' Class identifier
    Private Const CLASS_NAME As String = "Benavides.CC.Data.clstblGrupoArticulos"
    ...
    '                  - 
    '              ByVal intGrupoArticulosId As Integer
    '                  - 
    '              ByVal strGrupoArticulosNombreId As String
    '                  - 
    '              ByVal strGrupoArticulosNombre As String
    '                  - 
    '              ByVal dtmGrupoArticulosUltimaModificacion As DateTime
    '                  - 
    '              ByVal strGrupoArticulosModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar(ByVal intDivisionArticulosId As Integer, _
                                      ...
                                      ByVal strGrupoArticulosNombreId As String, _
                                      ByVal strGrupoArticulosNombre As String, _
                                      ByVal dtmGrupoArticulosUltimaModificacion As DateTime, _
                                      ByVal strGrupoArticulosModificadoPor As String, _
        ...
        Try
            ...
            Call sqlStatementToBeExecuted.Append("EXECUTE spAgregartblGrupoArticulos ")
            ...
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intGrupoArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strGrupoArticulosNombreId)
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strGrupoArticulosNombre)
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(dtmGrupoArticulosUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strGrupoArticulosModificadoPor)
            Call sqlStatementToBeExecuted.Append("'")
    ...
    Public Shared Function intEliminar(ByVal intDivisionArticulosId As Integer, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spEliminartblGrupoArticulos ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCategoriaArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    Public Shared Function strBuscar(ByVal intDivisionArticulosId As Integer, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscartblGrupoArticulos ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCategoriaArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    Public Shared Function strBuscar(ByVal dtmStart As DateTime, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscarCambiotblGrupoArticulos ")
            Call sqlStatementToBeExecuted.Append("'")
    ...
    Public Shared Function intActualizar(ByVal intDivisionArticulosId As Integer, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spActualizartblGrupoArticulos ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCategoriaArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
