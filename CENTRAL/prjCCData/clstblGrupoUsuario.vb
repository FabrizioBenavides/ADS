...
'====================================================================
Public NotInheritable Class clstblGrupoUsuario

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblGrupoUsuario"
    ...
    '                 - Tabla tblGrupoUsuario
    ' Parameters : 
    '              ByVal intGrupoUsuarioId As Integer
    '                 - 
    '              ByVal strGrupoUsuarioNombreId As String
    '                 - 
    '              ByVal strGrupoUsuarioNombre As String
    '                 - 
    '              ByVal strGrupoUsuarioDescripcion As String
    '                 - 
    '              ByVal dtmGrupoUsuarioUltimaModificacion As Date
    '                 - 
    '              ByVal strGrupoUsuarioModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strGrupoUsuarioNombreId As String, _
      ByVal strGrupoUsuarioNombre As String, _
      ByVal strGrupoUsuarioDescripcion As String, _
      ByVal blnGrupoUsuarioReplicable As Byte, _
      ByVal blnGrupoUsuarioSistema As Byte, _
      ByVal dtmGrupoUsuarioUltimaModificacion As Date, _
      ByVal strGrupoUsuarioModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblGrupoUsuario ")
            Call strSQLStatement.Append(intGrupoUsuarioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strGrupoUsuarioNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strGrupoUsuarioNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strGrupoUsuarioDescripcion)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnGrupoUsuarioReplicable)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnGrupoUsuarioSistema)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmGrupoUsuarioUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strGrupoUsuarioModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblGrupoUsuario ")
            Call strSQLStatement.Append(intGrupoUsuarioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strGrupoUsuarioNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblGrupoUsuario ")
            Call strSQLStatement.Append(intGrupoUsuarioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strGrupoUsuarioNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblGrupoUsuario ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblGrupoUsuario ")
            Call strSQLStatement.Append(intGrupoUsuarioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strGrupoUsuarioNombreId)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblGrupoUsuario ")
            Call strSQLStatement.Append(intGrupoUsuarioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strGrupoUsuarioNombreId)
