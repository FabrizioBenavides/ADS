...
'====================================================================
' Class         : clstblTipoDatoPoliticaPos
...
'====================================================================
Public NotInheritable Class clstblTipoDatoPoliticaPos

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTipoDatoPoliticaPos"
    ...
    '                 - Tabla tblTipoDatoPoliticaPos
    ' Parameters : 
    '              ByVal intTipoDatoPoliticaPosId As Integer
    '                 - 
    '              ByVal strTipoDatoPoliticaPosNombreId As String
    '                 - 
    '              ByVal strTipoDatoPoliticaPosNombre As String
    '                 - 
    '              ByVal intTipoDatoPoliticaPosLongitud As Integer
    '                 - 
    '              ByVal intTipoDatoPoliticaPosTipo As Integer
    '                 - 
    '              ByVal dtmTipoDatoPoliticaPosUltimaModificacion As Date
    '                 - 
    '              ByVal strTipoDatoPoliticaPosModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strTipoDatoPoliticaPosNombreId As String, _
      ByVal strTipoDatoPoliticaPosNombre As String, _
      ByVal intTipoDatoPoliticaPosLongitud As Integer, _
      ByVal intTipoDatoPoliticaPosTipo As Integer, _
      ByVal dtmTipoDatoPoliticaPosUltimaModificacion As Date, _
      ByVal strTipoDatoPoliticaPosModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblTipoDatoPoliticaPos ")
            Call strSQLStatement.Append(intTipoDatoPoliticaPosId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoPoliticaPosNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoPoliticaPosNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoDatoPoliticaPosLongitud)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoDatoPoliticaPosTipo)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmTipoDatoPoliticaPosUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoPoliticaPosModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblTipoDatoPoliticaPos ")
            Call strSQLStatement.Append(intTipoDatoPoliticaPosId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoPoliticaPosNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblTipoDatoPoliticaPos ")
            Call strSQLStatement.Append(intTipoDatoPoliticaPosId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoPoliticaPosNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblTipoDatoPoliticaPos ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblTipoDatoPoliticaPos ")
            Call strSQLStatement.Append(intTipoDatoPoliticaPosId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoPoliticaPosNombreId)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblTipoDatoPoliticaPos ")
            Call strSQLStatement.Append(intTipoDatoPoliticaPosId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDatoPoliticaPosNombreId)
