...
' Version       : 1.0
' Last Modified : Martes, Junio 01, 2010
'====================================================================

Public Class clstblTipoServicioVirtual

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTipoServicioVirtual"
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarTipoServicioVirtual ")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminarTipoServicioVirtual ")
            Call strSQLStatement.Append(intTipoServicioId)
    ...
    ' Output     : Integer
    '                  - Número de registros afectados por el comando
    ' PPSV : JPMB Add : nnuevo campo para la Validacion de Muestrar en POS 
    ' blnTipoServicioVirtualMuestraenPuntodeVenta
    '====================================================================
    Public Shared Function intGuardar( _
      ByVal intTipoServicioId As Integer, _
      ByVal strTipoServicioVirtualDescripcion As String, _
	  ByVal blnTipoServicioVirtualAplicaDevolucion As Boolean, _
	  ByVal blnTipoServicioVirtualMuestraenPuntodeVenta As Boolean, _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spGuardarTipoServicioVirtual ")
            Call strSQLStatement.Append(intTipoServicioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoServicioVirtualDescripcion)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            If blnTipoServicioVirtualAplicaDevolucion Then
                Call strSQLStatement.Append("1")
            Else
                Call strSQLStatement.Append("0")
            End If
            Call strSQLStatement.Append(",")
            If blnTipoServicioVirtualMuestraenPuntodeVenta Then
                Call strSQLStatement.Append("1")
            Else
                Call strSQLStatement.Append("0")
            End If
