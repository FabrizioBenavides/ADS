...
'====================================================================
' Class         : clstblServicioPublicoAsignadoSucursal
...
'====================================================================
Public NotInheritable Class clstblServicioPublicoAsignadoSucursal

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblServicioPublicoAsignadoSucursal"
    ...
    '                 - Tabla tblServicioPublicoAsignadoSucursal
    ' Parameters : 
    ...
    '                 - 
    '              ByVal dtmServicioPublicoAsignadoSucursalUltimaModificacion As Date
    '                 - 
    '              ByVal strServicioPublicoAsignadoSucursalModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal dtmServicioPublicoAsignadoSucursalUltimaModificacion As Date, _
      ByVal strServicioPublicoAsignadoSucursalModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblServicioPublicoAsignadoSucursal ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmServicioPublicoAsignadoSucursalUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strServicioPublicoAsignadoSucursalModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblServicioPublicoAsignadoSucursal ")
            Call strSQLStatement.Append(intServicioPublicoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblServicioPublicoAsignadoSucursal ")
            Call strSQLStatement.Append(intServicioPublicoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblServicioPublicoAsignadoSucursal ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblServicioPublicoAsignadoSucursal ")
            Call strSQLStatement.Append(intServicioPublicoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblServicioPublicoAsignadoSucursal ")
            Call strSQLStatement.Append(intServicioPublicoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spReenvioCambiotblServicioPublicoAsignadoSucursal  ")
