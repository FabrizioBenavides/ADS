...
'====================================================================
' Class         : clstblFolioTransferenciaRecibida
...
'====================================================================
Public NotInheritable Class clstblFolioTransferenciaRecibida

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblFolioTransferenciaRecibida"
    ...
    '                 - Tabla tblFolioTransferenciaRecibida
    ' Parameters : 
    '              ByVal intCompaniaId As Integer
    '                 - 
    '              ByVal intSucursalId As Integer
    '                 - 
    '              ByVal intFolioTransferenciaRecibidaValorActual As Integer
    '                 - 
    '              ByVal intFolioTransferenciaRecibidaValorMaximo As Integer
    '                 - 
    '              ByVal dtmFolioTransferenciaRecibidaUltimaModificacion As Date
    '                 - 
    '              ByVal strFolioTransferenciaRecibidaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intFolioTransferenciaRecibidaValorActual As Integer, _
      ByVal intFolioTransferenciaRecibidaValorMaximo As Integer, _
      ByVal dtmFolioTransferenciaRecibidaUltimaModificacion As Date, _
      ByVal strFolioTransferenciaRecibidaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblFolioTransferenciaRecibida ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFolioTransferenciaRecibidaValorActual)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFolioTransferenciaRecibidaValorMaximo)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmFolioTransferenciaRecibidaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strFolioTransferenciaRecibidaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblFolioTransferenciaRecibida ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblFolioTransferenciaRecibida ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblFolioTransferenciaRecibida ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblFolioTransferenciaRecibida ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblFolioTransferenciaRecibida ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
