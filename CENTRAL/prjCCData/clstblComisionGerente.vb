...
'====================================================================
Public NotInheritable Class clstblComisionGerente

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblComisionGerente"
    ...
    '                 - 
    '              ByVal fltComisionGerentePorcentaje As Double
    '                 - 
    '              ByVal dtmComisionGerenteUltimaModificacion As Date
    '                 - 
    '              ByVal strComisionGerenteModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal fltComisionGerentePorcentaje As Double, _
      ByVal dtmComisionGerenteUltimaModificacion As Date, _
      ByVal strComisionGerenteModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblComisionGerente ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltComisionGerentePorcentaje)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmComisionGerenteUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strComisionGerenteModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblComisionGerente ")
            Call strSQLStatement.Append(intConceptoPrenominaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intGrupoUsuarioId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblComisionGerente ")
            Call strSQLStatement.Append(intConceptoPrenominaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intGrupoUsuarioId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblComisionGerente ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblComisionGerente ")
            Call strSQLStatement.Append(intConceptoPrenominaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intGrupoUsuarioId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblComisionGerente ")
            Call strSQLStatement.Append(intConceptoPrenominaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intGrupoUsuarioId)
            Call strSQLStatement.Append(",")
