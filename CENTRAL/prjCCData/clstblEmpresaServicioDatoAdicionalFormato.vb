...
'====================================================================
' Class         : clstblEmpresaServicioDatoAdicionalFormato
...
' Version       : 1.0
' Last Modified : Miercoles, 4 de Junio, 2008
'====================================================================

Public NotInheritable Class clstblEmpresaServicioDatoAdicionalFormato

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblEmpresaServicioDatoAdicionalFormato"
    ...
    '                  - Tabla tblEmpresaServicioDatoAdicionalFormato
    ' Parameters : 
    '              ByVal intEmpresaServicioFormatoId As Integer
    '                  - 
    '              ByVal strEmpresaServicioDatoAdicionalFormatoNombre As String
    '                  - 
    '              ByVal strEmpresaServicioDatoAdicionalFormatoValor As String
    '                  - 
    '              ByVal dtmEmpresaServicioDatoAdicionalFormatoUltimaModificacion As Date
    '                  - 
    '              ByVal strEmpresaServicioDatoAdicionalFormatoModificadoPor As String
    '                  -       
    ...
    Shared Function intAgregar( _
                ...
                ByVal strEmpresaServicioDatoAdicionalFormatoNombre As String, _
                ByVal strEmpresaServicioDatoAdicionalFormatoValor As String, _
                ByVal dtmEmpresaServicioDatoAdicionalFormatoUltimaModificacion As Date, _
                ByVal strEmpresaServicioDatoAdicionalFormatoModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spAgregartblEmpresaServicioDatoAdicionalFormato ")
            Call strSQLStatement.Append(intEmpresaServicioFormatoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmpresaServicioDatoAdicionalFormatoNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmpresaServicioDatoAdicionalFormatoValor)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmEmpresaServicioDatoAdicionalFormatoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmpresaServicioDatoAdicionalFormatoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intActualizar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spActualizartblEmpresaServicioDatoAdicionalFormato ")
            Call strSQLStatement.Append(intEmpresaServicioFormatoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEmpresaServicioDatoAdicionalFormatoNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblEmpresaServicioDatoAdicionalFormato ")
    ...
    '                 - Tabla tblEmpresaServicioDatoAdicionalFormato
    ' Parameters : 
    '              ByVal intEmpresaServicioDatoAdicionalFormatoId As Integer
    '                 - 
    '              ByVal intEmpresaServicioFormatoId As Integer
    '                 - 
    '              ByVal strEmpresaServicioDatoAdicionalFormatoNombre As String
    ...
    Shared Function strBuscar( _
            ByVal intEmpresaServicioDatoAdicionalFormatoId As Integer, _
            ByVal intEmpresaServicioFormatoId As Integer, _
            ByVal strEmpresaServicioDatoAdicionalFormatoNombre As String, _
            ByVal strEmpresaServicioDatoAdicionalFormatoValor As String, _
            ByVal dtmEmpresaServicioDatoAdicionalFormatoUltimaModificacion As Date, _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblEmpresaServicioDatoAdicionalFormato ")
            Call strSQLStatement.Append(intEmpresaServicioDatoAdicionalFormatoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEmpresaServicioFormatoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
