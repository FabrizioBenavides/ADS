...
'====================================================================
Public NotInheritable Class clstblEstado

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblEstado"
    ...
    '                 - 
    '              ByVal strEstadoNombre As String
    '                 - 
    '              ByVal dtmEstadoUltimaModificacion As Date
    '                 - 
    '              ByVal strEstadoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strEstadoNombre As String, _
      ByVal dtmEstadoUltimaModificacion As Date, _
      ByVal strEstadoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblEstado ")
            Call strSQLStatement.Append(intEstadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPaisId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEstadoNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmEstadoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEstadoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblEstado ")
            Call strSQLStatement.Append(intEstadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPaisId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblEstado ")
            Call strSQLStatement.Append(intEstadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPaisId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblEstado ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblEstado ")
            Call strSQLStatement.Append(intEstadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPaisId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblEstado ")
            Call strSQLStatement.Append(intEstadoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPaisId)
            Call strSQLStatement.Append(",")
