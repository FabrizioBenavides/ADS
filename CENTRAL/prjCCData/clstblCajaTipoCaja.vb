...
'====================================================================
Public NotInheritable Class clstblCajaTipoCaja

    ' Class identifier
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblCajaTipoCaja"
    ...
    '                  - 
    '              ByVal dtmCajaTipoCajaUltimaModificacion As DateTime
    '                  - 
    '              ByVal strCajaTipoCajaModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal dtmCajaTipoCajaUltimaModificacion As DateTime, _
      ByVal strCajaTipoCajaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spAgregartblCajaTipoCaja ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCajaTipoCajaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCajaTipoCajaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spEliminartblCajaTipoCaja ")
            Call strSQLStatement.Append(intTipoCajaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscartblCajaTipoCaja ")
            Call strSQLStatement.Append(intTipoCajaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblCajaTipoCaja ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spActualizartblCajaTipoCaja ")
            Call strSQLStatement.Append(intTipoCajaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
