...
'====================================================================
' Class         : clstblVentaAgregadaPendiente
' Title         : Benavides
...
'====================================================================
Public NotInheritable Class clstblVentaAgregadaPendiente

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblVentaAgregadaPendiente"
    ...
    '====================================================================
    ' Name       : strBuscarVentaAgregadaPendientes
    ' Description: Búsqueda de registros.
    '                 - Tabla tblVentaAgregadaPendiente
    ' Parameters : 
    '              ByVal intVentaAgregadaPendienteCompaniaId As Integer
    '                 - 
    '              ByVal intVentaAgregadaPendienteSucursalId As Integer
    '                 - 
    '              ByVal dtmVentaAgregadaPendienteFechaCreacion As Date
    '                 - 
    ...
    '                   c = Campo
    '====================================================================
    Public Shared Function strBuscarVentaAgregadaPendientes( _
        ...
        ByVal dtmFechainiT As Date, _
        ByVal dtmFechafinT As Date, _
        ByVal intTrasmitido As String, _
        ...
        ' Constantes locales
        Const strmThisMemberName As String = "strBuscarVentaAgregadaPendientes"
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarTransmisionesVentaAgregadaPendientes ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmFechainiT.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmFechafinT.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTrasmitido)
            Call strSQLStatement.Append(",")
            ...
            strBuscarVentaAgregadaPendientes = clsSQLOperation.strExecuteQuery(strSQLStatement.ToString(), strConnectionString)
        ...
        Catch objException As Exception
            ...
            strBuscarVentaAgregadaPendientes = Nothing
    ...
    Public Shared Function strBuscar( _
      ByVal intVentaAgregadaPendienteCompaniaId As Integer, _
      ByVal intVentaAgregadaPendienteSucursalId As Integer, _
      ByVal dtmVentaAgregadaPendienteFechaCreacion As Date, _
      ByVal intPosicionInicial As Double, _
      ByVal intElementos As Double, _
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscartblVentaAgregadaPendiente ")
            Call strSQLStatement.Append(intVentaAgregadaPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaAgregadaPendienteSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmVentaAgregadaPendienteFechaCreacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPosicionInicial)
            Call strSQLStatement.Append(",")
    ...
    '====================================================================
    ' Name       : intAgregarTblVentaAgregadaDet
    ' Description: Adición de registros.
    '                  - Tabla tblVentaDiaria
    ' Parameters : 
    'ByVal IntVentaAgregadaId
    'ByVal intVentaAgregadaCompaniaId
    'ByVal intVentaAgregadaSucursalId
    'ByVal dtmFechaMov
    'ByVal intVentaAgregadaArticuloId
    'ByVal IntInterlocutorEdi
    'ByVal strFechaDocum
    'ByVal strRefExterno
    'ByVal strMonedaVenta
    'ByVal strCamposgte
    'ByVal strNumMaterial
    'ByVal strPromocion
    'ByVal strSgn1
    'ByVal strCantidad
    'ByVal strSgn2
    'ByVal strVolumenNegocio
    'ByVal strSgnCondicion
    'ByVal strClaseCondicion
    'ByVal strValorCondicion
    'ByVal strIdCondicion
    'ByVal strCampoCondid
    'ByVal strBonusBay
    'ByVal strIndicadorImpuesto
    ''ByVal strValorimpuesto
    'ByVal strNomCampo
    'ByVal strValCampo
    '                  - Cadena de conexión hacia el RDBMS
    ' Throws     : Exception
    ...
    '====================================================================
    Public Shared Function intAgregarVentaAgregadaDetCTX( _
 ...
 ByVal dtmFechaMov As DateTime, _
 ByVal intVentaAgregadaArticuloId As Integer, _
 ByVal IntInterlocutorEdi As String, _
 ...
 ByVal strValCampo As String) As Integer

        ' Constantes locales
        Const strmThisMemberName As String = "intAgregarVentaAgregadaDetCTX"
        ...
        Dim strConnectionString As String = "LOCALHOST"
        ...
        Try
            ...
            ' Regresamos la información
            strSQLStatement = Nothing
            intAgregarVentaAgregadaDetCTX = intRowsAffected
        ...
        Catch objException As Exception
            ...
            ' Regresamos la información
            intAgregarVentaAgregadaDetCTX = 0
    ...
    '====================================================================
    ' Name       : intAgregarVentaAgregadaCTX
    ' Description: Adición de registros.
    '                  - Tabla tblVentaDiaria
    ' Parameters : 
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal bolTrasmitio As Integer) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmFechaTrasmision.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmFechaContable.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(bolTrasmitio)
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblVentaAgregadaPendiente ")
            Call strSQLStatement.Append(intVentaAgregadaPendienteCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intVentaAgregadaPendienteSucursalId)
            Call strSQLStatement.Append(",")
