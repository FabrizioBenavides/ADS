Public NotInheritable Class clsOperacionDEX
    '====================================================================
    ' Class         : clsOperacionDEX
    ...
    ' Parameters    :   
    '              ByVal intTipoOperacionDEXId As Integer
    ...
    Public Shared Function aobjBuscarSucursales( _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarSucursalesConOperacionesDEX ")
    ...
    '====================================================================
    ' Name          : aobjBuscarOperacionesDeSucursal
    ' Description   : Regresa las sucursales con Operaciones de Dinero Express
    ' Parameters    :   
    '              ByVal intTipoOperacionDEXId As Integer
    '                  - Identificador de la operación
    ...
    ' Output        : Array
    '====================================================================
    Public Shared Function aobjBuscarOperacionesDeSucursal( _
          ByVal intTipoOperacionDEXId As Integer, _
          ByVal intFechaId As Integer, _
        ...
        ' Member identifier
        Const strmThisMemberName As String = "aobjBuscarOperacionesDeSucursal"
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarOperacionesDEXDeSucursal ")
            Call strSQLStatement.Append(intTipoOperacionDEXId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFechaId)
            Call strSQLStatement.Append(",")
    ...
    '====================================================================
    ' Name          : aobjBuscarDetalleSucursal(
    ' Description   : Regresa el nombre de sucursal, el nombre de la zona operativa y el nombre de la direccion operativa
    ' Parameters    :   
    ...
    ' Output        : Array
    '====================================================================
    Public Shared Function aobjBuscarDetalleSucursal( _
          ByVal intCompaniaId As Integer, _
          ByVal intSucursalId As Integer, _
          ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarDetalleSucursal ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
