...
'====================================================================
Public NotInheritable Class clstblMovimientoBonos

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblMovimientoBonos"
    ...
    '                 - Tabla tblMovimientoBonos
    ' Parameters : 
    '              ByVal intMovimientoBonosId As Double
    '                 - 
    '              ByVal intCompaniaId As Double
    '                 - 
    '              ByVal intSucursalId As Double
    '                 - 
    '              ByVal intMovimientoBonosTipo As Double
    '                 - 
    '              ByVal dtmMovimientoBonosFechaRegistro As Date
    '                 - 
    '              ByVal strMovimientoBonosNumero As String
    '                 - 
    '              ByVal intMovimientoBonosCantidad As Double
    '                 - 
    '              ByVal fltMovimientoBonosImporte As Double
    '                 - 
    '              ByVal dtmMovimientoBonosUltimaModificacion As Date
    '                 - 
    '              ByVal strMovimientoBonosModificadoPor As String
    '                 -       
    ...
    Shared Function intActualizar( _
                ByVal intMovimientoBonosId As Double, _
                ByVal intCompaniaId As Double, _
                ByVal intSucursalId As Double, _
                ByVal intMovimientoBonosTipo As Double, _
                ByVal dtmMovimientoBonosFechaRegistro As Date, _
                ByVal strMovimientoBonosNumero As String, _
                ByVal intMovimientoBonosCantidad As Double, _
                ByVal fltMovimientoBonosImporte As Double, _
                ByVal dtmMovimientoBonosUltimaModificacion As Date, _
                ByVal strMovimientoBonosModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblMovimientoBonos ")
            Call strSQLStatement.Append(intMovimientoBonosId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intMovimientoBonosTipo)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmMovimientoBonosFechaRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMovimientoBonosNumero)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intMovimientoBonosCantidad)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltMovimientoBonosImporte)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmMovimientoBonosUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strMovimientoBonosModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblMovimientoBonos ")
            Call strSQLStatement.Append(intMovimientoBonosId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblMovimientoBonos ")
            Call strSQLStatement.Append(intMovimientoBonosId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Shared Function intContar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblMovimientoBonos ")
            Call strSQLStatement.Append(intMovimientoBonosId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Shared Function intEliminar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblMovimientoBonos ")
            Call strSQLStatement.Append(intMovimientoBonosId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
