...
'====================================================================
' Class         : clstblRecetasCreditoPendientes
' Title         : Benavides
...
'====================================================================
Public NotInheritable Class clstblRecetasCreditoPendientes

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblRecetasCreditoPendientes"
    ...
    '                 - Tabla tblRecetasCreditoPendientes
    ' Parameters : 
    '              ByVal intRecetasCreditoPendientesCompaniaId As Integer
    '                 - 
    '              ByVal intRecetasCreditoPendientesSucursalId As Integer
    '                 - 
    '              ByVal dtmRecetasCreditoPendientesFechaRegistro As Date
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intRecetasCreditoPendientesCompaniaId As Integer, _
      ByVal intRecetasCreditoPendientesSucursalId As Integer, _
      ByVal dtmRecetasCreditoPendientesFechaRegistro As Date, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblRecetasCreditoPendientes ")
            Call strSQLStatement.Append(intRecetasCreditoPendientesCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intRecetasCreditoPendientesSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmRecetasCreditoPendientesFechaRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblRecetasCreditoPendientes ")
            Call strSQLStatement.Append(intRecetasCreditoPendientesCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intRecetasCreditoPendientesSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblRecetasCreditoPendientes ")
            Call strSQLStatement.Append(intRecetasCreditoPendientesCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intRecetasCreditoPendientesSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblRecetasCreditoPendientes ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblRecetasCreditoPendientes ")
            Call strSQLStatement.Append(intRecetasCreditoPendientesCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intRecetasCreditoPendientesSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblRecetasCreditoPendientes ")
            Call strSQLStatement.Append(intRecetasCreditoPendientesCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intRecetasCreditoPendientesSucursalId)
            Call strSQLStatement.Append(",")
