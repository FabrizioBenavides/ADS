...
Imports Benavides.Data.SQL.MSSQL
  ...
  '====================================================================
  Public NotInheritable Class clstblRespuestaPregunta
  
    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblRespuestaPregunta"
    ...
    '                 - Tabla tblRespuestaPregunta
    ' Parameters : 
    '              ByVal intRespuestaId As Double
    '                 - 
    '              ByVal intPreguntaId As Double
    '                 - 
    '              ByVal blnRespuestaPreguntaActivo As boolean
    '                 - 
    '              ByVal dtmRespuestaPreguntaUltimaModificacion As Date
    '                 - 
    '              ByVal strRespuestaPreguntaModificadoPor As String
    '                 -       
    ...
    Shared Function intActualizar( _
                ...
                ByVal blnRespuestaPreguntaActivo As Boolean, _
                ByVal dtmRespuestaPreguntaUltimaModificacion As Date, _
                ByVal strRespuestaPreguntaModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblRespuestaPregunta ")
            Call strSQLStatement.Append(intRespuestaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPreguntaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(CByte(blnRespuestaPreguntaActivo))
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmRespuestaPreguntaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strRespuestaPreguntaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblRespuestaPregunta ")
            Call strSQLStatement.Append(intRespuestaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPreguntaId)
            Call strSQLStatement.Append(",")
    ...
    Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblRespuestaPregunta ")
            Call strSQLStatement.Append(intRespuestaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPreguntaId)
            Call strSQLStatement.Append(",")
    ...
    Shared Function intEliminar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblRespuestaPregunta ")
            Call strSQLStatement.Append(intRespuestaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intPreguntaId)
            Call strSQLStatement.Append(",")
    ...
    ' Table name    : tblRespuestaPregunta
    ' Parameters    :
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblRespuestaPregunta ")
            Call strSQLStatement.Append("'")
