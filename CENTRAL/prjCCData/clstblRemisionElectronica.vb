...
'====================================================================
' Class         : clstblRemisionElectronica
...
'====================================================================
Public NotInheritable Class clstblRemisionElectronica

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblRemisionElectronica"
    ...
    '                 - Tabla tblRemisionElectronica
    ' Parameters : 
    '              ByVal intRemisionElectronicaId As Integer
    '                 - 
    ...
    '                 - 
    '              ByVal strRemisionElectronicaNumero As String
    '                 - 
    '              ByVal dtmRemisionElectronicaEmisionDocumento As Date
    '                 - 
    '              ByVal fltRemisionElectronicaImporteNeto As Double
    '                 - 
    '              ByVal fltRemisionElectronicaImporteIVA As Double
    '                 - 
    '              ByVal fltRemisionElectronicaImporteTotal As Double
    '                 - 
    '              ByVal fltRemisionElectronicaImporteDescuentoDespuesIVA As Double
    '                 - 
    '              ByVal fltRemisionElectronicaImporteIVADescuento As Double
    '                 - 
    '              ByVal dtmRemisionElectronicaUltimaModificacion As Date
    '                 - 
    '              ByVal strRemisionElectronicaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intRemisionElectronicaId As Integer, _
      ByVal intCompaniaId As Integer, _
      ByVal intSucursalId As Integer, _
      ByVal intProveedorId As Integer, _
      ByVal strRemisionElectronicaNumero As String, _
      ByVal dtmRemisionElectronicaEmisionDocumento As Date, _
      ByVal fltRemisionElectronicaImporteNeto As Double, _
      ByVal fltRemisionElectronicaImporteIVA As Double, _
      ByVal fltRemisionElectronicaImporteTotal As Double, _
      ByVal fltRemisionElectronicaImporteDescuentoDespuesIVA As Double, _
      ByVal fltRemisionElectronicaImporteIVADescuento As Double, _
      ByVal dtmRemisionElectronicaUltimaModificacion As Date, _
      ByVal strRemisionElectronicaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblRemisionElectronica ")
            Call strSQLStatement.Append(intRemisionElectronicaId)
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strRemisionElectronicaNumero)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmRemisionElectronicaEmisionDocumento.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltRemisionElectronicaImporteNeto)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltRemisionElectronicaImporteIVA)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltRemisionElectronicaImporteTotal)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltRemisionElectronicaImporteDescuentoDespuesIVA)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltRemisionElectronicaImporteIVADescuento)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmRemisionElectronicaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strRemisionElectronicaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblRemisionElectronica ")
            Call strSQLStatement.Append(intRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblRemisionElectronica ")
            Call strSQLStatement.Append(intRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblRemisionElectronica ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblRemisionElectronica ")
            Call strSQLStatement.Append(intRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblRemisionElectronica ")
            Call strSQLStatement.Append(intRemisionElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
