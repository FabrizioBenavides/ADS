...
'====================================================================
' Class         : clstblEstadoTransferencia
...
'====================================================================
Public NotInheritable Class clstblEstadoTransferencia

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblEstadoTransferencia"
    ...
    '                 - Tabla tblEstadoTransferencia
    ' Parameters : 
    '              ByVal intTransferenciaId As Integer
    '                 - 
    '              ByVal intTipoEstadoTransferenciaId As Integer
    '                 - 
    '              ByVal intEstadoTransferenciaFolio As Integer
    '                 - 
    '              ByVal dtmEstadoTransferenciaRegistro As Date
    '                 - 
    '              ByVal strEstadoTransferenciaComentarios As String
    '                 - 
    '              ByVal dtmEstadoTransferenciaUltimaModificacion As Date
    '                 - 
    '              ByVal strEstadoTransferenciaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intEstadoTransferenciaFolio As Integer, _
      ByVal dtmEstadoTransferenciaRegistro As Date, _
      ByVal strEstadoTransferenciaComentarios As String, _
      ByVal intEmpleadoId As Integer, _
      ByVal intRemisionElectronicaId As Integer, _
      ByVal dtmEstadoTransferenciaUltimaModificacion As Date, _
      ByVal strEstadoTransferenciaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblEstadoTransferencia ")
            Call strSQLStatement.Append(intTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEstadoTransferenciaFolio)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmEstadoTransferenciaRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEstadoTransferenciaComentarios)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            ...
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmEstadoTransferenciaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEstadoTransferenciaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblEstadoTransferencia ")
            Call strSQLStatement.Append(intTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoTransferenciaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblEstadoTransferencia ")
            Call strSQLStatement.Append(intTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoTransferenciaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblEstadoTransferencia ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblEstadoTransferencia ")
            Call strSQLStatement.Append(intTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoTransferenciaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblEstadoTransferencia ")
            Call strSQLStatement.Append(intTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoTransferenciaId)
            Call strSQLStatement.Append(",")
