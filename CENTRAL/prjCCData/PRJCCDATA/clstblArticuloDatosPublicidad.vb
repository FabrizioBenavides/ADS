...
Imports Benavides.Data.SQL.MSSQL
  ...
  '====================================================================
  ' Class         : clstblArticuloDatosPublicidad
  ...
  '====================================================================
  Public NotInheritable Class clstblArticuloDatosPublicidad
  
    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblArticuloDatosPublicidad"
    ...
    '                 - Tabla tblArticuloDatosPublicidad
    ' Parameters : 
    '              ByVal intArticuloId As Double
    '                 - 
    '              ByVal strArticuloDatosPublicidad As String
    '                 - 
    '              ByVal dtmArticuloDatosPublicidadUltimaModificacion As Date
    '                 - 
    '              ByVal strArticuloDatosPublicidadModificadoPor As String
    '                 -       
    ...
    Shared Function intActualizar( _
        ...
        ByVal strArticuloDatosPublicidad As String, _
        ByVal dtmArticuloDatosPublicidadUltimaModificacion As Date, _
        ByVal strArticuloDatosPublicidadModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblArticuloDatosPublicidad ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloDatosPublicidad)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloDatosPublicidadUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloDatosPublicidadModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblArticuloDatosPublicidad ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloDatosPublicidad)
    ...
    Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblArticuloDatosPublicidad ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloDatosPublicidad)
    ...
    Shared Function intEliminar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblArticuloDatosPublicidad ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloDatosPublicidad)
    ...
    ' Table name    : tblArticuloDatosPublicidad
    ' Parameters    :
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblArticuloDatosPublicidad ")
