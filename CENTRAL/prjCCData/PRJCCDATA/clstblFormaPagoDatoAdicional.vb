...
'====================================================================
' Class         : clstblFormaPagoDatoAdicional
...
'====================================================================
Public NotInheritable Class clstblFormaPagoDatoAdicional

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblFormaPagoDatoAdicional"
    ...
    '                 - Tabla tblFormaPagoDatoAdicional
    ' Parameters : 
    '              ByVal intFormaPagoId As Integer
    '                 - 
    '              ByVal intTipoDatoAdicionalPagoTicketId As Integer
    '                 - 
    '              ByVal dtmFormaPagoDatoAdicionalUltimaModificacion As Date
    '                 - 
    '              ByVal strFormaPagoDatoAdicionalModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal dtmFormaPagoDatoAdicionalUltimaModificacion As Date, _
      ByVal strFormaPagoDatoAdicionalModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblFormaPagoDatoAdicional ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoDatoAdicionalPagoTicketId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmFormaPagoDatoAdicionalUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strFormaPagoDatoAdicionalModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblFormaPagoDatoAdicional ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoDatoAdicionalPagoTicketId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblFormaPagoDatoAdicional ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoDatoAdicionalPagoTicketId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblFormaPagoDatoAdicional ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblFormaPagoDatoAdicional ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoDatoAdicionalPagoTicketId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblFormaPagoDatoAdicional ")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoDatoAdicionalPagoTicketId)
            Call strSQLStatement.Append(",")
