...
'====================================================================
' Class         : clstblArticuloOfertaPromocion
...
'====================================================================
Public NotInheritable Class clstblArticuloOfertaPromocion

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblArticuloOfertaPromocion"
    ...
    '                 - Tabla tblArticuloOfertaPromocion
    ' Parameters : 
    '              ByVal intOfertaId As Integer
    '                 - 
    ...
    '                 - 
    '              ByVal fltArticuloOfertaPrecioConImpuesto As Double
    '                 - 
    '              ByVal dtmArticuloOfertaVigenciaInicio As Date
    '                 - 
    '              ByVal dtmArticuloOfertaVigenciaFin As Date
    '                 - 
    '              ByVal intArticuloOfertaPrioridad As Integer
    '                 - 
    '              ByVal blnArticuloOfertaCancelada As Byte
    '                 - 
    '              ByVal dtmArticuloOfertaUltimaModificacion As Date
    '                 - 
    '              ByVal strArticuloOfertaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intOfertaId As Integer, _
      ByVal intArticuloId As Integer, _
      ByVal intCompaniaId As Integer, _
      ByVal intSucursalId As Integer, _
      ByVal fltArticuloOfertaPrecioConImpuesto As Double, _
      ByVal dtmArticuloOfertaVigenciaInicio As Date, _
      ByVal dtmArticuloOfertaVigenciaFin As Date, _
      ByVal intArticuloOfertaPrioridad As Integer, _
      ByVal blnArticuloOfertaCancelada As Byte, _
      ByVal dtmArticuloOfertaUltimaModificacion As Date, _
      ByVal strArticuloOfertaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblArticuloOfertaPromocion ")
            Call strSQLStatement.Append(intOfertaId)
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltArticuloOfertaPrecioConImpuesto)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloOfertaVigenciaInicio.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloOfertaVigenciaFin.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloOfertaPrioridad)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnArticuloOfertaCancelada)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloOfertaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloOfertaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblArticuloOfertaPromocion ")
            Call strSQLStatement.Append(intOfertaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblArticuloOfertaPromocion ")
            Call strSQLStatement.Append(intOfertaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblArticuloOfertaPromocion ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spReenvioCambiotblArticuloOfertaPromocion ")
    ...
    Public Shared Function strBuscarCambios( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL         
            Call strSQLStatement.Append("EXECUTE spBuscartblArticuloOfertaPromocionCambios ")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblArticuloOfertaPromocion ")
            Call strSQLStatement.Append(intOfertaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblArticuloOfertaPromocion ")
            Call strSQLStatement.Append(intOfertaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
