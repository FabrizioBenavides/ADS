...
'====================================================================
' Class         : clstblIntegradorServicioVirtual
...
' Version       : 1.0
' Last Modified : Viernes, 22 de Junio de 2012
'====================================================================
Public NotInheritable Class clstblIntegradorServicioVirtual

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblIntegradorServicioVirtual"
    ...
    '                 - Tabla tblIntegradorServicioVirtual
    ' Parameters : 
    '              ByVal intIntegradorServicioVirtualId As Double
    '                 - 
    '              ByVal strIntegradorServicioVirtualNombre As String
    '                 - 
    '              ByVal strIntegradorServicioVirtualDescripcion As String
    '                 - 
    '              ByVal dtmIntegradorServicioVirtualUltimaModificacion As Date
    '                 - 
    '              ByVal strIntegradorServicioVirtualModificadoPor As String
    '                 -       
    ...
    Public Shared Function intActualizar( _
                ByVal intIntegradorServicioVirtualId As Double, _
                ByVal strIntegradorServicioVirtualNombre As String, _
                ByVal strIntegradorServicioVirtualDescripcion As String, _
                ByVal dtmIntegradorServicioVirtualUltimaModificacion As Date, _
                ByVal strIntegradorServicioVirtualModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblIntegradorServicioVirtual ")
            Call strSQLStatement.Append(intIntegradorServicioVirtualId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strIntegradorServicioVirtualNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strIntegradorServicioVirtualDescripcion)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmIntegradorServicioVirtualUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strIntegradorServicioVirtualModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
            ...
            ByVal strIntegradorServicioVirtualNombre As String, _
            ByVal strIntegradorServicioVirtualDescripcion As String, _
            ByVal dtmCategoriaArticuloUltimaModificacion As Date, _
            ByVal strIntegradorServicioVirtualModificadoPor As String, _
            ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblIntegradorServicioVirtual ")
            Call strSQLStatement.Append(intIntegradorServicioVirtualId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strIntegradorServicioVirtualNombre)
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCategoriaArticuloUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strIntegradorServicioVirtualModificadoPor)
    ...
    Public Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblIntegradorServicioVirtual ")
            Call strSQLStatement.Append(intIntegradorServicioVirtualId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strIntegradorServicioVirtualNombre)
    ...
    Public Shared Function intContar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblIntegradorServicioVirtual ")
            Call strSQLStatement.Append(intIntegradorServicioVirtualId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strIntegradorServicioVirtualNombre)
    ...
    Public Shared Function intEliminar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblIntegradorServicioVirtual ")
            Call strSQLStatement.Append(intIntegradorServicioVirtualId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strIntegradorServicioVirtualNombre)
