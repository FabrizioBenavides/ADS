...
'====================================================================
' Class         : clstblEstadoFacturaElectronica
...
'====================================================================
Public NotInheritable Class clstblEstadoFacturaElectronica

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblEstadoFacturaElectronica"
    ...
    '                 - Tabla tblEstadoFacturaElectronica
    ' Parameters : 
    '              ByVal intFacturaElectronicaId As Integer
    '                 - 
    '              ByVal intTipoEstadoFacturaElectronicaId As Integer
    '                 - 
    '              ByVal intEstadoFacturaElectronicaFolio As Integer
    '                 - 
    '              ByVal dtmEstadoFacturaElectronicaRegistro As Date
    '                 - 
    '              ByVal dtmEstadoFacturaElectronicaUltimaModificacion As Date
    '                 - 
    '              ByVal strEstadoFacturaElectronicaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intTipoEstadoFacturaElectronicaId As Integer, _
      ByVal intEstadoFacturaElectronicaFolio As Integer, _
      ByVal dtmEstadoFacturaElectronicaRegistro As Date, _
      ByVal dtmEstadoFacturaElectronicaUltimaModificacion As Date, _
      ByVal strEstadoFacturaElectronicaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblEstadoFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEstadoFacturaElectronicaFolio)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmEstadoFacturaElectronicaRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmEstadoFacturaElectronicaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEstadoFacturaElectronicaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblEstadoFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblEstadoFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblEstadoFacturaElectronica ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblEstadoFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblEstadoFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
