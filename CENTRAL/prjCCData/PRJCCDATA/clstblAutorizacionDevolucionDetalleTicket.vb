...
'====================================================================
' Class         : clstblAutorizacionDevolucionDetalleTicket
...
'====================================================================
Public NotInheritable Class clstblAutorizacionDevolucionDetalleTicket

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblAutorizacionDevolucionDetalleTicket"
    ...
    '                 - Tabla tblAutorizacionDevolucionDetalleTicket
    ' Parameters : 
    '              ByVal intEmpleadoCajeroId As Integer
    '                 - 
    ...
    '                 - 
    '              ByVal intEmpleadoAutorizaId As Integer
    '                 - 
    ...
    '                 - 
    '              ByVal blnAutorizacionDevolucionEsDevolucion As Byte
    '                 - 
    '              ByVal dtmAutorizacionDevolucionDetalleTicketUltimaModificacion As Date
    '                 - 
    '              ByVal strAutorizacionDevolucionDetalleTicketModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intEmpleadoCajeroId As Integer, _
      ...
      ByVal intEmpleadoAutorizaId As Integer, _
      ...
      ByVal blnAutorizacionDevolucionEsDevolucion As Byte, _
      ByVal dtmAutorizacionDevolucionDetalleTicketUltimaModificacion As Date, _
      ByVal strAutorizacionDevolucionDetalleTicketModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblAutorizacionDevolucionDetalleTicket ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEmpleadoAutorizaId)
            Call strSQLStatement.Append(",")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnAutorizacionDevolucionEsDevolucion)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmAutorizacionDevolucionDetalleTicketUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strAutorizacionDevolucionDetalleTicketModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblAutorizacionDevolucionDetalleTicket ")
            Call strSQLStatement.Append(intEmpleadoCajeroId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblAutorizacionDevolucionDetalleTicket ")
            Call strSQLStatement.Append(intEmpleadoCajeroId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblAutorizacionDevolucionDetalleTicket ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblAutorizacionDevolucionDetalleTicket ")
            Call strSQLStatement.Append(intEmpleadoCajeroId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblAutorizacionDevolucionDetalleTicket ")
            Call strSQLStatement.Append(intEmpleadoCajeroId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
