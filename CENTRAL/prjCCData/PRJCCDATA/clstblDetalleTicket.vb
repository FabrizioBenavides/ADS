...
'====================================================================
Public NotInheritable Class clstblDetalleTicket

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblDetalleTicket"
    ...
    '                 - 
    '              ByVal intDetalleTicketCantidadArticulos As Integer
    '                 - 
    '              ByVal fltDetalleTicketPrecioNormalConImpuesto As Double
    '                 - 
    '              ByVal fltDetalleTicketPrecioVentaConImpuesto As Double
    '                 - 
    '              ByVal fltDetalleTicketImporteDelDescuentoConImpuesto As Double
    '                 - 
    '              ByVal fltDetalleTicketImporteVentaConImpuesto As Double
    '                 - 
    '              ByVal fltDetalleTicketImporteNormalConImpuesto As Double
    '                 - 
    '              ByVal blnDetalleTicketArticuloVendidoConCodigo As Byte
    '                 - 
    '              ByVal blnDetalleTicketCancelado As Byte
    '                 - 
    '              ByVal blnDetalleTicketExcentoImpuesto As Byte
    '                 - 
    '              ByVal dtmDetalleTicketUltimaModificacion As Date
    '                 - 
    '              ByVal strDetalleTicketModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intDetalleTicketCantidadArticulos As Integer, _
      ByVal fltDetalleTicketPrecioNormalConImpuesto As Double, _
      ByVal fltDetalleTicketPrecioVentaConImpuesto As Double, _
      ByVal fltDetalleTicketImporteDelDescuentoConImpuesto As Double, _
      ByVal fltDetalleTicketImporteVentaConImpuesto As Double, _
      ByVal fltDetalleTicketImporteNormalConImpuesto As Double, _
      ByVal blnDetalleTicketArticuloVendidoConCodigo As Byte, _
      ByVal blnDetalleTicketCancelado As Byte, _
      ByVal blnDetalleTicketExcentoImpuesto As Byte, _
      ByVal dtmDetalleTicketUltimaModificacion As Date, _
      ByVal strDetalleTicketModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblDetalleTicket ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDetalleTicketCantidadArticulos)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltDetalleTicketPrecioNormalConImpuesto)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltDetalleTicketPrecioVentaConImpuesto)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltDetalleTicketImporteDelDescuentoConImpuesto)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltDetalleTicketImporteVentaConImpuesto)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltDetalleTicketImporteNormalConImpuesto)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnDetalleTicketArticuloVendidoConCodigo)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnDetalleTicketCancelado)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnDetalleTicketExcentoImpuesto)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmDetalleTicketUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strDetalleTicketModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblDetalleTicket ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblDetalleTicket ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblDetalleTicket ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblDetalleTicket ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblDetalleTicket ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
