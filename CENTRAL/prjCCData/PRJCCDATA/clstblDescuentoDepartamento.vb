...
'====================================================================
' Class         : clstblDescuentoDepartamento
...
'====================================================================
Public NotInheritable Class clstblDescuentoDepartamento

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblDescuentoDepartamento"
    ...
    '                 - Tabla tblDescuentoDepartamento
    ' Parameters : 
    '              ByVal intDepartamentoId As Integer
    '                 - 
    '              ByVal intTipoDescuentoDepartamentoId As Integer
    '                 - 
    '              ByVal fltDescuentoDepartamentoPorcentaje As Double
    '                 - 
    '              ByVal blnDescuentoDepartamentoTotal As Byte
    '                 - 
    '              ByVal dtmDescuentoDepartamentoUltimaModificacion As Date
    '                 - 
    '              ByVal strDescuentoDepartamentoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal fltDescuentoDepartamentoPorcentaje As Double, _
      ByVal blnDescuentoDepartamentoTotal As Byte, _
      ByVal dtmDescuentoDepartamentoUltimaModificacion As Date, _
      ByVal strDescuentoDepartamentoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblDescuentoDepartamento ")
            Call strSQLStatement.Append(intDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoDescuentoDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltDescuentoDepartamentoPorcentaje)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnDescuentoDepartamentoTotal)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmDescuentoDepartamentoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strDescuentoDepartamentoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblDescuentoDepartamento ")
            Call strSQLStatement.Append(intDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoDescuentoDepartamentoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblDescuentoDepartamento ")
            Call strSQLStatement.Append(intDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoDescuentoDepartamentoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblDescuentoDepartamento ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblDescuentoDepartamento ")
            Call strSQLStatement.Append(intDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoDescuentoDepartamentoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblDescuentoDepartamento ")
            Call strSQLStatement.Append(intDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoDescuentoDepartamentoId)
            Call strSQLStatement.Append(",")
