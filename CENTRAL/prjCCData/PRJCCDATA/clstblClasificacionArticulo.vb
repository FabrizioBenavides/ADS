...
'====================================================================
' Class         : clstblClasificacionArticulo
...
'====================================================================
Public NotInheritable Class clstblClasificacionArticulo

    ' Class identifier
    Private Const CLASS_NAME As String = "Benavides.CC.Data.clstblClasificacionArticulo"
    ...
    ' Table name    : tblClasificacionArticulo
    ' Parameters    : 
    ...
    '                  - 
    '              ByVal dtmClasificacionArticuloUltimaModificacion As DateTime
    '                  - 
    '              ByVal strClasificacionArticuloModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar(ByVal intDivisionArticulosId As Integer, _
                                      ...
                                      ByVal dtmClasificacionArticuloUltimaModificacion As DateTime, _
                                      ByVal strClasificacionArticuloModificadoPor As String, _
        ...
        Try
            ...
            Call sqlStatementToBeExecuted.Append("EXECUTE spAgregartblClasificacionArticulo ")
            ...
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(dtmClasificacionArticuloUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strClasificacionArticuloModificadoPor)
            Call sqlStatementToBeExecuted.Append("'")
    ...
    Public Shared Function intEliminar(ByVal intDivisionArticulosId As Integer, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spEliminartblClasificacionArticulo ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCategoriaArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    Public Shared Function strBuscar(ByVal intDivisionArticulosId As Integer, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscartblClasificacionArticulo ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCategoriaArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    Public Shared Function strBuscar(ByVal dtmStart As DateTime, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscarCambiotblClasificacionArticulo ")
            Call sqlStatementToBeExecuted.Append("'")
    ...
    Public Shared Function intActualizar(ByVal intDivisionArticulosId As Integer, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spActualizartblClasificacionArticulo ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCategoriaArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
