...
'====================================================================
' Class         : clstblComisionEmpleadoPuntaje
' Title         : Grupo Benavides. Administrador POS y Backoffice.
' Description   : Store Procedure Mantenimiento Datos
' Copyright     : 2008 Todos los Derechos Reservados.
' Company       : Benavides
' Author        : Javier Augusto Pérez González, Softtek
' Version       : 1.0
' Last Modified : Lunes, 01 de Diciembre, 2008
'====================================================================
Public NotInheritable Class clstblComisionEmpleadoPuntaje

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblComisionEmpleadoPuntaje"
    ...
    '                 - Tabla tblComisiónEmpleadoPuntaje
    ' Parameters :
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblComisionEmpleadoPuntaje ")
