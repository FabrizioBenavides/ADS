...
'====================================================================
' Class         : clstblImporteEmisorFormaPagoCorteCaja
...
'====================================================================
Public NotInheritable Class clstblImporteEmisorFormaPagoCorteCaja

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblImporteEmisorFormaPagoCorteCaja"
    ...
    '                 - Tabla tblImporteEmisorFormaPagoCorteCaja
    ' Parameters : 
    ...
    '                 - 
    '              ByVal fltImporteEmisorFormaPagoCorteCajaCantidadDocumentos As Double
    '                 - 
    '              ByVal fltImporteEmisorFormaPagoCorteCajaAcumulado As Double
    '                 - 
    '              ByVal dtmImporteEmisorFormaPagoCorteCajaUltimaModificacion As Date
    '                 - 
    '              ByVal strImporteEmisorFormaPagoCorteCajaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal fltImporteEmisorFormaPagoCorteCajaCantidadDocumentos As Double, _
      ByVal fltImporteEmisorFormaPagoCorteCajaAcumulado As Double, _
      ByVal dtmImporteEmisorFormaPagoCorteCajaUltimaModificacion As Date, _
      ByVal strImporteEmisorFormaPagoCorteCajaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblImporteEmisorFormaPagoCorteCaja ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltImporteEmisorFormaPagoCorteCajaCantidadDocumentos)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltImporteEmisorFormaPagoCorteCajaAcumulado)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmImporteEmisorFormaPagoCorteCajaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strImporteEmisorFormaPagoCorteCajaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblImporteEmisorFormaPagoCorteCaja ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblImporteEmisorFormaPagoCorteCaja ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblImporteEmisorFormaPagoCorteCaja ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblImporteEmisorFormaPagoCorteCaja ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblImporteEmisorFormaPagoCorteCaja ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
