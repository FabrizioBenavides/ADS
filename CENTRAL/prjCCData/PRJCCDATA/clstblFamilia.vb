...
'====================================================================
Public NotInheritable Class clstblFamilia

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblFamilia"
    ...
    '                 - Tabla tblFamilia
    ' Parameters : 
    '              ByVal intFamiliaId As Integer
    '                 - 
    '              ByVal intFamiliaPadreId As Integer
    '                 - 
    '              ByVal intDepartamentoId As Integer
    '                 - 
    '              ByVal strFamiliaNombre As String
    '                 - 
    '              ByVal dtmFamiliaUltimaModificacion As Date
    '                 - 
    '              ByVal strFamiliaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intFamiliaId As Integer, _
      ByVal intFamiliaPadreId As Integer, _
      ByVal intDepartamentoId As Integer, _
      ByVal strFamiliaNombre As String, _
      ByVal dtmFamiliaUltimaModificacion As Date, _
      ByVal strFamiliaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblFamilia ")
            Call strSQLStatement.Append(intFamiliaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFamiliaPadreId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strFamiliaNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmFamiliaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strFamiliaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblFamilia ")
            Call strSQLStatement.Append(intFamiliaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFamiliaPadreId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblFamilia ")
            Call strSQLStatement.Append(intFamiliaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFamiliaPadreId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblFamilia ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblFamilia ")
            Call strSQLStatement.Append(intFamiliaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFamiliaPadreId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblFamilia ")
            Call strSQLStatement.Append(intFamiliaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFamiliaPadreId)
            Call strSQLStatement.Append(",")
