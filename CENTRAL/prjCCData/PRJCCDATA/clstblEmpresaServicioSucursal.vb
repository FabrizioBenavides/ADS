...
'====================================================================
' Class         : clstblEmpresaServicioSucursal
...
' Version       : 1.0
' Last Modified : Jueves, 15 de Mayo, 2008
'====================================================================

Public NotInheritable Class clstblEmpresaServicioSucursal

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblEmpresaServicioSucursal"
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblEmpresaServicioSucursal ")
    ...
    Shared Function strBuscar( _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscartblEmpresaServicioSucursal ")
    ...
    '====================================================================
    ' Name       : strBuscarSucursalesAsignadasAEmpresa
    ' Description: Búsqueda de registros.
    '                 - Tabla tblEmpresaServicioSucursal
    ' Parameters : 
    '              ByVal intCompaniaId As Double
    ...
    '                   c = Campo
    '====================================================================
    Shared Function strBuscarSucursalesAsignadasAEmpresa( _
            ByVal intCompaniaId As Integer, _
            ByVal intSucursalId As Integer, _
            ByVal intEmpresaServicioId As Integer, _
            ByVal blnEmpresaServicioSucursalActiva As Boolean, _
    ...
    '              ByVal blnEmpresaServicioSucursalActiva As boolean
    '                  - 
    '              ByVal fltEmpresaServicioSucursalComisionSucursal As boolean
    '                  - 
    '              ByVal dtmEmpresaServicioSucursalUltimaModificacion As Date
    '                  - 
    '              ByVal strEmpresaServicioSucursalModificadoPor As String
    ...
    Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblEmpresaServicioSucursal ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Shared Function intActualizar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spActualizartblEmpresaServicioSucursal ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    '====================================================================
    ' Name       : strObtenerEmpresasAsignadasASucursal
    ' Description: Búsqueda de empresas de servicio asignadas a una sucursal.
    '                 - Tabla tblEmpresaServicioSucursal
    ' Parameters : 
    '              ByVal strConnectionString As String
    '                 - Cadena de conexión hacia el RDBMS
    ...
    '                   c = Campo
    '====================================================================
    Shared Function strObtenerEmpresasAsignadasASucursal(ByVal intCompaniaId As Integer, _
                                                         ByVal intSucursalId As Integer, _
                                                         ByVal strConnectionString As String) As Array

        ' Member identifier
        Const strmThisMemberName As String = "spObtenerEmpresasAsignadasASucursal "
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spObtenerEmpresasAsignadasASucursal ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
    ...
    '                  - Número de registros afectados por el comando
    '====================================================================        
    Shared Function intEliminarEmpresaServicioSucursal( _
                ByVal intCompaniaId As Integer, _
                ByVal intSucursalId As Integer, _
                ByVal intEmpresaServicioId As Integer, _
                ByVal blnEmpresaServicioSucursalActiva As Boolean, _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spActualizarEmpresaServicioSucursalActiva ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    '                  - Número de registros afectados por el comando
    '====================================================================        
    Shared Function intAgregartblEmpresaServicioSucursalMontoMaximo( _
                ByVal intCompaniaId As Integer, _
                ByVal intSucursalId As Integer, _
                ByVal intEmpresaServicioId As Integer, _
                ByVal blnEmpresaServicioSucursalActiva As Boolean, _
        ...
        ' Member identifier
        Const strmThisMemberName As String = "intAgregartblEmpresaServicioSucursalMontoMaximo"
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblEmpresaServicioSucursalMontoMaximo ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
