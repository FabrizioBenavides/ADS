...
'====================================================================
' Class         : clstblDatoAdicionalPagoTicket
...
'====================================================================
Public NotInheritable Class clstblDatoAdicionalPagoTicket

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblDatoAdicionalPagoTicket"
    ...
    '                 - Tabla tblDatoAdicionalPagoTicket
    ' Parameters : 
    ...
    '                 - 
    '              ByVal strDatoAdicionalPagoTicketValor As String
    '                 - 
    '              ByVal dtmDatoAdicionalPagoTicketUltimaModificacion As Date
    '                 - 
    '              ByVal strDatoAdicionalPagoTicketModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strDatoAdicionalPagoTicketValor As String, _
      ByVal dtmDatoAdicionalPagoTicketUltimaModificacion As Date, _
      ByVal strDatoAdicionalPagoTicketModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblDatoAdicionalPagoTicket ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strDatoAdicionalPagoTicketValor)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmDatoAdicionalPagoTicketUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strDatoAdicionalPagoTicketModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblDatoAdicionalPagoTicket ")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblDatoAdicionalPagoTicket ")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblDatoAdicionalPagoTicket ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblDatoAdicionalPagoTicket ")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblDatoAdicionalPagoTicket ")
            Call strSQLStatement.Append(intEmisorFormaPagoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intFormaPagoId)
            Call strSQLStatement.Append(",")
