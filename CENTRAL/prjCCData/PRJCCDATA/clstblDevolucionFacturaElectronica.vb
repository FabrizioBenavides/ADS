...
'====================================================================
' Class         : clstblDevolucionFacturaElectronica
...
'====================================================================
Public NotInheritable Class clstblDevolucionFacturaElectronica

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblDevolucionFacturaElectronica"
    ...
    '                 - Tabla tblDevolucionFacturaElectronica
    ' Parameters : 
    ...
    '                 - 
    '              ByVal intDevolucionFacturaElectronicaCantidad As Integer
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intDevolucionFacturaElectronicaCantidad As Integer, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblDevolucionFacturaElectronica ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDevolucionFacturaElectronicaCantidad)
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblDevolucionFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblDevolucionFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblDevolucionFacturaElectronica ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblDevolucionFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblDevolucionFacturaElectronica ")
            Call strSQLStatement.Append(intFacturaElectronicaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoFacturaElectronicaId)
            Call strSQLStatement.Append(",")
