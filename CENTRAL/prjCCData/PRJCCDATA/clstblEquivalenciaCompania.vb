'====================================================================
' Class         : clstblEquivalenciaCompania
...
'====================================================================
Public NotInheritable Class clstblEquivalenciaCompania

    ' Class identifier
    Private Const strmThisClassName As String = "Benavides.POSAdmin.Data.clstblEquivalenciaCompania"
    ...
    ' Table name    : tblEquivalenciaCompania
    ' Parameters    : 
    '              ByVal intCompaniaId As Int32
    '                  - 
    '              ByVal intEquivalenciaCompaniaId As Int32
    '                  -      
    
    '              ByVal dtmEquivalenciaCompaniaUltimaModificacion As DateTime
    '                  - 
    '              ByVal strEquivalenciaCompaniaModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal intEquivalenciaCompaniaId As Int32, _
      ByVal dtmEquivalenciaCompaniaUltimaModificacion As DateTime, _
      ByVal strEquivalenciaCompaniaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spAgregartblEquivalenciaCompania ")

            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")

            Call strSQLStatement.Append(intEquivalenciaCompaniaId)
            Call strSQLStatement.Append(",")


            Call strSQLStatement.Append("'" & dtmEquivalenciaCompaniaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture) & "'")
            Call strSQLStatement.Append(",")

            Call strSQLStatement.Append("'" & strEquivalenciaCompaniaModificadoPor & "'")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spEliminartblEquivalenciaCompania ")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscartblEquivalenciaCompania ")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblEquivalenciaCompania ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spActualizartblEquivalenciaCompania ")
