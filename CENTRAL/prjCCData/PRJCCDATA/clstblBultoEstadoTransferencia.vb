...
'====================================================================
' Class         : clstblBultoEstadoTransferencia
...
'====================================================================
Public NotInheritable Class clstblBultoEstadoTransferencia

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblBultoEstadoTransferencia"
    ...
    '                 - Tabla tblBultoEstadoTransferencia
    ' Parameters : 
    '              ByVal intTransferenciaId As Double
    '                 - 
    '              ByVal intTipoEstadoTransferenciaId As Double
    '                 - 
    '              ByVal strBultoEstadoTransferenciaNumero As String
    '                 - 
    '              ByVal dtmBultoEstadoTransferenciaUltimaModificacion As Date
    '                 - 
    '              ByVal strBultoEstadoTransferenciaModificadoPor As String
    '                 -       
    ...
    Shared Function intActualizar( _
                ByVal intTransferenciaId As Double, _
                ByVal intTipoEstadoTransferenciaId As Double, _
                ByVal strBultoEstadoTransferenciaNumero As String, _
                ByVal dtmBultoEstadoTransferenciaUltimaModificacion As Date, _
                ByVal strBultoEstadoTransferenciaModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblBultoEstadoTransferencia ")
            Call strSQLStatement.Append(intTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strBultoEstadoTransferenciaNumero)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmBultoEstadoTransferenciaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strBultoEstadoTransferenciaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Shared Function intAgregar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblBultoEstadoTransferencia ")
            Call strSQLStatement.Append(intTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoTransferenciaId)
            Call strSQLStatement.Append(",")
    ...
    Shared Function strBuscar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblBultoEstadoTransferencia ")
            Call strSQLStatement.Append(intTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoTransferenciaId)
            Call strSQLStatement.Append(",")
    ...
    Shared Function intContar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblBultoEstadoTransferencia ")
            Call strSQLStatement.Append(intTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoTransferenciaId)
            Call strSQLStatement.Append(",")
    ...
    Shared Function intEliminar( _
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblBultoEstadoTransferencia ")
            Call strSQLStatement.Append(intTransferenciaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intTipoEstadoTransferenciaId)
            Call strSQLStatement.Append(",")
