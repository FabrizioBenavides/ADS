...
'====================================================================
Public NotInheritable Class clstblDiaCierre

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblDiaCierre"
    ...
    '                 - Tabla tblDiaCierre
    ' Parameters : 
    '              ByVal intDiaCierreId As Integer
    '                 - 
    '              ByVal intDiaCierreCompaniaId As Integer
    '                 - 
    '              ByVal intDiaCierre As Integer
    '                 - 
    '              ByVal dtmDiaCierreUltimaModificacion As Date
    '                 - 
    '              ByVal strDiaCierreModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intDiaCierreId As Integer, _
      ByVal intDiaCierreCompaniaId As Integer, _
      ByVal intDiaCierre As Integer, _
      ByVal dtmDiaCierreUltimaModificacion As Date, _
      ByVal strDiaCierreModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblDiaCierre ")
            Call strSQLStatement.Append(intDiaCierreId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDiaCierreCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDiaCierre)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmDiaCierreUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strDiaCierreModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblDiaCierre ")
            Call strSQLStatement.Append(intDiaCierreId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDiaCierreCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblDiaCierre ")
            Call strSQLStatement.Append(intDiaCierreId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDiaCierreCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblDiaCierre ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblDiaCierre ")
            Call strSQLStatement.Append(intDiaCierreId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDiaCierreCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblDiaCierre ")
            Call strSQLStatement.Append(intDiaCierreId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intDiaCierreCompaniaId)
            Call strSQLStatement.Append(",")
