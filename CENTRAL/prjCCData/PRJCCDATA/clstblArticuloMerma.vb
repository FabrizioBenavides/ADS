...
'====================================================================
Public NotInheritable Class clstblArticuloMerma

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblArticuloMerma"
    ...
    '                 - Tabla tblArticuloMerma
    ' Parameters : 
    '              ByVal intMermaId As Integer
    '                 - 
    '              ByVal intArticuloId As Integer
    '                 - 
    '              ByVal intMotivoMermaId As Integer
    '                 - 
    '              ByVal intArticuloMermaCantidad As Integer
    '                 - 
    '              ByVal fltArticuloMermaPrecioUnitario As Double
    '                 - 
    '              ByVal dtmArticuloMermaUltimaModificacion As Date
    '                 - 
    '              ByVal strArticuloMermaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intMermaId As Integer, _
      ByVal intArticuloId As Integer, _
      ByVal intMotivoMermaId As Integer, _
      ByVal intArticuloMermaCantidad As Integer, _
      ByVal fltArticuloMermaPrecioUnitario As Double, _
      ByVal dtmArticuloMermaUltimaModificacion As Date, _
      ByVal strArticuloMermaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblArticuloMerma ")
            Call strSQLStatement.Append(intMermaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intMotivoMermaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloMermaCantidad)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltArticuloMermaPrecioUnitario)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloMermaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloMermaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblArticuloMerma ")
            Call strSQLStatement.Append(intMermaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblArticuloMerma ")
            Call strSQLStatement.Append(intMermaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblArticuloMerma ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblArticuloMerma ")
            Call strSQLStatement.Append(intMermaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblArticuloMerma ")
            Call strSQLStatement.Append(intMermaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
