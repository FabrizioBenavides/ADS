...
'====================================================================
Public NotInheritable Class clstblEfectoPromocional

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblEfectoPromocional"
    ...
    '                 - Tabla tblEfectoPromocional
    ' Parameters : 
    '              ByVal intEfectoPromocionalId As Integer
    '                 - 
    '              ByVal intEfectoPromocionalCompaniaId As Integer
    '                 - 
    '              ByVal intEfectoPromocionalSucursalId As Integer
    '                 - 
    '              ByVal intEfectoPromocionalDepartamentoId As Integer
    '                 - 
    '              ByVal fltEfectoPromocionalImporteConImpuesto As Double
    '                 - 
    '              ByVal dtmEfectoPromocionalRegistro As Date
    '                 - 
    '              ByVal dtmEfectoPromocionalUltimaModificacion As Date
    '                 - 
    '              ByVal strEfectoPromocionalModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intEfectoPromocionalId As Integer, _
      ByVal intEfectoPromocionalCompaniaId As Integer, _
      ByVal intEfectoPromocionalSucursalId As Integer, _
      ByVal intEfectoPromocionalDepartamentoId As Integer, _
      ByVal fltEfectoPromocionalImporteConImpuesto As Double, _
      ByVal dtmEfectoPromocionalRegistro As Date, _
      ByVal dtmEfectoPromocionalUltimaModificacion As Date, _
      ByVal strEfectoPromocionalModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblEfectoPromocional ")
            Call strSQLStatement.Append(intEfectoPromocionalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEfectoPromocionalCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEfectoPromocionalSucursalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEfectoPromocionalDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltEfectoPromocionalImporteConImpuesto)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmEfectoPromocionalRegistro.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmEfectoPromocionalUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strEfectoPromocionalModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblEfectoPromocional ")
            Call strSQLStatement.Append(intEfectoPromocionalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEfectoPromocionalCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblEfectoPromocional ")
            Call strSQLStatement.Append(intEfectoPromocionalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEfectoPromocionalCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblEfectoPromocional ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblEfectoPromocional ")
            Call strSQLStatement.Append(intEfectoPromocionalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEfectoPromocionalCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblEfectoPromocional ")
            Call strSQLStatement.Append(intEfectoPromocionalId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intEfectoPromocionalCompaniaId)
            Call strSQLStatement.Append(",")
