...
'====================================================================
' Class         : clstblClaveVigenciaArticulo
...
'====================================================================
Public NotInheritable Class clstblClaveVigenciaArticulo

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblClaveVigenciaArticulo"
    ...
    '                 - Tabla tblClaveVigenciaArticulo
    ' Parameters : 
    '              ByVal intClaveVigenciaArticuloId As Integer
    '                 - 
    '              ByVal strClaveVigenciaNombreId As String
    '                 - 
    '              ByVal strClaveVigenciaArticuloNombre As String
    '                 - 
    '              ByVal dtmClaveVigenciaArticuloUltimaModificacion As Date
    '                 - 
    '              ByVal strClaveVigenciaArticuloModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strClaveVigenciaNombreId As String, _
      ByVal strClaveVigenciaArticuloNombre As String, _
      ByVal dtmClaveVigenciaArticuloUltimaModificacion As Date, _
      ByVal strClaveVigenciaArticuloModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblClaveVigenciaArticulo ")
            Call strSQLStatement.Append(intClaveVigenciaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strClaveVigenciaNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strClaveVigenciaArticuloNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmClaveVigenciaArticuloUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strClaveVigenciaArticuloModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblClaveVigenciaArticulo ")
            Call strSQLStatement.Append(intClaveVigenciaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strClaveVigenciaNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblClaveVigenciaArticulo ")
            Call strSQLStatement.Append(intClaveVigenciaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strClaveVigenciaNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblClaveVigenciaArticulo ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblClaveVigenciaArticulo ")
            Call strSQLStatement.Append(intClaveVigenciaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strClaveVigenciaNombreId)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblClaveVigenciaArticulo ")
            Call strSQLStatement.Append(intClaveVigenciaArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strClaveVigenciaNombreId)
