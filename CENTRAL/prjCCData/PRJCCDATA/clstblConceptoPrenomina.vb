...
'====================================================================
Public NotInheritable Class clstblConceptoPrenomina

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblConceptoPrenomina"
    ...
    '                 - Tabla tblConceptoPrenomina
    ' Parameters : 
    '              ByVal intConceptoPrenominaId As Integer
    '                 - 
    '              ByVal strConceptoPrenominaNombre As String
    '                 - 
    '              ByVal strConceptoPrenominaNombreId As String
    '                 - 
    '              ByVal blnConceptoPrenominaEsDecimal As Byte
    '                 - 
    '              ByVal intConceptoPrenominaRangoMaximo As Integer
    '                 - 
    '              ByVal blnConceptoPrenominaEsCapturado As Byte
    '                 - 
    '              ByVal dtmConceptoPrenominaUltimaModificacion As Date
    '                 - 
    '              ByVal strConceptoPrenominaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intConceptoPrenominaId As Integer, _
      ByVal strConceptoPrenominaNombre As String, _
      ByVal strConceptoPrenominaNombreId As String, _
      ByVal blnConceptoPrenominaEsDecimal As Byte, _
      ByVal intConceptoPrenominaRangoMaximo As Integer, _
      ByVal blnConceptoPrenominaEsCapturado As Byte, _
      ByVal dtmConceptoPrenominaUltimaModificacion As Date, _
      ByVal strConceptoPrenominaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblConceptoPrenomina ")
            Call strSQLStatement.Append(intConceptoPrenominaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strConceptoPrenominaNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strConceptoPrenominaNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnConceptoPrenominaEsDecimal)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intConceptoPrenominaRangoMaximo)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(blnConceptoPrenominaEsCapturado)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmConceptoPrenominaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strConceptoPrenominaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblConceptoPrenomina ")
            Call strSQLStatement.Append(intConceptoPrenominaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strConceptoPrenominaNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblConceptoPrenomina ")
            Call strSQLStatement.Append(intConceptoPrenominaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strConceptoPrenominaNombre)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblConceptoPrenomina ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblConceptoPrenomina ")
            Call strSQLStatement.Append(intConceptoPrenominaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strConceptoPrenominaNombre)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblConceptoPrenomina ")
            Call strSQLStatement.Append(intConceptoPrenominaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strConceptoPrenominaNombre)
