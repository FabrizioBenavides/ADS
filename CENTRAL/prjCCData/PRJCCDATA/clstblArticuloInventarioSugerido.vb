...
'====================================================================
' Class         : clstblArticuloInventarioSugerido
...
'====================================================================
Public NotInheritable Class clstblArticuloInventarioSugerido

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblArticuloInventarioSugerido"
    ...
    '                 - Tabla tblArticuloInventarioSugerido
    ' Parameters : 
    '              ByVal intInventarioSugeridoFolioId As Integer
    '                 - 
    ...
    '                 - 
    '              ByVal intArticuloInventarioSugeridoCantidad As Integer
    '                 - 
    '              ByVal dtmArticuloInventarioSugeridoUltimaModificacion As Date
    '                 - 
    '              ByVal strArticuloInventarioSugeridoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intInventarioSugeridoFolioId As Integer, _
      ByVal intCompaniaId As Integer, _
      ByVal intSucursalId As Integer, _
      ByVal intArticuloId As Integer, _
      ByVal intArticuloInventarioSugeridoCantidad As Integer, _
      ByVal dtmArticuloInventarioSugeridoUltimaModificacion As Date, _
      ByVal strArticuloInventarioSugeridoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblArticuloInventarioSugerido ")
            Call strSQLStatement.Append(intInventarioSugeridoFolioId)
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloInventarioSugeridoCantidad)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloInventarioSugeridoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloInventarioSugeridoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblArticuloInventarioSugerido ")
            Call strSQLStatement.Append(intInventarioSugeridoFolioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblArticuloInventarioSugerido ")
            Call strSQLStatement.Append(intInventarioSugeridoFolioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblArticuloInventarioSugerido ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblArticuloInventarioSugerido ")
            Call strSQLStatement.Append(intInventarioSugeridoFolioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblArticuloInventarioSugerido ")
            Call strSQLStatement.Append(intInventarioSugeridoFolioId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
