Imports System.Text
'====================================================================
' Class         : clsImportacionArticulosExceptosDeDescuento
' Title         : Grupo Benavides. Administrador POS y Backoffice.
' Description   : Operaciones con Articulo No Autorizado.
...
'====================================================================
Public NotInheritable Class clsImportacionArticulosExceptosDeDescuento

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clsImportacionArticulosExceptosDeDescuento"
    ...
    ' Description: Regresa el detalle de los articulos exceptos de descuento
    '             
    ' Parameters :
    ...
    Public Shared Function strBuscarDetalle( _
       ...
       ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscarDetalleImportacionArticulosExceptosDeDescuento ")
    ...
    '=======================================================================
    ' Name       : intReemplazar
    ' Description: Reemplaza los articulos exceptos de descuento
    '              con los artículos importados
    ' Parameters :
    ...
    Public Shared Function intReemplazar( _
       ...
       ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spReemplazarImportacionExceptoDescuentoArticulo ")
    ...
    '=======================================================================
    ' Name       : intAgregar
    ' Description: Agrega articulos exceptos de descuento
    '              con los artículos importados
    ' Parameters :
    '               ByVal intGrupoClienteEspecialId As Integer
    '               ByVal intTipoExceptoId As Integer
    ...
    Public Shared Function intAgregar( _
       ...
       ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregarImportacionExceptoDescuentoArticulo ")
            Call strSQLStatement.Append(intGrupoClienteEspecialId)
            Call strSQLStatement.Append(", ")
            Call strSQLStatement.Append(intTipoExceptoId)
            Call strSQLStatement.Append(", ")
