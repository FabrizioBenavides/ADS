...
'====================================================================
' Class         : clstblArticuloTransferenciaInterna
...
'====================================================================
Public NotInheritable Class clstblArticuloTransferenciaInterna

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblArticuloTransferenciaInterna"
    ...
    '                 - Tabla tblArticuloTransferenciaInterna
    ' Parameters : 
    '              ByVal intTransferenciaInternaId As Integer
    '                 - 
    '              ByVal intArticuloId As Integer
    '                 - 
    '              ByVal intArticuloTransferenciaInternaCantidad As Integer
    '                 - 
    '              ByVal fltArticuloTransferenciaInternaPrecioVenta As Double
    '                 - 
    '              ByVal dtmArticuloTransferenciaInternaUltimaModificacion As Date
    '                 - 
    '              ByVal strArticuloTransferenciaInternaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intArticuloTransferenciaInternaCantidad As Integer, _
      ByVal fltArticuloTransferenciaInternaPrecioVenta As Double, _
      ByVal dtmArticuloTransferenciaInternaUltimaModificacion As Date, _
      ByVal strArticuloTransferenciaInternaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblArticuloTransferenciaInterna ")
            Call strSQLStatement.Append(intTransferenciaInternaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloTransferenciaInternaCantidad)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltArticuloTransferenciaInternaPrecioVenta)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloTransferenciaInternaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloTransferenciaInternaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblArticuloTransferenciaInterna ")
            Call strSQLStatement.Append(intTransferenciaInternaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblArticuloTransferenciaInterna ")
            Call strSQLStatement.Append(intTransferenciaInternaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblArticuloTransferenciaInterna ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblArticuloTransferenciaInterna ")
            Call strSQLStatement.Append(intTransferenciaInternaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblArticuloTransferenciaInterna ")
            Call strSQLStatement.Append(intTransferenciaInternaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
