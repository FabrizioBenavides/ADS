'====================================================================
' Class         : clstblCategoriaComisionDiferenciadaArticulo
...
' Last Modified : Monday, October 03, 2005
'====================================================================
Public NotInheritable Class clstblCategoriaComisionDiferenciadaArticulo

    ' Class identifier
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblCategoriaComisionDiferenciadaArticulo"
    ...
    ' Table name    : tblCategoriaComisionDiferenciadaArticulo
    ' Parameters    : 
    '              ByVal intArticuloId As Int32
    '                  - 
    '              ByVal intCategoriaComisionDiferenciadaId As Int32
    '                  - 
    '              ByVal strCategoriaComisionDiferenciadaArticuloModificadoPor As String
    '                  - 
    '              ByVal dtmCategoriaComisionDiferenciadaArticuloUltimaModificacion As DateTime
    '                  - 
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal intCategoriaComisionDiferenciadaId As Int32, _
      ByVal strCategoriaComisionDiferenciadaArticuloModificadoPor As String, _
      ByVal dtmCategoriaComisionDiferenciadaArticuloUltimaModificacion As DateTime, _
      ByVal strConnectionString As String) As integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spAgregartblCategoriaComisionDiferenciadaArticulo ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCategoriaComisionDiferenciadaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strCategoriaComisionDiferenciadaArticuloModificadoPor)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmCategoriaComisionDiferenciadaArticuloUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intEliminar( _ 
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spEliminartblCategoriaComisionDiferenciadaArticulo ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCategoriaComisionDiferenciadaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscartblCategoriaComisionDiferenciadaArticulo ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCategoriaComisionDiferenciadaId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblCategoriaComisionDiferenciadaArticulo ")
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Create the SQL statement
            strSQLStatement = New System.Text.StringBuilder
            Call strSQLStatement.Append("EXECUTE spActualizartblCategoriaComisionDiferenciadaArticulo ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intCategoriaComisionDiferenciadaId)
            Call strSQLStatement.Append(",")
