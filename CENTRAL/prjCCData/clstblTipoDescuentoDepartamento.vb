...
'====================================================================
' Class         : clstblTipoDescuentoDepartamento
...
'====================================================================
Public NotInheritable Class clstblTipoDescuentoDepartamento

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblTipoDescuentoDepartamento"
    ...
    '                 - Tabla tblTipoDescuentoDepartamento
    ' Parameters : 
    '              ByVal intTipoDescuentoDepartamentoId As Integer
    '                 - 
    '              ByVal strTipoDescuentoDepartamentoNombreId As String
    '                 - 
    '              ByVal strTipoDescuentoDepartamentoNombre As String
    '                 - 
    '              ByVal dtmTipoDescuentoDepartamentoUltimaModificacion As Date
    '                 - 
    '              ByVal strTipoDescuentoDepartamentoModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ByVal intTipoDescuentoDepartamentoId As Integer, _
      ByVal strTipoDescuentoDepartamentoNombreId As String, _
      ByVal strTipoDescuentoDepartamentoNombre As String, _
      ByVal dtmTipoDescuentoDepartamentoUltimaModificacion As Date, _
      ByVal strTipoDescuentoDepartamentoModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblTipoDescuentoDepartamento ")
            Call strSQLStatement.Append(intTipoDescuentoDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDescuentoDepartamentoNombreId)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDescuentoDepartamentoNombre)
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmTipoDescuentoDepartamentoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDescuentoDepartamentoModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblTipoDescuentoDepartamento ")
            Call strSQLStatement.Append(intTipoDescuentoDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDescuentoDepartamentoNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblTipoDescuentoDepartamento ")
            Call strSQLStatement.Append(intTipoDescuentoDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDescuentoDepartamentoNombreId)
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblTipoDescuentoDepartamento ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblTipoDescuentoDepartamento ")
            Call strSQLStatement.Append(intTipoDescuentoDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDescuentoDepartamentoNombreId)
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblTipoDescuentoDepartamento ")
            Call strSQLStatement.Append(intTipoDescuentoDepartamentoId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strTipoDescuentoDepartamentoNombreId)
