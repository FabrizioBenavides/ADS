...
'====================================================================
Public NotInheritable Class clstblDivisionArticulos

    ' Class identifier
    Private Const CLASS_NAME As String = "Benavides.CC.Data.clstblDivisionArticulos"
    ...
    ' Table name    : tblDivisionArticulos
    ' Parameters    : 
    '              ByVal intDivisionArticulosId As Integer
    '                  - 
    '              ByVal strDivisionArticulosNombreId As String
    '                  - 
    '              ByVal strDivisionArticulosNombre As String
    '                  - 
    '              ByVal dtmDivisionArticulosUltimaModificacion As DateTime
    '                  - 
    '              ByVal strDivisionArticulosModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar(ByVal intDivisionArticulosId As Integer, _
                                      ...
                                      ByVal strDivisionArticulosNombre As String, _
                                      ByVal dtmDivisionArticulosUltimaModificacion As DateTime, _
                                      ByVal strDivisionArticulosModificadoPor As String, _
        ...
        Try
            ...
            Call sqlStatementToBeExecuted.Append("EXECUTE spAgregartblDivisionArticulos ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strDivisionArticulosNombreId)
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strDivisionArticulosNombre)
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(dtmDivisionArticulosUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strDivisionArticulosModificadoPor)
            Call sqlStatementToBeExecuted.Append("'")
    ...
    Public Shared Function intEliminar(ByVal intDivisionArticulosId As Integer, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spEliminartblDivisionArticulos ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strDivisionArticulosNombreId)
    ...
    Public Shared Function strBuscar(ByVal intDivisionArticulosId As Integer, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscartblDivisionArticulos ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strDivisionArticulosNombreId)
    ...
    Public Shared Function strBuscar(ByVal dtmStart As DateTime, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscarCambiotblDivisionArticulos ")
            Call sqlStatementToBeExecuted.Append("'")
    ...
    Public Shared Function intActualizar(ByVal intDivisionArticulosId As Integer, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spActualizartblDivisionArticulos ")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strDivisionArticulosNombreId)
