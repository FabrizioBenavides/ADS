...
'====================================================================
' Class         : clstblArticuloRestringidoPagoVales
...
'====================================================================
Public NotInheritable Class clstblArticuloRestringidoPagoVales

    'Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblArticuloRestringidoPagoVales"
    ...
    '                 - 
    '              ByVal dtmArticuloRestringidoPagoValesUltimaModificacion As Date
    '                 - 
    '              ByVal strArticuloRestringidoPagoValesModificadoPor As String
    '                 -
    ...
    Public Shared Function intActualizar( _
                    ...
                    ByVal dtmArticuloRestringidoPagoValesUltimaModificacion As Date, _
                    ByVal strArticuloRestringidoPagoValesModificadoPor As String, _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizatblArticuloRestringidoPagoVales ")
            Call strSQLStatement.Append(intArticuloId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmArticuloRestringidoPagoValesUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strArticuloRestringidoPagoValesModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
        ...
        Try
            ...
            strSQLStatement.Append("EXECUTE spAgregartblArticuloRestringidoPagoVales ")
            strSQLStatement.Append(intArticuloId)
            strSQLStatement.Append(",")
            strSQLStatement.Append("'")
            strSQLStatement.Append(dtmArticuloRestringidoPagoValesUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            strSQLStatement.Append("'")
            strSQLStatement.Append(",")
            strSQLStatement.Append("'")
            strSQLStatement.Append(strArticuloRestringidoPagoValesModificadoPor)
            strSQLStatement.Append("'")
    ...
    Public Shared Function strBuscar( _
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spBuscartblArticuloRestringidoPagoVales ")
            Call strSQLStatement.Append(intArticuloId)
    ...
    Public Shared Function strBuscar( _
     ...
     ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblArticuloRestringidoPagoVales")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intEliminar( _
        ...
        Try
            ...
            strSQLStatement.Append("EXECUTE spEliminartblArticuloRestringidoPagoVales ")
            strSQLStatement.Append(intArticuloId)
