...
'====================================================================
' Class         : clstblModificacionOferta
...
'====================================================================
Public NotInheritable Class clstblModificacionOferta

    ' Identificador de la clase
    Private Const strmThisClassName As String = "Benavides.CC.Data.clstblModificacionOferta"
    ...
    '                 - 
    '              ByVal intModificacionOfertaId As Integer
    '                 - 
    '              ByVal fltModificacionOfertaPrecioConImpuestoAnterior As Double
    '                 - 
    '              ByVal fltModificacionOfertaPrecioConImpuestoActual As Double
    '                 - 
    '              ByVal dtmModificacionOfertaVigenciaInicio As Date
    '                 - 
    '              ByVal dtmModificacionOfertaVigenciaFin As Date
    '                 - 
    '              ByVal intModificacionOfertaPrioridad As Integer
    '                 - 
    '              ByVal dtmModificacionOfertaUltimaModificacion As Date
    '                 - 
    '              ByVal strModificacionOfertaModificadoPor As String
    '                 - 
    ...
    Public Shared Function intActualizar( _
      ...
      ByVal intModificacionOfertaId As Integer, _
      ByVal fltModificacionOfertaPrecioConImpuestoAnterior As Double, _
      ByVal fltModificacionOfertaPrecioConImpuestoActual As Double, _
      ByVal dtmModificacionOfertaVigenciaInicio As Date, _
      ByVal dtmModificacionOfertaVigenciaFin As Date, _
      ByVal intModificacionOfertaPrioridad As Integer, _
      ByVal dtmModificacionOfertaUltimaModificacion As Date, _
      ByVal strModificacionOfertaModificadoPor As String, _
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            Call strSQLStatement.Append("EXECUTE spActualizartblModificacionOferta ")
            ...
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intModificacionOfertaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltModificacionOfertaPrecioConImpuestoAnterior)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(fltModificacionOfertaPrecioConImpuestoActual)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmModificacionOfertaVigenciaInicio.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmModificacionOfertaVigenciaFin.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intModificacionOfertaPrioridad)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(dtmModificacionOfertaUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append("'")
            Call strSQLStatement.Append(strModificacionOfertaModificadoPor)
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intAgregar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spAgregartblModificacionOferta ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscartblModificacionOferta ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function strBuscar( _
      ...
      ByVal strConnectionString As String) As Array
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spBuscarCambiotblModificacionOferta ")
            Call strSQLStatement.Append("'")
    ...
    Public Shared Function intContar( _
      ...
      ByVal strConnectionString As String) As Double
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spContartblModificacionOferta ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
    ...
    Public Shared Function intEliminar( _
      ...
      ByVal strConnectionString As String) As Integer
        ...
        Try
            ...
            ' Creamos es estatuto de SQL
            Call strSQLStatement.Append("EXECUTE spEliminartblModificacionOferta ")
            Call strSQLStatement.Append(intCompaniaId)
            Call strSQLStatement.Append(",")
            Call strSQLStatement.Append(intSucursalId)
            Call strSQLStatement.Append(",")
