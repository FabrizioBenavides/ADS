...
'====================================================================
Public NotInheritable Class clstblFondoFijoGastado

    ' Class identifier
    Private Const CLASS_NAME As String = "Benavides.CC.Data.clstblFondoFijoGastado"
    ...
    ' Table name    : tblFondoFijoGastado
    ' Parameters    : 
    ...
    '                  - 
    '              ByVal intFondoFijoGastadoId As Int32
    '                  - 
    '              ByVal intCajaId As Int32
    '                  - 
    '              ByVal fltFondoFijoGastadoImporte As Double
    '                  - 
    '              ByVal dtmFondoFijoGastadoUltimaModificacion As DateTime
    '                  - 
    '              ByVal strFondoFijoGastadoModificadoPor As String
    '                  - 
    ...
    Public Shared Function intAgregar(ByVal intFondoFijoPresupuestadoId As Decimal, _
                                      ...
                                      ByVal intFondoFijoGastadoId As Int32, _
                                      ByVal intCajaId As Int32, _
                                      ByVal fltFondoFijoGastadoImporte As Double, _
                                      ByVal dtmFondoFijoGastadoUltimaModificacion As DateTime, _
                                      ByVal strFondoFijoGastadoModificadoPor As String, _
        ...
        Try
            ...
            Call sqlStatementToBeExecuted.Append("EXECUTE spAgregartblFondoFijoGastado ")
            ...
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intFondoFijoGastadoId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCajaId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(fltFondoFijoGastadoImporte)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(dtmFondoFijoGastadoUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strFondoFijoGastadoModificadoPor)
            Call sqlStatementToBeExecuted.Append("'")
    ...
    Public Shared Function intEliminar(ByVal intFondoFijoPresupuestadoId As Decimal, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spEliminartblFondoFijoGastado ")
            Call sqlStatementToBeExecuted.Append(intFondoFijoPresupuestadoId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCompaniaId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    Public Shared Function strBuscar(ByVal intFondoFijoPresupuestadoId As Decimal, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscartblFondoFijoGastado ")
            Call sqlStatementToBeExecuted.Append(intFondoFijoPresupuestadoId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCompaniaId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    Public Shared Function strBuscar(ByVal dtmStart As DateTime, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscarCambiotblFondoFijoGastado ")
            Call sqlStatementToBeExecuted.Append("'")
    ...
    Public Shared Function intActualizar(ByVal intFondoFijoPresupuestadoId As Decimal, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spActualizartblFondoFijoGastado ")
            Call sqlStatementToBeExecuted.Append(intFondoFijoPresupuestadoId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intCompaniaId)
            Call sqlStatementToBeExecuted.Append(",")
