...
'====================================================================
' Class         : clstblProveedorCategoriaArticulosCupon
...
'====================================================================
Public NotInheritable Class clstblProveedorCategoriaArticulosCupon

    ' Class identifier
    Private Const CLASS_NAME As String = "Benavides.CC.Data.clstblProveedorCategoriaArticulosCupon"
    ...
    ' Table name    : tblProveedorCategoriaArticulosCupon
    ' Parameters    : 
    ...
    '                  - 
    '              ByVal dtmProveedorCategoriaArticulosCuponUltimaModificacion As DateTime
    '                  - 
    '              ByVal strProveedorCategoriaArticulosCuponModificadoPor As String
    '                  - 
    ...
    ' Output        : Integer
    '====================================================================
    Public Shared Function intAgregar(ByVal intCuponId As Int32, _
                                      ByVal intDivisionArticulosId As Decimal, _
                                      ByVal intCategoriaArticulosId As Decimal, _
                                      ByVal intProveedorId As Int32, _
                                      ByVal dtmProveedorCategoriaArticulosCuponUltimaModificacion As DateTime, _
                                      ByVal strProveedorCategoriaArticulosCuponModificadoPor As String, _
        ...
        Try
            ...
            Call sqlStatementToBeExecuted.Append("EXECUTE spAgregartblProveedorCategoriaArticulosCupon ")
            ...
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(dtmProveedorCategoriaArticulosCuponUltimaModificacion.ToString("MM/dd/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture))
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append("'")
            Call sqlStatementToBeExecuted.Append(strProveedorCategoriaArticulosCuponModificadoPor)
            Call sqlStatementToBeExecuted.Append("'")
    ...
    ' Output        : Integer
    '====================================================================
    Public Shared Function intEliminar(ByVal intCuponId As Int32, _
                                       ByVal intDivisionArticulosId As Decimal, _
                                       ByVal intCategoriaArticulosId As Decimal, _
                                       ByVal intProveedorId As Int32, _
                                       ByVal dtmProveedorCategoriaArticulosCuponUltimaModificacion As DateTime, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spEliminartblProveedorCategoriaArticulosCupon ")
            Call sqlStatementToBeExecuted.Append(intCuponId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    ' Output        : Array
    '====================================================================
    Public Shared Function strBuscar(ByVal intCuponId As Int32, _
                                     ByVal intDivisionArticulosId As Decimal, _
                                     ByVal intCategoriaArticulosId As Decimal, _
                                     ByVal intProveedorId As Int32, _
                                     ByVal dtmProveedorCategoriaArticulosCuponUltimaModificacion As DateTime, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscartblProveedorCategoriaArticulosCupon ")
            Call sqlStatementToBeExecuted.Append(intCuponId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
    ...
    Public Shared Function strBuscar(ByVal dtmStart As DateTime, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spBuscarCambiotblProveedorCategoriaArticulosCupon ")
            Call sqlStatementToBeExecuted.Append("'")
    ...
    ' Output        : Integer
    '====================================================================
    Public Shared Function intActualizar(ByVal intCuponId As Int32, _
                                         ByVal intDivisionArticulosId As Decimal, _
                                         ByVal intCategoriaArticulosId As Decimal, _
                                         ByVal intProveedorId As Int32, _
                                         ByVal dtmProveedorCategoriaArticulosCuponUltimaModificacion As DateTime, _
        ...
        Try
            ...
            ' Create the SQL statement
            sqlStatementToBeExecuted = New System.Text.StringBuilder
            Call sqlStatementToBeExecuted.Append("EXECUTE spActualizartblProveedorCategoriaArticulosCupon ")
            Call sqlStatementToBeExecuted.Append(intCuponId)
            Call sqlStatementToBeExecuted.Append(",")
            Call sqlStatementToBeExecuted.Append(intDivisionArticulosId)
            Call sqlStatementToBeExecuted.Append(",")
