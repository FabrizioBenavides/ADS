<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SucursalTipoServicioVirtual.aspx.vb" Inherits="com.isocraft.backbone.ccentral.SucursalTipoServicioVirtual" %>
...
function cmdAgregar_onclick() {
	document.forms[0].action = "SucursalTipoServicioVirtual.aspx?strCmd=AgregarTipo"
...
<body language="javascript" onload="return window_onload()">
	<form name="frmPage" action="about:blank" method="post">
		...
		<table cellSpacing="0" cellPadding="0" width="780" border="0">
			<tr>
				<td width="10">&nbsp;</td>
				<td class="tdtab" width="770">Está en : <A href="SucursalHome.aspx">Sucursal</A> : <A>Servicios 
						Virtuales</A> : Administrar Tipos de Servicios Virtuales</td>
			</tr>
		</table>
		<table cellSpacing="0" cellPadding="0" width="780" border="0">
			<tr>
				<td class="tdgeneralcontent">
					<h1>Administrar Tipos de Servicios Virtuales</h1>
					<p>Aquí podrá dar de alta o modificar tipos de servicios virtuales.</p>
					<br>
					<table cellSpacing="0" cellPadding="0" width="75%" border="0">
						<tr>
							<td class="tdtexttablebold" vAlign="top" align="right"><input language="javascript" class="button" id="cmdAgregar" onclick="return cmdAgregar_onclick()"
