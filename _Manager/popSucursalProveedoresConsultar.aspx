<%@ Page Language="vb" AutoEventWireup="false" EnableSessionState="False" enableViewState="False" Explicit="True" Trace="False" Strict="True" CodeBehind="popSucursalProveedoresConsultar.aspx.vb"      Inherits="com.isocraft.backbone.ccentral.popSucursalProveedoresConsultar" codePage="28592" %>
<HTML>
<HEAD>
<title>Benavides : Administrador de Puntos de Venta</title>
<%  '====================================================================
    ' Page          : popSucursalProveedoresConsultar.aspx
