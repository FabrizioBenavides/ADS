<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SucursalAsignacionDeArticuloDineroExpress.aspx.vb" Inherits="com.isocraft.backbone.ccentral.SucursalAsignacionDeArticuloDineroExpress"%>
...
function cmdAgregar_onclick() {
	document.forms[0].action = "SucursalAsignacionDeArticuloDineroExpress.aspx?strCmd=AgregarTipo"
	...
	<body language="javascript" onload="return window_onload()">
		<form name="frmPage" action="about:blank" method="post">
			...
			<table cellSpacing="0" cellPadding="0" width="780" border="0">
				<tr>
					<td width="10">&nbsp;</td>
					<td class="tdtab" width="770">Está en : <A href="SucursalHome.aspx">Sucursal</A> : <A href="SucursalAsignacionDeArticuloHome.aspx">
							Promociones de Servicios</A> : Administrar&nbsp;Asignación de Artículos 
						Promocionales</td>
				</tr>
			</table>
			<table cellSpacing="0" cellPadding="0" width="780" border="0">
				<tr>
					<td class="tdgeneralcontent">
						...
						<table cellSpacing="0" cellPadding="0" width="75%" border="0">
							<tr>
								<td class="tdtexttablebold" vAlign="top" align="right">
									<input language="javascript" class="button" id="cmdAgregar" onclick="return cmdAgregar_onclick()"
