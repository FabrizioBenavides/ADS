<%@ Page CodeBehind="SistemaTransmisionesPendientesDetalleZona.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="com.isocraft.backbone.ccentral.clsSistemaTransmisionesPendientesDetalleZona" %>
<html>
<head>
...
function window_onload() {
  ...
  document.forms[0].action = "SistemaTransmisionesPendientesDetalleZona.aspx";
...
function cmdConsultar_onClick() {
	...
	theForm.action += "?intDireccionOperativaId=<%=intDireccionOperativaId%>&intZonaOperativaId=<%=intZonaOperativaId%>&intReporteId=<%=intReporteId%>";
	theForm.submit();
	return true;
}
...
function cmdRegresar_onclick() {
  window.location.href = "SistemaTransmisionesPendientesDetalleDireccion.aspx?strCmd=Detalle&intReporteId=<%= intReporteId %>&intDireccionOperativaId=<%= intDireccionOperativaId %>";
}
...
<table width="780" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="10">&nbsp;</td>
    <td width="770" class="tdtab">Est&aacute; en : <a href="Sistema.htm">Sistema</a> : <a href="Transmisiones.htm">Trasmisiones</a> : <a href="ConsultarTransmisionesPendientes.htm">Consultar transmisiones pendientes</a> : Detalle zona </td>
  </tr>
</table>
<table width="780" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td class="tdgeneralcontent"><h1>Consultar transmisiones pendientes - Detalle zona </h1>
