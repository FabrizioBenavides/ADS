'====================================================================
' Class         : clsClasificacionDeArticulo2Admin
' Title         : Grupo Benavides. Catálogo de Catergorías de Artículo
...
Public Class clsClasificacionDeArticulo2Admin
...
#Region "metodos de la interface PrintInterface"
    ...
    Protected Overrides Function getHeaders() As String
        ...
        Dim widths As String() = {"20%", "65%", "15%"}
        Dim values As String() = {"Identificador", "Descripción", "Activo"}
