'====================================================================
' Class         : clsVentasCortesEnCeroDetalleZona
...
'====================================================================
Public Class clsVentasCortesEnCeroDetalleZona
...
#End Region
    ...
    Public Function strLlenarZonaComboBox() As String
        If intDireccionId > 0 Then
            Return isocraft.commons.clsWeb.strCreateJavascriptComboBoxOptions("cboZona", intZonaId, Benavides.CC.Data.clsCaja.strEjecutarBuscarCortesEnCeroPorDireccion(intDireccionId, CDate(strFechaInicial), CDate(strFechaFinal), 1, 100, strConnectionString), 1, 2, 1)
        End If
    End Function
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        Dim astrDataArray As Array = Benavides.CC.Data.clsCaja.strEjecutarBuscarCortesEnCeroPorZona(intDireccionId, intZonaId, dtmFechaInicial, dtmFechaFinal, CInt(Benavides.CC.Commons.clsRecordBrowser.clsIndicator.intCalculateFirstElement(intSelectedPage, intElementsPerPage)), intElementsPerPage, strConnectionString)
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case strCmd
            ...
            Case "Ver"
                ...
                Call Response.Redirect("VentasCortesEnCeroDetalleSucursal.aspx?intDireccionOperativaId=" & intDireccionId & "&intZonaOperativaId=" & intZonaId & "&intCompaniaId=" & isocraft.commons.clsWeb.strGetPageParameter("intCompaniaId", "0") & "&intSucursalId=" & isocraft.commons.clsWeb.strGetPageParameter("intSucursalId", "0") & "&intTotalPorSucursal=" & isocraft.commons.clsWeb.strGetPageParameter("intTotalPorSucursal", "0") & "&strFechaInicial=" & strFechaInicial & "&strFechaFinal=" & strFechaFinal)
