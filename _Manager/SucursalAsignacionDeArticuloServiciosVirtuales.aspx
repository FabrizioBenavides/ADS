<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SucursalAsignacionDeArticuloServiciosVirtuales.aspx.vb" Inherits="com.isocraft.backbone.ccentral.AsignacionDeArticuloServiciosVirtuales" %>
...
/*function cmdAgregar_onclick() {
	document.forms[0].action = "SucursalAsignacionDeArticuloDPServiciosVirtuales.aspx?strCmd=Agregar&intTipoServicioId=" + "<%= intTipoServicioVirtualId %>"
    document.forms[0].submit(); 
   
}*/

function cmdCancelar_onclick() {
   window.location.href = "SucursalAsignacionDeArticuloTipoServiciosVirtuales.aspx";
}
	...
	<body language="javascript" onload="return window_onload()">
		<form name="frmPage" action="about:blank" method="post">
			...
			<table cellSpacing="0" cellPadding="0" width="780" border="0">
				<tr>
					<td width="10">&nbsp;</td>
					<td class="tdtab" width="770">Está en : <A href="SucursalAsignacionDeArticuloHome.aspx">Sucursal</A>
						:&nbsp;Promoción de servicios&nbsp;: Administrar Promoción de&nbsp;Servicios 
						Virtuales</td>
				</tr>
			</table>
			<table cellSpacing="0" cellPadding="0" width="780" border="0">
				<tr>
					<td class="tdgeneralcontent">
						<h1 style="Z-INDEX: 0">Administrar&nbsp;Promoción de&nbsp;Servicios Virtuales</h1>
						...
						<table cellSpacing="0" cellPadding="0" width="75%" border="0">
							<tr>
								...
								<td class="tdpadleft5"><input class="field" id="txtTipoServicioVirtualDescripcion" maxLength="50" size="80" name="txtTipoServicioVirtualDescripcion"
										readOnly>
								</td>
							</tr>
							<TR>
