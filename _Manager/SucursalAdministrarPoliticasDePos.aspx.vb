'====================================================================
' Class         : clsSucursalAdministrarPoliticasDePos
' Title         : Grupo Benavides. Administrador POS y Backoffice.
' Description   : Administrar políticas de POS
...
'====================================================================
Public Class clsSucursalAdministrarPoliticasDePos
...
#End Region
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        Const strRecordBrowserName As String = "SucursalAdministrarPoliticasDePos"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case strCmd
            ...
            Case "Ver"
                ...
                Call Response.Redirect("SucursalVerPoliticasDePOSDeUnaSucursal.aspx?intDireccionId=" & intDireccionId & "&intZonaId=" & intZonaId & "&intCompaniaId=" & isocraft.commons.clsWeb.strGetPageParameter("intCompaniaId", "0") & "&intSucursalId=" & isocraft.commons.clsWeb.strGetPageParameter("intSucursalId", "0"))

            Case "Asignar"

                Call Response.Redirect("SucursalAsignarPoliticasDePosAUnaSucursal.aspx?intDestinoDireccionId=" & intDireccionId & "&intDestinoZonaId=" & intZonaId & "&intDestinoCompaniaId=" & isocraft.commons.clsWeb.strGetPageParameter("intCompaniaId", "0") & "&intDestinoSucursalId=" & isocraft.commons.clsWeb.strGetPageParameter("intSucursalId", "0"))
