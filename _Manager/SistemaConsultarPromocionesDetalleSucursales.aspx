<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SistemaConsultarPromocionesDetalleSucursales.aspx.vb" Inherits="com.isocraft.backbone.ccentral.SistemaConsultarPromocionesDetalleSucursales" %>
...
<form id="frmVerDetalleSucursalesCupones" method="post" name="frmVerDetalleSucursalesCupones" action="about:blank">
  <table border="0" cellSpacing="0" cellPadding="0" style="width:780px;">
    <tr> 
      <td class="tdtab" width="780px">Está en : Sistema : Consulta de Promociones
        : Detalle de Sucursales Por Promocion</td>
    </tr>
  </table>
  <table border="0" cellSpacing="0" cellPadding="0" style="width:780px;">
    <tr> 
      <td class="tdgeneralcontent" colspan="8"> 
          <table border="0"  cellSpacing="0" cellPadding="0" style="width:100%;">
                  <tr>
                      <td style="width:780px;"><h1>Sucursales</h1></td>
                  </tr>
            </table>
        <br> <table border="0" cellSpacing="0" cellPadding="0" style="width:100%;">
            <tr>
                <td colspan="8">
                    <h2>Detalle de las Sucursales</h2>
                </td>
            </tr>
          <tr> 
            <td>
        ...
        <div id="tblSucursales" style="width:80%"></div>
      </td>
    </tr>
  </table>
...
<div style="display:none;"> 
  <div id="divConsultaSucursales" colspan="8"> 
