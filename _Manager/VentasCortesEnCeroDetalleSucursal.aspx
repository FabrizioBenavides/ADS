<%@ Page CodeBehind="VentasCortesEnCeroDetalleSucursal.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="com.isocraft.backbone.ccentral.clsVentasCortesEnCeroDetalleSucursal" codePage="1252" enableViewState="False" EnableSessionState="False"%>
<html>
<head>
...
function cmdRegresar_onclick() {
  window.location.href = "<%= "VentasCortesEnCeroDetalleZona.aspx?strCmd=Consultar&intDireccionOperativaId=" & intDireccionId & "&intZonaOperativaId=" & intZonaId & "&txtFechaInicial=" & strFechaInicial & "&txtFechaFinal=" & strFechaFinal %>";
}
...
<form method="POST" action="about:blank" name="frmMain">
  ...
  <table width="780" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="10">&nbsp;</td>
      <td width="770" class="tdtab">Est&aacute; en : Ventas : Cierres : Consultar cortes en cero : Detalle sucursal </td>
    </tr>
  </table>
  <table width="780" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td class="tdgeneralcontent"><h1>Cortes en cero - Detalle sucursal </h1>
        ...
        <br>
        <br>
        <h2>Cortes en cero de otra sucursal </h2>
        <p>Para ver el reporte detallado de otra sucursal, seleccione la direci&oacute;n y oprima &quot;Actualizar reporte&quot; </p>
        <table width="60%" border="0" cellspacing="0" cellpadding="0">
          <tr>
