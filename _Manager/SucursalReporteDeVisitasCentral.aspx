<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SucursalReporteDeVisitasCentral.aspx.vb" Inherits="com.isocraft.backbone.ccentral.SucursalReporteDeVisitasCentral" %>
...
<form name="frmSucursalReporteDeVisitasCentral" action="about:blank" method="post" >
  ...
  <table width="780" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="10">&nbsp;</td>
      <td width="770" class="tdtab">Está en : <A href="../_Manager/InicioHome.aspx">Central</A> : Reporte de Visitas en Sucursales </td>
    </tr>
  </table>
  <table width="780" border="0" cellpadding="0" cellspacing="0">
      ...
      <td class="tdgeneralcontent">
		...
		<p>Elija primero la sucursal y los filtros del empleado asi como el periodo de visitas presionando el boton Buscar.</p> 
		...
		<table style="width:100%;">
            ...
            <tr>
                <td class="tdtexttablebold">
                    <input id="rdPorZona" value="1" type="radio"  name="cmdBusquedaSucursal"  checked="checked" onfocus="return cmdBusquedaSucursal_onfocus(this.value)"/>Por Zona
                </td>
                <td></td>
            
            <td class="tdtexttablebold">
                <input id="rdPorEstado" value="2" type="radio" name="cmdBusquedaSucursal"  onfocus="return cmdBusquedaSucursal_onfocus(this.value)"/>Por Estado
            </td>
                <td></td>
        </tr>
        <tr>
                        ...
                        <td class="tdpadleft5" style="width: 240px">
                            <select id="cboDireccionOperativa" name="cboDireccionOperativa" class="campotabla" style="width:150px" onchange="return cboDireccionOperativa_onchange()">
                                <option selected="selected" value="0">-- Elija una dirección --</option>
                        ...
                        <td class="tdtittablas" style="width: 240px">
                            <select id="cboEstado" class="campotabla" name="cboEstado" class="campotabla" style="width:150px" onChange="return cboEstado_onchange()">
                    ...
                    <tr>
                        ...
                        <td class="tdtittablas" style="width: 240px">
                            <select id="cboCiudad" class="campotabla" name="cboCiudad" class="campotabla" style="width:150px" onchange="return cboCiudad_onchange()">
                     ...
                     <tr>
                        ...
                        <td class="tdpadleft5" style="width: 240px">    
                         ...
                         <td class="tdtexttablebold" style="width: 150px">Sucursal</td>
                        <td class="tdtittablas" style="width: 240px">
                            <select id="cboSucursalEstado" class="campotabla" name="cboSucursalEstado" class="campotabla" style="width:150px" onchange="return cboSucursalEstado_onchange()">
		...
		<tr>
            <td></td>
            <td><input name="txtEmpleadoNombre" id="txtEmpleadoNombre" type="text" class="campotablaresultadoenvolventeazul" value='<%=Request.Form("txtEmpleadoNombre")%>' size="40" maxlength="60"  border="0" readonly tabindex="-1"></td>
		</tr>
            <tr>
                <td></td>
                <td><input class="button" id="cmdConsultar" name="cmdConsultar" value="Buscar" onclick="return cmdConsultar_onclick()" type="button"></td>
            </tr>	
		</table>
          <br>
