<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PopSucursalCupones.aspx.vb" Inherits="com.isocraft.backbone.ccentral.PopSucursalCupones" %>
...
<%  '====================================================================
    ...
    ' Version       : 1.0
    ' Last Modified : Miercoles, 21 de Enero, 2015
    '====================================================================
%>
...
function cmdCerrar_onclick() {
    ...
    opener.document.forms[0].elements['<%=Request.QueryString("strSucursal")%>'].value = intValorSuc;
