...
'====================================================================
' Class         : AsignacionDeArticuloEmpresaServicio
...
Public Class AsignacionDeArticuloEmpresasServicios
...
#End Region
    ...
    Public Function strGetRecordBrowserHTML() As String
        ...
        Const strRecordBrowserName As String = "AsignacionDeArticuloEmpresasServicios" '

        ' Declaramos e inicializamos las variables locales

        Dim intSelectedPage As Integer = GetPageParameter("intNavegadorRegistrosPagina", 1)
        Dim astrDataArray As Array = Benavides.CC.Business.clsConcentrador.clsSucursal.clsEmpresasServicio.strBuscar(intEmpresaServicioId, strConnectionString)

        ' Generamos el navegador de registros
        Return Benavides.CC.Commons.clsRecordBrowser.strGetHTML(strRecordBrowserName, astrDataArray, intSelectedPage, intElementsPerPage, strThisPageName & "?intTipoServicioId=" & intEmpresaServicioId & "&")
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Case "Asignar"
                ...
                If intEmpresaServicioId > 0 Then
                    Call Response.Redirect("SucursalAsignacionDeArticuloDPEmpresasServicios.aspx?strCmd=" & strCmd & "&intEmpresaServicioId=" & intEmpresaServicioId)
                End If
