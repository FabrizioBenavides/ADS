'====================================================================
' Class         : clsSistemaConsultarTransmisionesDetalleDireccion
...
'====================================================================
Public Class clsSistemaConsultarTransmisionesDetalleDireccion
...
#End Region
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        Const strRecordBrowserName As String = "SistemaConsultarTransmisionesDetalleDireccion"
        ...
        Dim astrDataArray As Array = Benavides.CC.Data.clsTransmision.strEjecutarBuscarNivelServicioTransmisionesPorDireccion(intDireccionId, dtmFechaInicial, dtmFechaFinal, intCategoriaRegistroEventoId, CInt(Benavides.CC.Commons.clsRecordBrowser.clsIndicator.intCalculateFirstElement(intSelectedPage, intElementsPerPage)), intElementsPerPage, strConnectionString)

        ' Generamos el navegador de registros
        Return Benavides.CC.Commons.clsRecordBrowser.strGetHTML(strRecordBrowserName, astrDataArray, intSelectedPage, intElementsPerPage, strThisPageName & "?intCategoriaRegistroEventoId=" & intCategoriaRegistroEventoId & "&strFechaInicial=" & CStr(dtmFechaInicial) & "&strFechaFinal=" & CStr(dtmFechaFinal) & "&").Replace("Cajas inhabilitadas", "<script language=""javascript"">strCategoriaRegistroEventoNombre()</script>")
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case strCmd
            ...
            Case "Ver"
                ...
                Call Response.Redirect("SistemaConsultarTransmisionesDetalleZona.aspx?intDireccionOperativaId=" & intDireccionId & "&intZonaOperativaId=" & intZonaId & "&intCategoriaRegistroEventoId=" & intCategoriaRegistroEventoId & "&strFechaInicial=" & strFechaInicial & "&strFechaFinal=" & strFechaFinal)
