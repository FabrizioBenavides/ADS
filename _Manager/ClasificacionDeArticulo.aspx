<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ClasificacionDeArticulo.aspx.vb" Inherits="com.isocraft.backbone.ccentral.clsClasificacionDeArticulo" Explicit="True" Trace="False" Strict="True" codePage="1252" EnableSessionState="true" enableViewState="False" %>
...
function cambiarDisponible()
{
if (document.forms[0].chkDisponible.checked == true)
{document.forms[0].blnClasificacionArticuloDisponibleEnCaptura.value="1";}
else
{document.forms[0].blnClasificacionArticuloDisponibleEnCaptura.value="0";}
}
...
function doSubmit()
{
    ...
    document.forms[0].action = "ClasificacionDeArticulo.aspx?strCmd="+action+ params
...
//-->
	...
	<body onload="window_onload()">
		...
		<form id="Form1" name="frmClasificacionArticulo" action="about:blank" method="post">
			...
			<input type=hidden value="0" name=blnClasificacionArticuloDisponibleEnCaptura> 			
			...
			<table cellSpacing="0" cellPadding="0" width="780" border="0">
				<tr>
					<td width="10">&nbsp;</td>
					<td class="tdtab" width="770">Está en : ADMIN : Catálogos : Clasificación de Artículos </td>
				</tr>
			</table>
			<table cellSpacing="0" cellPadding="0" width="780" border="0">
				<tr>
					<td class="tdgeneralcontent">
						<h1>Catálogo Clasificación de Artículos</h1>
						<p>Aquí podrá dar de alta o modificar las Clasificaciones de Artículos. Capturar los datos y 
							seleccionar el botón "Aceptar" para registrar un nueva nueva Clasificación de Artículos.
						</p>
			...
			<table class="tdenvolventetablas" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<tr>
					<td class="txtitintabla" vAlign="center" align=right><span class="tdtittablas3">Disponible en Captura de Ordenes:</span></td>
					<td class=txtitintabla vAlign=center  Align="left"><input class=field id=chkDisponible type=checkbox  onClick=cambiarDisponible() name=chkDisponible ></td>
				</tr>
				<tr>
