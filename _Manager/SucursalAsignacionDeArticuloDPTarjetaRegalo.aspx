<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SucursalAsignacionDeArticuloDPTarjetaRegalo.aspx.vb" Inherits="com.isocraft.backbone.ccentral.SucursalAsignacionDeArticuloDPTarjetaRegalo"%>
...
{
      document.forms[0].action += "?strCmd=Guardar&IntTarjetaRegaloId=" + <%= IntTarjetaRegaloId()%>;
				...
				<tr>
					...
					<td class="tdtab" width="770">Está en : <A href="SucursalHome.aspx">Sucursal</A> : 
						Promoción de Servicios :<A href="SucursalAsignacionDeArticuloHome.aspx"> Empresas 
							de Servicios </A>: Asignacion de codigo DP&nbsp;Tarjetas de Regalo
					</td>
				</tr>
			</table>
			<table border="0" cellSpacing="0" cellPadding="0" width="780">
				<tr>
					<td class="tdgeneralcontent">
						<h1>Promoción Asignación de Artículo&nbsp;Tarjetas de Regalo</h1>
						<P>Aquí podrá dar de alta o modificar&nbsp;el codigo DP de una Tarjetas De Regalo.</P>
						<P>&nbsp;</P>
						<table border="0" cellSpacing="0" cellPadding="0">
							<tr>
								...
								<td class="tdpadleft5"><input class="field" value="Tarjetas de Regalo" readOnly maxLength="50" size="80">
								</td>
							</tr>
							<tr>
						...
						<h2>Definir&nbsp;Tarjetas De Regalo</h2>
						<table border="0" cellSpacing="0" cellPadding="0">
							<tr>
								<td style="WIDTH: 179px" class="tdtexttablebold"><label for="txtEmpresaServicioNombre">Descripción 
										Tarjeta:</label>
								</td>
								<td class="tdpadleft5"><input id="txtTarjetaRegaloDescripcion" class="field" readOnly maxLength="80" size="80"
										name="txtTarjetaRegaloDescripcion">
								</td>
							</tr>
							<tr>
								...
								<td class="tdpadleft5"><input id="txtTarjetaRegaloCodigoProducto" class="field" readOnly maxLength="80" size="80"
										name="txtTarjetaRegaloCodigoProducto">
								</td>
							</tr>
							<tr>
								...
								<td class="tdpadleft5">
    					            ...
    					            <input name="txtArticuloEncontrado" class="campotablaresultado" size="40" border="0" id="txtArticuloEncontrado"  onchange="javascript:AsignarValorCampo()" readonly>
						...
						<table>
							<TBODY>
								<tr>
									<td class="tdpadleft5" width="499"><input style="DISPLAY: none" id="txtTarjetaRegaloId" class="campotablaresultado" readOnly maxLength="80" size="80" name="txtTarjetaRegaloId">
