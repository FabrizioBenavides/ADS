<%@ Page CodeBehind="SistemaAsignarArticulosPrecioFijo.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="com.isocraft.backbone.ccentral.clsSistemaAsignarArticulosPrecioFijo" codePage="1252" EnableSessionState="False" enableViewState="False"%>
<html>
<head>
...
<form action="about:blank" method="post" enctype="multipart/form-data" name="frmPage">
  ...
  <table width="780" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="10">&nbsp;</td>
      <td width="770" class="tdtab">Está en : <a href="Sistema.htm">Sistema</a> : <a href="SistemaClientesEspeciales.aspx"> Clientes
          especiales</a> : Asignar artículos con precio fijo </td>
    </tr>
  </table>
  <table width="780" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td class="tdgeneralcontent"><h1>Asignar artículos con precio fijo </h1>
        <p>Aquí podrá dar de alta en el sistema artículos con precios fijos y
          asignárselos a un cliente especial.</p>
        <h2>Buscar cliente especial y archivo con artículos </h2>
        <table border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td colspan="3"><p>1. Escriba el idenfiticador o el nombre del cliente
                y oprima el botón "Buscar". Puede usar parte del identificador
                o del nombre.</p>
            </td>
          </tr>
          <tr>
            ...
            <td width="683" class="tdpadleft5"><input name="txtCliente" type="text" class="field" id="txtCliente" size="35" maxlength="35" language=javascript onKeyDown="return txtCliente_onkeydown(event)">
              <input name="cmdBuscarCliente" type="button" class="button" id="cmdBuscarCliente" value="Buscar" language="javascript" onClick="return cmdBuscarCliente_onclick()">
            </td>
          ...
          <tr>
            ...
            <td class="tdpadleft5"><input name="txtArticuloClienteEspecialArchivo" type="file" class="field" id="txtArticuloClienteEspecialArchivo" size="35" title="Archivo" runat="server">
            </td>
