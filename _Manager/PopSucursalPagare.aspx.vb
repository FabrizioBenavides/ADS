...
' Title         : Control de Pagares: Sucursales
' Description   : Popup para selecionar el # de afiliacion por sucursal.
...
Public Class PopSucursalPagare
...
#End Region
    ...
    ' Description: Centro Logistico o Nombre de la Sucursal a Buscar.
    ' Accessor   : Read
    ' Throws     : Ninguna
    ' Output     : String
    '====================================================================
    Public ReadOnly Property strAfiliacionId() As String
        Get
            Return Request.QueryString("strAfiliacionId")
        End Get
    End Property

    '====================================================================
    ' Name       : strRecordBrowserHTML
    ' Description: Genera el Record Browser para mostrar las Sucursales
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        objSucursalDescripcion = Benavides.CC.Data.clsControlPagares.strBuscarSucursalPagare(strAfiliacionId, strCadenaConexion)
        ...
        If IsArray(objSucursalDescripcion) Then
            If objSucursalDescripcion.Length > 0 Then
                ...
                Call strSucursalHTML.Append("<tr class='trtitulos'>")
                Call strSucursalHTML.Append("<th class='rayita' align='center' valign='top' width='75'>Afiliación</th>")
                Call strSucursalHTML.Append("<th class='rayita' align='center' valign='top' width='90'>Sucursal</th>")
                ...
                For Each strSucursal In objSucursalDescripcion
                    ...
                    Call strSucursalHTML.Append("<a class='txaccion'>" & clsCommons.strFormatearDescripcion(strSucursal(1)).ToString & " </a>")
                    Call strSucursalHTML.Append("</td>")

                    Call strSucursalHTML.Append("<td class=" & strColorRegistro & ">")
                    Call strSucursalHTML.Append("<a class='txaccion' href=\""javascript:ClosePopup('" & clsCommons.strFormatearDescripcion(strSucursal(1)).ToString & "','" & clsCommons.strFormatearDescripcion(strSucursal(4)).ToString & "')\"">" & clsCommons.strFormatearDescripcion(strSucursal(4)).ToString & " </a>")
                    Call strSucursalHTML.Append("</td>")
                    Call strSucursalHTML.Append("</tr>")
