<%@ Page CodeBehind="VentasAdministrarArticulosNoAutorizados.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="com.isocraft.backbone.ccentral.clsVentasAdministrarArticulosNoAutorizados" codePage="1252" EnableSessionState="False" enableViewState="False"%>
<html>
<head>
...
function cmdBuscarCliente_onclick() {
  ...
  if (strSourceValue.length > 0) {
    ...
    //Pop("PopClienteEspecial.aspx?strCliente=txtClienteEspecialId&strClienteNombreId=txtClienteEspecialNombre&strClienteBuscar=" + document.forms[0].elements['txtCliente'].value + "&intClienteContado=0", "500", "540");
  } else {
  ...
  <table width="780" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="770" class="tdtab">Está en : <a href="Sistema.aspx">Sistema</a> : <a href="SistemaClientesEspeciales.aspx">Clientes
          especiales</a> : Asignar artículos no autorizados para venta a cr&eacute;dito </td>
    </tr>
  </table>
  <table width="780" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td class="tdgeneralcontent"><h1>Asignar artículos no autorizados para
          venta a crédito </h1>
        <p>Aquí podrá dar de alta en el sistema artículos no autorizados para
          ventas a crédito y asignárselos a un cliente especial.</p>
        ...
        <table border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td colspan="3"><p>2. Localice el archivo con la lista de artículos
                no autorizados para venta a crédito</p>
            </td>
          </tr>
          <tr>
