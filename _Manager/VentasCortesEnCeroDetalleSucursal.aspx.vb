'====================================================================
' Class         : clsVentasCortesEnCeroDetalleSucursal
...
'====================================================================
Public Class clsVentasCortesEnCeroDetalleSucursal
...
#End Region
    ...
    Public Function strLlenarSucursalComboBox() As String
        If intDireccionId > 0 AndAlso intZonaId > 0 Then
            Return isocraft.commons.clsWeb.strCreateJavascriptComboBoxOptions("cboSucursal", strCompaniaSucursalId, Benavides.CC.Data.clsCaja.strEjecutarBuscarCortesEnCeroPorZona(intDireccionId, intZonaId, CDate(strFechaInicial), CDate(strFechaFinal), 1, 100, strConnectionString), New Integer(1) {2, 3}, 4, 1)
        End If
    End Function
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        Const strRecordBrowserName As String = "VentasCortesEnCeroDetalleSucursal"
