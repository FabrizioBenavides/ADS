<%@ Page CodeBehind="SucursalVerCajasInhabilitadasDetalleDireccion.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="com.isocraft.backbone.ccentral.clsSucursalVerCajasInhabilitadasDetalleDireccion" codePage="1252" enableViewState="False" EnableSessionState="False"%>
<html>
<head>
...
function cmdRegresar_onclick() {
  window.location.href = "<%= "SucursalConsultarCajasInhabilitadas.aspx?strCmd=Consultar&txtFechaInicial=" & Benavides.POSAdmin.Commons.clsCommons.strMDYtoDMY(strFechaInicial) & "&txtFechaFinal=" & Benavides.POSAdmin.Commons.clsCommons.strMDYtoDMY(strFechaFinal) %>";
}
...
<table width="780" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="10">&nbsp;</td>
    <td width="770" class="tdtab">Est&aacute; en : Sucursal : Puntos de venta : Consultar cajas inhabilitadas : Ver cajas inhabilitadas - Detalle direcci&oacute;n </td>
  </tr>
</table>
<table width="780" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td class="tdgeneralcontent"><h1>Ver cajas inhabilitadas - Detalle direcci&oacute;n </h1>
      ...
      <br>
      <br>
      <h2>Cajas inhabilitadas en otra direcci&oacute;n </h2>
