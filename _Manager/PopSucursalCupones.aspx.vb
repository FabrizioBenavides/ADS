...
Public Class PopSucursalCupones
...
#End Region
    ...
    Public ReadOnly Property strSucursalId() As String
        Get
            Return Request.QueryString("strSucursalId")
        End Get
    End Property
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        objSucursalDescripcion = Benavides.CC.Data.clsConsultarPromociones.strBuscarPopSucursalCupones(strSucursalId, strCadenaConexion)
        ...
        If IsArray(objSucursalDescripcion) Then
            If objSucursalDescripcion.Length > 0 Then
                ...
                For Each strSucursal In objSucursalDescripcion
                    ...
                    Call strSucursalHTML.Append("<a class='txaccion' href=\""javascript:ClosePopup('" & clsCommons.strFormatearDescripcion(strSucursal(2)).ToString & "','" & clsCommons.strFormatearDescripcion(strSucursal(3)).ToString & "')\"">" & clsCommons.strFormatearDescripcion(strSucursal(2)).ToString & " " & clsCommons.strFormatearDescripcion(strSucursal(3)).ToString & " </a>")
