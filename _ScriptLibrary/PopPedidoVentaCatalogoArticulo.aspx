<%@ Page Language="vb" AutoEventWireup="false" EnableSessionState="False" EnableViewState="False" Explicit="True" Trace="False" Strict="True" Codebehind="PopPedidoVentaCatalogoArticulo.aspx.vb" Inherits="com.isocraft.backbone.ccentral.clsPopPedidoVentaCatalogoArticulo" codePage="28592" %>
...
<%  
    '====================================================================
    ' Page          : PopPedidoVentaCatalogoArticulo.aspx
...
<form name="frmPedidoVentaCatalogoArticulo" action="about:blank" method="post">
