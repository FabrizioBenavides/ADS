...
Public Class clsMercanciaConfirmarFacturaElectronica
...
#End Region
    ...
    Public ReadOnly Property strRecordBrowserHTML() As String
        Get
            ...
            Dim strTargetURL As String = "MercanciaFacturasPorConfirmar.aspx?"
            ...
            objProveedoresConFacturas = clsConcentrador.clsSucursal.clsMercancia.clsFacturaElectronica.strBuscarProveedor(intCompaniaId, intSucursalId, 0, intPosicionInicial, intElementos, strCadenaConexion)
            ...
            If IsArray(objProveedoresConFacturas) AndAlso (objProveedoresConFacturas.Length > 0) Then
                ...
                Return clsCommons.strGenerateJavascriptString(clsRecordBrowser.strGetHTML("MercanciaConfirmarFacturaElectronica", objProveedoresConFacturas, 1, objProveedoresConFacturas.Length, strTargetURL))
