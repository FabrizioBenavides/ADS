...
Public Class clsMercanciaConfirmarEnvioProductos
    ...
    Public strHdnSucursalQueRecibe As String
    Public strIntSucursalQueRecibe As String
    Public strmMensaje As String
    Public intAccionOnLoad As Integer = 0
    Public strHdnCompaniaSucursalDestino As String
...
#End Region
    ...
    '====================================================================
    ' Name       : strMensaje
    ' Description: valor del mensaje a desplegar
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If clsConcentrador.clsSucursal.bolBuscarSucursalCTFLiberada(intCompaniaId, intSucursalId, strCadenaConexion) Then
            Call Response.Redirect(strURLPOSAdmin & "/_ScriptLibrary/MercanciaConfirmarEnvioProductos.aspx")
        End If

        If cmdConfirmar.Equals("") AndAlso _
           (Trim(Request.QueryString("intTransferenciaId"))).Equals("") Then
            Response.Redirect("MercanciaProcesarEnviosAutomaticos.aspx")
        End If
        ...
        If cmdConfirmar.Equals("") Then
            strTipoEstadoTransferenciaNombreId = "GENERADA"
            If intTransferenciaId > 0 Then
                Dim objRegistro As String() = Nothing

                objArray = Nothing
                objArray = clsConcentrador.clsSucursal.clsMercancia.clsInventario.clsTransferencia.strBuscar(intCompaniaId, intSucursalId, intTransferenciaId, strTipoEstadoTransferenciaNombreId, True, 0, 0, strCadenaConexion)
                ...
                If IsArray(objArray) AndAlso (objArray.Length > 0) Then
                    ...
                    strHdnMotivoDeTransferencia = clsCommons.strFormatearDescripcion(CStr(objRegistro.GetValue(6))) '6 strMotivoTransferenciaNombre
                    strHdnSucursalQueRecibe = clsCommons.strFormatearDescripcion(CStr(objRegistro.GetValue(12))) '12 strSucursalDestinoNombre
                    strIntSucursalQueRecibe = clsCommons.strFormatearDescripcion(CStr(objRegistro.GetValue(11))) '11 intSucursalDestinoId 
                    strHdnCompaniaSucursalDestino = CStr(objRegistro.GetValue(10)) & " - " & CStr(objRegistro.GetValue(11))
        ...
        ElseIf cmdConfirmar.Equals("Confirmar") Then
            ...
            For i = 1 To CInt(Request.Form("hdnTotalDePartidas"))
                ...
                intArticuloEstadoTransferenciaCantidad = CInt(Request.Form("txtConfirmada_" & CStr(i)))
            ...
            If intResultado >= 0 Then
                ...
                Else
                    strHdnFolioEnvio = intResultado.ToString
                End If
            End If
            ...
            strHdnSucursalQueRecibe = Request.Form("hdnSucursalQueRecibe")
            strHdnCompaniaSucursalDestino = Request.Form("hdnCompaniaSucursalDestino")
            ...
            Else
                ...
                strMensaje = "Confirmación de envío de productos con éxito."
                intAccionOnLoad = 1
            End If
    ...
    Private Function strGeneraTabla(ByVal objArray As Array, _
        ...
        strHTML.Append("<th width='10%'  class='rayita'>" & strEncaCol0 & "</th>") '"No."
        ...
        strHTML.Append("<th width='10%'  class='rayita'>" & strEncaCol4 & "</th>") '"P. unitario"
        ...
        Else
            strHTML.Append("<th width='10%'  class='rayita'>" & strEncaCol7 & "</th>") '"Recibida"
        End If
        strHTML.Append("</tr>")
        ...
        If IsArray(objArray) AndAlso (objArray.Length > 0) Then
            For Each strRegistro In objArray
                ...
                If blnReadOnly Then
                    '6 intArticuloEstadoTransferenciaCantidad 
                    strHTML.Append("<td class='" & strClass & "'>" & strRegistro(6) & "&nbsp;")
                Else
                    strHTML.Append("<td class='" & strClass & "'>" & "<input name=txtConfirmada_" & Trim(CStr(intRenglon)) & " type=text class=campotabla size=4 " & strReadonly)
                    strHTML.Append("onblur=" & strComilla & "javascript:return ValidarDetalle(this);" & strComilla & ">")
                End If
                strHTML.Append("</td>")
