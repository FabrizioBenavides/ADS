...
Public Class clsMercanciaCapturarDevoluciones
...
#End Region
    ...
    Public Function strGeneraListaMotivosDeDevolucion(ByVal strObjeto As String) As String
        ...
        objMotivosDevolucion = clstblMotivoDevolucion.strBuscar(0, "", "", CDate("01/01/1900"), "", 0, 0, strCadenaConexion)
        ...
        Select Case strCmd
            ...
            Case "BuscarProveedor"
                ...
                If IsNumeric(Mid(strProveedorNombreId, 1, 4)) Then
                    ...
                    objArrayProveedor = clsProveedor.strBuscarPorSucursal(intCompaniaId, intSucursalId, strTipoProveedorNombreId, strProveedorNombreId, intTipoVigencia, 0, 0, strCadenaConexion)
            ...
            Case "BuscarFactura"
                ...
                objArrayFactura = clsConcentrador.clsSucursal.clsMercancia.clsFacturaElectronica.strBuscarFacturaConfirmada(intCompaniaId, intSucursalId, intProveedorId, strTxtFactura, "CONFIRMADA", strCadenaConexion)
            ...
            Case "BuscarArticulo"
                ...
                Dim blnArticuloBuscadoPermiteDevolucion As Byte

                ' Obtenemos la información de los Articulos
                objArrayArticulo = clsProveedor.strBuscarArticulo(intCompaniaId, intSucursalId, strTxtintArticuloId, intProveedorId, "", 1, 0, 0, strCadenaConexion)
                ...
                If IsArray(objArrayArticulo) AndAlso (objArrayArticulo.Length > 0) Then
                    ...
                    Select Case CByte(objRegistroArticulo.Item("blnPermiteDevolucion"))
                        Case 255
                            blnArticuloBuscadoPermiteDevolucion = 1
                        Case Else
                            blnArticuloBuscadoPermiteDevolucion = 0
                    End Select
                ...
                strComitasDobles & blnArticuloBuscadoPermiteDevolucion & strComitasDobles & "," & _
            ...
            Case "AgregarArticulo"
                ...
                Dim blnArticuloAgregarPermiteDevolucion As Byte
                Dim intFacturaAgregarId As Integer


                'Validar en el momento antes de insertar que el articulo exista
                '----------------------------------------------------------------
                objArrayArticulo = clsProveedor.strBuscarArticulo(intCompaniaId, intSucursalId, strTxtintArticuloId, intProveedorId, strTipoProveedorNombreId, 1, 0, 0, strCadenaConexion)
                ...
                If IsArray(objArrayArticulo) AndAlso (objArrayArticulo.Length > 0) Then
                    ...
                    Select Case CByte(objRegistroArticulo.Item("blnPermiteDevolucion"))
                        Case 255
                            blnArticuloAgregarPermiteDevolucion = 1
                        Case Else
                            blnArticuloAgregarPermiteDevolucion = 0
                    End Select
                ...
                If (intArticuloAgregarId > 0) Then
                    ...
                    If blnArticuloAgregarPermiteDevolucion = 1 Then
                        ...
                        If intDevolucionId.Equals(0) Then
                            ...
                            intDevolucionId = clstblDevolucion.intAgregar(0, intCompaniaId, intSucursalId, intProveedorId, CInt(strCmbMotivo), 0, 0, CInt(strTxtNoDeDocumento), strTxtFactura, CDate(strTxtFechaDeDevolucionMDY), CDate("01/01/1900"), strUsuarioNombre, strCadenaConexion)
                        ...
                        If intDevolucionId > 0 Then
                            ...
                            intResultado = clstblArticuloDevolucion.intAgregar(intDevolucionId, intArticuloAgregarId, CInt(strTxtCantidad), Date.Now(), strUsuarioNombre, strCadenaConexion)
                    ...
                    Else
                        strErrorAgregarArticulo = "-130" 'Articulo no permite devolucion
                    End If
                Else
                ...
                objArrayConsulta = clsConcentrador.clsSucursal.clsMercancia.clsDevolucion.strBuscarDetalle(intCompaniaId, intSucursalId, intDevolucionId, strCadenaConexion)
            ...
            Case "EliminarArticulo"
                ...
                intResultado = clstblArticuloDevolucion.intEliminar(intDevolucionEliminarId, intArticuloEliminarId, 0, CDate("01/01/1900"), "", strCadenaConexion)
                ...
                End If
                'strComitasDobles & "" & 1 & "," & _
                '4 strAccion = "ELIMINAR"
                strHTML.Append("<script language='Javascript'> parent.fnUpdArticuloPorIframe( " & _
                strComitasDobles & strAccion & strComitasDobles & "," & _
                strComitasDobles & strListaHTML & strComitasDobles & "," & _
                strComitasDobles & intRegistrosLista & strComitasDobles & "," & _
            ...
            Case "Registrar"
                ...
                If Trim(Request("txtDevolucionFolio")).Equals("") Then
                    ...
                    intResultado = clsConcentrador.clsSucursal.clsMercancia.clsDevolucion.intRegistrar(intCompaniaId, intSucursalId, intDevolucionId, strUsuarioNombre, strCadenaConexion)
