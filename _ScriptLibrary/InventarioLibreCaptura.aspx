...
<%@ Page Language="vb" AutoEventWireup="false" EnableSessionState="False" EnableViewState="False" Explicit="True" Trace="False" Strict="True" Codebehind="InventarioLibreCaptura.aspx.vb" Inherits="com.isocraft.backbone.ccentral.clsInventarioLibreCaptura" codePage="28592"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
<HEAD>
<title>Sistema Administrador de Sucursal</title>
<%  '====================================================================
    ' Page          : InventarioLibreCaptura.aspx
    '
...
function fnUpAccionInventarios(intAccion, strRecordBrowserHTML, intArticuloBuscadoId, strArticuloBuscadoDescripcion, intInventarioId, intTotalRegistrosCapturados, intTotalExistenciasCapturadas, intInventarioFolio, intResultadoAccion ) {
   ...
   if (intAccion == 3) { // Registrar Inventario
       if (intResultadoAccion == 1) {
		   ...
		   if (confirm (msg + "\n żDesea imprimir el Reporte de Diferencias ahora?")) {               
		   	   document.ifrPageToPrint.focus();
	           window.print();               
		   }		   
       }
      ...
      <td width="100%"> <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr> 
            ...
            <td class="tdmigaja" width="583"><span class="txdmigaja">Está en : 
              </span> <a class="txdmigaja" href="javascript:strRedireccionaPOSAdmin('Mercancia.aspx')">Mercancía</a> 
              <span class="txdmigaja">: <a class="txdmigaja" href="javascript:strRedireccionaPOSAdmin('MercanciaInventarios.aspx')"> 
              Inventarios</a></span> <span class="txdmigaja">: </span> <span class="txdmigaja"></span><span class="txdmigaja"> 
              <a class="txdmigaja" href="javascript:strRedireccionaPOSAdmin('MercanciaInventariosRotativos.aspx')"> 
              Inventario Rotativos</a> </span><span class="txdmigaja">: </span> 
              <span class="txdmigaja"></span><span class="txdmigaja"></span> <span class="txdmigaja">Capturar 
              Inventario Libre</span></td>
          ...
          <tr> 
            ...
            <td vAlign="top" width="583"> <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                <tr> 
                  <td class="tdtablacont" vAlign="top" width="1%"> <p><span class="txtitulo">Capturar 
                      Inventario Libre</span><br>
                      <span class="txcontenido">&nbsp;Capture el código&nbsp; 
                      y la cantidad del conteo de cada uno de los productos del 
                      Inventario Libre, oprima "Agregar" para cada uno de los 
                      códigos. Al finalizar oprima&nbsp;"Registrar Inventario"&nbsp;</span><br>
                    </p>
            ...
            <td class="tdcolumnader" vAlign="top" width="182" rowSpan="2"><script language="javascript">strGeneraTablaAyuda('');</script></td>
          </tr>
          <tr> 
