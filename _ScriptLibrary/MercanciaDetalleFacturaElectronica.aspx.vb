...
Public Class clsMercanciaDetalleFacturaElectronica
...
#End Region
    ...
    Public ReadOnly Property strRecordBrowserHTML() As String
        Get
            ...
            Dim strTipoEstadoFacturaElectronicaNombreId As String = "GENERADA"
            ...
            If (intProveedorId > 0) AndAlso (intFacturaElectronicaId > 0) Then
                ...
                objArticulos = clsConcentrador.clsSucursal.clsMercancia.clsFacturaElectronica.strBuscarDetalleFacturaElectronica(intCompaniaId, intSucursalId, intFacturaElectronicaId, intProveedorId, CDate("01/01/1900"), strTipoEstadoFacturaElectronicaNombreId, intPosicionInicial, intElementos, strCadenaConexion)
                ...
                If IsArray(objArticulos) AndAlso (objArticulos.Length > 0) Then
                    ...
                    strProveedorRazonSocial = strRegistroArticulo(6)

                    ' Obtenemos el numero de factura
                    strFacturaElectronicaNumero = strRegistroArticulo(3)

                    ' Obtenemos el numero de Pedido
                    intFacturaElectronicaPedido = CInt(strRegistroArticulo(4))

                    ' Obtenemos la fecha de la factura
                    dtmFacturaElectronicaEmisionDocumento = strRegistroArticulo(5)
