...
Public Class clsPopPedidoVentaCatalogoArticulo
...
#End Region
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        objArrayArticulo = clsCompras.clsPedidoVentaCatalogo.strBuscarArticulo(intCompaniaId, intSucursalId, strArticuloIdNombre, 50, 50, strCadenaConexion)
