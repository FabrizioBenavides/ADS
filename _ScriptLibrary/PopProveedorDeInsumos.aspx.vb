...
Public Class PopProveedorDeInsumos
...
#End Region
    ...
    Public ReadOnly Property intTipoVigencia() As Integer
        ...
        Get
            ...
            Else
                Return 2 ' Si no se lee se regresa 2 para que regrese todos
            End If
        End Get
    End Property
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        Call strProveedorHTML.Append(String.Empty)


        objProveedor = clsCapturaInsumosMateriaPrima.strBuscarProveedorInsumosMateriaPrima(intCompaniaId, intSucursalId, strTipoProveedorNombreId, strProveedorId, intTipoVigencia, 0, 0, strCadenaConexion)
