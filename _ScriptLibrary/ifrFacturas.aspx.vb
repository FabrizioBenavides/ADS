        ...
        Get
            ...
            If IsArray(objArrayFacturasElectronicas) AndAlso objArrayFacturasElectronicas.Length > 0 Then
                ...
                For Each objRegistroFacturasElectronicas In objArrayFacturasElectronicas
                    ...
                    strbldFacturas.Append("<a href='" & strURLSucursal & "MercanciaFacturasPorConfirmar.aspx&strUseRedirector=True&strCmd=VerTodo&intProveedorId=")  '<a href='MercanciaFacturasPorConfirmar.aspx?strCmd=VerTodo&intProveedorId=")
