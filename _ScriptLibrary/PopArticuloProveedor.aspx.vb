...
Public Class PopArticuloProveedor
...
#End Region
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        Call strArticuloProveedorHTML.Append("")

        objArticuloProveedor = clsProveedor.strBuscarArticulo(intCompaniaId, intSucursalId, strArticuloIdNombre, intProveedorId, strTipoProveedorNombreId, intArticulosCompletos, 100, 100, strCadenaConexion)
