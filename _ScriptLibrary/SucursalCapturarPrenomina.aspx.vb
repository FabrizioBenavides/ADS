...
Public Class clsSucursalCapturarPrenomina
...
#End Region
    ...
    Public ReadOnly Property strRecordBrowserHTML() As String
        Get
            ...
            Dim strTargetURL As String = "SucursalCapturarMovimientosEmpleado.aspx?"

            strbldRecordBrowserHTML = New StringBuilder

            ' Busco los empelados de la sucursal
            objEmpleadoPrenomina = clsConcentrador.clsPrenomina.strBuscarEmpleado(intCompaniaId, intSucursalId, 0, 0, 0, strCadenaConexion)

            If IsArray(objEmpleadoPrenomina) Then
                If objEmpleadoPrenomina.Length > 0 Then

                    ' Generamos el Navegador de Registros
                    strbldRecordBrowserHTML.Append(clsRecordBrowser.strGetHTML("SucursalCapturarPrenomina", objEmpleadoPrenomina, 1, intElementos, strTargetURL))
                End If
            End If
