...
Public Class PopArticuloProveedorInsumosMateriaPrima
...
#End Region
    ...
    '====================================================================
    ' Name       : intProveedorId
    ' Description: Código del proveedor a Buscar sus articulos.
    ' Accessor   : Read
    ' Throws     : Ninguna
    ' Output     : String
    '====================================================================
    Public ReadOnly Property intProveedorId() As Integer
        Get
            ...
            strTemporal = Trim(Request.QueryString("intProveedorId"))

            If IsNothing(strTemporal) OrElse strTemporal = String.Empty Then
                Return 0
            Else
    ...
    '====================================================================
    ' Name       : intArticulosCompletos
    ' Description: Si debe mostrar todos los articulos sin importar vigencia
    ' Accessor   : Read
    ' Throws     : Ninguna
    ' Output     : String
    '====================================================================
    Public ReadOnly Property intArticulosCompletos() As Integer
        Get
            Dim strTemporal As String
            strTemporal = Trim(Request.QueryString("intArticulosCompletos"))

            If IsNothing(strTemporal) OrElse strTemporal = "" Then
                Return 0
            Else
                Return CInt(strTemporal)
            End If
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        objArticuloProveedor = clsCapturaInsumosMateriaPrima.strBuscarArticuloInsumosMateriaPrima(intCompaniaId, intSucursalId, strArticuloIdNombre, intProveedorId, strTipoProveedorNombreId, intArticulosCompletos, 100, 100, strCadenaConexion)
        ...
        If IsArray(objArticuloProveedor) AndAlso objArticuloProveedor.Length > 0 Then
            ...
            Call strArticuloProveedorHTML.Append("<tr class='trtitulos'><th class='rayita' width='165'>Descripcion del Articulo</th></tr>")
            ...
            For Each objRegistroArticuloProveedor In objArticuloProveedor
                ...
                Call strArticuloProveedorHTML.Append(CStr(objRegistroArticuloProveedor.Item("intArticuloId")) & "','")
                Call strArticuloProveedorHTML.Append(clsCommons.strFormatearDescripcion(CStr(objRegistroArticuloProveedor.Item("strArticuloDescripcion"))) & "','")
                Call strArticuloProveedorHTML.Append(CStr(objRegistroArticuloProveedor.Item("fltArticuloSucursalCostoReposicion")) & "')\"">")
                Call strArticuloProveedorHTML.Append(CStr(objRegistroArticuloProveedor.Item("intArticuloId")) & " - " & clsCommons.strFormatearDescripcion(CStr(objRegistroArticuloProveedor.Item("strArticuloDescripcion"))))
