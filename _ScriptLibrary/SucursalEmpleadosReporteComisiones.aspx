...
<%@ Page Language="vb" AutoEventWireup="false" EnableSessionState="False" EnableViewState="False" Explicit="True" Trace="False" Strict="True" Codebehind="SucursalEmpleadosReporteComisiones.aspx.vb" Inherits="com.isocraft.backbone.ccentral.SucursalEmpleadosReporteComisiones" codePage="28592" %>
<HTML>
<HEAD>
<title>Sistema Administrador de Sucursal</title>
<%
    '====================================================================
    ' Page          : SucursalEmpleadosReporteComisiones
    ...
    ' Version       : 1.0
    ' Last Modified : 12 Noviembre 2010
...
function window_onload() {
  ...
  document.iframeLayout.document.location = strUrlADSDoc() + "pdf/Comision/" + "<%=strCentroLogisticoId%>" + ".pdf";
...
<form name="frmSucursalEmpleadosReporteComisiones" action="about:blank" method="post">
      ...
      <td width="100%"> <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr> 
            ...
            <td width="583" class="tdmigaja"><span class="txdmigaja">Está en : 
              ...
              Empleados</a><span class="txdmigaja"> : </span></span><span class="txdmigaja"></span><span class="txdmigaja">Reporte 
              de Comisiones</span></td>
            ...
            <td width="583" valign="top"> <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr> 
                  <td width="100%" colspan="3" valign="top" class="tdtablacont"> 
                    <p><span class="txtitulo">Reporte de Comisiones</span> 
