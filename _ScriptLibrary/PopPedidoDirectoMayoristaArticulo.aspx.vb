...
Public Class clsPopPedidoDirectoMayoristaArticulo
...
#End Region
    ...
    Public Function strRecordBrowserHTML() As String
        ...
        objArrayArticulo = clsCompras.clsPedido.strBuscarArticulo(intCompaniaId, intSucursalId, strArticuloIdNombre, intProveedorId, 50, 50, strCadenaConexion)
        ...
        If IsArray(objArrayArticulo) AndAlso objArrayArticulo.Length > 0 Then
            ...
            For Each objRegistroArticulo In objArrayArticulo
                ...
                Call strArticuloHTML.Append("'" & clsCommons.strFormatearDescripcion(CStr(objRegistroArticulo.Item("intClaveVigenciaArticuloId"))).ToString & "' , ")
                Call strArticuloHTML.Append("'" & clsCommons.strFormatearDescripcion(CStr(objRegistroArticulo.Item("strClaveVigenciaArticuloNombre"))).ToString & "' , ")
                Call strArticuloHTML.Append("'" & clsCommons.strFormatearDescripcion(CStr(objRegistroArticulo.Item("intEstacionalidadArticuloId"))).ToString & "' , ")
                Call strArticuloHTML.Append("'" & clsCommons.strFormatearDescripcion(CStr(objRegistroArticulo.Item("strEstacionalidadArticuloDescripcion"))).ToString & "' , ")
                Call strArticuloHTML.Append("'" & clsCommons.strFormatearDescripcion(CStr(objRegistroArticulo.Item("intTipoAbastoArticuloId"))).ToString & "' , ")
                Call strArticuloHTML.Append("'" & clsCommons.strFormatearDescripcion(CStr(objRegistroArticulo.Item("strTipoAbastoArticuloDescripcion"))).ToString & "' , ")
                Call strArticuloHTML.Append("'" & clsCommons.strFormatearDescripcion(CStr(objRegistroArticulo.Item("intProveedoresAutorizadosNo"))).ToString & "' , ")
                Call strArticuloHTML.Append("'" & clsCommons.strFormatearDescripcion(CStr(objRegistroArticulo.Item("strProveedoresAutorizadosDescripcion"))).ToString & "' , ")
                Call strArticuloHTML.Append("'" & clsCommons.strFormatearDescripcion(CStr(objRegistroArticulo.Item("blnArticuloAutorizado"))).ToString & "' ")
                Call strArticuloHTML.Append(")\"">")
