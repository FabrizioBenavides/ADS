...
Public Class MercanciaConsultaInventarioRotativo
    ...
    Protected WithEvents listadoNombre As System.Web.UI.WebControls.TextBox
    Protected WithEvents dtmSelectedDate As System.Web.UI.WebControls.TextBox
    Protected WithEvents intListadoId As System.Web.UI.HtmlControls.HtmlInputHidden
    Protected WithEvents intOrdenamiento As System.Web.UI.HtmlControls.HtmlInputHidden
    Protected WithEvents status As System.Web.UI.HtmlControls.HtmlInputHidden
    Protected WithEvents listadoEstatus As System.Web.UI.HtmlControls.HtmlInputHidden
    Protected WithEvents btnPrevious As System.Web.UI.HtmlControls.HtmlInputButton
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.currentDate.Text = Today.ToString("dd/MM/yyyy")
    ...
    Private Sub setSelectedDate()
        If Me.dateSelection1.Checked Then
            selDate = Today
        Else
            If Me.selectedDate.Text <> "" Then
                selDate = clsDateUtil.StringToDate(Me.selectedDate.Text, "dd/MM/yyyy")
            End If
        End If
    End Sub
...
#Region "metodos de la interface PrintInterface"
    ...
    Function getHeaders() As String Implements PrintInterface.getHeaders
        ...
        If Me.selectedOrdenamiento = PLANOGRAMA Then
            'Por planograma
            Dim widths As String() = {"5%", "7%", "26%", "7%", "25%", "10%", "10%", "10%"}
            Dim values As String() = {"#", "#Plano", "Planograma", "Código Prod.", "Descripción", "Cant. Bodega", "Cant. Piso", "Total"}

            code.Append(clsHTMLUtils.getTagTR("th", 8, "rayita", "txcont", widths, values))

        Else
            'Alfabeticamente
            Dim widths As String() = {"5%", "10%", "25%", "10%", "10%", "10%"}
            Dim values As String() = {"#", "Código Prod.", "Descripción", "Cant. Bodega", "Cant. Piso", "Total"}

            code.Append(clsHTMLUtils.getTagTR("th", 6, "rayita", "txcont", widths, values))
    ...
    Function getRow(ByVal aRow As Array, ByVal globalRowCounter As Integer) As String Implements PrintInterface.getRow
        ...
        If Me.selectedOrdenamiento = planograma Then
            ...
            code.Append(clsPrintUtil.getCell(clsStringUtil.TruncString(planograma, 26)))
        End If
        ...
        code.Append(clsPrintUtil.getCell(clsStringUtil.TruncString(descr, 26)))
